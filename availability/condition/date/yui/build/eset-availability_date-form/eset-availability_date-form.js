YUI.add('eset-availability_date-form', function (Y, NAME) {

/**
 * JavaScript for form editing date conditions.
 *
 * @module eset-availability_date-form
 */
 ...
 *
 * Because the date fields are complex depending on Eset calendar settings,
 ...
 * actual time via an AJAX request to Eset.
 *
...
}, '@VERSION@', {"requires": ["base", "node", "event", "io", "eset-core_availability-form"]});
