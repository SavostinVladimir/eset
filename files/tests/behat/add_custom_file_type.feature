...
Feature: Add a new custom file type
  ...
  Scenario: Add custom file type
    ...
    And I set the following fields to these values:
      | Extension | mdlr |
      | MIME type | application/x-eset-rules |
      | File icon | document                       |
      | Description type | Custom description specified in this form |
      | Custom description | Eset rules |
    And I press "Save changes"
    And I should see "application/x-eset-rules"
    And I log out
    ...
    And I should see "Eset rules" in the "span.resourcelinkdetails" "css_element"
