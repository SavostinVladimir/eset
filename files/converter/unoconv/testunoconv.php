...
$PAGE->set_url(new eset_url('/files/converter/unoconv/testunoconv.php'));
...
$PAGE->navbar->add(get_string('pluginname', 'fileconverter_unoconv'),
        new eset_url('/admin/settings.php', array('section' => 'fileconverterunoconv')));
...
$returl = new eset_url('/admin/settings.php', array('section' => 'fileconverterunoconv'));
