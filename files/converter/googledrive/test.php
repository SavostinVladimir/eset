...
$PAGE->set_url(new eset_url('/files/converter/googledrive/test.php'));
...
$PAGE->navbar->add(get_string('pluginname', 'fileconverter_googledrive'),
        new eset_url('/admin/settings.php', array('section' => 'fileconvertergoogledrive')));
...
if ($result) {
    ...
    $pdflink = new eset_url($PAGE->url, array('sendpdf' => 1, 'sesskey' => sesskey()));
...
$returl = new eset_url('/admin/settings.php', array('section' => 'fileconvertergoogledrive'));
