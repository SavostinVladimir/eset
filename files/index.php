...
/**
 * Eset file tree viewer based on YUI2 Treeview
 *
 * @package    core
 * @subpackage file
...
navigation_node::override_active_url(new eset_url('/files/index.php', array('contextid'=>$contextid)));
...
require_capability('eset/course:managefiles', $context);
