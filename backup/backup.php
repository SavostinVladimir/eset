...
$courseurl = new eset_url('/course/view.php', array('id' => $courseid));
$url = new eset_url('/backup/backup.php', array('id'=>$courseid));
if ($sectionid !== null) {
...
switch ($type) {
    ...
    case backup::TYPE_1SECTION :
        require_capability('eset/backup:backupsection', $coursecontext);
    ...
    case backup::TYPE_1ACTIVITY :
        ...
        require_capability('eset/backup:backupactivity', $activitycontext);
...
if (!async_helper::is_async_pending($id, 'course', 'backup')) {
    ...
    if (!($bc = backup_ui::load_controller($backupid))) {
        $bc = new backup_controller($type, $id, backup::FORMAT_ESET,
    ...
    if ($backup->get_stage() == backup_ui::STAGE_FINAL) {
        ...
        if ($backupmode != backup::MODE_ASYNC) {
            ...
            $restoreurl = new eset_url('/backup/restorefile.php', array('contextid' => $contextid));
            $progresssetup = array(
                    'backupid' => $backupid,
                    'contextid' => $contextid,
