...
navigation_node::override_active_url(new eset_url('/backup/restorefile.php', array('contextid'=>$contextid)));
$PAGE->set_url(new eset_url('/backup/restore.php', array('contextid'=>$contextid)));
