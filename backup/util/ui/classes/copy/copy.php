...
class copy  {
     ...
     * @throws \eset_exception If one of the required copy fields is missing
     */
    private final function get_copy_data(\stdClass $formdata): \stdClass {
        ...
        foreach ($this->copyfields as $field) {
            if (isset($formdata->{$field})) {
                ...
                throw new \eset_exception('copyfieldnotfound', 'backup', '', null, $field);
            }
        }
    ...
    public function create_copy(): array {
        ...
        $bc = new \backup_controller(\backup::TYPE_1COURSE, $this->copydata->courseid, \backup::FORMAT_ESET,
