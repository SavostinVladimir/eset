...
class import_ui extends backup_ui {
    ...
    public function get_progress_bar() {
        ...
        $selectorlink = new eset_url($PAGE->url, $this->stage->get_params());
...
class import_ui_stage_confirmation extends backup_ui_stage_confirmation {
    ...
    /**
     * Initialises the stages esetform
     * @return esetform
     */
    ...
    public function display(core_backup_renderer $renderer) {
        ...
        // A nasty hack follows to work around the sad fact that eset quickforms
...
class import_course_search extends restore_course_search {
    ...
    protected function setup_restrictions() {
        $this->require_capability('eset/backup:backuptargetimport');
    }
}
