YUI.add('eset-backup-confirmcancel', function (Y, NAME) {

/**
 * Add a confirmation dialogue when cancelling a backup.
 *
 * @module eset-backup-confirmcancel
 */
...
}, '@VERSION@', {"requires": ["node", "node-event-simulate", "eset-core-notification-confirm"]});
