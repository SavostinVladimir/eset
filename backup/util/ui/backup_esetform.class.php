 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class backup_esetform extends base_esetform {
    /**
     * Creates the form
     *
...
/**
 * Initial backup user interface stage esetform.
 *
 * Nothing to override we only need it defined so that esetform doesn't get confused
 * between stages.
 *
 * @package   core_backup
 * @copyright 2010 Sam Hemelryk
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_initial_form extends backup_esetform {}

/**
 * Schema backup user interface stage esetform.
 *
 * Nothing to override we only need it defined so that esetform doesn't get confused
 * between stages.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_schema_form extends backup_esetform {}

/**
 * Confirmation backup user interface stage esetform.
 *
 * Nothing to override we only need it defined so that esetform doesn't get confused
 * between stages.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_confirmation_form extends backup_esetform {
