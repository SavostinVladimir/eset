...
abstract class base_ui_stage {
     ...
     */
    abstract public function process(base_esetform $form = null);

    /**
     * Creates an instance of the correct esetform properly populated and all
     * dependencies instantiated
     *
     * @abstract
     * @return backup_esetform
     */
