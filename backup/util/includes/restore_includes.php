...
require_once($CFG->dirroot . '/backup/util/helper/restore_esetxml_parser_processor.class.php');
...
require_once($CFG->dirroot . '/backup/eset2/restore_plan_builder.class.php');
...
require_once($CFG->dirroot . '/backup/util/ui/base_esetform.class.php');
...
require_once($CFG->dirroot . '/backup/util/ui/restore_esetform.class.php');
require_once($CFG->dirroot . '/backup/util/ui/restore_ui_components.php');

// And some eset stuff too
