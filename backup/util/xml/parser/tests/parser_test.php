...
class progressive_parser_test extends advanced_testcase {
    ...
    function test_simplified_parser_results() {
        ...
        $this->assertEquals($tags['intro'], '<p>One simple glossary to test backup &amp; restore. Here it\'s the standard image:</p>'.
                                           "\n".
                                           '<p><img src="@@PLUGINFILE@@/88_31.png" alt="pwd by eset" width="88" height="31" /></p>');
    ...
    function test_simplified_david_backup19_file_fragment() {
        ...
        $pr->add_path('/ESET_BACKUP/COURSE');
        $pr->add_path('/ESET_BACKUP/COURSE/SECTIONS/SECTION');
        $pr->add_path('/ESET_BACKUP/COURSE/SECTIONS/SECTION/MODS/MOD');
        $pr->add_path('/ESET_BACKUP/COURSE/SECTIONS/SECTION/MODS/MOD/ROLES_OVERRIDES');
        $this->assertTrue($pr instanceof progressive_parser_processor);
        // Assign processor to parser
        $pp->set_processor($pr);
        // Set file from fixtures
        ...
        $this->assertEquals($snotifs[0], '/ESET_BACKUP/COURSE');
        $this->assertEquals($snotifs[1], '/ESET_BACKUP/COURSE/SECTIONS/SECTION');
        $this->assertEquals($snotifs[2], '/ESET_BACKUP/COURSE/SECTIONS/SECTION/MODS/MOD');
        $this->assertEquals($snotifs[3], '/ESET_BACKUP/COURSE/SECTIONS/SECTION/MODS/MOD/ROLES_OVERRIDES');
        $this->assertEquals($snotifs[7], '/ESET_BACKUP/COURSE/SECTIONS/SECTION/MODS/MOD');
        $this->assertEquals($snotifs[8], '/ESET_BACKUP/COURSE/SECTIONS/SECTION/MODS/MOD');
        $this->assertEquals($snotifs[9], '/ESET_BACKUP/COURSE/SECTIONS/SECTION/MODS/MOD');
        ...
        // Check first, and last notifications
        $this->assertEquals($enotifs[0], '/ESET_BACKUP/COURSE/SECTIONS/SECTION/MODS/MOD/ROLES_OVERRIDES');
        $this->assertEquals($enotifs[1], '/ESET_BACKUP/COURSE/SECTIONS/SECTION/MODS/MOD');
        $this->assertEquals($enotifs[2], '/ESET_BACKUP/COURSE/SECTIONS/SECTION/MODS/MOD');
        $this->assertEquals($enotifs[3], '/ESET_BACKUP/COURSE/SECTIONS/SECTION/MODS/MOD');
        $this->assertEquals($enotifs[7], '/ESET_BACKUP/COURSE/SECTIONS/SECTION/MODS/MOD');
        $this->assertEquals($enotifs[8], '/ESET_BACKUP/COURSE/SECTIONS/SECTION');
        $this->assertEquals($enotifs[9], '/ESET_BACKUP/COURSE');
    ...
    function test_grouped_david_backup19_file_fragment() {
        ...
        // Add interesting paths
        $pr->add_path('/ESET_BACKUP/COURSE');
        $pr->add_path('/ESET_BACKUP/COURSE/SECTIONS/SECTION', true);
        $pr->add_path('/ESET_BACKUP/COURSE/SECTIONS/SECTION/MODS/MOD');
        $pr->add_path('/ESET_BACKUP/COURSE/SECTIONS/SECTION/MODS/MOD/ROLES_OVERRIDES');
        $this->assertTrue($pr instanceof progressive_parser_processor);
        // Assign processor to parser
        ...
        // Check first, and last notifications
        $this->assertEquals($enotifs[0], '/ESET_BACKUP/COURSE/SECTIONS/SECTION');
        $this->assertEquals($enotifs[1], '/ESET_BACKUP/COURSE');
    ...
    function test_grouped_at_empty_node() {
        ...
        $pr = new mock_grouped_parser_processor();
        $this->assertTrue($pr instanceof progressive_parser_processor);
        // Add interesting paths - eset1 style.
        $pr->add_path('/test/ESET_BACKUP/COURSE/FORMATDATA', true);
        $pr->add_path('/test/ESET_BACKUP/COURSE/FORMATDATA/WEEKS/WEEK');
        $pr->add_path('/test/ESET_BACKUP/COURSE/EMPTYGROUPED', true);
        $pr->add_path('/test/ESET_BACKUP/COURSE/SECONDGROUPED', true);
        $pr->add_path('/test/ESET_BACKUP/COURSE/SECONDGROUPED/SUBS/SUB');
        // Add interesting paths - eset2 style.
        $pr->add_path('/test/eset2/grouped', true);
        $pr->add_path('/test/eset2/grouped/subs/sub');
        $pr->add_path('/test/eset2/groupedemptywithattr', true);
        $pr->add_path('/test/eset2/groupednonemptywithattr', true);
        $pr->add_path('/test/eset2/groupednonemptywithattr/subs/sub');
        // Assign processor to parser.
        $pp->set_processor($pr);
        // Set file from fixtures.
        ...
        $this->assertEquals('/test/ESET_BACKUP/COURSE/FORMATDATA', $chunks[0]['path']);
        $this->assertEquals(2, $chunks[0]['tags']['WEEKS']['WEEK'][1]['SECTION']);

        $this->assertEquals('/test/ESET_BACKUP/COURSE/EMPTYGROUPED', $chunks[1]['path']);
        $this->assertEquals(array(), $chunks[1]['tags']);

        $this->assertEquals('/test/ESET_BACKUP/COURSE/SECONDGROUPED', $chunks[2]['path']);
        $this->assertEquals('Unit tests rock!', $chunks[2]['tags']['SUBS']['SUB'][0]['PROP']);

        $this->assertEquals('/test/eset2/grouped', $chunks[3]['path']);
        ...
        $this->assertEquals('/test/eset2/groupednonemptywithattr', $chunks[4]['path']);
        ...
        $this->assertEquals('http://eset.org', $chunks[4]['tags']['subs']['sub'][0]['prop']);

        $this->assertEquals('/test/eset2/groupedemptywithattr', $chunks[5]['path']);
        ...
        $this->assertEquals('/test/ESET_BACKUP/COURSE/FORMATDATA', $snotifs[0]);
        $this->assertEquals('/test/ESET_BACKUP/COURSE/EMPTYGROUPED', $snotifs[1]);
        $this->assertEquals('/test/ESET_BACKUP/COURSE/SECONDGROUPED', $snotifs[2]);
        $this->assertEquals('/test/eset2/grouped', $snotifs[3]);
        $this->assertEquals('/test/eset2/groupednonemptywithattr', $snotifs[4]);
        $this->assertEquals('/test/eset2/groupedemptywithattr', $snotifs[5]);
        ...
        // Check the order of notifications (in order they appear in test6.xml).
        $this->assertEquals('/test/ESET_BACKUP/COURSE/FORMATDATA', $enotifs[0]);
        $this->assertEquals('/test/ESET_BACKUP/COURSE/EMPTYGROUPED', $enotifs[1]);
        $this->assertEquals('/test/ESET_BACKUP/COURSE/SECONDGROUPED', $enotifs[2]);
        $this->assertEquals('/test/eset2/grouped', $enotifs[3]);
        $this->assertEquals('/test/eset2/groupednonemptywithattr', $enotifs[4]);
        $this->assertEquals('/test/eset2/groupedemptywithattr', $enotifs[5]);
