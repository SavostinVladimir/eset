 ...
 *
 * This class implements various functions related with eset storage
...
class backup_file_manager {
    ...
    /**
     * Copy one file from eset storage to backup storage
     */
    public static function copy_file_eset2backup($backupid, $filerecorid) {
        global $DB;
