...
class async_helper  {
     ...
     *
     * @return eset_url $url The link to the resource.
     */
    private function get_resource_link() {
        ...
        if ($this->type == 'backup') {
            ...
            $url = new eset_url('/backup/restorefile.php', array('contextid' => $context->id));
        } else {
     ...
     *
     * @param \context $context The Eset context for the restores.
