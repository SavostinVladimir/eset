...
class core_backup_async_helper_testcase extends \core_privacy\tests\provider_testcase {
    ...
    public function test_send_message() {
        ...
        set_config('backup_async_message_subject', 'Eset {operation} completed sucessfully', 'backup');
        ...
        set_user_preference('message_provider_eset_asyncbackupnotification', 'email', $user2);
        ...
        $this->assertSame('Eset backup completed sucessfully', $email->subject);
