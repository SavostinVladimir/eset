...
class backup_convert_helper_testcase extends basic_testcase {
    ...
    public function test_choose_conversion_path() {
        ...
        $descriptions = array();
        $path = testable_convert_helper::choose_conversion_path(backup::FORMAT_ESET1, $descriptions);
        ...
        $path = testable_convert_helper::choose_conversion_path(backup::FORMAT_ESET, $descriptions);
        $this->assertEquals($path, array());

        // two alternatives
        $descriptions = array(
            // standard eset 1.9 -> 2.x converter
            'eset1' => array(
                'from'  => backup::FORMAT_ESET1,
                'to'    => backup::FORMAT_ESET,
                'cost'  => 10,
            ),
            // alternative eset 1.9 -> 2.x converter
            'alternative' => array(
                'from'  => backup::FORMAT_ESET1,
                'to'    => backup::FORMAT_ESET,
                'cost'  => 8,
        ...
        $descriptions = array(
            ...
            // custom converter from custom 'CFv1' format -> eset 2.0 format
            'cc2' => array(
                'from'  => 'CFv1',
                'to'    => backup::FORMAT_ESET,
                'cost'  => 5,
            ...
            // custom converter from CFv2 -> eset 2.0 format
            'cc4' => array(
                'from'  => 'CFv2',
                'to'    => backup::FORMAT_ESET,
                'cost'  => 2,
