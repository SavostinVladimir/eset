...
abstract class backup_helper {
     ...
     * into Eset file storage. For stored files it returns the complete file_info object
     *
     ...
     *
     * @throws eset_exception in case of any problems
     */
    static public function store_backup_file($backupid, $filepath, \core\progress\base $progress = null) {
        ...
        if (empty($filename)) {
            $filename = backup_plan_dbops::get_default_backup_filename('eset2', $backuptype, $id, $hasusers, $isannon);
        }
