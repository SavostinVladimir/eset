...
class backup_dbops_testcase extends advanced_testcase {
    ...
    function test_backup_controller_dbops() {
        ...
        $bc = new mock_backup_controller4dbops(backup::TYPE_1ACTIVITY, $this->moduleid, backup::FORMAT_ESET,
    ...
    function test_backup_controller_dbops_includes_files() {
        ...
        $bc = new mock_backup_controller4dbops(backup::TYPE_1COURSE, $this->courseid, backup::FORMAT_ESET,
