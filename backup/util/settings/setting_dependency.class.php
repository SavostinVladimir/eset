...
abstract class setting_dependency {
    ...
    /**
     * Returns an array of properties suitable to be used to define a esetforms
     * disabled command
     * @return array
     */
    abstract public function get_esetform_properties();
    /**
...
class setting_dependency_disabledif_equals extends setting_dependency {
     ...
     * @return array
     */
    public function get_esetform_properties() {
        return array(
