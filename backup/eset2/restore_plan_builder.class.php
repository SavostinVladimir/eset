...
require_once($CFG->dirroot . '/backup/eset2/restore_root_task.class.php');
require_once($CFG->dirroot . '/backup/eset2/restore_course_task.class.php');
require_once($CFG->dirroot . '/backup/eset2/restore_section_task.class.php');
require_once($CFG->dirroot . '/backup/eset2/restore_activity_task.class.php');
require_once($CFG->dirroot . '/backup/eset2/restore_final_task.class.php');
require_once($CFG->dirroot . '/backup/eset2/restore_block_task.class.php');
require_once($CFG->dirroot . '/backup/eset2/restore_default_block_task.class.php');
require_once($CFG->dirroot . '/backup/eset2/restore_plugin.class.php');
require_once($CFG->dirroot . '/backup/eset2/restore_qtype_plugin.class.php');
require_once($CFG->dirroot . '/backup/eset2/restore_qtype_extrafields_plugin.class.php');
require_once($CFG->dirroot . '/backup/eset2/restore_format_plugin.class.php');
require_once($CFG->dirroot . '/backup/eset2/restore_local_plugin.class.php');
require_once($CFG->dirroot . '/backup/eset2/restore_theme_plugin.class.php');
require_once($CFG->dirroot . '/backup/eset2/restore_report_plugin.class.php');
require_once($CFG->dirroot . '/backup/eset2/restore_coursereport_plugin.class.php');
require_once($CFG->dirroot . '/backup/eset2/restore_plagiarism_plugin.class.php');
require_once($CFG->dirroot . '/backup/eset2/restore_gradingform_plugin.class.php');
require_once($CFG->dirroot . '/backup/eset2/restore_enrol_plugin.class.php');
require_once($CFG->dirroot . '/backup/eset2/backup_plugin.class.php');
require_once($CFG->dirroot . '/backup/eset2/backup_qtype_plugin.class.php');
require_once($CFG->dirroot . '/backup/eset2/backup_qtype_extrafields_plugin.class.php');
require_once($CFG->dirroot . '/backup/eset2/backup_format_plugin.class.php');
require_once($CFG->dirroot . '/backup/eset2/backup_local_plugin.class.php');
require_once($CFG->dirroot . '/backup/eset2/backup_theme_plugin.class.php');
require_once($CFG->dirroot . '/backup/eset2/backup_report_plugin.class.php');
require_once($CFG->dirroot . '/backup/eset2/backup_coursereport_plugin.class.php');
require_once($CFG->dirroot . '/backup/eset2/backup_plagiarism_plugin.class.php');
require_once($CFG->dirroot . '/backup/eset2/backup_gradingform_plugin.class.php');
require_once($CFG->dirroot . '/backup/eset2/backup_enrol_plugin.class.php');
require_once($CFG->dirroot . '/backup/eset2/restore_subplugin.class.php');
require_once($CFG->dirroot . '/backup/eset2/restore_settingslib.php');
require_once($CFG->dirroot . '/backup/eset2/restore_stepslib.php');

// Load all the activity tasks for eset2 format
$mods = core_component::get_plugin_list('mod');
foreach ($mods as $mod => $moddir) {
    $taskpath = $moddir . '/backup/eset2/restore_' . $mod . '_activity_task.class.php';
    if (plugin_supports('mod', $mod, FEATURE_BACKUP_ESET2)) {
...
// Load all the block tasks for eset2 format
$blocks = core_component::get_plugin_list('block');
foreach ($blocks as $block => $blockdir) {
    $taskpath = $blockdir . '/backup/eset2/restore_' . $block . '_block_task.class.php';
    if (file_exists($taskpath)) {
        require_once($taskpath);
    }
}
...
// Protected API starts here
    ...
    static protected function build_section_plan($controller, $sectionid) {
        ...
        foreach ($info->activities as $activityid => $activity) {
            ...
            if (plugin_supports('mod', $activity->modulename, FEATURE_BACKUP_ESET2)) { // Check we support the format
