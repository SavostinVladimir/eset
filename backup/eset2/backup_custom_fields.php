 ...
 * physical file from eset file storage to backup file storage
 *
 * TODO: Finish phpdocs
 */
class file_nested_element extends backup_nested_element {
    ...
    public function fill_values($values) {
        ...
        // Do our own tasks (copy file from eset to backup)
        try {
            backup_file_manager::copy_file_eset2backup($this->backupid, $values);
