...
abstract class backup_block_task extends backup_task {
    ...
    public function __construct($name, $blockid, $moduleid = null, $plan = null) {
        ...
        // If moduleid passed, check exists, supports eset2 format and save info
        ...
        if (!empty($moduleid)) {
            ...
            if (!plugin_supports('mod', $coursemodule->modname, FEATURE_BACKUP_ESET2)) {
                throw new backup_task_exception('block_task_activity_lacks_eset2_backup_support', $coursemodule->modname);
            }
