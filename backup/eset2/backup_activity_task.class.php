 ...
 * mod/MODULENAME/backup/eset2/backup_MODULENAME_activity_task.class.php
...
abstract class backup_activity_task extends backup_task {
    ...
    public function __construct($name, $moduleid, $plan = null) {
        ...
        // Check activity supports this eset2 backup format
        if (!plugin_supports('mod', $coursemodule->modname, FEATURE_BACKUP_ESET2)) {
            throw new backup_task_exception('activity_task_activity_lacks_eset2_backup_support', $coursemodule->modname);
        }
...
// Protected API starts here
     ...
     * the course by URLs like http://my.eset.site/mod/workshop/view.php?id=42
