...
require_once($CFG->dirroot . '/backup/eset2/backup_root_task.class.php');
require_once($CFG->dirroot . '/backup/eset2/backup_activity_task.class.php');
require_once($CFG->dirroot . '/backup/eset2/backup_section_task.class.php');
require_once($CFG->dirroot . '/backup/eset2/backup_course_task.class.php');
require_once($CFG->dirroot . '/backup/eset2/backup_final_task.class.php');
require_once($CFG->dirroot . '/backup/eset2/backup_block_task.class.php');
require_once($CFG->dirroot . '/backup/eset2/backup_default_block_task.class.php');
require_once($CFG->dirroot . '/backup/eset2/backup_xml_transformer.class.php');
...
require_once($CFG->dirroot . '/backup/eset2/backup_subplugin.class.php');
require_once($CFG->dirroot . '/backup/eset2/backup_settingslib.php');
require_once($CFG->dirroot . '/backup/eset2/backup_stepslib.php');
require_once($CFG->dirroot . '/backup/eset2/backup_custom_fields.php');

// Load all the activity tasks for eset2 format
$mods = core_component::get_plugin_list('mod');
foreach ($mods as $mod => $moddir) {
    $taskpath = $moddir . '/backup/eset2/backup_' . $mod . '_activity_task.class.php';
...
foreach ($blocks as $block => $blockdir) {
    $taskpath = $blockdir . '/backup/eset2/backup_' . $block . '_block_task.class.php';
    if (file_exists($taskpath)) {
        require_once($taskpath);
    }
}
...
// Protected API starts here
    ...
    static protected function build_section_plan($controller, $id) {
        ...
        foreach ($coursemodules as $coursemodule) {
            if (plugin_supports('mod', $coursemodule->modname, FEATURE_BACKUP_ESET2)) { // Check we support the format
