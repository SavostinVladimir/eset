...
class core_backup_controller_testcase extends advanced_testcase {
    ...
    public function test_base_controller_set_copy() {
        ...
        $bc = new \backup_controller(backup::TYPE_1COURSE, $this->courseid, backup::FORMAT_ESET,
    ...
    public function test_backup_controller() {
        ...
        $bc = new mock_backup_controller(backup::TYPE_1ACTIVITY, $this->moduleid, backup::FORMAT_ESET,
    ...
    public function test_backup_controller_include_files() {
        ...
        $bc = new mock_backup_controller(backup::TYPE_1COURSE, $this->courseid, backup::FORMAT_ESET,
            backup::INTERACTIVE_NO, backup::MODE_IMPORT, $this->userid);
        $this->assertEquals($bc->get_include_files(), 0);
    }
    ...
    public function test_restore_controller_is_executing() {
        ...
        $bc = new backup_controller(backup::TYPE_1ACTIVITY, $this->moduleid, backup::FORMAT_ESET,
            backup::INTERACTIVE_NO, backup::MODE_IMPORT, $this->userid);
