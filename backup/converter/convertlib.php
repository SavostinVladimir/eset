 ...
 *
 * All Eset backup converters are supposed to extend this base class.
 *
...
abstract class base_converter implements loggable {
     ...
     *
     * Eset 2.x format is being detected by the core itself. The converters are
     * therefore supposed to detect the source format. Eventually, if the target
     * format os not {@link backup::FORMAT_ESET} then they should be able to
 ...
 */
class convert_exception extends eset_exception {
