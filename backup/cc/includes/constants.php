...
// ESET RESOURCES TYPE ********************************************************************************************** //
define('ESET_TYPE_FORUM', 'forum');
define('ESET_TYPE_QUIZ', 'quiz');
define('ESET_TYPE_QUESTION_BANK', 'question_bank');
define('ESET_TYPE_RESOURCE', 'resource');
define('ESET_TYPE_LABEL', 'label');
define('ESET_TYPE_BASICLTI', 'basiclti');
define('ESET_TYPE_LTI', 'lti');
...
//ESET QUESTIONS TYPES ********************************************************************************************** //
define('ESET_QUIZ_MULTIPLE_CHOICE', 'multichoice');
define('ESET_QUIZ_TRUE_FALSE', 'truefalse');
define('ESET_QUIZ_MULTIANSWER', 'multianswer');
define('ESET_QUIZ_MULTIPLE_RESPONSE', 'multichoice');
define('ESET_QUIZ_MACHT', 'match');
define('ESET_QUIZ_ESSAY', 'essay');
define('ESET_QUIZ_SHORTANSWER', 'shortanswer');
