...
class cc11_lti extends entities11 {
    ...
    public function generate_node () {
        ...
        if (!empty(cc2eset::$instances['instances'][ESET_TYPE_LTI])) {
            foreach (cc2eset::$instances['instances'][ESET_TYPE_LTI] as $instance) {
    ...
    private function create_node_course_modules_mod_basiclti ($instance) {
        ...
        $sheet_mod_basiclti = cc112eset::loadsheet(SHEET_COURSE_SECTIONS_SECTION_MODS_MOD_LTI);
