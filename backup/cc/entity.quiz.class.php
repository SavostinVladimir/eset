...
class cc_quiz extends entities {
    ...
    public function generate_node_course_modules_mod () {
        ...
        cc2eset::log_action('Creating Quiz mods');
    ...
    private function create_node_course_modules_mod_quiz_feedback () {
        ...
        $sheet_question_mod_feedback = cc2eset::loadsheet(SHEET_COURSE_SECTIONS_SECTION_MODS_MOD_QUIZ_FEEDBACK);
    ...
    private function generate_instances () {
        ...
        foreach ($types as $type) {
            ...
            if (!empty(cc2eset::$instances['instances'][$type])) {

                foreach (cc2eset::$instances['instances'][$type] as $instance) {
                    ...
                    if (!empty($assessment_file)) {
                        ...
                        $assessment = $this->load_xml_resource(
                            cc2eset::$path_to_manifest_folder . DIRECTORY_SEPARATOR . $assessment_file
                        );
    ...
    private function create_node_course_modules_mod ($instance) {
        ...
        $sheet_question_mod = cc2eset::loadsheet(SHEET_COURSE_SECTIONS_SECTION_MODS_MOD_QUIZ);
    ...
    private function create_node_course_modules_mod_quiz_question_instances ($instance) {
        ...
        $sheet_question_mod_instance = cc2eset::loadsheet(SHEET_COURSE_SECTIONS_SECTION_MODS_MOD_QUIZ_QUESTION_INSTANCE);
    ...
    private function create_node_course_question_categories($instances) {
        ...
        $sheet_question_categories = cc2eset::loadsheet(SHEET_COURSE_QUESTION_CATEGORIES);
    ...
    private function create_node_course_question_categories_question_category ($instance) {
        ...
        $sheet_question_categories_quetion_category = cc2eset::loadsheet(SHEET_COURSE_QUESTION_CATEGORIES_QUESTION_CATEGORY);
    ...
    private function create_node_course_question_categories_question_category_question ($instance) {
        ...
        $sheet_question_categories_question = cc2eset::loadsheet(SHEET_COURSE_QUESTION_CATEGORIES_QUESTION_CATEGORY_QUESTION);
    ...
    private function create_node_course_question_categories_question_category_question_multiple_choice ($question) {
        ...
        $sheet_question_categories_question = cc2eset::loadsheet(SHEET_COURSE_QUESTION_CATEGORIES_QUESTION_CATEGORY_QUESTION_MULTIPLE_CHOICE);
    ...
    private function create_node_course_question_categories_question_category_question_eesay ($question) {
        ...
        $sheet_question_categories_question = cc2eset::loadsheet(SHEET_COURSE_QUESTION_CATEGORIES_QUESTION_CATEGORY_QUESTION_EESAY);
    ...
    private function create_node_course_question_categories_question_category_question_shortanswer ($question) { //, &$fib_questions) {
        ...
        $sheet_question_categories_question = cc2eset::loadsheet(SHEET_COURSE_QUESTION_CATEGORIES_QUESTION_CATEGORY_QUESTION_SHORTANSWER);
        $node_course_question_categories_question_answer = '';
    ...
    private function create_node_course_question_categories_question_category_question_true_false ($question) {
        ...
        $sheet_question_categories_question = cc2eset::loadsheet(SHEET_COURSE_QUESTION_CATEGORIES_QUESTION_CATEGORY_QUESTION_TRUE_FALSE);
    ...
    private function create_node_course_question_categories_question_category_question_answer ($answer) {
        ...
        $sheet_question_categories_question_answer = cc2eset::loadsheet(SHEET_COURSE_QUESTION_CATEGORIES_QUESTION_CATEGORY_QUESTION_ANSWER);
