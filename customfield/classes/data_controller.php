...
abstract class data_controller {
    ...
    public static function create(int $id, \stdClass $record = null, field_controller $field = null) : data_controller {
        ...
        if (!class_exists($customfieldtype) || !is_subclass_of($customfieldtype, self::class)) {
            throw new \eset_exception('errorfieldtypenotfound', 'core_customfield', '', s($type));
        }
     ...
     */
    public function instance_form_definition_after_data(\EsetQuickForm $mform) {
     ...
     * @param \EsetQuickForm $mform
     */
    public abstract function instance_form_definition(\EsetQuickForm $mform);
