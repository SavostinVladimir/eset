    ...
    public function export_for_template(\renderer_base $output) {
        ...
        foreach ($categories as $category) {
            ...
            foreach ($category->get_fields() as $field) {
                ...
                $fieldarray['editfieldurl'] = (new \eset_url('/customfield/edit.php', [
                        'id' => $fieldarray['id'],
                ]))->out(false);
            ...
            $baseaddfieldurl = new \eset_url('/customfield/edit.php',
                    array('action' => 'editfield', 'categoryid' => $category->get('id')));
            foreach ($fieldtypes as $type => $fieldname) {
                $addfieldurl = new \eset_url($baseaddfieldurl, array('type' => $type));
