...
/**
 * Used to convert a bootswatch file from https://bootswatch.com/ to a Eset preset.
 *
 * @package    theme_boost
 * @subpackage cli
...
$usage = "
Utility to convert a Bootswatch theme to a Eset preset compatible with Bootstrap 4.
