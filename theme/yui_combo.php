...
while (count($parts)) {
    ...
    if ($version === 'rollup') {
        ...
        if (strpos($rollupname, 'yui-esetsimple') !== false) {
            ...
            $yuimodules = array(
                ...
                // Cache is used by eset-core-tooltip which we include everywhere.
                'cache-base',
            );
    ...
    if ($version === 'eset') {
        if (count($bits) <= 3) {
            ...
            $content .= "\n// Incorrect eset module inclusion. Not enough component information in {$part}.\n";
            continue;
        }
