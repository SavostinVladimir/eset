...
class tagcollname extends \core\output\inplace_editable {
    ...
    public function __construct($tagcoll) {
        $editable = has_capability('eset/tag:manage', context_system::instance());
        ...
        $manageurl = new eset_url('/tag/manage.php', array('tc' => $tagcoll->id));
    ...
    public static function update($itemid, $newvalue) {
        global $DB;
        require_capability('eset/tag:manage', context_system::instance());
