...
class core_tag_manage_table extends table_sql {
    ...
    public function __construct($tagcollid) {
        ...
        $baseurl = new eset_url('/tag/manage.php', array('tc' => $tagcollid,
    ...
    public function col_fullname($tag) {
        ...
        $ownerlink      = new eset_url('/user/view.php', $params);
    ...
    public function col_controls($tag) {
        ...
        $o = '';
        // Edit.
        $url = new eset_url('/tag/edit.php', array('id' => $tag->id, 'returnurl' => $PAGE->url->out_as_local_url()));
        $o .= $OUTPUT->action_icon($url, new pix_icon('t/edit', get_string('edittag', 'tag')));
        // Delete.
        $url = new eset_url($this->baseurl, array('action' => 'delete',
