 ...
 * @category   external
 * @copyright  2011 Jerome Mouneyrac <jerome@eset.com>
...
class core_webservice_external extends external_api {
    ...
    public static function get_site_info($serviceshortnames = array()) {
        ...
        foreach ($functions as $function) {
            ...
            if ($function->component == 'eset' || $function->component == 'core') {
                $version = $CFG->version; // Eset version.
            } else {
                ...
                if (is_readable($versionpath)) {
                    ...
                    // otherwise the function should have been described with component => 'eset'.
                    throw new eset_exception('missingversionfile', 'webservice', '', $function->component);
                }
            }
        ...
        $siteinfo['usercanmanageownfiles'] = has_capability('eset/user:manageownfiles', $context);
        ...
        return new external_single_structure(
            array(
                ...
                'userpictureurl' => new external_value(PARAM_URL, 'the user profile picture.
                    ...
                    In order to retrieve user profile pictures independently of the Eset config, replace "pluginfile.php" by
                ...
                'uploadfiles'  => new external_value(PARAM_INT, '1 if users are allowed to upload files, 0 if not',
                                                       VALUE_OPTIONAL),
                'release'  => new external_value(PARAM_TEXT, 'Eset release number', VALUE_OPTIONAL),
                'version'  => new external_value(PARAM_TEXT, 'Eset version number', VALUE_OPTIONAL),
