...
class webservice_rest_server extends webservice_base_server {
    ...
    public function set_rest_format(): void {
        ...
        $restformatisset = isset($methodvariables['esetwsrestformat'])
                && (($methodvariables['esetwsrestformat'] == 'xml' || $methodvariables['esetwsrestformat'] == 'json'));
        $this->restformat = $restformatisset ? $methodvariables['esetwsrestformat'] : 'xml';
    }
    ...
    protected function parse_request() {
        ...
        unset($methodvariables['esetwsrestformat']);
