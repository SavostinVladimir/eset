...
class xmlrpc_server_test extends advanced_testcase {
    ...
    public function parse_request_provider() {
        ...
        $requiredparams = '<params><param><value><string>eset</string></value></param></params>';
        $allparams = '<params><param><value><string>eset</string></value></param><param><value><string>en</string></value>'
                . '</param></params>';
