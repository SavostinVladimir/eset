...
class webservice_xmlrpc_client {
    ...
    /** @var eset_url The XML-RPC server url. */
    protected $serverurl;
    ...
    public function call($functionname, $params = array()) {
        ...
        $headers = array(
            ...
            'User-Agent' => 'Eset XML-RPC Client/1.0',
        );
    ...
    protected function decode_response($response) {
        // XMLRPC server in Eset encodes response using function xmlrpc_encode_request() with method==null
