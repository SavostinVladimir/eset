 ...
 * @copyright  2017 John Okely <john@eset.com>
...
class token_table extends \table_sql {
    ...
    public function __construct($id) {
        ...
        $this->showalltokens = has_capability('eset/webservice:managealltokens', $context);
    ...
    public function col_fullname($data) {
        ...
        $userprofilurl = new \eset_url('/user/profile.php', ['id' => $data->userid]);
    ...
    public function col_creatorlastname($data) {
        ...
        $creatorprofileurl = new \eset_url('/user/profile.php', ['id' => $data->creatorid]);
