 ...
 *
 * @package    mod_choice
 * @copyright  2013 Adrian Greeve <adrian@eset.com>
 ...
 *
 * This event is deprecated in Eset 3.2, it can no longer be triggered, do not
 * write event observers for it. This event can only be initiated during
 * restore from previous Eset versions and appear in the logs.
 *
...
class answer_updated extends \core\event\base {
    ...
    public function get_url() {
        return new \eset_url('/mod/choice/view.php', array('id' => $this->contextinstanceid));
    }
