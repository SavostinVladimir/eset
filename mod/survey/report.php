...
// Check that all the parameters have been provided.
    ...
    $url = new eset_url('/mod/survey/report.php', array('id'=>$id));
    if ($action !== '') {
    ...
    switch ($action) {
      ...
      case "download":
        ...
        if ($numusers > 0) {
            ...
            $options["type"] = "ods";
            echo $OUTPUT->single_button(new eset_url("download.php", $options), get_string("downloadods"));

            $options["type"] = "xls";
            echo $OUTPUT->single_button(new eset_url("download.php", $options), get_string("downloadexcel"));

            $options["type"] = "txt";
            echo $OUTPUT->single_button(new eset_url("download.php", $options), get_string("downloadtext"));
