 ...
 */
class eset1_mod_survey_handler extends eset1_mod_handler {
     ...
     * defined.
     *
     * Note that the path /ESET_BACKUP/COURSE/MODULES/MOD/SURVEY does not
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'survey', '/ESET_BACKUP/COURSE/MODULES/MOD/SURVEY',
                array(
                    'newfields' => array(
                        'introformat' => 0,
                    ),
    ...
    /**
     * This is executed every time we have one /ESET_BACKUP/COURSE/MODULES/MOD/SURVEY
     * data available
     */
