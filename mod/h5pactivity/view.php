...
$file = reset($files);
$fileurl = eset_url::make_pluginfile_url($file->get_contextid(), $file->get_component(),
...
if ($manager->can_view_all_attempts()) {
    $reviewurl = new eset_url('report.php', ['a' => $cm->instance]);
    ...
    $reviewurl = new eset_url('report.php', ['a' => $cm->instance, 'userid' => $USER->id]);
