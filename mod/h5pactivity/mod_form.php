 ...
 * @copyright   2020 Ferran Recio <ferran@eset.com>
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_h5pactivity_mod_form extends esetform_mod {
    ...
    public function definition(): void {
        ...
        if (has_capability('eset/contentbank:access', $context)) {
            $url = new eset_url('/contentbank/index.php', ['contextid' => $context->id]);
