 ...
 */
class eset1_mod_assignment_handler extends eset1_mod_handler {
    ...
    /** @var array of a eset1_assignment_[subplugin_name]_handler instances */
     ...
     * defined.
     *
     * Note that the path /ESET_BACKUP/COURSE/MODULES/MOD/ASSIGNMENT does not
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'assignment', '/ESET_BACKUP/COURSE/MODULES/MOD/ASSIGNMENT',
                array(
                    'renamefields' => array(
                        'description' => 'intro',
                        'format' => 'introformat',
            ...
            //new convert_path('assignment_submission', '/ESET_BACKUP/COURSE/MODULES/MOD/ASSIGNMENT/SUBMISSIONS/SUBMISSION')
        );
    }

    /**
     * This is executed every time we have one /ESET_BACKUP/COURSE/MODULES/MOD/ASSIGNMENT
     * data available
     */
    ...
    /**
     * This is executed every time we have one /ESET_BACKUP/COURSE/MODULES/MOD/ASSIGNMENT/SUBMISSIONS/SUBMISSION
     * data available
     */
     ...
     * @return eset1_assignment_subplugin_handler the instance of the handler
     */
    protected function get_subplugin_handler($subplugin) {
        ...
        if (is_null($this->subpluginhandlers)) {
            ...
            foreach ($subplugins as $name => $dir) {
                ...
                $handlerclass = "eset1_mod_assignment_{$name}_subplugin_handler";
                ...
                if (!$this->subpluginhandlers[$name] instanceof eset1_assignment_subplugin_handler) {
                    throw new eset1_convert_exception('wrong_handler_class', get_class($this->subpluginhandlers[$name]));
                }
            }
        }
        ...
        if (!isset($this->subpluginhandlers[$subplugin])) {
            ...
            $this->subpluginhandlers[$subplugin] = new eset1_assignment_unsupported_subplugin_handler($this, $subplugin);
        }
 ...
 */
abstract class eset1_assignment_subplugin_handler extends eset1_submod_handler {

    /**
     * @param eset1_mod_handler $assignmenthandler the handler of a module we are subplugin of
     * @param string $subpluginname the name of the subplugin
     */
    public function __construct(eset1_mod_handler $assignmenthandler, $subpluginname) {
 ...
 */
class eset1_assignment_unsupported_subplugin_handler extends eset1_assignment_subplugin_handler {
}
