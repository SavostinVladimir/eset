...
class mod_wiki_external_testcase extends externallib_advanced_testcase {
    ...
    public function test_view_wiki() {
        ...
        $esetwiki = new \eset_url('/mod/wiki/view.php', array('id' => $this->cm->id));
        $this->assertEquals($esetwiki, $event->get_url());
    ...
    public function test_view_page() {
        ...
        $this->assertEquals($this->context, $event->get_context());
        $pageurl = new \eset_url('/mod/wiki/view.php', array('pageid' => $this->firstpage->id));
    ...
    public function test_get_subwiki_files_collaborative_no_groups() {
        ...
        $expectedfile = array(
            ...
            'fileurl' => eset_url::make_webservice_pluginfile_url($file['contextid'], $file['component'],
        ...
        $expectedfile['fileurl'] = eset_url::make_webservice_pluginfile_url($file['contextid'], $file['component'],
                            $file['filearea'], $file['itemid'], $file['filepath'], $file['filename']);
