...
class EsetQuickForm_wikifiletable extends HTML_QuickForm_element {
     ...
     */
    public function EsetQuickForm_wikifiletable($elementName = null, $elementLabel = null, $attributes = null, $fileinfo = null, $format = null) {
...
//register wikieditor
EsetQuickForm::registerElementType('wikifiletable', $CFG->dirroot."/mod/wiki/editors/wikifiletable.php", 'EsetQuickForm_wikifiletable');
