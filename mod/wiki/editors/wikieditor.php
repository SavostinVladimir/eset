...
class EsetQuickForm_wikieditor extends EsetQuickForm_textarea {
     ...
     */
    public function EsetQuickForm_wikieditor($elementName = null, $elementLabel = null, $attributes = null) {
...
//register wikieditor
EsetQuickForm::registerElementType('wikieditor', $CFG->dirroot."/mod/wiki/editors/wikieditor.php", 'EsetQuickForm_wikieditor');
