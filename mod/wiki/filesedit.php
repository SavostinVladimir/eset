...
if (empty($returnurl)) {
    ...
    if (!empty($referer)) {
        ...
        $returnurl = new eset_url('/mod/wiki/files.php', array('subwiki' => $subwiki->id, 'pageid' => $pageid));
    }
}
...
$url = new eset_url('/mod/wiki/filesedit.php', array('subwiki'=>$subwiki->id, 'pageid'=>$pageid));
$PAGE->set_url($url);
