...
// 'create' action must be submitted by eset form
...
if (groups_get_activity_groupmode($cm)) {
    ...
    $canaccessgroups = has_capability('eset/site:accessallgroups', $modulecontext);
    if ($canaccessgroups) {
...
// set page action, and initialise eset form
