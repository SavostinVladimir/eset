...
class collaborative_page extends \core_search\base_mod {
     ...
     * @return eset_recordset|null Recordset (or null if no results)
     */
    ...
    public function get_document($record, $options = array()) {
        ...
        // Convert to text.
        $content = content_to_text($page->cachedcontent, FORMAT_ESET);
    ...
    public function get_doc_url(\core_search\document $doc) {
        ...
        return new \eset_url('/mod/wiki/view.php', $params);
    }
    ...
    public function get_context_url(\core_search\document $doc) {
        ...
        return new \eset_url('/mod/wiki/view.php', array('id' => $contextmodule->instanceid));
    }
