 ...
 *
 * @package    mod_quiz
 * @copyright  2018 Shamim Rezaie <shamim@eset.com>
...
if ($returnurl) {
    ...
    $returnurl = new eset_url('/mod/quiz/edit.php', array('cmid' => $cm->id));
}

$url = new eset_url('/mod/quiz/editrandom.php', array('slotid' => $slotid));
$PAGE->set_url($url);
...
$mform = new mod_quiz\form\randomquestion_form(new eset_url('/mod/quiz/editrandom.php'),
