...
class edit_renderer extends \plugin_renderer_base {
     ...
     * @param \eset_url $pageurl the canonical URL of this page.
     * @param array $pagevars the variables from {@link question_edit_setup()}.
     * @return string HTML to output.
     */
    public function edit_page(\quiz $quizobj, structure $structure,
            \question_edit_contexts $contexts, \eset_url $pageurl, array $pagevars) {
        $output = '';
     ...
     * @return string HTML to output.
     */
    public function maximum_grade_input($structure, \eset_url $pageurl) {
        $output = '';
     ...
     * @return string HTML to output.
     */
    protected function repaginate_button(structure $structure, \eset_url $pageurl) {
    ...
    protected function selectmultiple_controls(structure $structure) {
        ...
        $output .= html_writer::tag('div',
                        ...
                        " " .
                        html_writer::tag('button', get_string('cancel', 'eset'),
        ...
        $selectalltext = get_string('selectall', 'eset');
        $deselectalltext = get_string('deselectall', 'eset');
     ...
     * @return string HTML to output.
     */
    protected function repaginate_form(structure $structure, \eset_url $pageurl) {
        $perpage = array();
    ...
    protected function start_section($structure, $section) {
        ...
        if (!$structure->can_be_edited()) {
            ...
            $editsectionheadingicon = html_writer::link(new \eset_url('#'),
                $this->pix_icon('t/editstring', get_string('sectionheadingedit', 'quiz', $section->heading),
                        'eset', array('class' => 'editicon visibleifjs')),
    ...
    public function section_remove_icon($section) {
        ...
        $url = new \eset_url('/mod/quiz/edit.php',
     ...
     * @return string HTML to output.
     */
    public function add_menu_actions(structure $structure, $page, \eset_url $pageurl,
    ...
    public function edit_menu_actions(structure $structure, $page,
            \eset_url $pageurl, array $pagevars) {
        ...
        $returnurl = new \eset_url($pageurl, array('addonpage' => $page));
        ...
        $actions['addaquestion'] = new \action_menu_link_secondary(
            new \eset_url('/question/addquestion.php', $params),
            new \pix_icon('t/add', $str->addaquestion, 'eset', array('class' => 'iconsmall', 'title' => '')),
            $str->addaquestion, array('class' => 'cm-edit-action addquestion', 'data-action' => 'addquestion')
        );

        // Call question bank.
        $icon = new \pix_icon('t/add', $str->questionbank, 'eset', array('class' => 'iconsmall', 'title' => ''));
        if ($page) {
        ...
        if ($structure->can_add_random_questions()) {
            $returnurl = new \eset_url('/mod/quiz/edit.php', array('cmid' => $structure->get_cmid(), 'data-addonpage' => $page));
            $params = ['returnurl' => $returnurl, 'cmid' => $structure->get_cmid(), 'appendqnumstring' => 'addarandomquestion'];
            $url = new \eset_url('/mod/quiz/addrandom.php', $params);
            $icon = new \pix_icon('t/add', $str->addarandomquestion, 'eset', array('class' => 'iconsmall', 'title' => ''));
        ...
        $actions['addasection'] = new \action_menu_link_secondary(
            new \eset_url($pageurl, $params),
            new \pix_icon('t/add', $str->addasection, 'eset', array('class' => 'iconsmall', 'title' => '')),
     ...
     * @return string HTML to output.
     */
    protected function add_question_form(structure $structure, $page, \eset_url $pageurl, array $pagevars) {
        ...
        return html_writer::tag('form', html_writer::div($output),
                array('class' => 'addnewquestion', 'method' => 'post',
                        'action' => new \eset_url('/question/addquestion.php')));
    }
     ...
     * @return string HTML to output.
     */
    public function question(structure $structure, $slot, \eset_url $pageurl) {
        $output = '';
    ...
    public function question_move_icon(structure $structure, $slot) {
        return html_writer::link(new \eset_url('#'),
            $this->pix_icon('i/dragdrop', get_string('move'), 'eset', array('class' => 'iconsmall', 'title' => '')),
     ...
     * @param structure $structure object containing the structure of the quiz.
     * @param int $slot the first slot on the page we are outputting.
     * @param \eset_url $pageurl the canonical URL of the edit page.
     * @return string HTML to output.
     */
    public function question_remove_icon(structure $structure, $slot, $pageurl) {
        $url = new \eset_url($pageurl, array('sesskey' => sesskey(), 'remove' => $slot));
    ...
    public function page_split_join_button($structure, $slot) {
        ...
        $url = new \eset_url('repaginate.php', array('quizid' => $structure->get_quizid(),
    ...
    public function question_name(structure $structure, $slot, $pageurl) {
        ...
        $editurl = new \eset_url('/question/question.php', array(
        ...
        $editicon = $this->pix_icon('t/edit', '', 'eset', array('title' => ''));
    ...
    public function random_question(structure $structure, $slotnumber, $pageurl) {
        ...
        $editurl = new \eset_url('/mod/quiz/editrandom.php',
        ...
        $editicon = $this->pix_icon('t/edit', $configuretitle, 'eset', array('title' => ''));
        ...
        $qbankurl = new \eset_url('/question/edit.php', $qbankurlparams);
    ...
    public function marked_out_of_field(structure $structure, $slot) {
        if (!$structure->is_real_question($slot)) {
            ...
            $output .= html_writer::span(
                    $this->pix_icon('spacer', '', 'eset', array('class' => 'editicon visibleifjs', 'title' => '')),
                    'editing_maxmark');
        ...
        $output .= html_writer::span(
            html_writer::link(
                new \eset_url('#'),
                $this->pix_icon('t/editstring', '', 'eset', array('class' => 'editicon visibleifjs', 'title' => '')),
                array(
    ...
    protected function initialise_editing_javascript(structure $structure,
            \question_edit_contexts $contexts, array $pagevars, \eset_url $pageurl) {
        ...
        $this->page->requires->yui_module('eset-mod_quiz-toolboxes',
        ...
        $this->page->requires->yui_module('eset-mod_quiz-dragdrop', 'M.mod_quiz.init_section_dragdrop',
                array(array(
                        'courseid' => $structure,
                        'quizid' => $structure->get_quizid(),
                        'ajaxurl' => $config->sectionurl,
        ...
        $this->page->requires->yui_module('eset-mod_quiz-dragdrop', 'M.mod_quiz.init_resource_dragdrop',
                array(array(
                        'courseid' => $structure,
                        'quizid' => $structure->get_quizid(),
                        'ajaxurl' => $config->resourceurl,
