...
class quiz_access_manager {
    ...
    public static function add_settings_form_fields(
            mod_quiz_mod_form $quizform, EsetQuickForm $mform) {
     ...
     * @param eset_url $url the form action URL.
     * @param int|null $attemptid the id of the current attempt, if there is one,
     *      otherwise null.
     * @return mod_quiz_preflight_check_form the form.
     */
    public function get_preflight_check_form(eset_url $url, $attemptid) {
     ...
     * by the access rules.
     *
     * @param eset_page $page the page object to initialise.
     */
     ...
     * @param array $files un-used, Eset seems to not support it anymore
     * @param int|null $attemptid the id of the current attempt, if there is one,
     *      otherwise null.
