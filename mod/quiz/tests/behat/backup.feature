...
Feature: Backup and restore of quizzes
  ...
  Scenario: Restore a Eset 2.8 quiz backup
    When I am on "Course 1" course homepage
    And I navigate to "Restore" in current page administration
    And I press "Manage backup files"
    And I upload "mod/quiz/tests/fixtures/eset_28_quiz.mbz" file to "Files" filemanager
    And I press "Save changes"
    And I restore "eset_28_quiz.mbz" backup into "Course 1" course using this options:
    And I am on the "Restored Eset 2.8 quiz" "mod_quiz > Edit" page
    Then I should see "TF1"
    And I should see "TF2"
