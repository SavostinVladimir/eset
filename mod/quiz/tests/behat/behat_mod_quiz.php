...
class behat_mod_quiz extends behat_question_base {
    ...
    protected function resolve_page_instance_url(string $type, string $identifier): eset_url {
        ...
        switch ($type) {
            case 'View':
                return new eset_url('/mod/quiz/view.php',
                        ['id' => $this->get_cm_by_quiz_name($identifier)->id]);

            case 'Edit':
                return new eset_url('/mod/quiz/edit.php',
                        ['cmid' => $this->get_cm_by_quiz_name($identifier)->id]);

            case 'Group overrides':
                return new eset_url('/mod/quiz/overrides.php',
            ...
            case 'Grades report':
                return new eset_url('/mod/quiz/report.php',
            ...
            case 'Attempt review':
                ...
                return new eset_url('/mod/quiz/review.php', ['attempt' => $attempt->id]);
