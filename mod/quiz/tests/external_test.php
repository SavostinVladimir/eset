...
class mod_quiz_external_testcase extends externallib_advanced_testcase {
    ...
    public function test_view_quiz() {
        ...
        $esetquiz = new \eset_url('/mod/quiz/view.php', array('id' => $this->cm->id));
        $this->assertEquals($esetquiz, $event->get_url());
    ...
    public function test_view_attempt_summary() {
        ...
        $this->assertEquals($context, $event->get_context());
        $esetquiz = new \eset_url('/mod/quiz/summary.php', array('attempt' => $attempt->id));
        $this->assertEquals($esetquiz, $event->get_url());
        $this->assertEventContextNotUsed($event);
        $this->assertNotEmpty($event->get_name());
    ...
    public function test_view_attempt_review() {
        ...
        $this->assertEquals($context, $event->get_context());
        $esetquiz = new \eset_url('/mod/quiz/review.php', array('attempt' => $attempt->id));
        $this->assertEquals($esetquiz, $event->get_url());
        $this->assertEventContextNotUsed($event);
        $this->assertNotEmpty($event->get_name());
    ...
    public function test_get_quiz_feedback_for_grade() {
        ...
        $this->assertEquals(FORMAT_ESET, $result['feedbacktextformat']);
    }
