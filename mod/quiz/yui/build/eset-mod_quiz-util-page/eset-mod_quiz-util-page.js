YUI.add('eset-mod_quiz-util-page', function (Y, NAME) {
 ...
 * @submodule eset-mod_quiz-util-page
 */

Y.namespace('Eset.mod_quiz.util.page');

/**
 * A collection of utility classes for use with pages.
 *
 * @class Eset.mod_quiz.util.page
 * @static
 */
Y.Eset.mod_quiz.util.page = {
    CSS: {
        PAGE: 'page'
    },
    CONSTANTS: {
        ...
        PAGEIDPREFIX: 'page-',
        PAGENUMBERPREFIX: M.util.get_string('page', 'eset') + ' '
    },
    SELECTORS: {
        ACTIONMENU: 'div.eset-actionmenu',
     ...
     */
    getPages: function() {
        return Y.all(Y.Eset.mod_quiz.util.slot.SELECTORS.PAGECONTENT + ' ' +
                     Y.Eset.mod_quiz.util.slot.SELECTORS.SECTIONUL + ' ' +
                    this.SELECTORS.PAGE);
    },
    ...
    remove: function(page, keeppagebreak) {
        ...
        var previousslot = page.previous(Y.Eset.mod_quiz.util.slot.SELECTORS.SLOT);
        if (!keeppagebreak && previousslot) {
            Y.Eset.mod_quiz.util.slot.removePageBreak(previousslot);
        }
        page.remove();
    },
