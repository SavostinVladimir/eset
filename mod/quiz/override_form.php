 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quiz_override_form extends esetform {
    ...
    protected function definition() {
        ...
        $accessallgroups = ($quizgroupmode == NOGROUPS) || has_capability('eset/site:accessallgroups', $this->context);
        ...
        if ($this->groupmode) {
            ...
            if ($this->groupid) {
                ...
                if (empty($groups)) {
                    // Generate an error.
                    $link = new eset_url('/mod/quiz/overrides.php', array('cmid'=>$cm->id));
