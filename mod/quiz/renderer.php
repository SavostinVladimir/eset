...
class mod_quiz_renderer extends plugin_renderer_base {
     ...
     *
     * @param eset_url $url contains a url to the given page
     */
    ...
    public function attempt_form($attemptobj, $page, $slots, $id, $nextpage) {
        ...
        $output .= html_writer::start_tag('form',
                array('action' => new eset_url($attemptobj->processattempt_url(),
     ...
     * @param eset_url $url the URL to redirect the parent window to.
    ...
    public function summary_page_controls($attemptobj) {
        ...
        if ($attemptobj->get_state() == quiz_attempt::IN_PROGRESS) {
            $button = new single_button(
                    new eset_url($attemptobj->attempt_url(null, $attemptobj->get_currentpage())),
        ...
        $button = new single_button(
                new eset_url($attemptobj->processattempt_url(), $options),
     ...
     * @param eset_url $url The URL to POST to in order to start the attempt.
     ...
     * @return string HTML fragment.
     */
    public function start_attempt_button($buttontext, eset_url $url,
     ...
     *
     * @param eset_url $url of the target page.
    ...
    public function quiz_attempt_summary_link_to_reports($quiz, $cm, $context,
        ...
        $url = new eset_url('/mod/quiz/report.php', array(
     ...
     * @param eset_url $url the URL of the graph.
     * @param string $title the title to display above the graph.
     * @return string HTML fragment for the graph.
     */
    public function graph(eset_url $url, $title) {
        global $CFG;
...
class mod_quiz_links_to_other_attempts implements renderable {
     ...
     * url may be either a eset_url, or a renderable.
     */
    public $links = array();
}
...
class mod_quiz_view_object {
    ...
    public $canedit;
    /** @var eset_url $editurl the URL for editing this quiz. */
    public $editurl;
    ...
    public $buttontext;
    /** @var eset_url $startattempturl URL to start an attempt. */
    public $startattempturl;
    /** @var esetform|null $preflightcheckform confirmation form that must be
     *       submitted before an attempt is started, if required. */
    public $preflightcheckform;
    /** @var eset_url $startattempturl URL for any Back to the course button. */
