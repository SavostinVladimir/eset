...
// You also need the eset/question:useall capability somewhere.
require_capability('mod/quiz:manage', $contexts->lowest());
if (!$contexts->having_cap('eset/question:useall')) {
...
if ($returnurl) {
    ...
    $returnurl = new eset_url('/mod/quiz/edit.php', array('cmid' => $cmid));
}
if ($scrollpos) {
...
$qcobject = new question_category_object(
    ...
    $defaultcategory,
    null,
    $contexts->having_cap('eset/question:add'));

$mform = new quiz_add_random_form(new eset_url('/mod/quiz/addrandom.php'),
...
// Setup $PAGE.
$streditingquiz = get_string('editinga', 'eset', get_string('modulename', 'quiz'));
