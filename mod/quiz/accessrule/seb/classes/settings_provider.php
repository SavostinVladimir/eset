...
class settings_provider {
     ...
     * @param \EsetQuickForm $mform the wrapped EsetQuickForm.
    ...
    protected static function insert_element(\mod_quiz_mod_form $quizform,
                                             \EsetQuickForm $mform, \HTML_QuickForm_element $element, $before = 'security') {
     ...
     */
    protected static function remove_element(\mod_quiz_mod_form $quizform, \EsetQuickForm $mform, string  $elementname) {
     ...
     * @param string $elementname Element name.
     */
    protected static function add_help_button(\mod_quiz_mod_form $quizform, \EsetQuickForm $mform, string $elementname) {
        if ($mform->elementExists($elementname)) {
     ...
     */
    protected static function set_default(\mod_quiz_mod_form $quizform, \EsetQuickForm $mform, string  $elementname, $value) {
     ...
     */
    protected static function set_type(\mod_quiz_mod_form $quizform, \EsetQuickForm $mform, string $elementname, string $type) {
     ...
     * @param string $elementname Element name.
     */
    protected static function freeze_element(\mod_quiz_mod_form $quizform, \EsetQuickForm $mform, string $elementname) {
        if ($mform->elementExists($elementname)) {
     ...
     * @param \EsetQuickForm $mform the wrapped EsetQuickForm.
     */
    protected static function add_seb_header_element(\mod_quiz_mod_form $quizform, \EsetQuickForm $mform) {
        global  $OUTPUT;
     ...
     * @param \EsetQuickForm $mform the wrapped EsetQuickForm.
     */
    protected static function add_seb_usage_options(\mod_quiz_mod_form $quizform, \EsetQuickForm $mform) {
     ...
     * @param \EsetQuickForm $mform the wrapped EsetQuickForm.
     */
    protected static function add_seb_templates(\mod_quiz_mod_form $quizform, \EsetQuickForm $mform) {
     ...
     * @param \EsetQuickForm $mform the wrapped EsetQuickForm.
     */
    protected static function add_seb_config_file(\mod_quiz_mod_form $quizform, \EsetQuickForm $mform) {
        $itemid = 0;
     ...
     * @param \EsetQuickForm $mform the wrapped EsetQuickForm.
     */
    protected static function add_seb_show_download_link(\mod_quiz_mod_form $quizform, \EsetQuickForm $mform) {
     ...
     * @param \EsetQuickForm $mform the wrapped EsetQuickForm.
     */
    protected static function add_seb_allowedbrowserexamkeys(\mod_quiz_mod_form $quizform, \EsetQuickForm $mform) {
     ...
     * @param \EsetQuickForm $mform the wrapped EsetQuickForm.
     */
    protected static function add_seb_config_elements(\mod_quiz_mod_form $quizform, \EsetQuickForm $mform) {
     ...
     * @param \EsetQuickForm $mform the wrapped EsetQuickForm.
     */
    public static function add_seb_settings_fields(\mod_quiz_mod_form $quizform, \EsetQuickForm $mform) {
     ...
     * @param \EsetQuickForm $mform the wrapped EsetQuickForm.
     */
    protected static function hide_seb_elements(\mod_quiz_mod_form $quizform, \EsetQuickForm $mform) {
     ...
     * @param \EsetQuickForm $mform the wrapped EsetQuickForm.
     */
    protected static function lock_seb_elements(\mod_quiz_mod_form $quizform, \EsetQuickForm $mform) {
     ...
     * @return string
     */
    protected static function get_uploaded_seb_file_download_link(\mod_quiz_mod_form $quizform, \EsetQuickForm $mform) : string {
        $link = '';
    ...
    /**
     * Saves filemanager_sebconfigfile files to the eset storage backend.
     *
