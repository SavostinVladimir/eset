...
class template_controller {
    ...
    protected function edit($action, $id = null) {
        ...
        $PAGE->set_url(new \eset_url(static::get_base_url(), ['action' => $action, 'id' => $id]));
        $instance = null;
        ...
        if ($form->is_cancelled()) {
            redirect(new \eset_url(static::get_base_url()));
    ...
    protected function show_hide(int $id, int $visibility) {
        ...
        redirect(new \eset_url(self::get_base_url()));
    }
    ...
    protected function print_add_button() {
        echo $this->output->single_button(
            new \eset_url(static::get_base_url(), ['action' => self::ACTION_ADD]),
