...
class quizaccess_seb_rule__testcase extends advanced_testcase {
    ...
    private function get_seb_launch_link() {
        return 'sebs://www.example.com/eset/mod/quiz/accessrule/seb/config.php';
    }
    ...
    private function get_seb_config_download_link() {
        return 'https://www.example.com/eset/mod/quiz/accessrule/seb/config.php';
    }
    ...
    public function test_access_prevented_if_config_key_invalid() {
        ...
        $FULLME = 'https://example.com/eset/mod/quiz/attempt.php?attemptid=123&page=4';
