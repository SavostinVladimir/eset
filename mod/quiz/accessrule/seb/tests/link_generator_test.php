...
class quizaccess_seb_link_generator_testcase extends advanced_testcase {
    ...
    public function test_http_link_generated() {
        ...
        $this->assertEquals(
            "http://www.example.com/eset/mod/quiz/accessrule/seb/config.php?cmid=$quiz->cmid",
    ...
    public function test_https_link_generated() {
        ...
        $this->assertEquals(
            "https://www.example.com/eset/mod/quiz/accessrule/seb/config.php?cmid=$quiz->cmid",
    ...
    public function test_seb_link_generated() {
        ...
        $this->assertEquals(
            "seb://www.example.com/eset/mod/quiz/accessrule/seb/config.php?cmid=$quiz->cmid",
    ...
    public function test_sebs_link_generated() {
        ...
        $this->assertEquals(
            "sebs://www.example.com/eset/mod/quiz/accessrule/seb/config.php?cmid=$quiz->cmid",
