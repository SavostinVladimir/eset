...
class quizaccess_seb_quiz_settings_testcase extends advanced_testcase {
    ...
    /** @var eset_url $url Test quiz URL. */
    protected $url;
    ...
    public function setUp() {
        ...
        $this->url = new eset_url("/mod/quiz/view.php", ['id' => $this->quiz->cmid]);
    }
...
<plist version=\"1.0\"><dict><key>showTaskBar</key><true/><key>allowWlan</key><false/><key>showReloadButton</key><true/>"
    ...
    public function test_config_file_uploaded_converted_to_config() {
        $url = new eset_url("/mod/quiz/view.php", ['id' => $this->quiz->cmid]);
    ...
    public function test_using_seb_template_override_settings_when_they_set_in_template() {
        ...
        $this->assertContains(
            "<key>startURL</key><string>https://www.example.com/eset/mod/quiz/view.php?id={$this->quiz->cmid}</string>",
            $quizsettings->get_config()
        );
    ...
    public function filter_rules_provider() : array {
        return [
            'enabled simple expessions' => [
                ...
                . "<key>startURL</key><string>https://www.example.com/eset/mod/quiz/view.php?id=1</string>"
                . "<key>sendBrowserExamKey</key><true/><key>examSessionClearCookiesOnStart</key><false/>"
                . "<key>allowPreferencesWindow</key><false/></dict></plist>\n",
            ],
