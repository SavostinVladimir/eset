 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_quiz_mod_form extends esetform_mod {
    ...
    protected function definition() {
        ...
        $PAGE->requires->yui_module('eset-mod_quiz-modform', 'M.mod_quiz.modform.init');
    }
     ...
     * Part of the API defined by esetform_mod
