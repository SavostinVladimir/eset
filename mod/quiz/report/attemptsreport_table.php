...
abstract class quiz_attempts_report_table extends table_sql {
    ...
    /** @var eset_url the URL of this report. */
    protected $reporturl;
    ...
    public function col_fullname($attempt) {
        ...
        return $html . html_writer::empty_tag('br') . html_writer::link(
                new eset_url('/mod/quiz/review.php', array('attempt' => $attempt->attempt)),
    ...
    public function make_review_link($data, $attempt, $slot) {
        ...
        $url = new eset_url('/mod/quiz/reviewquestion.php', $reviewparams);
