...
abstract class quiz_attempts_report extends quiz_default_report {
     ...
     * @param eset_url $reporturl the URL of this report.
     ...
     * @param eset_url $redirecturl where to redircet to after a successful action.
     */
     ...
     * @deprecated since Eset 3.2 Please use get_students_joins() instead.
     */
