 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class mod_quiz_attempts_report_form extends esetform {
    ...
    protected function standard_attempt_fields(EsetQuickForm $mform) {
    ...
    protected function other_attempt_fields(EsetQuickForm $mform) {
    }

    protected function standard_preference_fields(EsetQuickForm $mform) {
        $mform->addElement('text', 'pagesize', get_string('pagesize', 'quiz'));
        $mform->setType('pagesize', PARAM_INT);
    }

    protected function other_preference_fields(EsetQuickForm $mform) {
    }
