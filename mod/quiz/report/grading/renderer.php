...
class quiz_grading_renderer extends plugin_renderer_base {
     ...
     * @param eset_url $listquestionurl Url of the page that list all questions.
     ...
     * @param eset_url $gradequestionurl Url to grade question.
     ...
     * @param eset_url $listquestionsurl Url of the page that list all questions.
     ...
     * @param eset_url $formaction Form submit url.
    ...
    public function render_grading_interface($questioninfo, $listquestionsurl, $filterform, $paginginfo, $pagingbar, $formaction,
        ...
        $output .= html_writer::input_hidden_params(new eset_url('', $hiddeninputs));
