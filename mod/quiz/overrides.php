...
$accessallgroups = ($quizgroupmode == NOGROUPS) || has_capability('eset/site:accessallgroups', $context);
...
$url = new eset_url('/mod/quiz/overrides.php', array('cmid'=>$cm->id, 'mode'=>$mode));
...
$overridedeleteurl = new eset_url('/mod/quiz/overridedelete.php');
$overrideediturl = new eset_url('/mod/quiz/overrideedit.php');
