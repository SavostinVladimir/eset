 ...
 */
class eset1_mod_book_handler extends eset1_mod_handler {
     ...
     *
     * Note that the path /ESET_BACKUP/COURSE/MODULES/MOD/BOOK does not
    ...
    public function get_paths() {
        return array(
            new convert_path('book', '/ESET_BACKUP/COURSE/MODULES/MOD/BOOK',
                    array(
                        'renamefields' => array(
                            'summary' => 'intro',
                        ),
            ...
            new convert_path('book_chapters', '/ESET_BACKUP/COURSE/MODULES/MOD/BOOK/CHAPTERS/CHAPTER',
                    array(
                        'newfields' => array(
    ...
    /**
     * This is executed every time we have one /ESET_BACKUP/COURSE/MODULES/MOD/BOOK
     * data available
     * @param array $data
     */
    ...
    /**
     * This is executed every time we have one /ESET_BACKUP/COURSE/MODULES/MOD/BOOK/CHAPTERS/CHAPTER
     * data available
     * @param array $data
     */
    public function process_book_chapters($data) {
        ...
        $data['content'] = eset1_converter::migrate_referenced_files($data['content'], $this->fileman);
