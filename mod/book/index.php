...
if (!$books = get_all_instances_in_course('book', $course)) {
    notice(get_string('thereareno', 'eset', $strbooks), "$CFG->wwwroot/course/view.php?id=$course->id");
    die;
}
...
foreach ($books as $book) {
    ...
    $table->data[] = array (
        $printsection,
        html_writer::link(new eset_url('view.php', array('id' => $cm->id)), format_string($book->name), $class),
