...
function booktool_print_extend_settings_navigation(settings_navigation $settings, navigation_node $node) {
    ...
    if (has_capability('booktool/print:print', $PAGE->cm->context)) {
        $url1 = new eset_url('/mod/book/tool/print/index.php', array('id'=>$params['id']));
        $url2 = new eset_url('/mod/book/tool/print/index.php', array('id'=>$params['id'], 'chapterid'=>$params['chapterid']));
