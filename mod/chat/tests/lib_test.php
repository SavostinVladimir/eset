...
class mod_chat_lib_testcase extends advanced_testcase {
    ...
    public function test_chat_core_calendar_provide_event_action_chattime_event_different_timezones() {
        ...
        $this->assertInstanceOf('eset_url', $actionevent12->get_url());
        ...
        $this->assertInstanceOf('eset_url', $actionevent21->get_url());
        ...
        $this->assertInstanceOf('eset_url', $actionevent22->get_url());
