...
/**
 * Strings for component 'chat', language 'en', branch 'ESET_20_STABLE'
 *
 * @package   mod_chat
...
* Smilies - Any smiley faces (emoticons) that you can type elsewhere in Eset can also be typed here, for example :-)
