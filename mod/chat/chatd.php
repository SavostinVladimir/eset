...
echo 'Eset chat daemon v1.0 on PHP '.$phpversion."\n\n";
...
if (!$daemon->query_start()) {
    ...
    echo 'Starts the Eset chat socket server on port '.$CFG->chat_serverport;
    echo "\n\n";
...
$daemon->trace('Started Eset chatd on port '.$CFG->chat_serverport.', listening socket '.$daemon->listen_socket, E_USER_WARNING);
