...
if (! $workshops = get_all_instances_in_course('workshop', $course)) {
    ...
    notice(get_string('noworkshops', 'workshop'), new eset_url('/course/view.php', array('id' => $course->id)));
    echo $OUTPUT->footer();
    die();
}
...
foreach ($workshops as $workshop) {
    if (empty($workshop->visible)) {
        $link = html_writer::link(new eset_url('/mod/workshop/view.php', array('id' => $workshop->coursemodule)),
