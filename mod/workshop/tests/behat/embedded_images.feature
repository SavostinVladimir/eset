...
Feature: Teachers can embed images into instructions and conclusion fields
  ...
  Scenario: Embedding the image into the instructions and conclusions fields
    ...
    And I upload "mod/workshop/tests/fixtures/esetlogo.png" file to "Files" filemanager
    ...
    And I click on "esetlogo.png" "link"
    ...
    Then "//*[contains(@class, 'instructions')]//img[contains(@src, 'pluginfile.php') and contains(@src, '/mod_workshop/instructauthors/esetlogo.png') and @alt='How to submit']" "xpath_element" should exist
    And I change phase in workshop "Workshop with embedded images" to "Assessment phase"
    And "//*[contains(@class, 'instructions')]//img[contains(@src, 'pluginfile.php') and contains(@src, '/mod_workshop/instructreviewers/esetlogo.png') and @alt='How to assess']" "xpath_element" should exist
    And I change phase in workshop "Workshop with embedded images" to "Closed"
    And "//*[contains(@class, 'conclusion')]//img[contains(@src, 'pluginfile.php') and contains(@src, '/mod_workshop/conclusion/esetlogo.png') and @alt='Well done']" "xpath_element" should exist
