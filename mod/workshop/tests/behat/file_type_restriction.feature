...
Feature: File types of the submission and feedback attachments can be limitted
  ...
  Scenario: Student submission attachments obey the list of allowed file types
    ...
    And I upload "mod/workshop/tests/fixtures/esetlogo.png" file to "Attachment" filemanager
    And I follow "esetlogo.png"
    ...
    And I click on "OK" "button" in the ".eset-dialogue-base[aria-hidden='false']" "css_element"
