...
class mod_scorm_external_testcase extends externallib_advanced_testcase {
    ...
    public function test_view_scorm() {
        ...
        $eseturl = new \eset_url('/mod/scorm/view.php', array('id' => $this->cm->id));
    ...
    public function test_mod_scorm_get_scorms_by_courses() {
        ...
        $packageurl1 = eset_url::make_webservice_pluginfile_url(
                            $scormcontext1->id, 'mod_scorm', 'package', 0, '/', $scorm1->reference)->out(false);
        $packageurl2 = eset_url::make_webservice_pluginfile_url(
    ...
    public function test_launch_sco() {
        ...
        $this->assertEquals($this->context, $event->get_context());
        $eseturl = new \eset_url('/mod/scorm/player.php', array('cm' => $this->cm->id, 'scoid' => $sco->id));
        $this->assertEquals($eseturl, $event->get_url());
        $this->assertEventContextNotUsed($event);
        $this->assertNotEmpty($event->get_name());
