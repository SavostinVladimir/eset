...
/**
 * Function to be run periodically according to the eset Tasks API
...
function scorm_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options=array()) {
    ...
    $canmanageactivity = has_capability('eset/course:manageactivities', $context);
    $lifetime = null;
...
function mod_scorm_core_calendar_provide_event_action(calendar_event $event,
    ...
    return $factory->create_instance(
        ...
        new \eset_url('/mod/scorm/view.php', array('id' => $cm->id)),
        1,
        $actionable
    );
}
