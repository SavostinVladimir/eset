...
$string['aiccuserid_desc'] = 'The AICC standard for usernames is very restrictive compared with Eset, and allows for alphanumeric characters, dash and underscore only. Periods, spaces and the @ symbol are not permitted. If enabled, user ID numbers are passed to the AICC package instead of usernames.';
...
$string['scormstandarddesc'] = 'When disabled, Eset allows SCORM 1.2 packages to store more than the specification allows, and uses Eset full name format settings when passing the users name to the SCORM package.';
