...
/**
 * URL conversion handler. This resource handler is called by eset1_mod_resource_handler
 */
class eset1_mod_url_handler extends eset1_resource_successor_handler {
    ...
    public function process_legacy_resource(array $data, array $raw = null) {
        ...
        $url['intro'] = eset1_converter::migrate_referenced_files($url['intro'], $this->fileman);
