...
/**
 * Strings for component 'url', language 'en', branch 'ESET_20_STABLE'
 *
 * @package    mod_url
...
$string['parametersheader_help'] = 'Some internal Eset variables may be automatically appended to the URL. Type your name for the parameter into each text box(es) and then select the required matching variable.';
