...
if ($itemid) {
    ...
    $url = new eset_url('/mod/feedback/edit_item.php', array('id' => $itemid));
    $typ = $item->typ;
} else {
    $item = null;
    list($course, $cm) = get_course_and_cm_from_cmid($cmid, 'feedback');
    $url = new eset_url('/mod/feedback/edit_item.php', array('cmid' => $cm->id, 'typ' => $typ));
...
$editurl = new eset_url('/mod/feedback/edit.php', array('id' => $cm->id));
...
navigation_node::override_active_url(new eset_url('/mod/feedback/edit.php',
