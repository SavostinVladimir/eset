...
$url = new eset_url('/mod/feedback/analysis_course.php', array('id'=>$id));
...
if ($data = $courseselectform->get_data()) {
    redirect(new eset_url($url, ['courseid' => $data->courseid]));
}
...
if (has_capability('mod/feedback:viewreports', $context) && $feedbackstructure->get_items()) {
    ...
    $aurl = new eset_url('/mod/feedback/analysis_to_excel.php',
