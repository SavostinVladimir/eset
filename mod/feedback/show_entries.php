...
$baseurl = new eset_url('/mod/feedback/show_entries.php', array('id' => $cm->id));
$PAGE->set_url(new eset_url($baseurl, array('userid' => $userid, 'showcompleted' => $showcompleted,
        'delete' => $deleteid)));
...
if ($data = $courseselectform->get_data()) {
    redirect(new eset_url($baseurl, ['courseid' => $data->courseid]));
}
