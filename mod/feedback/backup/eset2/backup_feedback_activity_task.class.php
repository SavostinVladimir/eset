...
require_once($CFG->dirroot . '/mod/feedback/backup/eset2/backup_feedback_stepslib.php');
require_once($CFG->dirroot . '/mod/feedback/backup/eset2/backup_feedback_settingslib.php');
