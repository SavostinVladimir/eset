 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_feedback_course_select_form extends esetform {
    /** @var eset_url */
    protected $action;
     ...
     * Constructor
     *
     * @param string|eset_url $action the action attribute for the form
    ...
    public function __construct($action, mod_feedback_structure $feedbackstructure, $editable = true) {
        $this->action = new eset_url($action, ['courseid' => null]);
