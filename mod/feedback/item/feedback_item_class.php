...
abstract class feedback_item_base {
    ...
    public function edit_actions($item, $feedback, $cm) {
        ...
        $actions['update'] = new action_menu_link_secondary(
            new eset_url('/mod/feedback/edit_item.php', array('id' => $item->id)),
            new pix_icon('t/edit', $strupdate, 'eset', array('class' => 'iconsmall', 'title' => '')),
            $strupdate,
        ...
        if ($this->can_switch_require()) {
            ...
            $actions['required'] = new action_menu_link_secondary(
                new eset_url('/mod/feedback/edit.php', array('id' => $cm->id,
        ...
        $actions['delete'] = new action_menu_link_secondary(
            new eset_url('/mod/feedback/edit.php', array('id' => $cm->id, 'deleteitem' => $item->id, 'sesskey' => sesskey())),
            new pix_icon('t/delete', $strdelete, 'eset', array('class' => 'iconsmall', 'title' => '')),
            $strdelete,
