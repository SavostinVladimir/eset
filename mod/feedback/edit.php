...
$url = new eset_url('/mod/feedback/edit.php', array('id'=>$id, 'do_show'=>$do_show));
...
if (count($feedbackitems) > 1) {
    if ($do_show == 'edit') {
        ...
        $PAGE->requires->yui_module('eset-mod_feedback-dragdrop', 'M.mod_feedback.init_dragdrop',
...
if ($do_show == 'templates') {
    ...
    if ($cancreatetemplates) {
        $deleteurl = new eset_url('/mod/feedback/delete_template.php', array('id' => $id));
    ...
    if (has_capability('mod/feedback:edititems', $context)) {
        ...
        $exporturl = new eset_url('/mod/feedback/export.php', $urlparams);
        $importurl = new eset_url('/mod/feedback/import.php', array('id'=>$id));
        echo '<p>
...
if ($do_show == 'edit') {
    ...
    $select = new single_select(new eset_url('/mod/feedback/edit_item.php',
