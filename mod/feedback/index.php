...
$url = new eset_url('/mod/feedback/index.php', array('id'=>$id));
...
if (! $feedbacks = get_all_instances_in_course("feedback", $course)) {
    ...
    notice(get_string('thereareno', 'eset', $strfeedbacks), $url);
    die;
}
...
foreach ($feedbacks as $feedback) {
    ...
    $viewurl = new eset_url('/mod/feedback/view.php', array('id'=>$feedback->coursemodule));
