...
$previewlnk = new eset_url('/mod/feedback/print.php', array('id' => $id));
if ($courseid) {
...
if (!has_capability('mod/feedback:viewreports', $context) &&
    ...
    $analysisurl = new eset_url('/mod/feedback/analysis.php', array('id' => $id));
...
if (has_capability('mod/feedback:mapcourse', $context) && $feedback->course == SITEID) {
    ...
    $mapurl = new eset_url('/mod/feedback/mapcourse.php', array('id' => $id));
...
if ($feedbackcompletion->can_complete()) {
    ...
    if (!$feedbackcompletion->is_open()) {
        ...
        $completeurl = new eset_url('/mod/feedback/complete.php',
