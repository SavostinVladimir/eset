...
class mod_feedback_external_testcase extends externallib_advanced_testcase {
    ...
    public function test_view_feedback() {
        ...
        $esetdata = new \eset_url('/mod/feedback/view.php', array('id' => $this->cm->id));
    ...
    protected function complete_basic_feedback() {
        ...
        assign_capability('eset/site:accessallgroups', CAP_PROHIBIT, $this->teacherrole->id, $this->context);
        accesslib_clear_all_caches_for_unit_testing();
