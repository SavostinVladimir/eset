...
$format = optional_param('format', FORMAT_ESET, PARAM_INT);
...
$url = new eset_url('/mod/feedback/show_nonrespondents.php', array('id'=>$cm->id));
...
$canbulkmessaging = has_capability('eset/course:bulkmessaging', $coursecontext);
...
$baseurl = new eset_url('/mod/feedback/show_nonrespondents.php');
