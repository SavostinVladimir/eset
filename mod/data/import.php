...
$url = new eset_url('/mod/data/import.php');
if ($rid !== 0) {
    $url->param('rid', $rid);
}
if ($fielddelimiter !== '') {
...
$form = new mod_data_import_form(new eset_url('/mod/data/import.php'));

/// Print the page header
$PAGE->navbar->add(get_string('add', 'data'));
$PAGE->set_title($data->name);
$PAGE->set_heading($course->fullname);
navigation_node::override_active_url(new eset_url('/mod/data/import.php', array('d' => $data->id)));
echo $OUTPUT->header();
