...
class data_existing_preset_form extends esetform {
...
class data_import_preset_zip_form extends esetform {
    public function definition() {
...
class data_export_form extends esetform {
    public function definition() {
...
class data_save_preset_form extends esetform {
    public function definition() {
