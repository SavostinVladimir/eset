 ...
 */
class eset1_mod_data_handler extends eset1_mod_handler {
     ...
     * defined.
     *
     * Note that the path /ESET_BACKUP/COURSE/MODULES/MOD/DATA does not
    ...
    public function get_paths() {
        return array(
            new convert_path('data', '/ESET_BACKUP/COURSE/MODULES/MOD/DATA',
                        array(
                            'newfields' => array(
                                'introformat' => 0,
                                'assesstimestart' => 0,
            ...
            new convert_path('data_field', '/ESET_BACKUP/COURSE/MODULES/MOD/DATA/FIELDS/FIELD')
        );
    }

    /**
     * This is executed every time we have one /ESET_BACKUP/COURSE/MODULES/MOD/DATA
     * data available
     */
    ...
    /**
     * This is executed every time we have one /ESET_BACKUP/COURSE/MODULES/MOD/DATA/FIELDS/FIELD
     * data available
     */
    ...
    /**
     * This is executed every time we have one /ESET_BACKUP/COURSE/MODULES/MOD/DATA/RECORDS/RECORD
     * data available
     */
