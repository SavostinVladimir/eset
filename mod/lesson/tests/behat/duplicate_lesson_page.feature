...
Feature: In a lesson activity, a teacher can duplicate a lesson page
  ...
  Background:
    ...
    And I upload "mod/lesson/tests/fixtures/eset_logo.jpg" file to "Files" filemanager
  ...
  Scenario: Duplicate content page with an image.
    ...
    Then "//*[contains(@id, 'id_contents_editor')]//img[contains(@src, 'eset_logo.jpg')]" "xpath_element" should exist
  ...
  Scenario: Duplicate question page with image in answer.
    ...
    Then "//*[contains(@id, 'id_answer_editor_0')]//img[contains(@src, 'eset_logo.jpg')]" "xpath_element" should exist
  ...
  Scenario: Duplicate question page with image in feedback.
    ...
    And I should see "Select the picture"
    Then "//*[contains(@id, 'id_response_editor_0')]//img[contains(@src, 'eset_logo.jpg')]" "xpath_element" should exist
