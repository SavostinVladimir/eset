...
Feature: In a lesson activity, teacher can add embedded images in questions answers and responses
  ...
  Scenario: questions with images in answers and responses
    ...
    And "//*[contains(@class, 'answeroption')]//img[contains(@src, 'eset_logo.jpg')]" "xpath_element" should exist
    And I set the following fields to these values:
      | Cat | 1 |
    And I press "Submit"
    ...
    And "//img[contains(@src, 'eset_logo.jpg')]" "xpath_element" should exist in the ".correctanswer" "css_element"
    And I press "Continue"
