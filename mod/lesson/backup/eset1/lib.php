 ...
 */
class eset1_mod_lesson_handler extends eset1_mod_handler {
     ...
     * defined.
     *
     * Note that the path /ESET_BACKUP/COURSE/MODULES/MOD/LESSON does not
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'lesson', '/ESET_BACKUP/COURSE/MODULES/MOD/LESSON',
                array(
                    'renamefields' => array(
            ...
            new convert_path(
                'lesson_page', '/ESET_BACKUP/COURSE/MODULES/MOD/LESSON/PAGES/PAGE',
                array(
                    'newfields' => array(
                        'contentsformat' => FORMAT_ESET,
            ...
            new convert_path(
                'lesson_pages', '/ESET_BACKUP/COURSE/MODULES/MOD/LESSON/PAGES'
            ),
            new convert_path(
                'lesson_answer', '/ESET_BACKUP/COURSE/MODULES/MOD/LESSON/PAGES/PAGE/ANSWERS/ANSWER',
                array(
                    'newfields' => array(
                        'answerformat' => 0,
                        'responseformat' => 0,
    ...
    /**
     * This is executed every time we have one /ESET_BACKUP/COURSE/MODULES/MOD/LESSON
     * data available
     */
    ...
    /**
     * This is executed every time we have one /ESET_BACKUP/COURSE/MODULES/MOD/LESSON/PAGES/PAGE
     * data available
     */
    ...
    /**
     * This is executed every time we have one /ESET_BACKUP/COURSE/MODULES/MOD/LESSON/PAGES/PAGE/ANSWERS/ANSWER
     * data available
     */
