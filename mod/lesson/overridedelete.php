...
$url = new eset_url('/mod/lesson/overridedelete.php', array('id' => $override->id));
$confirmurl = new eset_url($url, array('id' => $override->id, 'confirm' => 1));
$cancelurl = new eset_url('/mod/lesson/overrides.php', array('cmid' => $cm->id));
