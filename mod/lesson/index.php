...
if (! $lessons = get_all_instances_in_course("lesson", $course)) {
    notice(get_string('thereareno', 'eset', $strlessons), "../../course/view.php?id=$course->id");
    die;
}
...
foreach ($lessons as $lesson) {
    ...
    $link = html_writer::link(new eset_url('view.php', array('id' => $cm->id)), format_string($lesson->name, true), $class);
