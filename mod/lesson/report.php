...
$url = new eset_url('/mod/lesson/report.php', array('id'=>$id));
...
if ($action === 'delete') {
    ...
    redirect(new eset_url($PAGE->url, array('action'=>'reportoverview')));
    ...
    **************************************************************************/
    ...
    if (has_capability('gradereport/grader:view', $course_context) && has_capability('eset/grade:viewall', $course_context)) {
        $seeallgradeslink = new eset_url('/grade/report/grader/index.php', array('id'=>$course->id));
    ...
    if (has_capability('mod/lesson:edit', $context)) {
        $reporturl = new eset_url('/mod/lesson/report.php');
