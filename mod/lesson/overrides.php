...
$accessallgroups = ($lessongroupmode == NOGROUPS) || has_capability('eset/site:accessallgroups', $context);
...
$url = new eset_url('/mod/lesson/overrides.php', array('cmid' => $cm->id, 'mode' => $mode));
...
$userurl = new eset_url('/user/view.php', array());
$groupurl = new eset_url('/group/overview.php', array('id' => $cm->course));

$overridedeleteurl = new eset_url('/mod/lesson/overridedelete.php');
$overrideediturl = new eset_url('/mod/lesson/overrideedit.php');
