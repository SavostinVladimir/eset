...
$url = new eset_url('/mod/lesson/view.php', array('id'=>$id));
if ($pageid !== null) {
...
if (empty($pageid)) {
    ...
    if (($lastpageseen !== false && ($lastpageseen != LESSON_EOL))) {
        ...
        if ($lesson->left_during_timed_session($retries)) {
            ...
            if ($lesson->timelimit) {
                if ($lesson->retake) {
                    $continuelink = new single_button(new eset_url('/mod/lesson/view.php',
                    ...
                    $courselink = new single_button(new eset_url('/course/view.php',
    ...
    if ($attemptflag) {
        if (!$lesson->retake) {
            ...
            $courselink = new single_button(new eset_url('/course/view.php', array('id'=>$PAGE->course->id)), get_string('returntocourse', 'lesson'), 'get');
