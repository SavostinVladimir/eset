...
$redirect = new eset_url('/mod/lti/toolproxies.php', array('tab' => $tab));
...
$redirect = new eset_url('/mod/lti/toolproxies.php');
if ($duplicate) {
...
$url = new eset_url('/mod/lti/register.php', array('id' => $id));
$PAGE->set_url($url);
...
$registration = new eset_url('/mod/lti/registration.php',
