...
/**
 * This file contains the script used to clone Eset admin setting page.
 *
...
if ($returnto == 'toolconfigure') {
    $returnurl = new eset_url($CFG->wwwroot . '/mod/lti/toolconfigure.php');
}
...
if (!empty($id)) {
    ...
    if (!empty($type->toolproxyid)) {
        ...
        $redirect = new eset_url('/mod/lti/toolssettings.php', $params);
        redirect($redirect);
    }
} else {
    $type = new stdClass();
...
$pageurl = new eset_url('/mod/lti/typessettings.php');
if (!empty($id)) {
    $pageurl->param('id', $id);
}
if (!empty($returnto)) {
