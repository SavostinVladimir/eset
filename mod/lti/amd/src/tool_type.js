...
/**
 * Provides an interface for a tool type in the Eset server.
 *
...
define(['core/ajax', 'core/notification'], function(ajax, notification) {
    return /** @alias module:mod_lti/tool_type */ {
        /**
         * Get a list of tool types from Eset for the given
         * search args.
         *
         * See also:
