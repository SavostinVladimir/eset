 ...
 */
 define(['jquery', 'core/ajax', 'core/notification', 'core/templates', 'core/modal_factory',
    ...
    /**
     * Delete the tool type from the Eset server. Triggers a success
     ...
     * in the Eset server. A success or failure announcement is triggered depending
     * on the result.
     *
     ...
     * type requires access to in Eset (if any).
     *
