...
$capabilities = array(
    ...
    'mod/lti:addinstance' => array(
        ...
        'clonepermissionsfrom' => 'eset/course:manageactivities'
    ),

    // When the user arrives at the external tool, if they have this capability
    // in Eset, then they are given the Instructor role in the remote system,
    ...
    // When the user arrives at the external tool, if they have this capability
    // in Eset, then they are given the Administrator role in the remote system,
    // otherwise they are given Learner. See the lti_get_ims_role function.
    'mod/lti:admin' => array(
        'riskbitmask' => RISK_PERSONAL, // A bit of a guess, but seems likely.
