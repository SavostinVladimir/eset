...
namespace eset\mod\lti; // Using a namespace as the basicLTI module imports classes with the same names.
...
class TrivialOAuthDataStore extends OAuthDataStore {
     ...
     * @param string $consumerkey     Consumer key
     *
     * @return eset\mod\lti\OAuthConsumer  OAuthConsumer object
     */
     ...
     *
     * @param eset\mod\lti\OAuthConsumer $consumer     Consumer
     * @param string $tokentype    Type of token
     * @param string $token        Token ID
     *
     * @return eset\mod\lti\OAuthToken OAuthToken object
     */
