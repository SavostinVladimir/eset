...
Feature: Add preconfigured tools via teacher interface
  ...
  Scenario: Add a tool from a cartridge
    ...
    And the field "Icon URL" matches value "http://download.eset.org/unittest/test.jpg"
    And the field "Secure icon URL" matches value "https://download.eset.org/unittest/test.jpg"
