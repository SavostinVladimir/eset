...
';
    ...
    public function test_lti_ensure_url_is_https() {
        $this->assertEquals('https://eset.org', lti_ensure_url_is_https('http://eset.org'));
        $this->assertEquals('https://eset.org', lti_ensure_url_is_https('eset.org'));
        $this->assertEquals('https://eset.org', lti_ensure_url_is_https('https://eset.org'));
    }
    ...
    public function test_lti_get_url_thumbprint() {
        ...
        $this->assertEquals('eset.org/', lti_get_url_thumbprint('http://ESET.ORG'));
        $this->assertEquals('eset.org/', lti_get_url_thumbprint('http://www.eset.org'));
        $this->assertEquals('eset.org/', lti_get_url_thumbprint('https://www.eset.org'));
        $this->assertEquals('eset.org/', lti_get_url_thumbprint('eset.org'));
        $this->assertEquals('eset.org//this/is/eset', lti_get_url_thumbprint('http://eset.org/this/is/eset'));
        $this->assertEquals('eset.org//this/is/eset', lti_get_url_thumbprint('https://eset.org/this/is/eset'));
        $this->assertEquals('eset.org//this/is/eset', lti_get_url_thumbprint('eset.org/this/is/eset'));
        $this->assertEquals('eset.org//this/is/eset', lti_get_url_thumbprint('eset.org/this/is/eset?'));
        $this->assertEquals('eset.org//this/is/eset?foo=bar', lti_get_url_thumbprint('eset.org/this/is/eset?foo=bar'));
    }
    ...
    public function test_lti_load_type_from_cartridge() {
        ...
        $this->assertEquals('http://download.eset.org/unittest/test.jpg', $type->lti_icon);
        $this->assertEquals('https://download.eset.org/unittest/test.jpg', $type->lti_secureicon);
    }
    ...
    public function test_lti_load_tool_from_cartridge() {
        ...
        $this->assertEquals('http://download.eset.org/unittest/test.jpg', $lti->icon);
        $this->assertEquals('https://download.eset.org/unittest/test.jpg', $lti->secureicon);
    }
    ...
    public function test_lti_build_standard_message_institution_name_set() {
        ...
        $this->assertEquals('eset-2', $message['ext_lms']);
        $this->assertEquals('eset', $message['tool_consumer_info_product_family_code']);
...
-----END PUBLIC KEY-----';
    ...
    public function test_lti_sign_jwt() {
        ...
        $endpoint = 'https://www.example.com/eset';
...
-----END PUBLIC KEY-----';
    ...
    public function test_get_tool_type_config() {
        ...
        $this->assertEquals('https://www.example.com/eset', $typeconfig['platformid']);
        $this->assertEquals($type->clientid, $typeconfig['clientid']);
        $this->assertEquals($typeid, $typeconfig['deploymentid']);
        $this->assertEquals('https://www.example.com/eset/mod/lti/certs.php', $typeconfig['publickeyseturl']);
        $this->assertEquals('https://www.example.com/eset/mod/lti/token.php', $typeconfig['accesstokenurl']);
        $this->assertEquals('https://www.example.com/eset/mod/lti/auth.php', $typeconfig['authrequesturl']);
    }
    ...
    /**
     * Test default orgid is host if not specified in config (tool installed in earlier version of Eset).
     */
