...
class mod_lti_external_testcase extends externallib_advanced_testcase {
    ...
    public function test_view_lti() {
        ...
        $esetlti = new eset_url('/mod/lti/view.php', array('id' => $cm->id));
        $this->assertEquals($esetlti, $event->get_url());
    ...
    public function test_mod_lti_create_tool_type() {
        ...
        $this->assertEquals('https://download.eset.org/unittest/test.jpg', $type['urls']['icon']);
