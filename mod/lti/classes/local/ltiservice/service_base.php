...
abstract class service_base {
     ...
     *
     * @param \EsetQuickForm $mform Eset quickform object definition
     */
     ...
     * @deprecated since Eset 3.7 - please do not use this function any more.
     */
    ...
    public static function get_service_path() {
        ...
        $url = new \eset_url('/mod/lti/services.php');
