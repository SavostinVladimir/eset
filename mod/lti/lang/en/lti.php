...
Some tool providers support reporting grades back to Eset based on actions taken within the tool, creating a more integrated
experience.';
...
Some tool providers support reporting grades back to Eset based on actions taken within the tool, creating a more integrated experience.
...
$string['allow'] = 'Allow';
$string['allowsetting'] = 'Allow tool to store 8K of settings in Eset';
...
real estate to the tool, and others provide a more integrated feel with the Eset environment.

* **Default** - Use the launch container specified by the tool configuration.
* **Embed** - The tool is displayed within the existing Eset window, in a manner similar to most other Activity types.
* **Embed, without blocks** - The tool is displayed within the existing Eset window, with just the navigation controls
...
$string['errormisconfig'] = 'Misconfigured tool. Please ask your Eset administrator to fix the configuration of the tool.';
...
$string['failedtoconnect'] = 'Eset was unable to communicate with the "{$a}" system';
...
If using this option, confirm that this Eset site and the tool provider support SSL.';
...
$string['launch_in_eset'] = 'Launch tool in Eset';
...
$string['module_class_type'] = 'Eset module type';
...
$string['notypes'] = 'There are currently no LTI tools set up in Eset. Click the Install link above to add some.';
...
$string['organizationid_default_help'] = 'The default value to use for Organisation ID. Site ID identifies this installation of Eset.';
$string['organizationidguid'] = 'Organisation ID';
$string['organizationidguid_help'] = 'A unique identifier for this Eset instance passed to the tool as the Platform Instance GUID.

If this field is left blank, the default value will be used.';
$string['organizationurl'] = 'Organisation URL';
$string['organizationurl_help'] = 'The base URL of this Eset instance.
...
Tools which do not require secure communication from Eset and do not provide additional services (such as grade reporting)
...
$string['register_warning'] = 'The registration page seems to be taking a while to open. If it does not appear, check that you entered the correct URL in the configuration settings. If Eset is using https, ensure the tool you are configuring supports https and you are using https in the URL.';
...
It can be used by the tool provider to uniquely identify the Eset site from which users launch into the tool.
...
$string['secure_launch_url_help'] = 'Similar to the tool URL, but used instead of the tool URL if high security is required. Eset will use the secure tool URL instead of the tool URL if the Eset site is accessed through SSL, or if the tool configuration is set to always launch through SSL.
...
$string['typename_help'] = 'The tool name is used to identify the tool provider within Eset. The name entered will be visible to teachers when adding external tools within courses.';
$string['types'] = 'Types';
...
$string['organizationid_help'] = 'A unique identifier for this Eset instance. Typically, the DNS name of the organisation is used.

If this field is left blank, the host name of this Eset site will be used as the default value.';
