...
class mod_lti_mod_form extends esetform_mod {
    ...
    public function definition() {
        ...
        // Set contentitem URL.
        $contentitemurl = new eset_url('/mod/lti/contentitem.php');
        ...
        $launchoptions[LTI_LAUNCH_CONTAINER_REPLACE_ESET_WINDOW] = get_string('existing_window', 'lti');
        ...
        $editurl = new eset_url('/mod/lti/instructor_edit_tool_type.php',
                array('sesskey' => sesskey(), 'course' => $COURSE->id));
        $ajaxurl = new eset_url('/mod/lti/ajax.php');
