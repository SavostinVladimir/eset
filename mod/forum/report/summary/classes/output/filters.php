...
class filters implements renderable, templatable {
    ...
    /**
     * Eset URL used as the form action on the generate button.
     *
     * @var eset_url $actionurl
     */
    protected $actionurl;
     ...
     * @param eset_url $actionurl The form action URL.
     ...
     */
    public function __construct(stdClass $course, array $cms, eset_url $actionurl, array $filterdata = []) {
        $this->cms = $cms;
