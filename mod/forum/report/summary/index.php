 ...
 * @copyright 2019 Michael Hawkins <michaelh@eset.com>
...
if ($forumid) {
    if (!isset($forumsvisibletouser[$forumid])) {
        throw new \eset_exception('A valid forum ID is required to generate a summary report.');
    }
    ...
    $redirecturl = new eset_url('/mod/forum/view.php', ['id' => $forumid]);
    $numforums = 1;
    ...
    $canexport = false;
    $redirecturl = new eset_url('/course/view.php', ['id' => $courseid]);
...
$pageurl = new eset_url('/mod/forum/report/summary/index.php', $pageurlparams);
...
$allowbulkoperations = !$download && !empty($CFG->messaging) && has_capability('eset/course:bulkmessaging', $context);
...
if ($download) {
    ...
    $reporturl = new eset_url('/mod/forum/report/summary/index.php', ['courseid' => $courseid]);
