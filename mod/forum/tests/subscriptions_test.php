...
class mod_forum_subscriptions_testcase extends advanced_testcase {
    ...
    public function test_unsubscribable_forums() {
        ...
        // Add the eset/course:viewhiddenactivities capability to the student user.
        $roleids = $DB->get_records_menu('role', null, '', 'shortname, id');
        $context = \context_course::instance($course->id);
        assign_capability('eset/course:viewhiddenactivities', CAP_ALLOW, $roleids['student'], $context);
