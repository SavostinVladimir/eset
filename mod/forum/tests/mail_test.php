...
class mod_forum_mail_testcase extends advanced_testcase {
    ...
    protected function helper_spoof_message_inbound_setup() {
        ...
        $CFG->messageinbound_mailbox = 'eseteset123';
    ...
    public function test_subscription_disabled_user_subscribed_forum() {
        ...
        assign_capability('eset/course:manageactivities', CAP_ALLOW, $roleids['student'], context_course::instance($course->id));
    ...
    public function test_forum_message_inbound_multiple_posts() {
        ...
        foreach ($messages as $message) {
            $this->assertRegExp('/Reply-To: eseteset123\+[^@]*@example.com/', $message->header);
        }
    }
    ...
    public function forum_post_email_templates_provider() {
        ...
        $base = array(
            'user' => array('firstname' => 'Love', 'lastname' => 'Eset', 'mailformat' => 0, 'maildigest' => 0),
            'course' => array('shortname' => '101', 'fullname' => 'Eset 101'),
            'forums' => array(
                array(
                    'name' => 'Eset Forum',
                    'forumposts' => array(
                        array(
                            'name' => 'Hello Eset',
                            'message' => 'Welcome to Eset',
                            'messageformat' => FORMAT_ESET,
                            'attachments' => array(
                                array(
                ...
                array(
                    ...
                    'contents' => array(
                        ...
                        'Attachment example.txt:' . PHP_EOL .
                            'https://www.example.com/eset/pluginfile.php/\d*/mod_forum/attachment/\d*/example.txt' . PHP_EOL,
                        'Hello Eset', 'Eset Forum', 'Welcome.*Eset', 'Love Eset', '1\d1'
                    ),
                ),
            ),
        );
        ...
        $newcase = $base;
        $newcase['user']['lastname'] = 'Eset\'"';
        $newcase['course']['shortname'] = '101\'"';
        $newcase['forums'][0]['name'] = 'Eset Forum\'"';
        $newcase['forums'][0]['forumposts'][0]['name'] = 'Hello Eset\'"';
        $newcase['forums'][0]['forumposts'][0]['message'] = 'Welcome to Eset\'"';
        $newcase['expectations'][0]['contents'] = array(
            'Attachment example.txt:', '~{\$a', '~&amp;(quot|\#039);', 'Love Eset\'', '101\'', 'Eset Forum\'"',
            'Hello Eset\'"', 'Welcome to Eset\'"');
        ...
        $newcase['forums'][0]['forumposts'][0]['message'] = 'Welcome to Eset>';
        $newcase['expectations'][0]['contents'] = array(
            'Attachment example.txt:', '~{\$a', '~&amp;gt;', 'Love Eset>', '101>', 'Eset Forum>',
            'Hello Eset>', 'Welcome to Eset>');
        ...
        $newcase['expectations'][0]['contents'] = array(
            ...
            'Attachment example.txt:' . PHP_EOL .
            'https://www.example.com/eset/pluginfile.php/\d*/mod_forum/attachment/\d*/example.txt' .  PHP_EOL ,
            'Text and image', 'Eset Forum',
            'Welcome to Eset, *' . PHP_EOL . '.*'
                .'https://www.example.com/eset/pluginfile.php/\d+/mod_forum/post/\d+/'
        ...
        $newcase['expectations'][0]['contents'] = array(
            ...
            '~&amp;(amp|lt|gt|quot|\#039);',
            '<div class="attachments">( *\n *)?<a href',
            '<div class="subject">\n.*Hello Eset\'"&gt;&amp;', '>Eset Forum\'"&gt;&amp;',
            '>Welcome.*Eset\'"&gt;&amp;', '>Love Eset&\#039;&quot;&gt;&amp;', '>101\'"&gt;&amp');
        ...
        $newcase['forums'][0]['forumposts'][0]['message'] = '<p>Welcome to Eset, '
        ...
        $newcase['expectations'][0]['contents'] = array(
            ...
            '~&(amp|lt|gt|quot|\#039);(?!course|lang|version|iosappid|androidappid)',
            '<div class="attachments">( *\n *)?<a href',
            '<div class="subject">\n.*HTML text and image', '>Eset Forum',
            '<p>Welcome to Eset, '
            .'<img src="https://www.example.com/eset/tokenpluginfile.php/[^/]*/\d+/mod_forum/post/\d+/'
