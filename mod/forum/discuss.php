...
$url = new eset_url('/mod/forum/discuss.php', array('d'=>$d));
if ($parent !== 0) {
...
if (!$discussion) {
    throw new \eset_exception('Unable to find discussion with id ' . $discussionid);
}
...
if (!$forum) {
    throw new \eset_exception('Unable to find forum with id ' . $discussion->get_forum_id());
}
