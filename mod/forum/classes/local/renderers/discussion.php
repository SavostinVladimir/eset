...
class discussion {
    ...
    /** @var eset_page $page The page this discussion is being rendered for */
    private $page;
    ...
    /** @var eset_url $baseurl The base URL for the discussion */
    private $baseurl;
     ...
     * @param eset_page $page The page this discussion is being rendered for
     ...
     * @param eset_url $baseurl The base URL for the discussion
    ...
    public function render(
        ...
        if (!$capabilitymanager->can_view_discussions($user)) {
            throw new eset_exception('noviewdiscussionspermission', 'mod_forum');
        }
