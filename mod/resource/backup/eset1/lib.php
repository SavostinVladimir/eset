 ...
 */
class eset1_mod_resource_handler extends eset1_mod_handler {
     ...
     * defined.
     *
     * Note that the paths /ESET_BACKUP/COURSE/MODULES/MOD/RESOURCE do not
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'resource', '/ESET_BACKUP/COURSE/MODULES/MOD/RESOURCE',
                array(
                    'renamefields' => array(
                        'summary' => 'intro',
                    ),
    ...
    public function process_resource(array $data, array $raw) {
        ...
        $resource['intro'] = eset1_converter::migrate_referenced_files($resource['intro'], $this->fileman);
     ...
     * @throws eset1_convert_exception for the unknown types
     * @return null|eset1_mod_handler the instance of the handler, or null if the type does not have a successor
     */
    protected function get_successor($type, $reference) {
        ...
        switch ($type) {
            ...
            case 'file':
                ...
                break;
            default:
                throw new eset1_convert_exception('unknown_resource_successor', $type);
        }
        ...
        if (!isset($this->successors[$name])) {
            ...
            $class = 'eset1_mod_'.$name.'_handler';
