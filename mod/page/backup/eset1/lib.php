...
/**
 * Page conversion handler. This resource handler is called by eset1_mod_resource_handler
 */
class eset1_mod_page_handler extends eset1_resource_successor_handler {
    ...
    public function process_legacy_resource(array $data, array $raw = null) {
        ...
        if ($data['type'] === 'html') {
            ...
            if ($page['contentformat'] < 0 or $page['contentformat'] > 4) {
                $page['contentformat'] = FORMAT_ESET;
            }
        }
        ...
        $page['intro'] = eset1_converter::migrate_referenced_files($page['intro'], $this->fileman);

        // convert course files embedded into the content
        $this->fileman->filearea = 'content';
        $this->fileman->itemid   = 0;
        $page['content'] = eset1_converter::migrate_referenced_files($page['content'], $this->fileman);
