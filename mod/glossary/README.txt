...
This is the Glossary module. Created and maintained by Williams Castillo. This are my first lines in PHP... It means that, although I've tried to do my best, it might (in fact, it does) shows my inexperience... in PHP... and eset as well.

Basically, this module allows you to maintain a repository of data in the form of concepts, Entry->Definitions, etc. Thus:

- Entries could be automatically linked from within eset resources, labels, forum posts, etc.
...
- The display format of the entries is modular so you can create your own formats (and share them with the Eset community!)
...
1) Be sure you have at least Eset 1.2 dev installed
