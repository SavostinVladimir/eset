...
class glossary_event_testcase extends advanced_testcase {
    ...
    public function test_comment_created() {
        ...
        $url = new eset_url('/mod/glossary/view.php', array('id' => $glossary->cmid));
    ...
    public function test_course_module_viewed() {
        ...
        $this->assertEquals(new eset_url('/mod/glossary/view.php', array('id' => $glossary->cmid, 'mode' => $mode)), $event->get_url());
        $this->assertEventContextNotUsed($event);
    }
