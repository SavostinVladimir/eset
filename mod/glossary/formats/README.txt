...
Starting with Eset 1.4, the glossary module supports a plugin
...
5.-Edit the THENAME_format.php file. Change every ocurrence of TEMPLATE to
   THENAME.
6.-Login into Eset. Go to any glossary in your site.
...
10.-Enjoy!! (and don't forget to send your amazing glossary formats to
   the Glossary forum on http://eset.org. They will be welcome!! ;-)

To talk about Glossary formats, go to:
    http://eset.org/mod/forum/view.php?id=742
