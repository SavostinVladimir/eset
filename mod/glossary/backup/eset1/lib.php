 ...
 */
class eset1_mod_glossary_handler extends eset1_mod_handler {
     ...
     * defined.
     *
     * Note that the path /ESET_BACKUP/COURSE/MODULES/MOD/GLOSSARY does not
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'glossary', '/ESET_BACKUP/COURSE/MODULES/MOD/GLOSSARY',
                array(
                    'newfields' => array(
                        'introformat'       => FORMAT_ESET,
                        'completionentries' => 0,
                    ),
                )
            ),
            new convert_path('glossary_categories', '/ESET_BACKUP/COURSE/MODULES/MOD/GLOSSARY/CATEGORIES'),
            new convert_path(
                'glossary_category', '/ESET_BACKUP/COURSE/MODULES/MOD/GLOSSARY/CATEGORIES/CATEGORY',
                array(
                    'dropfields' => array(
                        'glossaryid'
                    )
    ...
    /**
     * This is executed every time we have one /ESET_BACKUP/COURSE/MODULES/MOD/GLOSSARY
     * data available
     */
    ...
    /**
     * This is executed every time we have one /ESET_BACKUP/COURSE/MODULES/MOD/GLOSSARY/CATEGORIES/CATEGORY
     * data available
     */
