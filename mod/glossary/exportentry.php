...
$url = new eset_url('/mod/glossary/exportentry.php', array('id'=>$id,'prevmode'=>$prevmode));
if ($confirm !== 0) {
...
if (!data_submitted() or !$confirm or !confirm_sesskey()) {
    ...
    echo $OUTPUT->confirm($areyousure, new eset_url($linkyes, $optionsyes), new eset_url($linkno, $optionsno));
    echo '</div>';
    echo $OUTPUT->footer();
    die;
