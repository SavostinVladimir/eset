...
/**
 * This file contains the eset hooks for the submission comments plugin
 *
...
/**
 *
 * Callback method for data validation---- required method for AJAXeset based comment API
 *
...
/**
 * Permission control method for submission plugin ---- required method for AJAXeset based comment API
 *
 * @param stdClass $options
 * @return array
 */
