...
class assign_submission_onlinetext extends assign_submission_plugin {
     ...
     *
     * @param EsetQuickForm $mform The form to add elements to
     * @return void
     */
     ...
     */
    public function get_form_elements($submission, EsetQuickForm $mform, stdClass $data) {
        $elements = array();
    ...
    public function get_files(stdClass $submission, stdClass $user) {
        ...
        if ($onlinetextsubmission) {
            // Do not pass the text through format_text. The result may not be displayed in Eset and
    ...
    /**
     * Return true if this plugin can upgrade an old Eset 2.2 assignment of this type and version.
     *
