...
class assign_form implements renderable {
    /** @var esetform $form is the edit submission form */
    public $form = null;
     ...
     * @param esetform $form This is the esetform
     * @param string $jsinitfunction This is an optional js function to add to the page requires
     */
    public function __construct($classname, esetform $form, $jsinitfunction = '') {
...
class assign_files implements renderable {
    ...
    /** @var string $context */
    public $dir;
    /** @var EsetQuickForm $portfolioform */
