...
$accessallgroups = ($assigngroupmode == NOGROUPS) || has_capability('eset/site:accessallgroups', $context);
...
$url = new eset_url('/mod/assign/overrides.php', array('cmid' => $cm->id, 'mode' => $mode));
...
$overridedeleteurl = new eset_url('/mod/assign/overridedelete.php');
$overrideediturl = new eset_url('/mod/assign/overrideedit.php');
