...
class assign_feedback_file extends assign_feedback_plugin {
     ...
     */
    public function get_form_elements_for_user($grade, EsetQuickForm $mform, stdClass $data, $userid) {
    ...
    public function view_batch_upload_files($users) {
        ...
        foreach ($users as $userid) {
            ...
            $usersummary = new assign_user_summary($user,
                                                   ...
                                                   has_capability('eset/site:viewfullnames',
        ...
        if ($mform->is_cancelled()) {
            redirect(new eset_url('view.php',
    ...
    public function view_upload_zip() {
        ...
        if ($mform->is_cancelled()) {
            ...
            $urlparams = array('id'=>$this->assignment->get_course_module()->id,
                               'action'=>'grading');
            $url = new eset_url('view.php', $urlparams);
            redirect($url);
            return;
        } else if ($confirm) {
