YUI.add('eset-assignfeedback_editpdf-editor', function (Y, NAME) {
 ...
 *
 * @module eset-assignfeedback_editpdf-editor
 */
...
Y.Base.modifyAttrs(DROPDOWN, {
     ...
     *
     * Eset override: We override this for commentsearch to force it always false.
     *
     * @attribute Modal
     * @type Boolean
     * @default false
...
Y.Base.modifyAttrs(COMMENTSEARCH, {
     ...
     * Whether the widget should be modal or not.
     *
     * Eset override: We override this for commentsearch to force it always true.
     *
     * @attribute Modal
     * @type Boolean
     * @default true
...
Y.extend(EDITOR, Y.Base, EDITOR.prototype, {
    NAME: 'eset-assignfeedback_editpdf-editor',
    ATTRS: {
        userid: {
...
M.assignfeedback_editpdf.editor.init = M.assignfeedback_editpdf.editor.init || function(params) {
    ...
    "requires": [
        ...
        "eset-core-notification-dialog",
        "eset-core-notification-alert",
        "eset-core-notification-warning",
