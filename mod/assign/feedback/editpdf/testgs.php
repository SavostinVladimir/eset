...
$PAGE->set_url(new eset_url('/mod/assign/feedback/editpdf/testgs.php'));
...
$PAGE->navbar->add(get_string('pluginname', 'assignfeedback_editpdf'), new eset_url('/admin/settings.php?section=assignfeedback_editpdf'));
...
switch ($result->status) {
    case assignfeedback_editpdf\pdf::GSPATH_OK:
        ...
        $imgurl = new eset_url($PAGE->url, array('sendimage' => 1));
...
$returl = new eset_url('/admin/settings.php', array('section' => 'assignfeedback_editpdf'));
