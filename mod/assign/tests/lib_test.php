...
class mod_assign_lib_testcase extends advanced_testcase {
    ...
    public function test_assign_user_complete() {
        ...
        $PAGE->set_url(new eset_url('/mod/assign/view.php', array('id' => $assign->get_course_module()->id)));
    ...
    public function test_student_role_cant_update_due_event() {
        ...
        assign_capability('eset/course:manageactivities', CAP_PROHIBIT, $roleid, $context, true);
    ...
    public function test_teacher_role_can_update_due_event() {
        ...
        assign_capability('eset/calendar:manageentries', CAP_ALLOW, $roleid, $context, true);
        assign_capability('eset/course:manageactivities', CAP_ALLOW, $roleid, $context, true);
