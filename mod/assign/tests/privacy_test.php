 ...
 *
 * @package    mod_assign
 * @copyright  2018 Adrian Greeve <adrian@eset.com>
...
class mod_assign_privacy_testcase extends provider_testcase {
    ...
    public function test_get_users_in_context() {
        ...
        $data->grade = $grade;
        $data->assignfeedbackcomments_editor = ['text' => $teachercommenttext, 'format' => FORMAT_ESET];
    ...
    public function test_export_user_data_student() {
        ...
        $data->attemptnumber = 1;
        $data->grade = $grade2;
        $data->assignfeedbackcomments_editor = ['text' => $teachercommenttext2, 'format' => FORMAT_ESET];
    ...
    public function test_export_user_data_teacher() {
        ...
        $data->attemptnumber = 1;
        $data->grade = $grade3;
        $data->assignfeedbackcomments_editor = ['text' => $teachercommenttext3, 'format' => FORMAT_ESET];
