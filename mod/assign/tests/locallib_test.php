...
class mod_assign_locallib_testcase extends advanced_testcase {
    ...
    public function test_return_links() {
        ...
        $PAGE->set_url(new eset_url('/mod/assign/view.php', ['id' => $assign->get_course_module()->id]));
    ...
    public function test_gradingtable_filter_by_requiresgrading_no_grade() {
        ...
        $PAGE->set_url(new eset_url('/mod/assign/view.php', array(
...
External link 1:<img src=\"https://eset.org/logo/logo-240x60.gif\" alt=\"Eset\" />
External link 2:<img alt=\"Eset\" src=\"https://eset.org/logo/logo-240x60.gif\" />
Internal link 1:<img src=\"$url/logo-240x60.gif\" alt=\"Eset\" />
Internal link 2:<img alt=\"Eset\" src=\"@@PLUGINFILE@@logo-240x60.gif\" />
...
";
    ...
    public function test_get_shared_group_members_override() {
        ...
        assign_capability('eset/site:accessallgroups', CAP_ALLOW, $roleid, $assign->get_context()->id);
        role_assign($roleid, $student1->id, $assign->get_context()->id);
        accesslib_clear_all_caches_for_unit_testing();
    ...
    public function test_view_group_override() {
        ...
        $currenturl = new eset_url('/mod/assign/view.php', array('id' => $assign->get_course_module()->id));
