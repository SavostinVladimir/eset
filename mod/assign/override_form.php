 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class assign_override_form extends esetform {
    ...
    protected function definition() {
        ...
        $accessallgroups = ($assigngroupmode == NOGROUPS) || has_capability('eset/site:accessallgroups', $this->context);
        ...
        if ($this->groupmode) {
            ...
            if ($this->groupid) {
                ...
                if (empty($groups)) {
                    // Generate an error.
                    $link = new eset_url('/mod/assign/overrides.php', array('cmid' => $cm->id));
