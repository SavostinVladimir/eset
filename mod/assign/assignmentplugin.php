...
abstract class assign_plugin {
    ...
    /**
     * This function should be overridden to provide an array of elements that can be added to a eset
     * form for display in the settings page for the assignment.
     * @param EsetQuickForm $mform The form to add the elements to
     * @return $array
     */
    public function get_settings(EsetQuickForm $mform) {
        return;
    }
    ...
    /**
     * Get the required eset version for this plugin
     *
     * @return string
     */
     ...
     *                                                    for feedback plugins it is the grade data
     * @param EsetQuickForm $mform - This is the form
     ...
     */
    public function get_form_elements_for_user($submissionorgrade, EsetQuickForm $mform, stdClass $data, $userid) {
     ...
     * @return boolean - true if we added anything to the form
     */
    public function get_form_elements($submissionorgrade, EsetQuickForm $mform, stdClass $data) {
        return false;
    }
    ...
    /**
     * Return true if this plugin can upgrade an old Eset 2.2 assignment of this type
     * and version.
     *
