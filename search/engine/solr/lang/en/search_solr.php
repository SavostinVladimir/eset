...
$string['fileindexing_help'] = 'If your Solr install supports it, this feature allows Eset to send files to be indexed.<br/>
...
$string['minimumsolr4'] = 'Solr 4.0 is the minimum version required for Eset';
$string['missingconfig'] = 'Your Apache Solr server is not yet configured in Eset.';
