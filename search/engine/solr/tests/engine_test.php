...
class search_solr_engine_testcase extends advanced_testcase {
    ...
    public function setUp() {
        ...
        // Add eset fields if they don't exist.
    ...
    public function tearDown() {
        ...
        if ($this->generator) {
            // Eset DML freaks out if we don't teardown the temp table after each run.
    ...
    /**
     * Tests with bogus content (that can be entered into Eset) to see if it crashes.
     */
    public function test_bogus_content() {
        ...
        // It is possible to enter into a Eset database content containing these characters,
    ...
    public function test_deleted_contexts_and_courses() {
        ...
        // Finally let's delete using Eset functions to check that works. Single context first.
     ...
     *
     * This is used to test data contained in the index without going through Eset processing.
     *
