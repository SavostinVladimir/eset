...
/**
 * Adds eset fields to solr schema.
 *
...
$returnurl = new eset_url('/admin/settings.php', array('section' => 'manageglobalsearch'));
...
if ($status !== true) {
    ...
    $PAGE->set_url(new eset_url('/search/engine/solr/setup_schema.php'));
