...
abstract class base_activity extends base_mod {
     ...
     * @return \eset_recordset|null Recordset, or null if no possible activities in given context
     */
    ...
    public function get_context_url(\core_search\document $doc) {
        ...
        return new \eset_url('/mod/' . $this->get_module_name() . '/view.php', array('id' => $cminfo->id));
    }
