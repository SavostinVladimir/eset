...
abstract class base_block extends base {
     ...
     * @return false|\eset_recordset|null
     */
    ...
    public function get_doc_url(\core_search\document $doc) {
        ...
        if ($instance->cmid) {
            ...
            return new \eset_url($cm->url, null, $anchor);
        } else {
            ...
            if ($instance->pagetypepattern === '*' || $instance->pagetypepattern === 'course-*' ||
                ...
                return new \eset_url('/course/view.php', ['id' => $courseid], $anchor);
            } else if ($instance->pagetypepattern === 'site-index') {
                return new \eset_url('/', ['redirect' => 0], $anchor);
            } else {
     ...
     * @throws \eset_exception If any DB error
     */
