...
abstract class base {
    ...
    /**
     * Returns the eset component name.
     *
     ...
     *
     * It depends on whether it is a eset subsystem or a plugin as plugin-related config should remain in their own scope.
     *
     * @access private
     ...
     *
     * Since Eset 3.4, subclasses should instead implement get_document_recordset, which has
     ...
     * @return \eset_recordset|null|false Recordset / null if no results / false if not supported
     * @since Eset 3.4
     */
