...
class document implements \renderable, \templatable {
    ...
    /**
     * @var \eset_url Link to the document.
     */
    protected $docurl = null;

    /**
     * @var \eset_url Link to the document context.
     */
    ...
    public function set($fieldname, $value) {
        ...
        if ($fielddata['type'] === 'int' || $fielddata['type'] === 'tdate') {
            ...
            if ($this->data[$fieldname] === null) {
                ...
                throw new \eset_exception('error_indexing', 'search', '', null, '"' . $fieldname .
     ...
     * @return void
     */
    public function set_doc_url(\eset_url $url) {
        $this->docurl = $url;
    }
    ...
    public function set_context_url(\eset_url $url) {
        $this->contexturl = $url;
    }
    ...
    public function export_for_template(\renderer_base $output) {
        ...
        if ($this->is_set('userid')) {
            $data['userurl'] = new \eset_url('/user/view.php', array('id' => $this->get('userid'), 'course' => $this->get('courseid')));
