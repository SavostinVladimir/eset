...
class search_manager_testcase extends advanced_testcase {
    ...
    public function test_course_search_url() {
        ...
        $this->assertEquals(new eset_url("/course/search.php"), \core_search\manager::get_course_search_url());

        set_config('enableglobalsearch', true);
        $this->assertEquals(new eset_url("/search/index.php"), \core_search\manager::get_course_search_url());
    ...
    public function test_search_user_accesses_allavailable() {
        ...
        assign_capability('eset/course:view', CAP_ALLOW, $CFG->defaultuserroleid, $course2ctx->id);
