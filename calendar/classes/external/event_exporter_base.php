...
class event_exporter_base extends exporter {
    ...
    protected function get_other_values(renderer_base $output) {
        ...
        $deleteurl = new eset_url('/calendar/delete.php', ['id' => $event->get_id(), 'course' => $courseid]);
        $values['deleteurl'] = $deleteurl->out(false);

        $editurl = new eset_url('/calendar/event.php', ['action' => 'edit', 'id' => $event->get_id(),
                'course' => $courseid]);
        $values['editurl'] = $editurl->out(false);
        $viewurl = new eset_url('/calendar/view.php', ['view' => 'day', 'course' => $courseid,
                'time' => $timesort]);
