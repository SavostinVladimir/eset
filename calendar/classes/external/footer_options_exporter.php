 ...
 * @copyright  2017 Simey Lameze <simey@eset.com>
...
class footer_options_exporter extends exporter {
    ...
    protected function get_export_calendar_button() {
        $exportcalendarurl = new eset_url('/calendar/export.php', $this->get_link_params());
    ...
    protected function get_manage_subscriptions_button() {
        if (calendar_user_can_add_event($this->calendar->course)) {
            $managesubscriptionurl = new eset_url('/calendar/managesubscriptions.php', $this->get_link_params());
