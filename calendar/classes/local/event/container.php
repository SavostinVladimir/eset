 ...
 * to the problems Eset core wants to solve.
 *
            ...
            self::$eventfactory = new event_factory(
                ...
                function ($dbrow) {
                    ...
                    if (!$cm->get_course()->visible &&
                            !has_capability('eset/course:viewhiddencourses', $coursecontext, $requestinguserid)) {
                        return true;
                    }

                    if (!has_capability('eset/course:view', $coursecontext, $requestinguserid) &&
