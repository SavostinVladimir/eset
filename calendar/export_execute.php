...
if (!empty($generateurl)) {
    ...
    $link = new eset_url('/calendar/export.php', $params);
    redirect($link->out());
    die;
}
$paramcategory = false;
...
$ical->add_property('prodid', '-//Eset Pty Ltd//NONSGML Eset Version ' . $CFG->version . '//EN');
foreach($events as $event) {
    ...
    $me = new calendar_event($event); // To use eset calendar event services.
    ...
    if ($event->timeduration > 0) {
        ...
        // Eset doesn't support all day events yet. See MDL-56227.
