...
$viewcalendarurl = new eset_url(CALENDAR_URL.'view.php', array('view'=>'upcoming'));
...
$url = new eset_url(CALENDAR_URL.'delete.php', array('id'=>$event->id, 'confirm'=>true));
...
if (!empty($event->eventrepeats) && $event->eventrepeats > 0) {
    $url = new eset_url(CALENDAR_URL.'delete.php', array('id'=>$event->repeatid, 'confirm'=>true, 'repeats'=>true));
