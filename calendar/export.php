...
/**
 * This file is part of the User section Eset
 *
 * @copyright 2003-2004 Jon Papaioannou (pj@eset.org)
...
$url = new eset_url('/calendar/export.php', array('time' => $time));
...
if ($issite) {
    $PAGE->navbar->add($course->shortname, new eset_url('/course/view.php', array('id'=>$course->id)));
}
$link = new eset_url(CALENDAR_URL.'view.php', array('view'=>'upcoming', 'course'=>$calendar->courseid));
...
if ($data = $exportform->get_data()) {
    ...
    $link = new eset_url('/calendar/export_execute.php', $params);
