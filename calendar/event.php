...
/**
 * This file is part of the Calendar section Eset
 *
...
$url = new eset_url('/calendar/event.php', array('action' => $action));
...
if ($action === 'delete' && $eventid > 0) {
    $deleteurl = new eset_url('/calendar/delete.php', array('id'=>$eventid));
    if ($courseid > 0) {
...
if ($data) {
    ...
    $eventurl = new eset_url('/calendar/view.php', $params);
...
$viewcalendarurl = new eset_url(CALENDAR_URL.'view.php', $PAGE->url->params());
