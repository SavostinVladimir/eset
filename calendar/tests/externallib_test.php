...
class core_calendar_externallib_testcase extends externallib_advanced_testcase {
     ...
     *
     * @expectedException eset_exception
     */
    public function test_delete_calendar_events() {
        ...
        // Remove all caps.
        $this->unassignUserCapability('eset/calendar:manageentries', $sitecontext->id, $role->id);
        $this->unassignUserCapability('eset/calendar:manageentries', $coursecontext->id, $role->id);
        $this->unassignUserCapability('eset/calendar:managegroupentries', $coursecontext->id, $role->id);
        $this->unassignUserCapability('eset/calendar:manageownentries', $usercontext->id, $role->id);

        // Assign proper caps and attempt delete.
         $this->assignUserCapability('eset/calendar:manageentries', $sitecontext->id, $role->id);
         $events = array(
                array('eventid' => $siteevent->id, 'repeat' => 0),
                );
        core_calendar_external::delete_calendar_events($events);
        ...
        $this->assertEquals($count, $deletedcount);
         ...
         $this->assignUserCapability('eset/calendar:manageownentries', $usercontext->id, $role->id);
         $events = array(
                array('eventid' => $userevent->id, 'repeat' => 0),
                );
        core_calendar_external::delete_calendar_events($events);
        ...
        $this->assertEquals($count, $deletedcount);
         ...
         $this->assignUserCapability('eset/calendar:managegroupentries', $coursecontext->id, $role->id);
         $events = array(
                array('eventid' => $groupevent->id, 'repeat' => 0),
                );
        core_calendar_external::delete_calendar_events($events);
    ...
    public function test_core_create_calendar_events() {
        ...
        $this->getDataGenerator()->enrol_user($user->id, $course->id, $role->id);
        groups_add_member($group, $user);
        $this->assignUserCapability('eset/calendar:manageentries', $coursecontext->id, $role->id);
        $this->assignUserCapability('eset/calendar:managegroupentries', $coursecontext->id, $role->id);
        $eventsret = core_calendar_external::create_calendar_events($events);
        $eventsret = external_api::clean_returnvalue(core_calendar_external::create_calendar_events_returns(), $eventsret);
        // Check to see if things were created properly.
    ...
    public function test_update_event_start_day() {
        ...
        assign_capability('eset/calendar:manageownentries', CAP_ALLOW, $roleid, $context, true);
    ...
    public function test_update_event_start_day_no_permission() {
        ...
        assign_capability('eset/calendar:manageownentries', CAP_PROHIBIT, $roleid, $context, true);
        $this->expectException('eset_exception');
        $result = core_calendar_external::update_event_start_day($event->id, $newstartdate->getTimestamp());
        $result = external_api::clean_returnvalue(
            core_calendar_external::update_event_start_day_returns(),
    ...
    public function test_update_event_start_day_module_event() {
        ...
        assign_capability('eset/calendar:manageentries', CAP_ALLOW, $roleid, $context, true);
        $this->expectException('eset_exception');
        $result = core_calendar_external::update_event_start_day($event->id, $newstartdate->getTimestamp());
        $result = external_api::clean_returnvalue(
            core_calendar_external::update_event_start_day_returns(),
    ...
    /**
     * A user with the eset/calendar:manageownentries capability at the
    ...
    /**
     * A user without the eset/calendar:manageownentries capability at the
    ...
    /**
     * A user with the eset/calendar:manageentries capability at the
    ...
    /**
     * A user without the eset/calendar:manageentries capability at the
    ...
    public function test_submit_create_update_form_create_site_event_no_permission() {
        ...
        assign_capability('eset/calendar:manageentries', CAP_PROHIBIT, $roleid, $context, true);
    ...
    /**
     * A user that has the eset/calendar:manageentries in a course that they
    ...
    /**
     * A user without the eset/calendar:manageentries capability in a course
     ...
     * a course in which they are enrolled and have the eset/calendar:manageentries capability.
     */
    ...
    /**
     * A user should be able to create an event for a group that they are a member of in
     * a course in which they are enrolled and have the eset/calendar:managegroupentries capability.
     */
    public function test_submit_create_update_form_create_group_event_group_member_manage_group_entries() {
        ...
        assign_capability('eset/calendar:manageentries', CAP_PROHIBIT, $roleid, $context, true);
        assign_capability('eset/calendar:managegroupentries', CAP_ALLOW, $roleid, $context, true);
     ...
     * they are enrolled and have the eset/site:accessallgroups capability.
     */
    public function test_submit_create_update_form_create_group_event_access_all_groups() {
        ...
        assign_capability('eset/calendar:manageentries', CAP_ALLOW, $roleid, $context, true);
        assign_capability('eset/site:accessallgroups', CAP_ALLOW, $roleid, $context, true);
     ...
     * eset/site:accessallgroups capability.
     */
    public function test_submit_create_update_form_create_group_event_non_member_no_permission() {
        ...
        assign_capability('eset/calendar:manageentries', CAP_ALLOW, $roleid, $context, true);
        assign_capability('eset/site:accessallgroups', CAP_PROHIBIT, $roleid, $context, true);
