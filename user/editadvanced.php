...
if ($id == -1) {
    ...
    $user->deleted = 0;
    $user->timezone = '99';
    require_capability('eset/user:create', $systemcontext);
    admin_externalpage_setup('addnewuser', '', array('id' => -1));
} else {
    // Editing existing user.
    require_capability('eset/user:update', $systemcontext);
...
// Create form.
$userform = new user_editadvanced_form(new eset_url($PAGE->url, array('returnto' => $returnto)), array(
