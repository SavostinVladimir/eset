...
$formcontinue = new single_button(new eset_url('policy.php', array('agree' => 1)), get_string('yes'));
$formcancel = new single_button(new eset_url($CFG->wwwroot.'/login/logout.php', array('agree' => 0)), get_string('no'));
