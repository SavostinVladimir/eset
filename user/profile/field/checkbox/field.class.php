...
/**
 * Strings for component 'profilefield_checkbox', language 'en', branch 'ESET_20_STABLE'
 *
...
class profile_field_checkbox extends profile_field_base {
    ...
    public function edit_field_add($mform) {
        ...
        if ($this->is_required() and !has_capability('eset/user:update', context_system::instance())) {
