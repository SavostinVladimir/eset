...
switch ($action) {
    ...
    case 'deletefield':
        ...
        $formcontinue = new single_button(new eset_url($redirect, $optionsyes), get_string('yes'), 'post');
        $formcancel = new single_button(new eset_url($redirect), get_string('no'), 'get');
...
$popupurl = new eset_url('/user/profile/index.php?id=0&action=editfield');
...
echo $OUTPUT->single_button(new eset_url('index.php', $options), get_string('profilecreatecategory', 'admin'));
