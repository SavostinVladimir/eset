...
class participants_search_test extends advanced_testcase {
    ...
    /**
     * Helper to convert a eset_recordset to an array of records.
     *
     * @param eset_recordset $recordset
     * @return array
     */
    protected function convert_recordset_to_array(eset_recordset $recordset): array {
        $records = [];
    ...
    public function test_roles_filter(array $usersdata, array $testroles, int $jointype, int $count, array $expectedusers): void {
        ...
        $this->assertInstanceOf(eset_recordset::class, $rs);
