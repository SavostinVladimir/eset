...
class core_user_externallib_testcase extends externallib_advanced_testcase {
    ...
    public function test_get_users() {
        ...
        $roleid = $this->assignUserCapability('eset/user:viewdetails', $context->id);
        ...
        try {
            ...
            // Call the external function.
            $result = core_user_external::get_users($searchparams);
            $this->fail('Expecting \'keyalreadyset\' eset_exception to be thrown.');
    ...
    public function test_get_course_user_profiles() {
        ...
        $data = $this->get_course_user_profiles_setup('eset/user:viewdetails');
    ...
    public function test_create_users() {
        ...
        $roleid = $this->assignUserCapability('eset/user:create', $context->id);
        $this->assignUserCapability('eset/user:editprofile', $context->id, $roleid);
        ...
        $this->unassignUserCapability('eset/user:create', $context->id, $roleid);
    ...
    public function test_create_users_invalid_parameter(array $data, $expectmessage) {
        ...
        $this->resetAfterTest(true);
        $this->assignUserCapability('eset/user:create', SYSCONTEXTID);
    ...
    public function test_delete_users() {
        ...
        $context = context_system::instance();
        $roleid = $this->assignUserCapability('eset/user:delete', $context->id);
        ...
        // Call without required capability.
        $this->unassignUserCapability('eset/user:delete', $context->id, $roleid);
        $this->expectException('required_capability_exception');
        core_user_external::delete_users(array($user1->id, $user2->id));
    }
    ...
    public function test_update_users() {
        ...
        $context = context_system::instance();
        $roleid = $this->assignUserCapability('eset/user:update', $context->id);
        $this->assignUserCapability('eset/user:editprofile', $context->id, $roleid);
        ...
        // Call without required capability.
        $this->unassignUserCapability('eset/user:update', $context->id, $roleid);
        $this->expectException('required_capability_exception');
        core_user_external::update_users(array($user1));
    }
    ...
    public function test_add_user_private_files() {
        ...
        $context = context_system::instance();
        $roleid = $this->assignUserCapability('eset/user:manageownfiles', $context->id);
    ...
    public function test_agree_site_policy() {
        ...
        try {
            $result = core_user_external::agree_site_policy();
            $this->fail('Expecting \'usernotfullysetup\' eset_exception to be thrown');
        } catch (eset_exception $e) {
