...
Feature: Custom profile fields should be visible and editable by those with the correct permissions.
  ...
  @javascript
  Scenario: User with eset/user:update but without eset/user:viewalldetails can only update visible profile fields.
    Given the following "roles" exist:
      | name         | shortname   | description | archetype |
      | Update Users | updateusers | updateusers |           |
    And the following "permission overrides" exist:
      | capability         | permission | role        | contextlevel | reference |
      | eset/user:update | Allow      | updateusers | System       |           |
  ...
  @javascript
  Scenario: User with eset/user:viewalldetails but without eset/user:update can view all profile fields.
    Given the following "roles" exist:
      | name             | shortname      | description    | archetype |
      | View All Details | viewalldetails | viewalldetails |           |
    And the following "permission overrides" exist:
      | capability                 | permission | role           | contextlevel | reference |
      | eset/user:viewalldetails | Allow      | viewalldetails | System       |           |
    And the following "users" exist:
      | username            | firstname      | lastname | email                      |
  ...
  @javascript
  Scenario: User with eset/user:viewalldetails and eset/user:update capabilities can view and edit all profile fields.
    Given the following "roles" exist:
      | name                              | shortname                    | description                  | archetype |
      | View All Details and Update Users | viewalldetailsandupdateusers | viewalldetailsandupdateusers |           |
    And the following "permission overrides" exist:
      | capability                 | permission | role                         | contextlevel | reference |
      | eset/user:viewalldetails | Allow      | viewalldetailsandupdateusers | System       |           |
      | eset/user:update         | Allow      | viewalldetailsandupdateusers | System       |           |
    And the following "users" exist:
      | username                          | firstname                    | lastname | email                                    |
  ...
  Scenario: Users can view but not edit custom profile fields when denied the edit own profile capability.
    ...
    And the following "permission overrides" exist:
      | capability                 | permission | role               | contextlevel | reference |
      | eset/user:editownprofile | Prohibit   | denyeditownprofile | System       |           |
    And the following "role assigns" exist:
      | user                | role               | contextlevel | reference |
