...
$url = new eset_url('/user/portfolio.php', array('courseid' => $courseid));
...
if (!empty($config)) {
    navigation_node::override_active_url(new eset_url('/user/portfolio.php', array('courseid' => $courseid)));
...
if ($display) {
    ...
    foreach ($instances as $i) {
        ...
        if ($i->has_user_config()) {
            $configurl = new eset_url($baseurl);
        ...
        $showhideurl = new eset_url($baseurl);
