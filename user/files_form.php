 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class user_files_form extends esetform {
    ...
    public function definition() {
        ...
        if (isset($data->emaillink)) {
            $emaillink = html_writer::link(new eset_url('mailto:' . $data->emaillink), $data->emaillink);
            $mform->addElement('static', 'emailaddress', '',
                get_string('emailtoprivatefiles', 'eset', $emaillink));
        }
