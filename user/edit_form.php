 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class user_edit_form extends esetform {
    ...
    public function definition () {
        ...
        // Print the required eset fields first.
        $mform->addElement('header', 'eset', $strgeneral);
        ...
        if ($usernotfullysetup) {
            ...
            if ($mform->elementExists('eset_additional_names')) {
                $mform->insertElementBefore($userpicturewarning, 'eset_additional_names');
            } else if ($mform->elementExists('eset_interests')) {
                $mform->insertElementBefore($userpicturewarning, 'eset_interests');
            } else {
                $mform->insertElementBefore($userpicturewarning, 'eset_optional');
            }
    ...
    public function validation($usernew, $files) {
        ...
        if (isset($usernew->email) and !empty($CFG->verifychangedemail) and !isset($errors['email']) and !has_capability('eset/user:update', context_system::instance())) {
