...
class participants extends \table_sql implements dynamic_table {
    ...
    /** @var eset_url $baseurl The base URL for the report. */
    public $baseurl;
    ...
    public function out($pagesize, $useinitialsbar, $downloadhelpbutton = '') {
        ...
        $bulkoperations = has_capability('eset/course:bulkmessaging', $this->context);
        if ($bulkoperations) {
        ...
        $hiddenfields = array();
        if (!has_capability('eset/course:viewhiddenuserfields', $this->context)) {
        ...
        $canreviewenrol = has_capability('eset/course:enrolreview', $this->context);
        ...
        if (has_capability('eset/course:enrolreview', $this->context)) {
            $params = [
    ...
    public function col_select($data) {
        ...
        $checkbox = new \core\output\checkbox_toggleall('participants-table', false, [
            ...
            'name' => 'user' . $data->id,
            'checked' => false,
            'label' => get_string('selectitem', 'eset', fullname($data)),
    ...
    public function col_status($data) {
        ...
        $canreviewenrol = has_capability('eset/course:enrolreview', $this->context);
        if ($canreviewenrol) {
            $canviewfullnames = has_capability('eset/site:viewfullnames', $this->context);
    ...
    public function guess_base_url(): void {
        $this->baseurl = new eset_url('/user/index.php', ['id' => $this->courseid]);
    }
