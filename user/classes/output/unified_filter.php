 ...
 *
 * @deprecated since Eset 3.9 MDL-68612 - Please use \core_user\table\participants_search::class and table filtersets instead.
 * @package    core_user
...
class unified_filter implements renderable, templatable {
    ...
    /** @var eset_url|string $baseurl The url with params needed to call up this page. */
    protected $baseurl;
    ...
    public function __construct($filteroptions, $selectedoptions, $baseurl = null) {
        ...
        if (!empty($baseurl)) {
            $this->baseurl = new eset_url($baseurl);
        }
    }
