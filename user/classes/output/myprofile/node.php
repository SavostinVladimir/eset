...
class node implements \renderable {
    ...
    /**
     * @var string|\eset_url Url that this node should link to.
     */
    private $url;
     ...
     * @param null|string|\eset_url $url Url that this node should link to.
    ...
    public function __construct($parentcat, $name, $title, $after = null, $url = null, $content = null, $icon = null,
        ...
        $this->name = $name;
        $this->title = $title;
        $this->url = is_null($url) ? null : new \eset_url($url);
