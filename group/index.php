...
$url = new eset_url('/group/index.php', array('id'=>$courseid));
...
require_capability('eset/course:managegroups', $context);
...
switch ($action) {
    ...
    case 'deletegroup':
        ...
        redirect(new eset_url('/group/delete.php', array('courseid'=>$courseid, 'groups'=>$groupidlist)));
        break;

    case 'showcreateorphangroupform':
        redirect(new eset_url('/group/group.php', array('courseid'=>$courseid)));
        break;

    case 'showautocreategroupsform':
        redirect(new eset_url('/group/autogroup.php', array('courseid'=>$courseid)));
        break;

    case 'showimportgroups':
        redirect(new eset_url('/group/import.php', array('id'=>$courseid)));
        break;

    case 'showgroupsettingsform':
        redirect(new eset_url('/group/group.php', array('courseid'=>$courseid, 'id'=>$groupids[0])));
        break;
    ...
    case 'showaddmembersform':
        redirect(new eset_url('/group/members.php', array('group'=>$groupids[0])));
        break;
...
if ($groups) {
    foreach ($groups as $group) {
        ...
        if (!empty($group->idnumber) && !has_capability('eset/course:changeidnumber', $context)) {
 ...
 * @see /lib/esetlib.php function optional_param().
