...
if ($editform->is_cancelled()) {
    ...
    $onlyactive = !empty($data->includeonlyactiveenrol) || !has_capability('eset/course:viewsuspendedusers', $context);
...
$PAGE->navbar->add($strgroups, new eset_url('/group/index.php', array('id'=>$courseid)));
