...
class core_group_externallib_testcase extends externallib_advanced_testcase {
    ...
    public function test_create_groups() {
        ...
        $group1['descriptionformat'] = FORMAT_ESET;
        ...
        $roleid = $this->assignUserCapability('eset/course:managegroups', $context->id);
        $this->assignUserCapability('eset/course:view', $context->id, $roleid);
        ...
        foreach ($groups as $group) {
            ...
            switch ($dbgroup->name) {
                ...
                case $group2['name']:
                    ...
                    break;
                default:
                    throw new eset_exception('unknowgroupname');
                    break;
            }
        ...
        $this->unassignUserCapability('eset/course:managegroups', $context->id, $roleid);
    ...
    public function test_update_groups() {
        ...
        $group1data['descriptionformat'] = FORMAT_ESET;
        ...
        foreach ([$group1, $group2] as $group) {
            ...
            switch ($dbgroup->name) {
                ...
                case $group2data['name']:
                    ...
                    break;
                default:
                    throw new eset_exception('unknowngroupname');
                    break;
            }
            $this->assertEquals($dbgroup->description, $groupdescription);
        }
    ...
    public function test_create_update_groupings() {
        ...
        $grouping1data['descriptionformat'] = FORMAT_ESET;
        ...
        $grouping2data['descriptionformat'] = FORMAT_ESET;
    ...
    public function test_get_groupings() {
        ...
        $groupingdata['descriptionformat'] = FORMAT_ESET;
        ...
        $group2data['name'] = 'Group Test 2';
        $group2data['description'] = 'Group Test 2 description';
        $group2data['descriptionformat'] = FORMAT_ESET;
