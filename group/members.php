...
$PAGE->navbar->add($strparticipants, new eset_url('/user/index.php', array('id'=>$course->id)));
$PAGE->navbar->add($strgroups, new eset_url('/group/index.php', array('id'=>$course->id)));
