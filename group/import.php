...
$returnurl = new eset_url('/group/index.php', array('id'=>$id));
    ...
    while ($line = $csvimport->next()) {
        ...
        if (trim(implode($line)) !== '') {
            ...
            if (isset($newgroup->courseid)) {
                ...
                if (!has_capability('eset/course:managegroups', $newgrpcoursecontext) or (!is_enrolled($newgrpcoursecontext) and !has_capability('eset/course:view', $newgrpcoursecontext))) {
                    ...
                    if (isset($newgroup->groupidnumber)) {
                        ...
                        if (has_capability('eset/course:changeidnumber', $newgrpcoursecontext)) {
