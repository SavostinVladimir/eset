 ...
 *
 * @copyright 2019 Victor Deniz <victor@eset.com>, based on Michael Milette <michael.milette@tngconsulting.ca> code
...
$homeurl = new eset_url('/admin/category.php', array('category' => 'email'));
$returnurl = new eset_url('/admin/testoutgoingconf.php');
...
if ($data) {
    ...
    // Restore Eset debugging options.
    ...
    if ($success) {
        ...
        // No communication between Eset and the SMTP server - no error output.
