...
require_capability('eset/user:delete', context_system::instance());
...
if ($confirm and confirm_sesskey()) {
    ...
    $formcontinue = new single_button(new eset_url('user_bulk_delete.php', array('confirm' => 1)), get_string('yes'));
