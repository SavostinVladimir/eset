...
require_capability('eset/cohort:assign', context_system::instance());
...
foreach ($allcohorts as $c) {
    ...
    if (!has_capability('eset/cohort:assign', $context)) {
        continue;
    }
...
if (count($cohorts) < 2) {
    redirect(new eset_url('/admin/user/user_bulk.php'), get_string('bulknocohort', 'core_cohort'));
}
...
if (empty($users) or $mform->is_cancelled()) {
    redirect(new eset_url('/admin/user/user_bulk.php'));
