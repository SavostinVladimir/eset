...
require_capability('eset/user:update', context_system::instance());
...
if ($confirm and confirm_sesskey()) {
    ...
    $continue = new single_button(new eset_url($return), get_string('continue'), 'post');
    ...
    $formcontinue = new single_button(new eset_url('user_bulk_confirm.php', array('confirm' => 1)), get_string('yes'));
