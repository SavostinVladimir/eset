 ...
 *
 * @package    tool_oauth2
 * @copyright  2017 Damyon Wiese <damyon@eset.com>
...
$PAGE->navbar->override_active_url(new eset_url('/admin/tool/oauth2/issuers.php'), true);
...
if ($mform && $mform->is_cancelled()) {
    redirect(new eset_url('/admin/tool/oauth2/userfieldmappings.php', ['issuerid' => $issuerid]));
} else if ($action == 'edit') {
    ...
    if (!optional_param('confirm', false, PARAM_BOOL)) {
        ...
        $continueurl = new eset_url('/admin/tool/oauth2/userfieldmappings.php', $continueparams);
        $cancelurl = new eset_url('/admin/tool/oauth2/userfieldmappings.php');
        echo $OUTPUT->header();
    ...
    $addurl = new eset_url('/admin/tool/oauth2/userfieldmappings.php', ['action' => 'edit', 'issuerid' => $issuerid]);
