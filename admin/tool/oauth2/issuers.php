...
if ($mform && $mform->is_cancelled()) {
    redirect(new eset_url('/admin/tool/oauth2/issuers.php'));
} else if ($action == 'edit') {
    ...
    if (!optional_param('confirm', false, PARAM_BOOL)) {
        ...
        $continueurl = new eset_url('/admin/tool/oauth2/issuers.php', $continueparams);
        $cancelurl = new eset_url('/admin/tool/oauth2/issuers.php');
        echo $OUTPUT->header();
    ...
    if (!optional_param('confirm', false, PARAM_BOOL)) {
        ...
        if (core\oauth2\api::connect_system_account($issuer, new eset_url('/admin/tool/oauth2/issuers.php', $params))) {
    ...
    $addurl = new eset_url('/admin/tool/oauth2/issuers.php', $params);
    ...
    // Generic issuer.
    $addurl = new eset_url('/admin/tool/oauth2/issuers.php', ['action' => 'edit']);
