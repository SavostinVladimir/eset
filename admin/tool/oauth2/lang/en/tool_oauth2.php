...
$string['authconfirm'] = 'This action will grant permanent API access to Eset for the authenticated account. This is intended to be used as a system account for managing files owned by Eset.';
...
$string['issuerrequireconfirmation_help'] = 'Require that all users verify their email address before they can log in with OAuth. This applies to newly created accounts as part of the login process, or when an existing Eset account is connected to an OAuth login via matching email addresses.';
...
$string['userfieldinternalfield_help'] = 'Name of the Eset user field that should be mapped from the external field.';
