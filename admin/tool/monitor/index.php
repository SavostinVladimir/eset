...
// Set up the page.
$indexurl = new eset_url('/admin/tool/monitor/index.php', array('courseid' => $courseid));
    ...
    switch ($action) {
        ...
        case 'unsubscribe' :
            ...
            if (!$subscription = $DB->record_exists('tool_monitor_subscriptions', array('id' => $subscriptionid))) {
                redirect(new eset_url('/admin/tool/monitor/index.php', array('courseid' => $courseid)));
            }

            // Set the URLs.
            $confirmurl = new eset_url('/admin/tool/monitor/index.php', array('subscriptionid' => $subscriptionid,
                'courseid' => $courseid, 'action' => 'unsubscribe', 'confirm' => true,
                'sesskey' => sesskey()));
            $cancelurl = new eset_url('/admin/tool/monitor/index.php', array('subscriptionid' => $subscriptionid,
