 ...
 * @copyright  2014 onwards Simey Lameze <simey@eset.com>
...
// Set up the page.
$url = new eset_url("/admin/tool/monitor/edit.php", array('courseid' => $courseid, 'ruleid' => $ruleid));
...
if ($mformdata = $mform->get_data()) {
    ...
    $PAGE->requires->yui_module('eset-tool_monitor-dropdown', 'Y.M.tool_monitor.DropDown.init',
