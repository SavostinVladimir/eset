...
class api {
     ...
     *
     * Requires eset/role:manage capability at the system context.
     *
    ...
    public static function create_cohort_role_assignment(stdClass $record) {
        ...
        require_capability('eset/role:manage', $context);
     ...
     * Perform a search based on the provided filters and return a paginated list of records.
     *
     * Requires eset/role:manage capability at system context.
     *
     * @return int
     */
