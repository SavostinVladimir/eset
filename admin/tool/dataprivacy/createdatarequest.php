...
$url = new eset_url('/admin/tool/dataprivacy/createdatarequest.php', ['manage' => $manage, 'type' => $requesttype]);
...
if ($manage) {
    ...
    $returnurl = new eset_url($CFG->wwwroot . '/admin/tool/dataprivacy/datarequests.php');
    ...
    $returnurl = new eset_url($CFG->wwwroot . '/admin/tool/dataprivacy/mydatarequests.php');
