...
class tool_dataprivacy_external_testcase extends externallib_advanced_testcase {
     ...
     * don't have "eset/site:viewuseridentity" permission.
     *
     * @throws coding_exception
     * @throws dml_exception
     * @throws invalid_parameter_exception
     ...
     * even they have "eset/site:viewuseridentity" permission.
     *
     * @throws coding_exception
     * @throws dml_exception
     * @throws invalid_parameter_exception
    ...
    public function test_get_users_using_field_not_in_identity() {
        ...
        role_assign($role, $requester->id, $context);
        assign_capability('tool/dataprivacy:managedatarequests', CAP_ALLOW, $role, $context);
        assign_capability('eset/site:viewuseridentity', CAP_ALLOW, $role, $context);
        $this->setUser($requester);
     ...
     * with "eset/site:viewuseridentity" permission.
     *
     * @throws coding_exception
     * @throws dml_exception
     * @throws invalid_parameter_exception
