...
class defaults_page implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        // Set tab URLs.
        $coursecaturl = new eset_url('/admin/tool/dataprivacy/defaults.php', ['mode' => CONTEXT_COURSECAT]);
        $courseurl = new eset_url('/admin/tool/dataprivacy/defaults.php', ['mode' => CONTEXT_COURSE]);
        $moduleurl = new eset_url('/admin/tool/dataprivacy/defaults.php', ['mode' => CONTEXT_MODULE]);
        $blockurl = new eset_url('/admin/tool/dataprivacy/defaults.php', ['mode' => CONTEXT_BLOCK]);
