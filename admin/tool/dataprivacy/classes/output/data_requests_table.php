 ...
 * @copyright  2018 Jun Pataleta <jun@eset.com>
...
class data_requests_table extends table_sql {
    ...
    public function col_actions($data) {
        ...
        if ($this->manage) {
            ...
            $canreset = $canreset && ($persistent->get('type') != api::DATAREQUEST_TYPE_DELETE ||
                    api::can_create_data_deletion_request_for_other());
            if ($canreset) {
                $reseturl = new eset_url('/admin/tool/dataprivacy/resubmitrequest.php', [
                        'requestid' => $requestid,
                    ]);
    ...
    public function wrap_html_finish() {
        ...
        $perpageselect->label = get_string('perpage', 'eset');
