...
class data_registry_page implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $defaultsbutton = new \action_link(
            new \eset_url('/admin/tool/dataprivacy/defaults.php'),
