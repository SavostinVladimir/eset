    ...
    public function execute() {
        ...
        switch ($request->type) {
            case api::DATAREQUEST_TYPE_EXPORT:
                ...
                // systems, not just one Eset instance, so we don't want every instance emailing
                // the user.)
                ...
                // We want to notify the user in Eset about the processing results.
                $message->notification = 1;
                $datarequestsurl = new eset_url('/admin/tool/dataprivacy/mydatarequests.php');
                ...
                $downloadurl = eset_url::make_pluginfile_url($usercontext->id, 'tool_dataprivacy', 'export', $thing->get_itemid(),
            ...
            case api::DATAREQUEST_TYPE_DELETE:
                ...
                // No point notifying a deleted user in Eset.
                ...
                break;
            default:
                throw new eset_exception('errorinvalidrequesttype', 'tool_dataprivacy');
        }
