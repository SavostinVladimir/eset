...
function tool_dataprivacy_myprofile_navigation(tree $tree, $user, $iscurrentuser, $course) {
    ...
    if (\tool_dataprivacy\api::can_contact_dpo() && $iscurrentuser) {
        ...
        $url = new eset_url('/admin/tool/dataprivacy/mydatarequests.php');
        ...
        if (!$hasexportrequest) {
            ...
            $exporturl = new eset_url('/admin/tool/dataprivacy/createdatarequest.php', $exportparams);
        ...
        if (!$hasdeleterequest && \tool_dataprivacy\api::can_create_data_deletion_request_for_self()) {
            ...
            $deleteurl = new eset_url('/admin/tool/dataprivacy/createdatarequest.php', $deleteparams);
    ...
    if ($showsummary && $iscurrentuser) {
        $summaryurl = new eset_url('/admin/tool/dataprivacy/summary.php');
...
function tool_dataprivacy_standard_footer_html() {
    ...
    if ($showsummary) {
        $url = new eset_url('/admin/tool/dataprivacy/summary.php');
