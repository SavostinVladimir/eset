...
$url = new eset_url('/admin/tool/dataprivacy/resubmitrequest.php', ['requestid' => $requestid]);
...
$manageurl = new eset_url('/admin/tool/dataprivacy/datarequests.php');
...
$confirmurl = new \eset_url($PAGE->url, ['confirm' => 1]);
