...
class controller {
     ...
     * @throws \eset_exception when error is encountered installing langpack
     */
        ...
        foreach ($results as $langcode => $langstatus) {
            switch ($langstatus) {
                case \lang_installer::RESULT_DOWNLOADERROR:
                    ...
                    throw new \eset_exception('remotedownloaderror', 'error', $a);
                    break;
    ...
    /**
     * checks the md5 of the zip file, grabbed from download.eset.org,
