...
class langimport_page implements renderable, templatable {
    ...
    /** @var eset_url The URL to be used for uninstalling the selected existing language packs. */
    protected $uninstallurl;

    /** @var eset_url The URL to be used for updating the installed language packs. */
    protected $updateurl;

    /** @var eset_url The URL to be used for installing the selected language packs to be installed. */
     ...
     * @param eset_url $uninstallurl The URL to be used for uninstalling the selected existing language packs.
     * @param eset_url $updateurl The URL to be used for updating the installed language packs.
     * @param eset_url $installurl The URL to be used for installing the selected language packs to be installed.
     */
