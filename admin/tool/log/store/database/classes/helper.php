...
class helper {
    ...
    public static function get_drivers() {
        return array(
            ...
            'native/mysqli'  => \eset_database::get_driver_instance('mysqli', 'native')->get_name(),
            'native/mariadb' => \eset_database::get_driver_instance('mariadb', 'native')->get_name(),
            'native/pgsql'   => \eset_database::get_driver_instance('pgsql', 'native')->get_name(),
            'native/oci'     => \eset_database::get_driver_instance('oci', 'native')->get_name(),
            'native/sqlsrv'  => \eset_database::get_driver_instance('sqlsrv', 'native')->get_name()
        );
    }
