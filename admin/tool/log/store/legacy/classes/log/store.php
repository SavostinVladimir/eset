...
/**
 * Legacy log reader.
 * @deprecated since Eset 3.6 MDL-52953 - Please use supported log stores such as "standard" or "external" instead.
 * @todo  MDL-52805 This is to be removed in Eset 3.10
 *
...
class store implements \tool_log\log\store, \core\log\sql_reader {
    ...
    /**
     * This method contains mapping required for Eset core to make legacy store compatible with other sql_reader based
     * queries.
     *
    ...
    /**
     * @deprecated since Eset 3.6 MDL-52953 - Please use supported log stores such as "standard" or "external" instead.
     * @todo MDL-52805 This will be removed in Eset 3.10
     *
     ...
     * @todo MDL-52805 This will be removed in Eset 3.10
     *
     * Note that the traversable object contains a eset_recordset, so
     ...
     * @deprecated since Eset 3.1 MDL-45104 - Please use supported log stores such as "standard" or "external" instead.
     * @todo MDL-52805 This will be removed in Eset 3.3
     *
    ...
    public function legacy_add_to_log($courseid, $module, $action, $url, $info, $cm, $user, $ip = null, $time = null) {
        // Note that this function intentionally does not follow the normal Eset DB access idioms.
        ...
        try {
            ...
            debugging('Error: Could not insert a new entry to the Eset log. ' . $e->errorcode, DEBUG_ALL);
            ...
            if ($CFG->supportemail and empty($CFG->noemailever)) {
                ...
                $site = get_site();
                $subject = 'Insert into log failed at your eset site ' . $site->fullname;
