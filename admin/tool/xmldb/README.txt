...
Complete Documentation:
  ...
  http://docs.eset.org/en/XMLDB_Defining_one_XML_structure
...
under Eset > 1.7 to store all the DB info in a
...
under your eset/admin dir and point your browser (as admin)
to http://your.server/eset/admin/xmldb
...
"generators" needed in order to use it to create Eset DB structures
for each RDBMS flavour.

Once the interface was finished (2-3 days from now) related documentation
will be sent to http://docs.eset.org/en/XML_database_schema in order
