...
$string['aim'] = 'This administration tool helps developers and test writers to create .feature files describing Eset\'s functionalities and run them automatically. Step definitions available for use in .feature files are listed below.';
$string['allavailablesteps'] = 'All available step definitions';
$string['errorapproot'] = '$CFG->behat_ionic_dirroot is not pointing to a valid Eset app developer install.';
...
<li>You ran "{$a->behatinit}" from your Eset root directory.</li>
