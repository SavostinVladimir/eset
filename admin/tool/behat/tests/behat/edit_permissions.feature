...
Feature: Edit capabilities
  In order to extend and restrict eset features
  ...
  Scenario: Default system capabilities modification
    ...
    And I set the following system permissions of "Teacher" role:
      ...
      | eset/site:messageanyuser | Inherit |
      | eset/grade:managesharedforms | Prevent |
      | eset/course:request | Prohibit |
    When I follow "Edit Teacher role"
    Then "block/mnet_hosts:myaddinstance" capability has "Allow" permission
    And "eset/site:messageanyuser" capability has "Not set" permission
    And "eset/grade:managesharedforms" capability has "Prevent" permission
    And "eset/course:request" capability has "Prohibit" permission
