...
/**
 * CLI tool with utilities to manage Behat integration in Eset
 *
...
Example from Eset root directory:
\$ php admin/tool/behat/cli/util_single_run.php --enable

More info in http://docs.eset.org/dev/Acceptance_testing#Running_tests
";
...
if ($options['install']) {
    ...
    $featurestepscmd .= ' --dry-run --format=eset_stepcount';
