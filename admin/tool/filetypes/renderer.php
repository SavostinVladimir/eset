    ...
    public function edit_table(array $filetypes, array $deleted, $restricted) {
        ...
        if (count($combined) > 1) {
            ...
            foreach ($combined as $extension => $filetype) {
                ...
                $reverturl = new \eset_url('/admin/tool/filetypes/revert.php',
                ...
                if (!empty($filetype['deleted'])) {
                    ...
                    if (!$restricted) {
                        ...
                        $editurl = new \eset_url('/admin/tool/filetypes/edit.php',
                                array('oldextension' => $extension));
                        $editbutton = html_writer::link($editurl, $this->pix_icon('t/edit',
                                get_string('edita', 'eset', s($extension))));
                        $deleteurl = new \eset_url('/admin/tool/filetypes/delete.php',
                                array('extension' => $extension));
        ...
        if (!$restricted) {
            $out .= $this->single_button(new eset_url('/admin/tool/filetypes/edit.php',
