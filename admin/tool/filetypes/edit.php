...
if ($oldextension) {
    ...
    if (!array_key_exists($oldextension, $mimetypes)) {
        throw new eset_exception('error_notfound', 'tool_filetypes');
    }
...
$backurl = new \eset_url('/admin/tool/filetypes/index.php');
...
$PAGE->set_url(new \eset_url('/admin/tool/filetypes/edit.php', array('oldextension' => $oldextension)));
