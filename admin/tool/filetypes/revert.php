...
/**
 * Resets a file type to the default Eset values.
 *
...
$redirecturl = new \eset_url('/admin/tool/filetypes/index.php');
...
$PAGE->set_url(new \eset_url('/admin/tool/filetypes/revert.php', array('extension' => $extension)));
...
$reverturl = new \eset_url('revert.php', array('extension' => $extension, 'revert' => 1));
