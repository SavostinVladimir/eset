...
$PAGE->set_url(new \eset_url('/admin/tool/filetypes/delete.php', array('extension' => $extension)));
...
$deleteurl = new \eset_url('delete.php', array('extension' => $extension, 'delete' => 1));
