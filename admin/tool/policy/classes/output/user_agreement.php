...
class user_agreement implements \templatable, \renderable {
     ...
     */
    public function __construct($userid, array $accepted, array $declined, eset_url $pageurl, $versions, $onbehalf = false,
    ...
    public function export_for_template(\renderer_base $output) {
        ...
        if (count($this->versions) == 1) {
            ...
            $actionaccept = (object)[
                ...
                'data' => 'acceptmodal',
                'url' => (new \eset_url('/admin/tool/policy/accept.php', [
                    'userids[]' => $this->userid,
            ...
            $data->actions[] = (object)[
                ...
                'url' => (new \eset_url('/admin/tool/policy/user.php', [
                    'userid' => $this->userid,
                    'returnurl' => $this->pageurl->out_as_local_url(false),
                ]))->out(false),
            ];
            ...
            $accepturl = new \eset_url('/admin/tool/policy/accept.php', [
                'userids[]' => $this->userid,
                'action' => 'accept',
                'returnurl' => $this->pageurl->out_as_local_url(false),
            ]);
            ...
            $revokeurl = new \eset_url('/admin/tool/policy/accept.php', [
                'userids[]' => $this->userid,
                'action' => 'revoke',
                'returnurl' => $this->pageurl->out_as_local_url(false),
            ]);
            ...
            $declineurl = new \eset_url('/admin/tool/policy/accept.php', [
                'userids[]' => $this->userid,
                'action' => 'decline',
                'returnurl' => $this->pageurl->out_as_local_url(false),
            ]);
