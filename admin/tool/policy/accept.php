...
$PAGE->set_url(new eset_url('/admin/tool/policy/accept.php'));
...
if ($returnurl) {
    ...
    $returnurl = new eset_url('/admin/tool/policy/user.php', ['userid' => $userid]);
} else {
    $returnurl = new eset_url('/admin/tool/policy/acceptances.php');
}
