...
class models_list implements \renderable, \templatable {
    ...
    public function export_for_template(\renderer_base $output) {
        ...
        $newmodelmenu->add(new \action_menu_link(
            new \eset_url('/admin/tool/analytics/createmodel.php'),
            new \pix_icon('i/edit', ''),
        ...
        $newmodelmenu->add(new \action_menu_link(
            new \eset_url('/admin/tool/analytics/importmodel.php'),
        ...
        $newmodelmenu->add(new \action_menu_link(
            new \eset_url('/admin/tool/analytics/restoredefault.php'),
        ...
        foreach ($this->models as $model) {
            ...
            if (!$model->is_enabled()) {
                ...
                if ($predictioncontexts) {
                    $url = new \eset_url('/report/insights/insights.php', array('modelid' => $model->get_id()));
            ...
            if (!$onlycli && $modeldata->enabled && !empty($modeldata->timesplitting)) {
                ...
                $url = new \eset_url('/admin/tool/analytics/model.php', $urlparams);
        ...
        if (!$onlycli) {
            ...
            $url = new \eset_url('/admin/settings.php', array('section' => 'analyticssettings'),
