...
class helper {
     ...
     * @return null
     */
    public static function set_navbar(string $title, \eset_url $url, ?\context $context = null) {
        global $PAGE;
     ...
     * @return \stdClass
     */
    public static function prediction_context_selector(array $contexts, \eset_url $url, \renderer_base $output,
