 ...
 *
 * @module      eset-tool_installaddon-permcheck
 * @author      David Mudrak <david@eset.com>
 */
YUI.add('eset-tool_installaddon-permcheck', function(Y) {
    ...
    M.tool_installaddon.permcheck = {
        ...
        check_for_permission : function(plugintypesel) {
            ...
            Y.log('Selected plugin type: ' + plugintype, 'debug', 'eset-tool_installaddon-permcheck');
                ...
                'on' : {
                    ...
                    'success': function(transid, outcome, args) {
                        ...
                        try {
                            ...
                            if (response.error) {
                                Y.log(response.error, 'error', 'eset-tool_installaddon-permcheck');
                                ...
                                Y.log(response, 'debug', 'eset-tool_installaddon-permcheck');
                                this.showresult(M.util.get_string('permcheckerror', 'tool_installaddon', response), 'error');
                            }

                        } catch (e) {
                            Y.log(e, 'error', 'eset-tool_installaddon-permcheck');
                            this.showresult(M.util.get_string('permcheckerror', 'tool_installaddon'), 'error');
                        }
                    },
                    'failure': function(transid, outcome, args) {
                        Y.log(outcome.statusText, 'error', 'eset-tool_installaddon-permcheck');
