...
class tool_installaddon_renderer extends plugin_renderer_base {
    ...
    public function index_page() {
        ...
        $permcheckurl = new eset_url('/admin/tool/installaddon/permcheck.php');
        $this->page->requires->yui_module('eset-tool_installaddon-permcheck', 'M.tool_installaddon.permcheck.init',
     ...
     * @return string
     */
    public function zip_not_valid_plugin_package_page(eset_url $continueurl) {
     ...
     * @return string
     */
    public function remote_request_invalid_page(eset_url $continueurl) {
     ...
     * @return string
     */
    public function remote_request_alreadyinstalled_page(stdClass $data, eset_url $continueurl) {
     ...
     * @param stdClass $data decoded request data
     * @param eset_url $continueurl
     * @param eset_url $cancelurl
     * @return string
     */
    public function remote_request_confirm_page(stdClass $data, eset_url $continueurl, eset_url $cancelurl) {
     ...
     * @param eset_url $continueurl to repeat the write permission check
     * @param eset_url $cancelurl to cancel the installation
     * @return string
     */
    public function remote_request_permcheck_page(stdClass $data, $plugintypepath, eset_url $continueurl, eset_url $cancelurl) {
     ...
     * @return string
     */
    public function remote_request_non_installable_page(stdClass $data, eset_url $continueurl) {
