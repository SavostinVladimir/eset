...
class tool_installaddon_installer {
    ...
    public function index_url(array $params = null) {
        return new eset_url('/admin/tool/installaddon/index.php', $params);
    }
    ...
    public function get_addons_repository_url() {
        ...
        if (!empty($CFG->config_php_settings['alternativeaddonsrepositoryurl'])) {
            ...
            $url = 'https://eset.org/plugins/get.php';
        }
        ...
        return new eset_url($url, array('site' => $site));
    }
     ...
     * Eset Plugins directory and is redirected back to their site to install
     * it.
     *
    ...
    /**
     * Decode the request from the Eset Plugins directory
     *
    ...
    protected function decode_remote_request($request) {
        ...
        // Keep this regex in sync with the one used by the download.eset.org/api/x.y/pluginfo.php
