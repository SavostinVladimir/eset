...
Feature: show capabilities for selected roles
  ...
  Background:
    ...
    And the following "permission overrides" exist:
      ...
      | eset/course:changefullname  | Allow      | studentdf   | System       |           |
      | eset/course:changeshortname | Prohibit   | studentdf   | System       |           |
      | eset/course:changeidnumber  | Prevent    | studentdf   | System       |           |
  ...
  Scenario: visualize capabilities table with a limited number of capabilities
    When I set the following fields to these values:
      | Capability: | eset/course:changefullname, eset/course:changeshortname |
      | Roles:      | Studentdf                                                                                 |
    And I click on "Get the overview" "button"
    Then I should see "eset/course:changefullname" in the "comparisontable" "table"
    And I should see "eset/course:changeshortname" in the "comparisontable" "table"
    And I should not see "eset/course:changecategory" in the "comparisontable" "table"

  Scenario: visualize an allow capability
    When I set the following fields to these values:
      | Capability: | eset/course:changefullname |
      | Roles:      | Studentdf                                                                                                     |
    And I click on "Get the overview" "button"
  ...
  Scenario: visualize a prohibit capability
    When I set the following fields to these values:
      | Capability: | eset/course:changeshortname |
      | Roles:      | Studentdf                                                                                                     |
    And I click on "Get the overview" "button"
  ...
  Scenario: visualize a not set capability
    When I set the following fields to these values:
      | Capability: | eset/course:changecategory |
      | Roles:      | Studentdf                    |
    And I click on "Get the overview" "button"
    Then I should not see "Allow" in the "comparisontable" "table"
    And I should not see "Prevent" in the "comparisontable" "table"
  ...
  Scenario: filter capability list using javascript
    Given I should see "eset/site:config" in the "Capability" "field"
    And I should see "eset/course:change" in the "Capability" "field"
    When I wait until the page is ready
    And I set the field "capabilitysearch" to "eset/course:change"
    Then I should see "eset/course:change" in the "Capability" "field"
    And I should not see "eset/site:config" in the "Capability" "field"

  @javascript
  Scenario: selecting capabilities using filters
    Given I should see "eset/course:change" in the "Capability" "field"
    When I wait until the page is ready
    And I set the field "capabilitysearch" to "eset/course:change"
    When I set the following fields to these values:
      | Capability: | eset/course:changecategory |
    ...
    And I click on "Get the overview" "button"
    Then I should see "eset/course:changecategory" in the "comparisontable" "table"
