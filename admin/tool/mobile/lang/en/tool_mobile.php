...
$string['apprequired'] = 'This functionality is only available when accessed via the Eset mobile or desktop app.';
...
$string['cachedef_subscriptiondata'] = 'This stores the Eset app subscription information.';
...
$string['mobileappsubscription'] = 'Eset app subscription';
...
$string['esetappsportalfeatureswarning'] = 'Please note that some features may be restricted depending on your Eset app subscription. For details, visit the <a href="{$a}" target="_blank">Eset Apps Portal</a>.';
$string['notifications'] = 'Notifications';
$string['notificationsactivedevices'] = 'Active devices';
$string['notificationsignorednotifications'] = 'Notifications not sent';
$string['notificationslimitreached'] = 'The monthly active user devices limit has been exceeded. Notifications for some users will not be sent. It is recommended that you upgrade your app plan in the <a href="{$a}" target="_blank">Eset Apps Portal</a>.';
$string['notificationsmissingwarning'] = 'Eset app notification statistics could not be retrieved. This is most likely because mobile notifications are not yet enabled on the site. You can enable them in Site Administration / Messaging / Mobile.';
$string['notificationsnewdevices'] = 'New devices';
$string['notificationsseemore'] = 'Note: Eset app usage statistics are not calculated in real time. To access more detailed statistics, including data from previous months, please log in to the <a href="{$a}" target="_blank">Eset Apps Portal</a>.';
...
$string['pluginname'] = 'Eset app tools';
...
$string['subscriptionerrorrequest'] = 'There was an unexpected error when trying to retrieve your Eset app subscription information.';
$string['subscriptionexpiration'] = 'Expiry date';
$string['subscriptionfeaturenotapplied'] = 'This feature is configured on your site but it is not included in your Eset app plan. Thus, the setting will have no effect.';
$string['subscriptionfeatures'] = 'Subscription features';
$string['subscriptionlimitsurpassed'] = 'Subscription limit exceeded';
$string['subscriptionregister'] = 'For details of the various app plans, and to access Eset app usage statistics, please visit the <a href="{$a}" target="_blank">Eset Apps Portal</a>.';
$string['subscriptionsseemore'] = 'Note: The information displayed is not updated in real time. You may need to log out and log in again to see updates. For information on upgrading your app plan, please log in to the <a href="{$a}" target="_blank">Eset Apps Portal</a>.';
...
$string['getesetonyourmobile'] = 'Get the mobile app';
