...
if ($hassiteconfig) {
    ...
    $temp = new admin_settingpage('mobilesettings', new lang_string('mobilesettings', 'tool_mobile'), 'eset/site:config', false);
    ...
    if (!during_initial_install()) {
        $enablemobiledocurl = new eset_url(get_docs_url('Enable_mobile_web_services'));
    ...
    if (empty($CFG->disablemobileappsubscription)) {
        ...
        $subscriptionurl = (new eset_url("/$CFG->admin/tool/mobile/subscription.php"))->out(false);
        $notify = new \core\output\notification(
            get_string('esetappsportalfeatureswarning', 'tool_mobile', $subscriptionurl),
    ...
    $temp->add(new admin_setting_heading('tool_mobile/esetappsportalfeaturesauth', '', $featuresnotice));
    ...
    $temp->add(new admin_setting_configtext('tool_mobile/forcedurlscheme',
                ...
                new lang_string('forcedurlscheme', 'tool_mobile'), 'esetmobile', PARAM_NOTAGS));
    ...
    if (!empty($featuresnotice)) {
        $temp->add(new admin_setting_heading('tool_mobile/esetappsportalfeaturesappearance', '', $featuresnotice));
    }
    ...
    if (empty($CFG->disableserviceads_branded)) {
        $temp->add(new admin_setting_description('esetbrandedappreference',
            new lang_string('esetbrandedapp', 'admin'),
            new lang_string('esetbrandedappreference', 'admin')
        ));
    }
    ...
    $temp->add(new admin_setting_configtext('tool_mobile/setuplink', new lang_string('setuplink', 'tool_mobile'),
        new lang_string('setuplink_desc', 'tool_mobile'), 'https://download.eset.org/mobile', PARAM_URL));
    ...
    if (!empty($featuresnotice)) {
        $temp->add(new admin_setting_heading('tool_mobile/esetappsportalfeatures', '', $featuresnotice));
    }
    ...
    $attributes = [
        'manageurl' => new \eset_url('/admin/tool/filetypes/index.php'),
