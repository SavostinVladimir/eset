...
$string['left'] = 'Left';
$string['modifyshippedtourwarning'] = 'This is a user tour that has shipped with Eset. Any modifications you make may be overridden during your next site upgrade.';
...
$string['tourlist_explanation'] = 'You can create as many tours as you like and enable them for different parts of Eset. Only one tour can be created per page.';
$string['tours'] = 'Tours';
...
$string['tour1_content_addingblocks'] = 'In fact, think carefully about including any blocks on your pages. Blocks are not shown in the Eset app, so as a general rule it\'s much better to make sure your site works well without any blocks.';
...
$string['tour2_content_addblock'] = 'If you turn editing on you can add blocks from the nav drawer. However, think carefully about including any blocks on your pages. Blocks are not shown in the Eset app, so for the best user experience it is better to make sure your course works well without any blocks.';
$string['tour2_title_addingblocks'] = 'Adding blocks';
$string['tour2_content_addingblocks'] = 'You can add blocks to this page using this button. However, think carefully about including any blocks on your pages. Blocks are not shown in the Eset app, so for the best user experience it is better to make sure your course works well without any blocks.';
