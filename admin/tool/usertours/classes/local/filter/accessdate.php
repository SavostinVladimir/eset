...
class accessdate extends base {
     ...
     *
     * @param \EsetQuickForm $mform The form to add filter settings to.
     *
     * @throws \coding_exception
     */
    public static function add_filter_to_form(\EsetQuickForm &$mform) {
    ...
    public static function filter_matches(tour $tour, context $context) {
        ...
        if (!empty($values[$key])) {
            ...
            // If the base date has no value because a user hasn't accessed Eset yet, default to account creation.
