...
class tour {
     ...
     *
     * @param   EsetQuickForm $mform      The form to add configuration to.
     * @return  $this
     */
    public function add_config_to_form(\EsetQuickForm &$mform) {
     ...
     * @return  $this
     */
    protected function add_config_field_to_form(\EsetQuickForm &$mform, $key) {
        $options = [
            true    => get_string('yes'),
            false   => get_string('no'),
        ];
    ...
    /**
     * Prepare the configuration data for the eset form.
     *
     * @return  object
     */
