...
class helper {
    ...
    public static function get_edit_step_link($tourid, $stepid = null, $targettype = null) {
        $link = new \eset_url('/admin/tool/usertours/configure.php');
     ...
     *
     * @return  eset_url              The required URL.
     */
    ...
    public static function get_view_tour_link($tourid) {
        return new \eset_url('/admin/tool/usertours/configure.php', [
                'id'        => $tourid,
     ...
     * @return  string
     */
    public static function format_icon_link($url, $icon, $alt, $iconcomponent = 'eset', $options = array()) {
        global $OUTPUT;
