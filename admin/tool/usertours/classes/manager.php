...
class manager {
    ...
    protected function print_tour_list() {
        ...
        $actions = [
            ...
            (object) [
                'link'  => new \eset_url('https://archive.eset.net/tours'),
                'linkproperties' => [
                        'target' => '_blank',
                    ],
                'img'   => 'b/tour-shared',
     ...
     *
     * @param   eset_url  $pageurl        The URL to match.
     * @return  tour
     */
    public static function get_matching_tours(\eset_url $pageurl) {
        global $PAGE;
    ...
    /**
     * Make sure all of the default tours that are shipped with Eset are created
     * and up to date with the latest version.
     */
    public static function update_shipped_tours() {
        global $DB, $CFG;

        // A list of tours that are shipped with Eset. They are in
        ...
        $unshippedtours = [
            // Formerly included in Eset 3.2.0.
            'boost_administrator.json' => 1,
            'boost_course_view.json' => 1,

            // Formerly included in Eset 3.6.0.
            '36_dashboard.json' => 3,
            '36_messaging.json' => 3,
        ];
