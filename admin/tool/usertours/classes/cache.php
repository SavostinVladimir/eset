...
EOF;
     ...
     *
     * @param   eset_url  $targetmatch    The URL to match.
     */
    public static function get_matching_tourdata(\eset_url $targetmatch) {
        ...
        $isfrontpage = $targetmatch->compare(new \eset_url('/'), URL_MATCH_BASE);
