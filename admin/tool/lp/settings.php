...
if (get_config('core_competency', 'enabled')) {
    ...
    $temp = new admin_externalpage(
        ...
        new eset_url('/admin/tool/lp/competencyframeworks.php', array('pagecontextid' => context_system::instance()->id)),
        array('eset/competency:competencymanage')
    );
    ...
    $temp = new admin_externalpage(
        ...
        new eset_url('/admin/tool/lp/learningplans.php', array('pagecontextid' => context_system::instance()->id)),
        array('eset/competency:templatemanage')
    );
    $ADMIN->add($parentname, $temp);
}
