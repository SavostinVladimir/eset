...
$functions = array(
    ...
    'tool_lp_data_for_competency_frameworks_manage_page' => array(
        ...
        'type'         => 'read',
        'capabilities' => 'eset/competency:competencyview',
        'ajax'         => true,
    ),
    ...
    'tool_lp_list_courses_using_competency' => array(
        ...
        'type'         => 'read',
        'capabilities' => 'eset/competency:coursecompetencyview',
        'ajax'         => true,
    ),
    ...
    'tool_lp_data_for_template_competencies_page' => array(
        ...
        'type'         => 'read',
        'capabilities' => 'eset/competency:templateview',
        'ajax'         => true,
    ),
    ...
    'tool_lp_data_for_plan_page' => array(
        ...
        'type'         => 'read',
        'capabilities' => 'eset/competency:planview',
        'ajax'         => true,
        'services'     => array(ESET_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'tool_lp_data_for_user_evidence_list_page' => array(
        ...
        'type'         => 'read',
        'capabilities' => 'eset/competency:userevidenceview',
        'ajax'         => true,
        'services'     => array(ESET_OFFICIAL_MOBILE_SERVICE),
    ),
