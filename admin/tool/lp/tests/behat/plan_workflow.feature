...
Feature: Manage plan workflow
  ...
  Background:
    ...
    And I set the following system permissions of "User manage own draft plan role" role:
      ...
      | eset/competency:planmanageowndraft | Allow |
    And I set the following system permissions of "User manage own plan role" role:
      | capability | permission |
      | eset/competency:planmanageowndraft | Allow |
      | eset/competency:planmanageown | Allow |
    And I set the following system permissions of "Manager all plans role" role:
      | capability | permission |
      | eset/competency:planmanage | Allow |
      | eset/competency:planmanagedraft | Allow |
      | eset/competency:planmanageowndraft | Allow |
      | eset/competency:planview | Allow |
      | eset/competency:planreview | Allow |
      | eset/competency:planrequestreview | Allow |
    And I log out
