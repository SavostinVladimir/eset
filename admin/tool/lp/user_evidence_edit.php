...
$url = new eset_url('/admin/tool/lp/user_evidence_edit.php', array('id' => $id, 'userid' => $userid, 'return' => $returntype));
...
if ($data = $form->get_data()) {
    ...
    if (empty($userevidence)) {
        ...
        $returnurl = new eset_url('/admin/tool/lp/user_evidence.php', ['id' => $userevidence->get('id')]);
