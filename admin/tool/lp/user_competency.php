...
$params = array('id' => $id);
$url = new eset_url('/admin/tool/lp/user_competency.php', $params);
...
$PAGE->set_url($url);
$PAGE->navigation->override_active_url(new eset_url('/admin/tool/lp/plans.php', array('userid' => $uc->get('userid'))));
