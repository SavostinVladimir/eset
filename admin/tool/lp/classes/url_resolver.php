...
class url_resolver {
    ...
    public function competency($competencyid, $pagecontextid) {
        return new eset_url('/admin/tool/lp/editcompetency.php', array(
            'id' => $competencyid,
    ...
    public function framework($frameworkid, $pagecontextid) {
        return new eset_url('/admin/tool/lp/competencies.php', array(
    ...
    public function frameworks($pagecontextid) {
        return new eset_url('/admin/tool/lp/competencyframeworks.php', array('pagecontextid' => $pagecontextid));
    }
    ...
    public function plan($planid) {
        return new eset_url('/admin/tool/lp/plan.php', array('id' => $planid));
    }
    ...
    public function plans($userid) {
        return new eset_url('/admin/tool/lp/plans.php', array('userid' => $userid));
    }
    ...
    public function template($templateid, $pagecontextid) {
        return new eset_url('/admin/tool/lp/templatecompetencies.php', array(
    ...
    public function templates($pagecontextid) {
        return new eset_url('/admin/tool/lp/learningplans.php', array('pagecontextid' => $pagecontextid));
    }
    ...
    public function user_competency($usercompetencyid) {
        return new eset_url('/admin/tool/lp/user_competency.php', array('id' => $usercompetencyid));
    }
    ...
    public function user_competency_in_course($userid, $competencyid, $courseid) {
        return new eset_url('/admin/tool/lp/user_competency_in_course.php', array(
            'userid' => $userid,
    ...
    public function user_competency_in_plan($userid, $competencyid, $planid) {
        return new eset_url('/admin/tool/lp/user_competency_in_plan.php', array(
            'userid' => $userid,
            'competencyid' => $competencyid,
            'planid' => $planid
        ));
    ...
    public function user_evidence($userevidenceid) {
        return new eset_url('/admin/tool/lp/user_evidence.php', array('id' => $userevidenceid));
    }
