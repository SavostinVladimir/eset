...
class external extends external_api {
    ...
    public static function data_for_competency_frameworks_manage_page_returns() {
        return new external_single_structure(array (
            ...
            'pluginbaseurl' => new external_value(PARAM_LOCALURL, 'Url to the tool_lp plugin folder on this Eset site'),
    ...
    public static function search_users($query, $capability = '', $limitfrom = 0, $limitnum = 100) {
        ...
        if (!empty($CFG->showuseridentity) && has_capability('eset/site:viewuseridentity', $context)) {
