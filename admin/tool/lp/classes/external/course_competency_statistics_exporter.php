...
class course_competency_statistics_exporter extends \core\external\exporter {
    ...
    protected function get_other_values(renderer_base $output) {
        ...
        return array(
            ...
            'canbegradedincourse' => has_capability('eset/competency:coursecompetencygradable', $this->related['context']),
            'canmanagecoursecompetencies' => has_capability('eset/competency:coursecompetencymanage', $this->related['context'])
        );
    }
}
