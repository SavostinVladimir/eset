...
class template_competencies_page implements renderable, templatable {
    ...
    public function __construct(template $template, context $pagecontext) {
        ...
        $this->canmanagecompetencyframeworks = has_capability('eset/competency:competencymanage', $this->pagecontext);
        $this->canmanagetemplatecompetencies = has_capability('eset/competency:templatemanage', $this->pagecontext);
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $data->pluginbaseurl = (new eset_url('/admin/tool/lp'))->out(false);
