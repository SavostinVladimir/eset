...
class course_competencies_page implements renderable, templatable {
    ...
    public function __construct($courseid, $moduleid) {
        ...
        $this->canmanagecoursecompetencies = has_capability('eset/competency:coursecompetencymanage', $this->context);
        $this->canconfigurecoursecompetencies = has_capability('eset/competency:coursecompetencyconfigure', $this->context);
        $this->cangradecompetencies = has_capability('eset/competency:competencygrade', $this->context);
        ...
        foreach ($contexts as $context) {
            $canmanage = has_capability('eset/competency:competencymanage', $context);
            if ($canmanage) {
                $this->manageurl = new eset_url('/admin/tool/lp/competencyframeworks.php',
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $data->pluginbaseurl = (new eset_url('/admin/tool/lp'))->out(true);

        $gradable = is_enrolled($this->context, $USER, 'eset/competency:coursecompetencygradable');
        if ($gradable) {
