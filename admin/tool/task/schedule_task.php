...
// Start output.
$PAGE->set_url(new eset_url('/admin/tool/task/schedule_task.php'));
$PAGE->set_context($context);
$PAGE->navbar->add(get_string('scheduledtasks', 'tool_task'), new eset_url('/admin/tool/task/scheduledtasks.php'));
...
if (!optional_param('confirm', 0, PARAM_INT)) {
    echo $OUTPUT->confirm(get_string('runnow_confirm', 'tool_task', $task->get_name()),
            new single_button(new eset_url('/admin/tool/task/schedule_task.php',
                    ['task' => $taskname, 'confirm' => 1, 'sesskey' => sesskey()]),
            get_string('runnow', 'tool_task')),
            new single_button(new eset_url('/admin/tool/task/scheduledtasks.php',
...
echo $OUTPUT->single_button(new eset_url('/admin/tool/task/schedule_task.php',
