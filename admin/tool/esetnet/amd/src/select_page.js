...
/**
 * When returning to Eset let the user select which course to add the resource to.
 *
 * @module     tool_esetnet/select_page
...
define([
    ...
    var renderNoCourses = function(areaReplace) {
        return Templates.renderPix('courses', 'tool_esetnet').then(function(img) {
            return img;
        }).then(function(img) {
    ...
    var renderCourses = function(areaReplace, courses) {
        return Templates.render('tool_esetnet/view-cards', {
            courses: courses
        }).then(function(html, js) {
            Templates.replaceNodeContents(areaReplace, html, js);
    ...
    var searchCourses = function(inputValue, page, areaReplace) {
        ...
        Ajax.call([{
            methodname: 'tool_esetnet_search_courses',
            args: args
    ...
    /**
     * Define our own debounce function as Eset 3.7 does not have it.
     *
     * @method debounce
     * @from underscore.js
