...
class import_info {
    ...
    public static function load(string $id): ?import_info {
        ...
        global $SESSION;
        return isset($SESSION->esetnetimports[$id]) ? unserialize($SESSION->esetnetimports[$id]) : null;
    }
    ...
    public function save(): void {
        global $SESSION;
        $SESSION->esetnetimports[$this->id] = serialize($this);
    }
    ...
    public function purge(): void {
        global $SESSION;
        unset($SESSION->esetnetimports[$this->id]);
    }
}
