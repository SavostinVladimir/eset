...
/**
 * Class tool_esetnet_url_testcase, providing test cases for the url class.
 */
class tool_esetnet_url_testcase extends \advanced_testcase {
    ...
    public function url_provider() {
        return [
            'No path' => [
                'url' => 'https://example.eset.net',
                'host' => 'example.eset.net',
                'path' => null,
                'exception' => false,
            ],
            'Slash path' => [
            ...
            'Path includes file and extension' => [
                'url' => 'https://example.eset.net/uploads/123456789/pic.png',
                'host' => 'example.eset.net',
                'path' => '/uploads/123456789/pic.png',
                'exception' => false,
            ],
            'Path includes file, extension and params' => [
                'url' => 'https://example.eset.net/uploads/123456789/pic.png?option=1&option2=test',
                'host' => 'example.eset.net',
                'path' => '/uploads/123456789/pic.png',
                'exception' => false,
            ],
