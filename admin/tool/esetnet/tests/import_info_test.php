...
/**
 * Class tool_esetnet_import_info_testcase, providing test cases for the import_info class.
 */
class tool_esetnet_import_info_testcase extends \advanced_testcase {
