...
use tool_esetnet\local\import_strategy;
use tool_esetnet\local\import_strategy_file;

defined('ESET_INTERNAL') || die();

/**
 * Class tool_esetnet_import_handler_info_testcase, providing test cases for the import_handler_info class.
 */
class tool_esetnet_import_handler_info_testcase extends \advanced_testcase {
