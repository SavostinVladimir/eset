...
/**
 * Unit tests for tool_esetnet lib
 *
...
global $CFG;
require_once($CFG->dirroot . '/admin/tool/esetnet/lib.php');

/**
 * Test esetnet functions
 */
class tool_esetnet_lib_testcase extends advanced_testcase {
    ...
    public function get_endpoints_provider() {
        ...
        return [
            [
                ...
                1,
                2,
                'https://domain.name/' . ESETNET_DEFAULT_ENDPOINT . '?site=' . urlencode($CFG->wwwroot)
                    . '&course=1&section=2'
            ],
            [
