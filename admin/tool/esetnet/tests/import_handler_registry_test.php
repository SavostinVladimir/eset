 ...
 */
namespace tool_esetnet\local\tests;

use tool_esetnet\local\import_handler_registry;
use tool_esetnet\local\import_handler_info;
use tool_esetnet\local\import_strategy_file;
use tool_esetnet\local\import_strategy_link;
use tool_esetnet\local\remote_resource;
use tool_esetnet\local\url;

defined('ESET_INTERNAL') || die();

/**
 * Class tool_esetnet_import_handler_registry_testcase, providing test cases for the import_handler_registry class.
 */
class tool_esetnet_import_handler_registry_testcase extends \advanced_testcase {
