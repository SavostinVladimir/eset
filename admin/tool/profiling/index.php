...
// TODO: Move all the DB stuff to profiling_db_xxxx() function in xhprof_eset.php
...
if ($listurl) {
    $listurlnav = new eset_url('/admin/tool/profiling/index.php', array('listurl' => $listurl));
