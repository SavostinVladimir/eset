...
$capabilities = array(
    'eset/backup:backupcourse',
    'eset/category:manage',
    'eset/course:create',
    'eset/site:approvecourse',
    'eset/restore:restorecourse'
);
if ($hassiteconfig or has_any_capability($capabilities, $systemcontext)) {
    ...
    $temp->add(new admin_setting_configselect('esetcourse/visible', new lang_string('visible'), new lang_string('visible_help'),
        1, $choices));
    ...
    $temp->add(new admin_setting_configselect('esetcourse/format', new lang_string('format'), new lang_string('coursehelpformat'),
        'topics', $formcourseformats));

    $temp->add(new admin_setting_configtext('esetcourse/maxsections', new lang_string('maxnumberweeks'),
        new lang_string('maxnumberweeks_desc'), 52));

    $temp->add(new admin_settings_num_course_sections('esetcourse/numsections', new lang_string('numberweeks'),
    ...
    $temp->add(new admin_setting_configselect('esetcourse/hiddensections', new lang_string('hiddensections'),
    ...
    $temp->add(new admin_setting_configselect('esetcourse/coursedisplay', new lang_string('coursedisplay'),
        new lang_string('coursedisplay_help'), COURSE_DISPLAY_SINGLEPAGE, $choices));

    $temp->add(new admin_setting_configcheckbox('esetcourse/courseenddateenabled', get_string('courseenddateenabled'),
        get_string('courseenddateenabled_desc'), 1));

    $temp->add(new admin_setting_configduration('esetcourse/courseduration', get_string('courseduration'),
    ...
    $temp->add(new admin_setting_configselect('esetcourse/lang', new lang_string('forcelanguage'), '', key($languages),
        $languages));

    $options = range(0, 10);
    $temp->add(new admin_setting_configselect('esetcourse/newsitems', new lang_string('newsitemsnumber'),
        new lang_string('coursehelpnewsitemsnumber'), 5, $options));
    $temp->add(new admin_setting_configselect('esetcourse/showgrades', new lang_string('showgrades'),
        new lang_string('coursehelpshowgrades'), 1, array(0 => new lang_string('no'), 1 => new lang_string('yes'))));
    $temp->add(new admin_setting_configselect('esetcourse/showreports', new lang_string('showreports'), '', 0,
    ...
    if (!empty($CFG->legacyfilesinnewcourses)) {
        ...
        $temp->add(new admin_setting_configselect('esetcourse/legacyfiles', new lang_string('courselegacyfiles'),
            new lang_string('courselegacyfiles_help'), key($choices), $choices));
    }

    $currentmaxbytes = get_config('esetcourse', 'maxbytes');
    if (isset($CFG->maxbytes)) {
        $choices = get_max_upload_sizes($CFG->maxbytes, 0, 0, $currentmaxbytes);
    } else {
        $choices = get_max_upload_sizes(0, 0, 0, $currentmaxbytes);
    }
    $temp->add(new admin_setting_configselect('esetcourse/maxbytes', new lang_string('maximumupload'),
    ...
    $temp->add(new admin_setting_configselect('esetcourse/enablecompletion', new lang_string('completion', 'completion'),
    ...
    $temp->add(new admin_setting_configselect('esetcourse/groupmode', new lang_string('groupmode'), '', key($choices),$choices));
    $temp->add(new admin_setting_configselect('esetcourse/groupmodeforce', new lang_string('force'), new lang_string('coursehelpforce'), 0,array(0 => new lang_string('no'), 1 => new lang_string('yes'))));
    ...
    $temp->add(new admin_setting_users_with_capability('courserequestnotify', new lang_string('courserequestnotify', 'admin'), new lang_string('configcourserequestnotify2', 'admin'), array(), 'eset/site:approvecourse'));
    $ADMIN->add('courses', $temp);

    // Pending course requests.
    if (!empty($CFG->enablecourserequests)) {
        $ADMIN->add('courses', new admin_externalpage('coursespending', new lang_string('pendingrequests'),
                $CFG->wwwroot . '/course/pending.php', array('eset/site:approvecourse')));
    }
    ...
    $ADMIN->add('activitychooser',
        new admin_externalpage('activitychooserrecommended', new lang_string('activitychooserrecommendations', 'course'),
            new eset_url('/course/recommendations.php'),
            array('eset/course:recommendactivity')
        )
    );
    ...
    $temp = new admin_settingpage('backupgeneralsettings', new lang_string('generalbackdefaults', 'backup'), 'eset/backup:backupcourse');
    ...
    $temp = new admin_settingpage('importgeneralsettings', new lang_string('importgeneralsettings', 'backup'), 'eset/backup:backupcourse');
    ...
    $temp = new admin_settingpage('automated', new lang_string('automatedsetup','backup'), 'eset/backup:backupcourse');
