...
preferences,eset|/user/preferences.php|t/preferences',
        PARAM_RAW,
        '50',
        '10'
    ));
    ...
    // blog
    $temp = new admin_settingpage('blog', new lang_string('blog','blog'), 'eset/site:config', empty($CFG->enableblogs));
    ...
    $choices = array(
        ...
        HOMEPAGE_MY => new lang_string('myeset', 'admin'),
    ...
    $temp->add(new admin_setting_configcheckbox('allowguestmyeset', new lang_string('allowguestmyeset', 'admin'), new lang_string('configallowguestmyeset', 'admin'), 1));
    ...
    $ADMIN->add('appearance', new admin_externalpage('resetemoticons', new lang_string('emoticonsreset', 'admin'),
        new eset_url('/admin/resetemoticons.php'), 'eset/site:config', true));

    // "documentation" settingpage
    $temp = new admin_settingpage('documentation', new lang_string('esetdocs'));
    $temp->add(new admin_setting_configtext('docroot', new lang_string('docroot', 'admin'), new lang_string('configdocroot', 'admin'), 'https://docs.eset.org', PARAM_URL));
    ...
    $url = new eset_url('/tag/manage.php');
    $hidden = empty($CFG->usetags);
    $page = new admin_externalpage('managetags', new lang_string('managetags', 'tag'), $url, 'eset/tag:manage', $hidden);
