...
if ($hassiteconfig) {
    ...
    // Statistics.
    $temp = new admin_settingpage('stats', new lang_string('stats'), 'eset/site:config', empty($CFG->enablestats));
    $temp->add(new admin_setting_configselect('statsfirstrun', new lang_string('statsfirstrun', 'admin'),
        ...
        [
            ...
            60 * 60 * 24 * 7 => new lang_string('numweeks', 'eset', 1),
            60 * 60 * 24 * 14 => new lang_string('numweeks', 'eset', 2),
            60 * 60 * 24 * 21 => new lang_string('numweeks', 'eset', 3),
            60 * 60 * 24 * 28 => new lang_string('nummonths', 'eset', 1),
            60 * 60 * 24 * 56 => new lang_string('nummonths', 'eset', 2),
            60 * 60 * 24 * 84 => new lang_string('nummonths', 'eset', 3),
            60 * 60 * 24 * 112 => new lang_string('nummonths', 'eset', 4),
            60 * 60 * 24 * 140 => new lang_string('nummonths', 'eset', 5),
            60 * 60 * 24 * 168 => new lang_string('nummonths', 'eset', 6),
    ...
    $ADMIN->add('server', new admin_externalpage('testoutgoingmailconf', new lang_string('testoutgoingmailconf', 'admin'),
        new eset_url('/admin/testoutgoingmailconf.php'), 'eset/site:config', true));
    ...
    $url = new eset_url('/admin/testoutgoingmailconf.php');
