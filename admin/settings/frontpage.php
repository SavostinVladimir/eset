...
if (!during_initial_install()) { //do not use during installation
    ...
    if ($hassiteconfig or has_any_capability(array(
            ...
            'eset/question:moveall'), $frontpagecontext)) {

        // "frontpage" settingpage
        $temp = new admin_settingpage('frontpagesettings', new lang_string('frontpagesettings','admin'), 'eset/course:update', false, $frontpagecontext);
