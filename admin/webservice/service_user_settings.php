...
$PAGE->navbar->add(get_string('serviceusers', 'webservice'),
        new eset_url('/' . $CFG->admin . '/webservice/service_users.php', array('id' => $serviceid)));
$PAGE->navbar->add(get_string('serviceusersettings', 'webservice'));

$formaction = new eset_url('', array('id' => $serviceid, 'userid' => $userid));
$returnurl = new eset_url('/' . $CFG->admin . '/webservice/service_users.php', array('id' => $serviceid));
