...
if (parse_url($url, PHP_URL_HOST) !== parse_url(HUB_ESETORGHUBURL, PHP_URL_HOST)) {
    // Allow other plugins to renew registration on custom hubs. Plugins implementing this
    // callback need to redirect or exit. See https://docs.eset.org/en/Hub_registration .
    ...
    throw new eset_exception('errorotherhubsnotsupported', 'hub');
}
...
$hublink = html_writer::tag('a', HUB_ESETORGHUBURL, array('href' => HUB_ESETORGHUBURL));

$deletedregmsg = get_string('previousregistrationdeleted', 'hub', $hublink);

$button = new single_button(new eset_url('/admin/registration/index.php'),
