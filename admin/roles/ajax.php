...
if (!isset($overridableroles[$roleid])) {
    throw new eset_exception('invalidarguments');
}

if (!has_capability('eset/role:override', $context)) {
    if (!has_capability('eset/role:safeoverride', $context) || !is_safe_capability($capability)) {
        require_capability('eset/role:override', $context);
    }
}
