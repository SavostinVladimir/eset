...
$url = new eset_url('/admin/roles/override.php', array('contextid' => $contextid, 'roleid' => $roleid));
...
if (!has_capability('eset/role:override', $context)) {
    require_capability('eset/role:safeoverride', $context);
...
if ($context->contextlevel == CONTEXT_USER and $USER->id != $context->instanceid) {
    ...
    navigation_node::override_active_url(new eset_url('/admin/roles/permissions.php',
        array('contextid'=>$context->id, 'userid'=>$context->instanceid, 'courseid'=>$course->id)));

} else {
    $PAGE->set_context($context);
    navigation_node::override_active_url(new eset_url('/admin/roles/permissions.php', array('contextid'=>$context->id)));
}

$courseid = $course->id;

$returnurl = new eset_url('/admin/roles/permissions.php', array('contextid' => $context->id));
...
switch ($context->contextlevel) {
    case CONTEXT_SYSTEM:
        ...
        break;
    case CONTEXT_USER:
        $fullname = fullname($user, has_capability('eset/site:viewfullnames', $context));
