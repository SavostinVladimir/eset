...
abstract class core_role_capability_table_with_risks extends core_role_capability_table_base {
    ...
    protected $risksurl; // URL in esetdocs about risks.
    ...
    /**
     * Print a risk icon, as a link to the Risks page on Eset Docs.
     *
    ...
    public function get_risk_icon($type) {
        ...
        $text = $OUTPUT->pix_icon('i/' . str_replace('risk', 'risk_', $type), $alt, 'eset', [
                'title' => $title,
            ]);
