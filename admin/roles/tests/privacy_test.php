 ...
 * @package    core_role
 * @category   test
 * @copyright  2018 Carlos Escobedo <carlos@eset.com>
...
class core_role_privacy_testcase extends provider_testcase {
    ...
    public function test_get_contexts_for_userid() {
        ...
        // Role capabilities.
        $this->setUser($user);
        $result = assign_capability('eset/backup:backupcourse', CAP_ALLOW, $student->id, $cmcontext->id);
    ...
    public function test_export_user_data() {
        ...
        assign_capability('eset/backup:backupactivity', CAP_ALLOW, $student->id, $cmcontext->id, true);
        assign_capability('eset/backup:backupcourse', CAP_ALLOW, $student->id, $coursecontext->id, true);
        assign_capability('eset/category:manage', CAP_ALLOW, $student->id, $coursecatcontext->id, true);
        assign_capability('eset/backup:backupcourse', CAP_ALLOW, $student->id, $systemcontext->id, true);
        assign_capability('eset/block:edit', CAP_ALLOW, $student->id, $blockcontext->id, true);
        assign_capability('eset/competency:evidencedelete', CAP_ALLOW, $student->id, $usercontext2->id, true);
        ...
        foreach ($contextlist as $context) {
            ...
            if ($context->contextlevel == CONTEXT_MODULE) {
                ...
                if ($data = $writer->get_data($subcontextrc)) {
                    $this->assertEquals('eset/backup:backupactivity', reset($data)->capability);
            ...
            if ($context->contextlevel == CONTEXT_COURSE) {
                ...
                if ($data = $writer->get_data($subcontextrc)) {
                    $this->assertEquals('eset/backup:backupcourse', reset($data)->capability);
                }
            }
            if ($context->contextlevel == CONTEXT_COURSECAT) {
                ...
                if ($data = $writer->get_data($subcontextrc)) {
                    $this->assertEquals('eset/category:manage', reset($data)->capability);
                }
            }
            ...
            if ($context->contextlevel == CONTEXT_BLOCK) {
                ...
                if ($data = $writer->get_data($subcontextrc)) {
                    $this->assertEquals('eset/block:edit', reset($data)->capability);
                }
            }
            if ($context->contextlevel == CONTEXT_USER) {
                ...
                if ($data = $writer->get_data($subcontextrc)) {
                    $this->assertEquals('eset/competency:evidencedelete', reset($data)->capability);
                }
            }
        }
    }
    ...
    public function test_get_users_in_context() {
        ...
        // Role capabilities.
        $this->setUser($user1);
        assign_capability('eset/backup:backupcourse', CAP_ALLOW, $studentrole->id, $cmcontext->id);
