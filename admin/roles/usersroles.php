...
$baseurl = new eset_url('/admin/roles/usersroles.php', array('userid'=>$userid, 'courseid'=>$courseid));
...
$canview = has_any_capability(array('eset/role:assign', 'eset/role:safeoverride',
        'eset/role:override', 'eset/role:manage'), $usercontext);
if (!$canview) {
...
function print_report_tree($contextid, $contexts, $systemcontext, $fullname, $allroles) {
    ...
    if (is_null($stredit)) {
        ...
        $globalroleassigner = has_capability('eset/role:assign', $systemcontext);
