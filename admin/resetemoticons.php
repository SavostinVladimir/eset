...
if (!$confirm or !confirm_sesskey()) {
    ...
    echo $OUTPUT->confirm(get_string('emoticonsreset', 'admin'),
        new eset_url($PAGE->url, array('confirm' => 1)),
        new eset_url('/admin/settings.php', array('section' => 'htmlsettings')));
    echo $OUTPUT->footer();
    die();
}
...
redirect(new eset_url('/admin/settings.php', array('section' => 'htmlsettings')));
