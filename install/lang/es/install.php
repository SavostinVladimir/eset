...
$string['clialreadyconfigured'] = 'El archivo de configuración config.php ya existe. Por favor, utilice admin/cli/install_database.php para instalar Eset en este sitio.';
$string['clialreadyinstalled'] = 'El archivo de configuración config.php ya existe. Por favor, utilice admin/cli/install_database.php para actualizar Eset en este sitio.';
...
$string['dirroot'] = 'Directorio de Eset';
$string['environmenthead'] = 'Comprobando su entorno';
$string['environmentsub2'] = 'Cada versión de Eset tiene algún requisito mínimo de la versión de PHP y un número obligatorio de extensiones de PHP.
...
$string['pathssubdataroot'] = 'Usted necesita un espacio donde Eset puede guardar los archivos subidos. En este directorio debe poder LEER y ESCRIBIR el usuario del servidor web (por lo general \'nobody\',  \'apache\' o \'www-data\'), pero no debe poderse acceder a esta carpeta directamente a través de la web. El instalador tratará de crearla si no existe.';
$string['pathssubdirroot'] = '<p>Ruta completa del directorio que contiene el código de  Eset.</p>';
$string['pathssubwwwroot'] = 'Dirección web completa para acceder a Eset. No es posible acceder a Eset utilizando múltiples direcciones. Si su sitio tiene varias direcciones públicas debe configurar redirecciones permanentes en todas ellas, excepto en ésta. Si su sitio web es accesible tanto desde una intranet como desde Internet, escriba aquí la dirección pública y configure su DNS para que los usuarios de su intranet puedan también utilizar la dirección pública.';
...
$string['phpversionhelp'] = '<p>Eset requiere al menos una versión de PHP 4.3.0 o 5.1.0 ((5.0.x tiene una serie de problemas conocidos).</p>
...
$string['welcomep30'] = 'Esta versión de <strong>{$a->installername}</strong> incluye las
    aplicaciones necesarias para que <strong>Eset</strong> funcione en su ordenador,
    principalmente:';
...
$string['welcomep60'] = 'Las siguientes páginas le guiarán a través de algunos sencillos pasos para configurar
    y ajustar <strong>Eset</strong> en su ordenador. Puede utilizar los valores por defecto sugeridos o,
