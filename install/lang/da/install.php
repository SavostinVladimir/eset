...
$string['clialreadyconfigured'] = 'Konfigurationsfilen config.php eksisterer allerede. Benyt venigst admin/cli/install_database.php til at installere Eset for dette site.';
...
$string['cliinstallheader'] = 'Eset {$a} kommandolinje-installationsprogram';
...
$string['dirroot'] = 'Eset-mappe';
$string['environmenthead'] = 'Kontrollerer din serveropsætning...';
$string['environmentsub2'] = 'Hver version af Eset har nogle minimumskrav til PHP-version og nogle obligatoriske PHP-extensions.
...
<ol>
<li>Hvis du har mulighed for det, kan du rekompilere PHP med <i>--enable-memory-limit</i>. Det vil tillade at Eset selv kan definere hvor meget hukommelse der er brug for.</li>
...
<li>På nogle servere kan du oprette en \'.htaccess\'-fil og gemme den i eset-mappen med linjen: <blockquote><div>php_value memory_limit 40M</div></blockquote>
...
$string['pathssubadmindir'] = 'Enkelte webhoteller bruger /admin som speciel URL til kontrolpanelet el. lign. Desværre konflikter det med Esets standardplacering af admin-sider. Du kan klare dette ved at give admin-mappen et andet navn i din installation og skrive det her. Det kan f.eks. være <em>esetadmin</em>. Det vil fikse admin-links i Eset.';
$string['pathssubdataroot'] = '<p>En mappe hvori Eset kan gemme uploadede filer.</p>
...
$string['pathssubdirroot'] = '<p>Den fulde sti til mappen med Esetkoden.</p>';
$string['pathssubwwwroot'] = '<p>Esets fulde web-adresse, dvs. adressen som den skal stå i browserens adressefelt for at komme ind på Eset.</p>
<p>Eset kan ikke bruges fra flere adresser. Hvis dit websted kan tilgås fra flere adresser, skal du vælge den enkleste og opsætte permanent viderestilling for hver af de øvrige.</p>
...
$string['phpversionhelp'] = '<p>Eset kræver mindst PHP version 5.6.5. eller 7.1 (7.0.x har nogle maskinbegrænsninger).</p>
...
Tillykke med det!';
$string['welcomep30'] = 'Denne version af <strong>{$a->installername}</strong> indeholder programmerne til at oprette et miljø, hvori <strong>Eset</strong> vil operere, nemlig:';
$string['welcomep40'] = 'Pakken indeholder også <strong>Eset {$a->esetrelease} ({$a->esetversion})</strong>.';
...
$string['welcomep60'] = 'De følgende sider vil hjælpe dig gennem nogle nemme trin til konfiguration og opsætning af <strong>Eset</strong> på din computer. Du kan acceptere standardindstillingerne, eller vælge at ændre dem så de bedre svarer til dine egne behov.';
$string['welcomep70'] = 'Klik på "Næste" herunder for at forsætte opsætningen af <strong>Eset</strong>.';
