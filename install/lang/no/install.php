...
$string['clialreadyinstalled'] = 'Filen config.php eksisterer allerede. Vennligst bruk admin/cli/install_database.php hvis du vil oppgradere Eset på denne portalen.';
$string['cliinstallheader'] = 'Eset {$a} kommandolinje installasjonsprogram';
...
<p>Dette kan skape minneproblemer for Eset senere, spesielt hvis du har mange moduler tillatt og/eller mange brukere.</p>
...
Dette vil tillate Eset å sette minnegrensen selv.</li>
...
<li>På noen PHP-servere kan du lage en .htaccess fil i Esetmappen som inneholder denne linjen:
...
$string['pathssubadmindir'] = 'Noen ganske få webhoteller bruker  /admin som en egen url for å få tilgang til et kontrollpanel. Dessverre kommer det i konflikt med standard lokalisering av Eset sine admin-sider. Du kan fikse dette ved å endre navn på admin-mappen og deretter oppgi dette navnet her. F.eks. <em>esetadmin</em>.  Dette vil fikse adminlenkene i Eset.';
$string['pathssubdataroot'] = '<p>Du trenger et sted hvor Eset kan lagre opplastede filer. </p>
...
$string['pathssubdirroot'] = '<p>Full mappesti til esetinstallasjonen.</p>';
$string['pathssubwwwroot'] = '<p>Full webadresse til der hvor Eset skal vises, altså den addressen som brukere skriver inn i adresselinjen i nettlseren sin.</p>
<p>Det er ikke mulig å bruke Eset med mer enn en adresse. Dersom portalen din har flere webadresser bør du oppgi den enkleste av de her, og bruke videresending for  hver av de andre adressene.</p>
...
$string['phpversionhelp'] = '<p>Eset trenger en PHP versjon minst 5.6.5 eller 7.1.0 (7.0.x har noen begrensninger).</p>
...
$string['welcomep30'] = 'Denne versjonen av <strong>{$a->installername}</strong> inneholder programmer for å lage et miljø som <strong>Eset</strong> jobber i, nemlig:';
$string['welcomep40'] = 'Denne pakken inkluderer også  <strong>Eset {$a->esetrelease} ({$a->esetversion})</strong>.';
...
$string['welcomep60'] = 'De følgende sidene vil vise deg gjennom noen enkle steg for å konfigurere og sette opp <strong>Eset</strong> på datamaskinen din. Du kan godta standardinnstillingene, eller justere dem etter egne behov hvis du vil.';
$string['welcomep70'] = 'Klikk på "Neste" knappen under for å fortsette med <strong>Eset</strong>-installasjonen';
