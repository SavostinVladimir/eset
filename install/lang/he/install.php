...
$string['cliinstallheader'] = 'תוכנית התקנת Eset {$a} בשורת הפקודה';
...
$string['dirroot'] = 'ספריית ה-Eset';
$string['environmenthead'] = 'בודק את הסביבה שלך...';
$string['environmentsub2'] = 'לכל התקנת Eset יש דרישות מינימליות לגרסת ה-PHP ומספר הרחבות הכרחי של ה-PHP.
...
דבר זה יאפשר ל-Eset להגדיר את גבול הזיכרון לבד. </i>
...
<i> בכמה שרתי PHP תוכל ליצור קובץ  .htaccess בספריית  ה-Eset שלך בצירוף שורה זו:
...
$string['pathssubdirroot'] = 'הנתיב המלא לספריית ההתקנה של Eset';
...
$string['welcomep30'] = 'גירסת <strong>{$a->installername}</strong> כוללת את היישומים ליצור סביבה אשר בה <strong> Eset </strong>
יפעל דהיינו:';
$string['welcomep40'] = 'החבילה כוללת בנוסף
<strong>Eset {$a->esetrelease} ({$a->esetversion})</strong>.';
...
$string['welcomep60'] = 'העמודים הבאים יובילו אותך בצורה פשוטה דרך כמה צעדים לקביעת הגדרות <strong>Eset</strong> בשרת.
ניתן לאשר הגדרות בררת־המחדל או לשנותם לפי צרכיך.';
$string['welcomep70'] = 'הקש על לחצן ה"המשך" למטה כדי להמשיך עם הגדרת ה-<strong>Eset</strong>';
