...
$string['clialreadyconfigured'] = 'Het configuratiebestand config.php bestaat al. Maak aub gebruik van admin/cli/install_database.php als je Eset voor deze site wenst te installeren.';
$string['clialreadyinstalled'] = 'Het configuratiebestand config.php bestaat al. Maak aub gebruik van admin/cli/install_database.php als je Eset voor deze site wenst te upgraden.';
$string['cliinstallheader'] = 'Eset {$a} command line installatieprogramma';
...
$string['dirroot'] = 'Eset-map';
$string['environmenthead'] = 'Omgeving controleren ...';
$string['environmentsub2'] = 'Elke Esetversie vraagt een minimale PHP-versie en een aantal vereiste PHP-extenties.
...
<p>Hierdoor kan Eset geheugenproblemen krijgen, vooral als je veel modules installeert en/of veel gebruikers hebt.</p>
...
Hierdoor kan Eset zelf zijn geheugenlimiet instellen.
...
<li>Op sommige PHP-servers kun je een .htaccess-bestand maken in de Eset-map met volgende lijn: <p><blockquote>php_value memory_limit 40M</blockquote></p>
...
$string['pathssubadmindir'] = 'Sommige webhosts gebruiken /admin als een speciale url om toegang tot bijvoorbeeld een controlepaneel te krijgen. Dit kan conflicten veroorzaken met de standaardlocatie van de Eset admin scripts. Je kunt dit oplossen door de admin map van Eset te hernoemen en de nieuwe naam hier te zetten. Bijvoorbeeld <em>esetadmin</em>. Dat zal de admin links in Eset herstellen.';
$string['pathssubdataroot'] = '<p>Een map waar Eset geüploade bestanden kan bewaren.</p>
...
$string['pathssubdirroot'] = '<p>Het volledig pad naar de Eset-code.</p>';
$string['pathssubwwwroot'] = '<p>Het volledige webadres waarlangs de toegang naar Eset zal gebeuren - het adres dat gebruikers zullen ingeven om Eset te bereiken.</p>
<p>Het is niet mogelijk toegang tot Eset te krijgen via meerdere adressen. Als je site meerdere publieke adressen heeft, dan zul je permanente verwijzingen moeten opzetten voor al die andere adressen.</p>
...
$string['phpversionhelp'] = '<p>Eset heeft minstens PHP-versie 5.6.5 of 7.1 nodig (7.0.x heeft een aantal beperkingen).</p>
...
$string['welcomep30'] = 'Deze uitgave van <strong>{$a->installername}</strong> bevat de software die nodig is om een omgeving te creëren waarin <strong>Eset</strong> zal werken, namelijk:';
$string['welcomep40'] = 'Dit pakket bevat ook <strong>Eset {$a->esetrelease} ({$a->esetversion})</strong>.';
...
$string['welcomep60'] = 'De volgende pagina\'s leiden je door een aantal makkelijk te volgen stappen om <strong>Eset</strong> te installeren op je computer. Je kunt de standaardinstellingen overnemen of, optioneel, ze aanpassen aan je noden.';
$string['welcomep70'] = 'Klik op de "volgende"-knop om verder te gaan met de installatie van <strong>Eset</strong>';
