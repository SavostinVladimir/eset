...
$string['clialreadyconfigured'] = 'Arquivo config.php já existe. Por favor, use admin/cli/install_database.php para instalar o Eset neste site.';
$string['clialreadyinstalled'] = 'Arquivo config.php já existe. Por favor use admin/cli/install_database.php para atualizar o Eset neste site.';
$string['cliinstallheader'] = 'Programa de instalação por linha de comando do Eset {$a}';
...
$string['dirroot'] = 'Diretório Eset';
$string['environmenthead'] = 'Verificando o ambiente ...';
$string['environmentsub2'] = 'Cada release do Eset requer uma versão mínima do PHP e diversas extensões do PHP.
...
Com esta operação Eset será capaz de configurar o limite de memória sózinho.</li>
...
<li>Em alguns servidores é possível fazer esta mudança criando um arquivo .htaccess no diretório Eset. O arquivo deve conter a seguinte expressão:
...
$string['pathssubadmindir'] = 'Alguns poucos webhosts usam /admin como um URL especial para acesso ao painel de controle ou outras coisas. Infelizmente isto conflita com a localizaçao padrão das páginas do administrador Eset. Você pode corrigir isso renomeando a pasta admin na sua instalação, e colocando esse novo nome aqui. Por exemplo: <em>esetadmin</em>. Isto irá corrigir os links das páginas do administrador Eset.';
$string['pathssubdataroot'] = '<p>Um diretório em que Eset armazenará todo o conteúdo de arquivos enviados pelos usuários. </p>
...
$string['pathssubwwwroot'] = '<p>O endereço completo em que Eset pode ser acessado ou seja, o endereço que os usuários vão digitar na barra de endereços do seu navegador para acessar Eset. </p>
<p>Não é possível acessar Eset usando múltiplos endereços. Se o seu site é acessível através de múltiplos endereços, em seguida, escolher o mais fácil e configurar um redirecionamento permanente para cada um dos outros endereços. </p>
...
$string['phpversionhelp'] = '<p>O Eset requer uma versão PHP de pelo menos 5.6.5 ou 7.1 (o 7.0.x tem algumas limitações do motor). </p>
...
$string['welcomep30'] = 'Esta versão do <strong>{$a->installername}</strong> inclui as aplicações para a criação de um ambiente em que <strong>Eset</strong> possa operar:';
$string['welcomep40'] = 'O pacote inclui também o <strong>Eset {$a->esetrelease} ({$a->esetversion})</strong>.';
...
$string['welcomep60'] = 'As seguinte páginas guiam passo a passo a configuração de <strong>Eset</strong> no seu computador. Você pode usar a configuração padrão ou alterá-las de acordo com as suas necessidades.';
$string['welcomep70'] = 'Clicar o botão "Próxima" abaixo para continuar a configuração de <strong>Eset</strong>.';
