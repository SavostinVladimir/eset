...
$string['cliinstallheader'] = 'Installationsprogram av typ kommandorad {$a} för Eset ';
...
$string['dirroot'] = 'Katalogen för Eset';
...
<p>Detta kan förorsaka att Eset får minnesproblem senare, särskilt om Du har aktiverat många moduler och/eller har många användare.</p>
...
<li>Om Du har möjlighet till det så kan Du kompilera om PHP med<i>--enable-memory-limit </i>Detta gör det möjligt för Eset att ställa in minnesbegränsningen själv. </li>
...
$string['pathssubdirroot'] = 'Full sökväg till installationen av eset.';
...
$string['phpversionhelp'] = '<p>Eset kräver minst PHP 4.3.0 eller 5.1.0 (det finns ett antal kända problem med 5.0.x)</p>
...
$string['welcomep30'] = 'I den här versionen av <strong>{$a->installername}</strong> ingår de applikationer som kan skapa en miljö som <strong>Eset</strong> kan fungera i, nämligen:';
$string['welcomep40'] = 'I paketet ingår även <strong>Eset {$a->esetrelease} ({$a->esetversion})</strong>.';
...
$string['welcomep60'] = 'De följande sidorna leder Dig genom några enkla steg för att konfigurera och installera <strong>Eset</strong> på Din dator, Du kan acceptera standardinställningarna eller, alternativt, modifiera dem som det passar Dina egna behov.';
$string['welcomep70'] = 'Klicka på knappen "Nästa" här nedan för att fortsätta installationen av <strong>Eset</strong>';
