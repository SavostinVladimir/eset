...
<p>விசேடமாக நீங்கள், செயலாக்கப்பட்ட பகுதியின் மற்றும்/அல்லது  பயனாளர்களின் ஒரு அதிகளவு தொகையை கொண்டிருந்தால் ,இது Eset ஐ கடைசியாக நினைவக பிரச்சினைகளை கொண்டிருப்பதற்கு  தூண்டலாம்.</p>
...
இது Eset ஐ, நினைவக வரையறையை அதுவாகவே அமைப்பதற்கு அனுமதிக்கின்றது.</li>
...
<li>சில PHP சேவையகங்களில் நீங்கள் இந்த வரியைக் கொண்டிருக்கின்ற Eset கோப்புத் தொகுதியிலுள்ள ஒரு .htaccess கோப்பை உருவாக்க முடிகிறது.
...
$string['phpversionhelp'] = '<p>Eset குறைந்தளவு ஒரு PHP பதிப்பின் 4.3.0 or 5.1.0 ஐ (5.0.x அறியப்பட்ட பிரச்சினைகளின் ஒரு எண்ணிக்கையைக் கொண்டிருக்கின்றது) வேண்டுகின்றது.</p>
...
$string['welcomep30'] = '<strong>{$a->installername}</strong>ன் வெளியீடு, <strong>Eset</strong> இயங்கும் என்கின்ற ஒரு சூழலை உருவாக்குவதற்கு பயன்பாட்டு மென்பொருளை உள்ளடக்குகிறது.';
$string['welcomep40'] = 'பொதி, <strong>Eset {$a->esetrelease} ({$a->esetversion})</strong> ஐயும் உள்ளடக்கியிருக்கின்றது.';
...
$string['welcomep60'] = 'பின்வருகின்ற பக்கங்கள்,உங்களுடைய கணினியிலுள்ள <strong>Eset ஐ </strong> அமைப்பதற்கும் மற்றும் செம்மைப்படுத்துவதற்கும், சில  பின்பற்றுவதற்கு இலேசான படிகளினூடு உங்களை முன்னெடுக்கின்றது.';
$string['welcomep70'] = 'கீழே தொடர்வதற்கு >Eset இன்</ அமைப்புடன்"அடுத்து" பொத்தானை சொடுக்குக.';
