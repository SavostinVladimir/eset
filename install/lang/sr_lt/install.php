...
$string['clialreadyconfigured'] = 'Datoteka config.php već postoji. Molimo, koristite admin/cli/install_database.php ako želite da instalirate Eset na ovom serveru.';
$string['clialreadyinstalled'] = 'Datoteka config.php već postoji. Molimo koristite admin/cli/upgrade.php ako želite da nadogradite Eset na ovom serveru.';
$string['cliinstallheader'] = 'Eset {$a} program za instalaciju iz komandne linije';
...
$string['dirroot'] = 'Eset direktorijum';
$string['environmenthead'] = 'Proveravanje Vašeg okruženja...';
$string['environmentsub2'] = 'Svako izdanje Eseta ima minimum zahteva po pitanju odgovarajuće PHP verzije i nekoliko obaveznih PHP ekstenzija.
...
<p>Ovo podešavanje može kasnije da prouzrokuje da Eset ima problema sa memorijom, posebno ako imate mnogo aktiviranih modula i/ili mnogo korisnika.</p>
...
<li>Ako možete, rekompajlirajte PHP sa <i>--enable-memory-limit</i>. Ovo će omogućiti Eset sistemu da sam postavi memorijsko ograničenje.</li>
...
<li>Na nekim PHP serverima možete da kreirate .htaccess datoteku u Eset direktorijumu koja sadrži red:
...
$string['pathssubadmindir'] = 'Vrlo mali broj veb servera koristi /admin kao specijalni URL za pristup raznim podešavanjima (kontrolni panel i sl.). Nažalost, to dovodi do konflikta sa standardnom lokacijom za administratorske stranice u Esetu. Ovaj problem možete rešiti tako što ćete promeniti ime administratorskog direktorijuma u vašoj instalaciji, i ovde upisati to novo ime. Na primer <em>esetadmin</em>. Ovo podešavanje će prepraviti administratorske linkove u Eset sistemu.';
$string['pathssubdataroot'] = '<p>Direktorijum gde će Eset čuvati datoteke i sadržaj koji su postavili korisnici. </p>
...
$string['pathssubdirroot'] = '<p>Puna putanja do direktorijuma koji sadrži kôd Eseta.</p>';
$string['pathssubwwwroot'] = '<p>Puna adresa putem koje će se pristupati Esetu, tj. adresa koju će korisnici uneti u adresnu traku svojih veb čitača kako bi pristupili Esetu.</p> <p>Nije moguće pristupati Esetu korišćenjem više adresa. Ako se vašem sajtu može pristupiti sa više adresa, onda izaberite najlakšu, a za sve ostale adrese podesite permanentnu redirekciju.</p> <p>Ako se vašem sajtu može pristupiti kako sa interneta, tako i iz interne mreže (koja se ponekad naziv intranet), onda ovde upotrebite javnu adresu.</p> <p>Ako je tekuća adresa netačna, molimo vas, promenite URL adresu u adresnoj traci svog veb čitača i ponovo pokrenite instalaciju.</p>';
...
$string['phpversionhelp'] = '<p>Eset zahteva najmanje PHP verziju 5.6.7 ili 7.1 (7.0.x ima neka ograničenja).</p>
<p>Trenutno koristite verziju {$a}</p>
<p>Morate da nadogradite PHP ili da premestiti Eset na veb server sa novijom verzijom PHP-a.</p>';
...
$string['welcomep30'] = 'Ovo izdanje <strong>{$a->installername}</strong> uključuje aplikacije za kreiranje okruženja u kojem će <strong>Eset</strong> uspešno funkcionisati, konkretno:';
...
$string['welcomep60'] = 'Naredne stranice će vas provesti kroz nekoliko jednostavnih koraka tokom kojih ćete konfigurisati i podesiti <strong>Eset</strong> na svom računaru. Možete prihvatiti podrazumevana podešavanja ili ih, opciono, prilagoditi sopstvenim potrebama.';
