...
$string['cliinstallheader'] = 'Eset {$a} namestitveni program z ukazno vrstico';
...
<p>To lahko povzroči, da bo imel Eset pozneje težave s pomnilnikom. Še posebej,
...
<li>Če lahko, ponovno prevedite PHP z <i>--enable-memory-limit</i>.
    To bo omogočilo, da bo Eset sam nastavil omejitev pomnilnik zase.</li>
...
<li>Na nekaterih strežnikih PHP lahko ustvarite datoteko .htaccess v imeniku Eset,
...
$string['phpversionhelp'] = '<p>Eset zahteva različico PHP vsaj 4.3.0 ali 5.1.0 (5.0.x ima vrsto znanih težav).</p>
...
$string['welcomep30'] = 'Ta različica <strong>{$a->installername}</strong> vključuje aplikacije
    za ustvarjanje okolja v katerem bo deloval <strong>Eset</strong> in sicer:';
$string['welcomep40'] = 'Ta paket vključuje tudi <strong>Eset {$a->esetrelease} ({$a->esetversion})</strong>.';
...
$string['welcomep60'] = 'Naslednje strani vas bodo popeljale skozi nekaj enostavno sledljivih korakov za
    konfiguracijo in nastavitev <strong>Eset</strong>  na vašem računalniku. Sprejmete lahko privzete
    nastavitve ali jih, če tako želite, spremenite, da bodo ustrezale vašim potrebam.';
$string['welcomep70'] = 'Kliknite spodnji gumb "Naprej" za nadaljevanje nastavitve <strong>Eset</strong>.';
