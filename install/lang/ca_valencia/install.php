...
$string['cliinstallheader'] = 'Programa d\'instal·lació de línia d\'ordes de Eset {$a}';
...
<p>Això pot causar que Eset tinga problemes de memòria més avant, especialment si teniu molts mòduls habilitats i/o molts usuaris.</p>
...
<ol>
<li>Si podeu, recompileu el PHP amb <i>--enable-memory-limit</i>. Això permetrà que Eset definisca el límit de memòria per si mateix.</li>
...
<li>En alguns servidors PHP podeu crear un fitxer .htaccess dins del directori de Eset amb esta línia:
...
$string['pathssubadmindir'] = 'Alguns serveis d\'allotjament web (pocs) utilitzen un URL especial /admin p. ex. per a accedir a un tauler de control o quelcom paregut. Malauradament això entra en conflicte amb la ubicació estàndard de les pàgines d\'administració de Eset. Podeu arreglar este problema canviant el nom del directori d\'administració de Eset en la vostra instal·lació i posant el nou nom ací. Per exemple <em>esetadmin</em>. Això modificarà els enllaços d\'administració de Eset.';
$string['pathssubdataroot'] = 'Necessiteu un espai on Eset puga guardar els fitxers penjats. Este directori hauria de tindre permisos de lectura I ESCRIPTURA per a l\'usuari del servidor web (normalment \'nobody\' o \'apache\'), però no cal que siga accessible directament via web. L\'instal·lador provarà de crear-lo si no existeix.';
$string['pathssubwwwroot'] = 'L\'adreça web completa on s\'accedirà a Eset.
No és possible accedir a Eset en diferents adreces.
...
<p>Vos cal actualitzar el PHP o traslladar Eset a un ordinador amb una versió de PHP més recent.<br />(Si esteu utilitzant la versió 5.0.x, alternativament també podríeu tornar arrere a la 4.4.x)</p>';
...
$string['welcomep30'] = 'Esta versió de <strong>{$a->installername}</strong> inclou les aplicacions necessàries per crear un entorn en el qual funcione <strong>Eset</strong>:';
...
$string['welcomep60'] = 'Les pàgines següents vos guiaran per una sèrie de passos fàcils de seguir per configurar <strong>Eset</strong> en el vostre ordinador. Podeu acceptar els paràmetres per defecte o, opcionalment, modificar-los perquè s\'ajusten a les vostres necessitats.';
