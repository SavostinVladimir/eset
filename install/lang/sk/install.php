...
$string['clialreadyconfigured'] = 'Konfiguračný súbor config.php už existuje. Spusťte admin/cli/install_database.php, ak chcete inštalovať Eset pre tento portál.';
...
$string['cliinstallheader'] = 'Eset {$a} inštalačný program z príkazového riadku';
...
$string['dirroot'] = 'Adresár Eset';
$string['environmenthead'] = 'Kontrola programového prostredia...';
$string['environmentsub2'] = 'Každé vydanie Eset vyžaduje určitú minimálnu verziu PHP a niekoľko povinných rozšírení PHP. Plná kontrola prostredia sa vykonáva pred každou inštaláciou a aktualizáciou. Prosím, kontaktujte správcu servera, ak neviete, ako nainštalovať novú verziu, alebo povoliť rozšírenia PHP.';
...
<p>Toto môže neskôr spôsobiť problémy v Eset, najmä ak máte veľa modulov a/alebo veľa používateľov.</p>
...
<ol>
<li>Ak je to možné, znovu vytvorte PHP s <i>--enable-memory-limit</i>. Toto umožní Eset samonastavenie limitu pamäte.</li>
...
Na niektorých PHP serveroch, si môžete vytvoriť súbor .htaccess v Adresári Eset, ktorý bude obsahovať tento riadok: <p><blockquote><div>php_value memory_limit 40M</div></blockquote></p>
...
$string['pathssubdataroot'] = '<p>Potrebujete adresár, kam Eset bude ukladať nahrané súbory.</p>
...
$string['pathssubdirroot'] = '<p>Absolútna cesta adresára Eset inštalácie.</p>';
...
$string['phpversionhelp'] = '<p>Eset si vyžaduje verziu PHP aspoň  5.6.5 alebo 7.1 (7.0.x má určité obmedzenia jadra).</p>
...
$string['welcomep30'] = 'Táto verzia <strong>{$a->installername}</strong> obsahuje aplikáciu k vytvoreniu prostredia, v ktorom bude prevádzkovaný váš <strong>Eset</strong>. Menovite sa jedná o:';
$string['welcomep40'] = 'Balíček tiež obsahuje <strong>Eset vo verzii {$a->esetrelease} ({$a->esetversion})</strong>.';
...
$string['welcomep60'] = 'Nasledujúce stránky vás povedú v nekoľkých jednoduchých krokoch nastavením <strong>Eset</strong> na vašom počítači. Môžete prijať východzie nastavenie, alebo si ich upraviť podľa svojich potrieb.';
$string['welcomep70'] = 'Stlačením nižšie uvedeného tlačidla "Ďalší" pokračujte v nastavení vašej inštalácie Eset.';
