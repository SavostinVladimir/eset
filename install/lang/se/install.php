...
$string['clialreadyinstalled'] = 'Fiila config.php gávdno jo. Geavat admin/cli/install_database.php jus háliidat ođasmahttit Eset dán portálas.';
...
$string['welcomep70'] = 'Coahkkal "Boahtte"-boalu joatkit<strong>Eset</strong>-installašuvnnain';
