...
$string['cliinstallheader'] = 'Esetn {$a} komentoriviasennusohjelma';
...
$string['dirroot'] = 'Eset-hakemisto';
$string['environmenthead'] = 'Ympäristön tarkistus';
$string['environmentsub2'] = 'Jokaisessa Eset-julkaisussa on joitakin vähimmäisvaatimuksia PHP-versiolta sekä joitakin pakollisia PHP-lisäosia.
...
<p>Tämä saattaa aiheuttaa Esetlle muistiongelmia myöhemmin, varsinkin jos sinulla on paljon mahdollisia moduuleita ja/tai paljon käyttäjiä.</p>
...
Tämä sallii Esetn asettaa muistirajan itse.</li>
...
<li>Joillain PHP palvelimilla voit luoda a .htaccess tiedoston Eset hakemistossa, sisältäen tämän rivin:
...
$string['pathssubadmindir'] = 'Jotkut sivustot käyttävät /admin URL-osoitetta hallintapaneelille tai vastaavalle. Tämä on valitettavasti ristiriidassa Esetn normaalin admin-sivun sijainnin kanssa.
Voit korjata tämän nimeämällä asennuksesi admin-hakemiston uudelleen, antamalla uuden nimen tähän. Esimerkiksi: <em>esetadmin</em>. Tämä korjaa admin-linkit Esetssa.';
$string['pathssubdataroot'] = 'Tarvitset paikan, jonne Eset voi tallentaa ladatut tiedostot. Tämän hakemiston pitäisi olla luettavissa ja kirjoitettavissa web-palvelimen käyttäjän taholta (yleensä "nobody" tai "apache"), mutta se ei saa olla käytettävissä suoraan web:in kautta. Jos hakemistoa ei ole, asennusohjelma yrittää luoda sen.';
$string['pathssubdirroot'] = 'Koko hakemistopolku Eset-asennukseen.';
$string['pathssubwwwroot'] = 'Esetn koko verkko-osoite.
Eseten ei ole mahdollista päästä käyttäen useita osoitteita.
...
$string['phpversionhelp'] = '<p>Eset vaatii vähintään PHP-version 4.3.0 tai 5.1.0 (5.0.x sisältää monia tunnettuja ongelmia).</p> <p>Käytössäsi on versio {$a}</p> <p>Sinun pitää päivittää PHP tai siirtää palvelimelle jossa on uudempi PHP.<br /> (Jos käytössäsi on 5.0.x voit myös päivittää alaspäin 4.4.x -versioon)</p>';
...
Onnittelut!';
$string['welcomep30'] = 'Tämä julkaisu <strong>{$a->installername}</strong> sisältää sovellukset ympäristön luomiseen, jossa <strong>Eset</strong> toimii:';
$string['welcomep40'] = 'Tämä paketti sisältää myös <strong>Esetn {$a->esetrelease} ({$a->esetversion})</strong>.';
...
$string['welcomep60'] = 'Seuraavat sivut opastavat sinua helposti seurattavien vaiheiden läpi <strong>Esetn</strong> konfiguroinnissa koneellesi. Voit hyväksyä oletusasetukset tai vaihtoehtoisesti muuttaa niitä tarvitsemallasi tavalla.';
$string['welcomep70'] = 'Napsauta "Seuraava"-painiketta jatkaaksesi esetn asennusta';
