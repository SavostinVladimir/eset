...
$string['cliinstallheader'] = 'Programa de instalación de Eset en liña de ordes {$a}';
...
$string['environmentsub2'] = 'Cada versión de Eset ten algún requisito mínimo da versión de PHP e un número obrigatorio de extensións de PHP.
...
<p>Isto pode facer que Eset teña problemas de memoria máis adiante, especialmente
...
<li>Se vostede e quen de facelo, volva compilar PHP con <i>--enable-memory-limit</i>.
    Isto fai que sexa Eset quen estabeleza o límite de memoria.</li>
...
<li>Nalgúns servidores PHP, pode crear un ficheiro .htaccess no directorio Eset
...
permitirlle acceder a un panel de control ou semellante. Desafortunadamente, isto entra en conflito coa localización estándar das páxinas de administración de Eset. Vostede pode corrixir isto
renomeando o directorio admin na súa instalación, e poñendo aquí ese novo nome.  Por exemplo: <em>esetadmin</em>. Iso corrixirá as ligazóns admin en Eset.';
$string['pathssubdataroot'] = 'Necesitase un lugar no que Eset poida gardar os ficheiros enviados. Este directorio debe ser lexíbel E ESCRIBÍBEL polo usuario do servidor web
...
$string['pathssubdirroot'] = 'Ruta completa do directorio de instalación de Eset.';
$string['pathssubwwwroot'] = 'Enderezo web completo para acceder a Eset.
Non é posíbel acceder a Eset empregando enderezos múltiples.
...
$string['phpversionhelp'] = '<p>Eset require polo menos unha das versións de PHP 4.3.0 ou 5.1.0 ( as versións 5.0.x teñen unha serie de problemas coñecidos).</p>
...
$string['welcomep30'] = 'Esta versión de <strong>{$a->installername}</strong> inclúe os aplicativos
    para crear un entorno no que <strong>Eset</strong> funcione, nomeadamente:';
$string['welcomep40'] = 'O paquete inclúe tamen <strong>Eset {$a->esetrelease} ({$a->esetversion})</strong>.';
...
$string['welcomep60'] = 'As páxinas seguintes guiarano a través de algúns sinxelos pasos para configurar
    e axustar <strong>Eset</strong> no seu computador. Pode empregar os axustes predeterminados
    ou, opcionalmente, modificalos para que se axusten ás súas necesidades.';
$string['welcomep70'] = 'Prema no botón «Seguinte» para continuar coa configuración de <strong>Eset</strong>.';
