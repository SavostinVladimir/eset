...
class core_notes_external extends external_api {
                ...
                'notes' => new external_multiple_structure(
                    new external_single_structure(
                        array(
                            ...
                            'courseid' => new external_value(PARAM_INT, 'course id of the note (in Eset a note can only be created into a course, even for site and personal notes)'),
    ...
    public static function create_notes($notes = array()) {
        ...
        if (!$CFG->enablenotes) {
            throw new eset_exception('notesdisabled', 'notes');
        }
        ...
        foreach ($params['notes'] as $note) {
            ...
            if (empty($courses[$note['courseid']])) {
                ...
                require_capability('eset/notes:manage', $context);
            }
    ...
    public static function get_notes($notes) {
        ...
        foreach ($params['notes'] as $noteid) {
            ...
            if (isset($note->id)) {
                ...
                $context = context_course::instance($note->courseid);
                self::validate_context($context);
                require_capability('eset/notes:view', $context);
    ...
    public static function get_course_notes($courseid, $userid = 0) {
        ...
        $canmanagesystemnotes = has_capability('eset/notes:manage', $systemcontext);
        ...
        if ($course->id == SITEID) {
            ...
            $canmanagecoursenotes = has_capability('eset/notes:manage', $context);
        }
        self::validate_context($context);
        ...
        if ($course->id != SITEID) {
            ...
            if (has_capability('eset/notes:view', $context)) {
            ...
            if (!empty($user)) {
                ...
                foreach ($usercourses as $c) {
                    ...
                    if (has_capability('eset/notes:view', context_course::instance($c->id))) {
