...
class core_notes_externallib_testcase extends externallib_advanced_testcase {
    ...
    public function test_create_notes() {
        ...
        $roleid = $this->assignUserCapability('eset/notes:manage', $contextid);
        $this->assignUserCapability('eset/course:view', $contextid, $roleid);
        ...
        $this->unassignUserCapability('eset/notes:manage', $contextid, $roleid);
    ...
    public function test_get_notes() {
        ...
        $contextid = context_course::instance($course->id)->id;
        $roleid = $this->assignUserCapability('eset/notes:manage', $contextid);
        $this->assignUserCapability('eset/notes:view', $contextid, $roleid);
        $this->assignUserCapability('eset/course:view', $contextid, $roleid);
        ...
        // Call without required capability.
        $this->unassignUserCapability('eset/notes:view', $contextid, $roleid);
        $this->expectException('required_capability_exception');
