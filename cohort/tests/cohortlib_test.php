...
class core_cohort_cohortlib_testcase extends advanced_testcase {
    ...
    public function test_cohort_add_cohort_event() {
        ...
        $url = new eset_url('/cohort/index.php', array('contextid' => $event->contextid));
    ...
    public function test_cohort_update_cohort_event() {
        ...
        $url = new eset_url('/cohort/edit.php', array('id' => $event->objectid));
        $this->assertEquals($url, $event->get_url());
        $this->assertEquals($cohort, $event->get_record_snapshot('cohort', $id));
        $this->assertEventLegacyData($cohort, $event);
        $this->assertEventContextNotUsed($event);
    ...
    public function test_cohort_add_member_event() {
        ...
        $url = new eset_url('/cohort/assign.php', array('id' => $event->objectid));
        $this->assertEquals($url, $event->get_url());
    ...
    public function test_cohort_get_all_cohorts() {
        ...
        role_change_permission($managerrole->id, $context2, 'eset/cohort:view', CAP_PROHIBIT);
        role_change_permission($managerrole->id, $context2, 'eset/cohort:manage', CAP_PROHIBIT);
        $this->assertFalse(has_any_capability(array('eset/cohort:view', 'eset/cohort:manage'), $context2));
