...
class core_cohort_externallib_testcase extends externallib_advanced_testcase {
    ...
    public function test_create_cohorts() {
        ...
        $roleid = $this->assignUserCapability('eset/cohort:manage', $contextid);
        ...
        $this->unassignUserCapability('eset/cohort:manage', $contextid, $roleid);
    ...
    public function test_get_cohorts() {
        ...
        $roleid = $this->assignUserCapability('eset/cohort:view', $context->id);
        ...
        $this->unassignUserCapability('eset/cohort:view', $context->id, $roleid);
        $roleid = $this->assignUserCapability('eset/cohort:manage', $context->id, $roleid);
        // Call the external function.
        $returnedcohorts = core_cohort_external::get_cohorts(array(
            $cohort1->id, $cohort2->id));
        $returnedcohorts = external_api::clean_returnvalue(core_cohort_external::get_cohorts_returns(), $returnedcohorts);
    ...
    public function test_update_cohorts() {
        ...
        $context = context_system::instance();
        $roleid = $this->assignUserCapability('eset/cohort:manage', $context->id);
        ...
        // Call without required capability.
        $this->unassignUserCapability('eset/cohort:manage', $context->id, $roleid);
        core_cohort_external::update_cohorts(array($cohort1));
    }
    ...
    public function test_update_cohorts_missing_dest() {
        ...
        $roleid = $this->assignUserCapability('eset/cohort:manage', $context1->id);
    ...
    public function test_update_cohorts_missing_src() {
        ...
        $roleid = $this->assignUserCapability('eset/cohort:manage', $context2->id);
    ...
    public function test_add_cohort_members() {
        ...
        $roleid = $this->assignUserCapability('eset/cohort:assign', $contextid);
        ...
        $this->unassignUserCapability('eset/cohort:assign', $contextid, $roleid);
    ...
    public function test_delete_cohort_members() {
        ...
        $context = context_system::instance();
        $roleid = $this->assignUserCapability('eset/cohort:assign', $context->id);
        ...
        // Call without required capability.
        $this->unassignUserCapability('eset/cohort:assign', $context->id, $roleid);
        core_cohort_external::delete_cohort_members(array($cohortdel1, $cohortdel2));
    }
    ...
    public function test_search_cohorts() {
        ...
        assign_capability('eset/cohort:manage', CAP_ALLOW, $creatorrole, $syscontext->id);
        assign_capability('eset/cohort:view', CAP_ALLOW, $courserole, $syscontext->id);
