...
$baseurl = new eset_url('/cohort/upload.php', array('contextid' => $context->id));
...
if ($context->contextlevel == CONTEXT_COURSECAT) {
    ...
    navigation_node::override_active_url(new eset_url('/cohort/index.php', array('contextid' => $context->id)));
} else {
