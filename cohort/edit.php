...
if ($returnurl) {
    ...
    $returnurl = new eset_url('/cohort/index.php', array('contextid'=>$context->id));
}
...
$baseurl = new eset_url('/cohort/edit.php', array('contextid' => $context->id, 'id' => $cohort->id));
...
if ($context->contextlevel == CONTEXT_COURSECAT) {
    ...
    navigation_node::override_active_url(new eset_url('/cohort/index.php', array('contextid'=>$cohort->contextid)));

} else {
    navigation_node::override_active_url(new eset_url('/cohort/index.php', array()));
}
...
if ($delete and $cohort->id) {
    ...
    $yesurl = new eset_url('/cohort/edit.php', array('id' => $cohort->id, 'delete' => 1,
...
if ($editform->is_cancelled()) {
    ...
    if ($returnurl->get_param('showall') || $returnurl->get_param('contextid') == $data->contextid) {
        ...
        redirect(new eset_url('/cohort/index.php', array('contextid' => $data->contextid)));
    }
}
