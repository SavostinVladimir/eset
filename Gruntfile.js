...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        babel: {
            options: {
                ...
                plugins: [
                    ...
                    //
                    // It also adds the Eset plugin name to the AMD module definition
        ...
        sass: {
            dist: {
                files: {
                    "theme/boost/style/eset.css": "theme/boost/scss/preset/default.scss",
                    "theme/classic/style/eset.css": "theme/classic/scss/classicgrunt.scss"
                }
            },
            options: {
                implementation: sass,
    ...
    tasks.ignorefiles = function() {
        ...
        const stylelintIgnores = [
            '# Generated by "grunt ignorefiles"',
            '**/yui/build/*',
            'theme/boost/style/eset.css',
            'theme/classic/style/eset.css',
        ].concat(thirdPartyPaths);
