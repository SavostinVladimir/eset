...
class favourite_repository implements favourite_repository_interface {
     ...
     * @throws \eset_exception if the supplied favourite has missing or unsupported fields.
     */
    protected function validate(favourite $favourite) {
        ...
        if ($missingfields = array_keys(array_diff_key($requiredfields, $favourite))) {
            throw new \eset_exception("Missing object property(s) '" . join(', ', $missingfields) . "'.");
        }
        ...
        if ($unsupportedfields = array_keys(array_diff_key($favourite, $allowedfields))) {
            throw new \eset_exception("Unexpected object property(s) '" . join(', ', $unsupportedfields) . "'.");
        }
    }
     ...
     * @throws \eset_exception if the favourite has missing or invalid properties.
     */
     ...
     * @throws \dml_exception if any database errors are encountered.
     * @throws \eset_exception if any of the favourites have missing or invalid properties.
     */
