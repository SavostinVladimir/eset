...
class user_favourite_service {
     ...
     * @throws \eset_exception if the component name is invalid, or if the repository encounters any errors.
     */
    public function create_favourite(string $component, string $itemtype, int $itemid, \context $context,
        ...
        if (!in_array($component, \core_component::get_component_names())) {
            throw new \eset_exception("Invalid component name '$component'");
        }
     ...
     * @throws \eset_exception if the user does not control the favourite, or it doesn't exist.
     */
    public function delete_favourite(string $component, string $itemtype, int $itemid, \context $context) {
        ...
        try {
            ...
            throw new \eset_exception("Favourite does not exist for the user. Cannot delete.");
        }
