...
/**
 * mnet server exception.  extends eset_exception, but takes slightly different arguments.
 * and unlike the rest of eset, the actual int error code is used.
 * this exception should only be used during an xmlrpc server request, ie, not for client requests.
 */
class mnet_server_exception extends eset_exception {
