...
admin_externalpage_setup('mnetenrol', '', array('host'=>$hostid, 'course'=>$courseid, 'usecache'=>1, 'sesskey'=>sesskey()),
                         new eset_url('/mnet/service/enrol/course.php'));
...
if ($usecache) {
    echo $OUTPUT->single_button(new eset_url($PAGE->url, array('usecache'=>0, 'sesskey'=>sesskey())),
                                get_string('refetch', 'mnetservice_enrol'), 'get');
}

echo $OUTPUT->single_button(new eset_url('/mnet/service/enrol/host.php', array('id'=>$host->id)),
