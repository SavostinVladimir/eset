...
class completion_criteria_grade extends completion_criteria {
     ...
     *
     * @param eset_form $mform Eset forms object
    ...
    public function config_form_display(&$mform, $data = null) {
        ...
        // Grades are stored in Eset with 5 decimal points, make sure we do not accidentally round them
    ...
    public function get_icon($alt, array $attributes = null) {
        return new pix_icon('i/grades', $alt, 'eset', $attributes);
    }
}
