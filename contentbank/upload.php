...
require_capability('eset/contentbank:upload', $context);
...
$returnurl = new \eset_url('/contentbank/index.php', ['contextid' => $contextid]);
...
if ($mform->is_cancelled()) {
    ...
    if (!empty($files)) {
        ...
        $viewurl = new \eset_url('/contentbank/view.php', ['id' => $content->get_id(), 'contextid' => $contextid]);
        redirect($viewurl);
    } else {
