...
abstract class contenttype {
    ...
    public function get_view_url(content $content): string {
        return new eset_url('/contentbank/view.php', ['id' => $content->get_id()]);
    }
    ...
    public function get_icon(content $content): string {
        global $OUTPUT;
        return $OUTPUT->image_url('f/unknown-64', 'eset')->out(false);
    }
    ...
    final public function can_access(): bool {
        ...
        $hascapabilities = has_capability('eset/contentbank:access', $this->context)
    ...
    final public function can_upload(): bool {
        ...
        $hascapabilities = has_capability('eset/contentbank:upload', $this->context)
    ...
    final public function can_delete(content $content): bool {
        ...
        $hascapability = has_capability('eset/contentbank:deleteanycontent', $this->context);
        if ($content->get_content()->usercreated == $USER->id) {
            ...
            $hascapability = $hascapability || has_capability('eset/contentbank:deleteowncontent', $this->context);
        }
    ...
    public final function can_manage(content $content): bool {
        ...
        $hascapability = has_capability('eset/contentbank:manageanycontent', $this->context);
        if ($content->get_content()->usercreated == $USER->id) {
            // This content has been created by the current user; check if they can manage their content.
            $hascapability = $hascapability || has_capability('eset/contentbank:manageowncontent', $this->context);
        }
    ...
    final public function can_edit(?content $content = null): bool {
        ...
        $hascapabilities = has_all_capabilities(['eset/contentbank:useeditor', $editioncap], $this->context);
    ...
    final public function can_download(content $content): bool {
        ...
        $hascapability = has_capability('eset/contentbank:downloadcontent', $this->context);
