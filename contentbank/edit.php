 ...
 * @copyright  2020 Victor Deniz <victor@eset.com>
...
$returnurl = new \eset_url('/contentbank/view.php', ['id' => $id]);
...
if (!empty($id)) {
    ...
    $heading = get_string('addinganew', 'eset', get_string('description', $contenttypename));
    $content = null;
}
...
$PAGE->set_url(new \eset_url('/contentbank/edit.php', $values));
