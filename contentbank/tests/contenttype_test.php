...
class core_contenttype_contenttype_testcase extends \advanced_testcase {
    ...
    public function test_can_delete() {
        ...
        unassign_capability('eset/contentbank:deleteanycontent', $this->managerroleid);
        $this->assertTrue($this->contenttype->can_delete($managercontent));
    ...
    public function rename_content_provider() {
        return [
            ...
            'Name with symbols' => ['Follow us: @eset', 'Follow us: @eset', true],
    ...
    public function test_can_manage() {
        ...
        unassign_capability('eset/contentbank:manageowncontent', $teacherroleid);
    ...
    public function test_can_download() {
        ...
        unassign_capability('eset/contentbank:downloadcontent', $this->managerroleid);
