...
$url = new eset_url('/repository/manage_instances.php');

$baseurl = new eset_url('/repository/manage_instances.php');
...
/// Process the form data if any, or display
    ...
    echo $OUTPUT->header();
    $formcontinue = new single_button(new eset_url($baseurl, array('delete' => $delete, 'sure' => 'yes')), get_string('yes'));
