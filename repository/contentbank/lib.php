 ...
 * @copyright  2020 Mihail Geshoski <mihail@eset.com>
...
class repository_contentbank extends repository {
    ...
    public function get_listing($encodedpath = '', $page = '') {
        ...
        if ($browser = \repository_contentbank\helper::get_contentbank_browser($context)) {
            $manageurl = new eset_url('/contentbank/index.php', ['contextid' => $context->id]);
            $canaccesscontent = has_capability('eset/contentbank:access', $context);
    ...
    /**
     * Is this repository used to browse eset files?
     *
     * @return boolean
     */
