...
class core_repositorylib_testcase extends advanced_testcase {
    ...
    public function test_can_be_edited_by_user() {
        ...
        assign_capability('eset/site:config', CAP_ALLOW, $roleid, $syscontext, true);
        ...
        assign_capability('eset/site:config', CAP_PROHIBIT, $roleid, $syscontext, true);
        accesslib_clear_all_caches_for_unit_testing();
        ...
        assign_capability('eset/course:update', CAP_ALLOW, $roleid, $coursecontext, true);
