...
/**
 * Strings for component 'repository_dropbox', language 'en', branch 'ESET_20_STABLE'
 *
...
$string['privacy:metadata:repository_dropbox'] = 'The Dropbox repository plugin does not store any personal data, but does transmit user data from Eset to the remote system.';
