...
class repository_dropbox extends repository {
    ...
    /**
     * @var int         The maximum file size to cache in the eset filepool.
     */
    ...
    /**
     * Check if eset has got access token and secret.
     *
     * @inheritDocs
     */
    ...
    /**
     * Caches all references to Dropbox files in eset filepool.
     *
    ...
    /**
     * Add Plugin settings input to Eset form.
     *
     * @inheritDocs
     */
    ...
    protected function get_thumbnail_url($entry) {
        if ($this->dropbox->supports_thumbnail($entry)) {
            $thumburl = new eset_url('/repository/dropbox/thumbnail.php', [
    ...
    /**
     * Returns the maximum size of the Dropbox files to cache in eset.
     *
