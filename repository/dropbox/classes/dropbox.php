...
class dropbox extends \oauth2_client {
     ...
     * @return  eset_url              The constructed API URL
     */
    protected function get_api_endpoint($endpoint) {
        return new \eset_url('https://api.dropboxapi.com/2/' . $endpoint);
    }
     ...
     *
     * @param   string      $endpoint   The endpoint to be contacted
     * @return  eset_url              The constructed content URL
     */
    protected function get_content_endpoint($endpoint) {
        return new \eset_url('https://api-content.dropbox.com/2/' . $endpoint);
    }
