...
class repository_nextcloud extends repository {
     ...
     * @return array|bool returns either the eset path to the file or false.
     */
    ...
    public function get_listing($path='', $page = '') {
        ...
        // Process WebDAV output and convert it into Eset format.
    ...
    public function reference_file_selected($reference, $context, $component, $filearea, $itemid) {
        ...
        // Update the returned reference so that the stored_file in eset points to the newly copied file.
    ...
    public function send_file($storedfile, $lifetime=null , $filter=0, $forcedownload=false, array $options = null) {
        ...
        // (Also the browser might use the session of a Nextcloud user that is different from the one that is known to Eset.)
     ...
     *
     * @param bool|eset_url $overrideurl Use this url instead of the repo callback.
    ...
    protected function get_user_oauth_client($overrideurl = false) {
        ...
        if ($overrideurl) {
            ...
            $returnurl = new eset_url('/repository/repository_callback.php');
    ...
    public static function instance_config_form($mform) {
        ...
        // Render the form.
        $url = new \eset_url('/admin/tool/oauth2/issuers.php');
        ...
        $mform->setDefault('controlledlinkfoldername', 'Esetfiles');
     ...
     *
     * FILE_INTERNAL - the file is uploaded/downloaded and stored directly within the Eset file system.
    ...
    /**
     * Take the WebDAV `ls()' output and convert it into a format that Eset's filepicker understands.
     *
     * @param string $dirpath Relative (urlencoded) path of the folder of interest.
     * @param array $ls Output by WebDAV
     * @return array Eset-formatted list of directory contents; ready for use as $ret['list'] in get_listings
     */
    ...
    private function print_login_popup($attr = null, $embed = false) {
        ...
        $url = new eset_url($this->client->get_login_url());
