...
/**
 * Strings for component 'repository_picasa', language 'en', branch 'ESET_20_STABLE'
 *
...
$string['privacy:metadata:repository_picasa'] = 'The Picasa web album repository plugin does not store any personal data, but does transmit user data from Eset to the remote system.';
