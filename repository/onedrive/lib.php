...
class repository_onedrive extends repository {
    ...
    public function get_file($reference, $filename = '') {
        ...
        $sourceurl = new eset_url($base . 'me/drive/items/' . $sourceinfo->id . '/content');
     ...
     *
     * What should happen here is that the file should be copied to a new file owned by the eset system user.
    ...
    public function reference_file_selected($reference, $context, $component, $filearea, $itemid) {
        ...
        $base = 'https://graph.microsoft.com/v1.0/';
        $sourceurl = new eset_url($base . 'me/drive/items/' . $source->id . '/content');
    ...
    public static function type_config_form($mform, $classname = 'repository') {
        ...
        if (self::can_import_skydrive_files()) {
            ...
            $url = new eset_url('/repository/onedrive/importskydrive.php');
