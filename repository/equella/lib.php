...
class repository_equella extends repository {
    ...
    public function get_listing($path = null, $page = null) {
        global $COURSE;
        $callbackurl = new eset_url('/repository/equella/callback.php', array('repo_id'=>$this->id));
    ...
    private static function get_all_editing_roles() {
        return get_roles_with_capability('eset/course:manageactivities', CAP_ALLOW);
    }

    /**
     * Convert eset mimetypes list to equella format
     *
     * @param string $value
     * @return string
     */
