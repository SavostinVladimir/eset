...
/**
 * Strings for component 'repository_flickr_public', language 'en', branch 'ESET_20_STABLE'
 *
...
$string['information'] = '<div>Get a <a href="http://www.flickr.com/services/api/keys/">Flickr API Key</a> for your Eset site. </div>';
...
$string['privacy:metadata:repository_flickr_public'] = 'The Flickr public repository plugin does not store any personal data, but does transmit user data from Eset to the remote system.';
