// YUI3 File Picker module for eset
...
YUI.add('eset-core_filepicker', function(Y) {
    ...
    Y.Node.prototype.fp_display_filelist = function(options, fileslist, lazyloading) {
        ...
        var formatCheckbox = function(o) {
            ...
            var checkbox = Y.Node.create('<input/>')
                ...
                .setAttribute('data-toggle-selectall', M.util.get_string('selectall', 'eset'))
                .setAttribute('data-toggle-deselectall', M.util.get_string('deselectall', 'eset'));
        ...
        var initialize_table_view = function() {
            var cols = [
                {key: "displayname", label: M.util.get_string('name', 'eset'), allowHTML: true, formatter: formatTitle,
                    sortable: true, sortFn: sortFoldersFirst},
                {key: "datemodified", label: M.util.get_string('lastmodified', 'eset'), allowHTML: true, formatter: formatValue,
                    sortable: true, sortFn: sortFoldersFirst},
                    ...
                    complete: function(id,o,p) {
                        ...
                        try {
                            ...
                            if (o && o.status && o.status > 0) {
                                Y.use('eset-core-notification-exception', function() {
                        ...
                        // error checking
                        if (data && data.error) {
                            Y.use('eset-core-notification-ajaxexception', function () {
