 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @deprecated since Eset 2.7 MDL-40457
 */
...
function question_build_edit_resources($edittab, $baseurl, $params) {
    ...
    $thispageurl = new eset_url($baseurl);
    ...
    if (is_null($cmid) && is_null($courseid)) {
        throw new \eset_exception('Must provide a cmid or courseid');
    }
 ...
 * @param eset_url $thispageurl if the value has been explicitly set, we add
 *      it to this URL.
...
function create_new_question_button($categoryid, $params, $caption, $tooltip = '', $disabled = false) {
    ...
    $url = new eset_url('/question/addquestion.php', $params);
