...
class qformat_default {
     ...
     * @param course object Eset course variable
     */
     ...
     * @param array $contexts Eset course variable
     */
    ...
    protected function create_category_path($catpath, $lastcategoryinfo = null) {
        ...
        if ($this->contextfromfile && $contextid !== false) {
            ...
            require_capability('eset/question:add', $context);
        } else {
        ...
        foreach ($catnames as $key => $catname) {
            if ($parent == 0) {
                ...
                require_capability('eset/question:managecategory', $context);
    ...
    protected function defaultquestion() {
        ...
        $question->questiontextformat = FORMAT_ESET;
        $question->generalfeedback = '';
        $question->generalfeedbackformat = FORMAT_ESET;
     ...
     * object suitable for processing and insertion into Eset.
     *
...
class qformat_based_on_xml extends qformat_default {
    ...
    /**
     * Return the array eset is expecting
