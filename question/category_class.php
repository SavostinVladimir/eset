 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class question_category_list extends eset_list {
...
class question_category_list_item extends list_item {
    public function set_icon_html($first, $last, $lastitem){
        global $CFG;
        $category = $this->item;
        $url = new eset_url('/question/category.php', ($this->parentlist->pageurl->params() + array('edit'=>$category->id)));
        ...
        if (($this->parentlist->nextlist !== null) && $last && $toplevel && (count($this->parentlist->items)>1)){
            $url = new eset_url($this->parentlist->pageurl, array('movedowncontext'=>$this->id, 'tocontext'=>$this->parentlist->nextlist->context->id, 'sesskey'=>sesskey()));
        ...
        if (($this->parentlist->lastlist !== null) && $first && $toplevel && (count($this->parentlist->items)>1)){
            $url = new eset_url($this->parentlist->pageurl, array('moveupcontext'=>$this->id, 'tocontext'=>$this->parentlist->lastlist->context->id, 'sesskey'=>sesskey()));
    ...
    public function item_html($extraargs = array()){
        ...
        $questionbankurl = new eset_url('/question/edit.php', $this->parentlist->pageurl->params());
        ...
        if ($category->parent && !question_is_only_child_of_top_category_in_context($category->id)) {
            $deleteurl = new eset_url($this->parentlist->pageurl, array('delete' => $this->id, 'sesskey' => sesskey()));
...
class question_category_object {
    ...
    /**
     * @var eset_url Object representing url for this page
     */
    public $pageurl;
     ...
     * @param eset_url $pageurl base URL of the display categories page. Used for redirects.
    ...
    public function add_category($newparent, $newcategory, $newinfo, $return = false, $newinfoformat = FORMAT_HTML,
        ...
        //eset_form makes sure select element output is legal no need for further cleaning
        require_capability('eset/question:managecategory', context::instance_by_id($contextid));
    ...
    public function update_category($updateid, $newparent, $newname, $newinfo, $newinfoformat = FORMAT_HTML,
        ...
        require_capability('eset/question:managecategory', $fromcontext);
        ...
        if ($oldcat->contextid != $tocontextid) {
            ...
            require_capability('eset/question:managecategory', $tocontext);
