...
class qformat_blackboard_six_qti extends qformat_blackboard_six_base {
    ...
    protected function readquestions($text) {
        ...
        foreach ($rawquestions as $quest) {
            ...
            // Warning : rawquestions are not Eset questions.
            $question = $this->create_raw_question($quest);
            // Third step : convert a rawquestion into a Eset question.
    ...
    /**
     * Creates a cleaner object to deal with for processing into Eset.
     * The object returned is NOT a eset question object.
     ...
     * @param object $quest rawquestion
     * @param array $questions array of Eset questions already done
     */
    ...
    public function process_essay($quest, &$questions) {
        ...
        foreach ($quest->feedback as $feedback) {
            ...
            // instructor gives as the Eset answer for an essay question.
    ...
    public function process_matching($quest, &$questions) {
        ...
        // Blackboard matching questions can't be imported in core Eset without a loss in data,
