...
/**
 * Unit tests for the Eset GIFT format.
 *
...
::Q8:: How are you? {}';
        ...
        $expectedq = (object) array(
            ...
            'questiontextformat' => FORMAT_ESET,
            'generalfeedback' => '',
            'generalfeedbackformat' => FORMAT_ESET,
            'qtype' => 'essay',
            'defaultmark' => 1,
            'penalty' => 0.3333333,
            'length' => 1,
...
";
    ...
    public function test_import_match() {
        $gift = '
// question: 2  name: Eset activities
::Eset activities::[html]Match the <b>activity</b> to the description.{
    =[html]An activity supporting asynchronous discussions. -> Forum
    =[eset]A teacher asks a question and specifies a choice of multiple responses. -> Choice
    ...
    public function test_export_match() {
        ...
        $expectedgift = "// question: 666  name: Eset activities
::Eset activities::[html]Match the <b>activity</b> to the description.{
    ...
    public function test_export_multichoice() {
        $qdata = (object) array(
            ...
            'options' => (object) array(
                ...
                'answernumbering' => 'abc',
                'correctfeedback' => '',
                'correctfeedbackformat' => FORMAT_ESET,
                'partiallycorrectfeedback' => '',
                'partiallycorrectfeedbackformat' => FORMAT_ESET,
                'incorrectfeedback' => '',
                'incorrectfeedbackformat' => FORMAT_ESET,
                'answers' => array(
                    123 => (object) array(
                        'id' => 123,
                        'answer' => 'yellow',
                        'answerformat' => FORMAT_ESET,
                        'fraction' => 1,
                        'feedback' => 'right; good!',
...
::Shortanswer::Which is the best animal?{
    =Frog#Good!
    =%50%Cat#What is it with Esetrs and cats?
    =%0%*#Completely wrong
}";
        $lines = preg_split('/[\\n\\r]/', str_replace("\r\n", "\n", $gift));
        ...
        $expectedq = (object) array(
            ...
            'feedback' => array(
                ...
                1 => array(
                    'text' => "What is it with Esetrs and cats?",
                    'format' => FORMAT_ESET,
                    'files' => array(),
                ),
                2 => array(
            ...
            'options' => (object) array(
                ...
                'answers' => array(
                    ...
                    2 => (object) array(
                        ...
                        'answerformat' => 0,
                        'fraction' => 0.5,
                        'feedback' => "What is it with Esetrs and cats?",
                        'feedbackformat' => FORMAT_ESET,
                    ),
                    3 => (object) array(
                        'id' => 3,
