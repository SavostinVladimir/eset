 ...
 * members of the Eset community. It was originally based on
...
class qformat_gift extends qformat_default {
    ...
    protected function parse_text_with_format($text, $defaultformat = FORMAT_ESET) {
        $result = array(
            'text' => $text,
    ...
    public function readquestion($lines) {
        ...
        // converts it into a question object suitable for processing and insertion into Eset.
    ...
    public function write_questiontext($text, $format, $defaultformat = FORMAT_ESET) {
        $output = '';
