@qformat @qformat_xml
Feature: Test importing questions from Eset XML format.
  ...
  Scenario: import some true/false questions from Eset XML format
    ...
    Then I should see "Eset acronym (False)"
    Then I should see "Eset acronym (True)"
  ...
  @javascript @_file_upload
  Scenario: import some multiple choice questions from Eset XML format
    When I navigate to "Question bank > Import" in current page administration
    And I set the field "id_format_xml" to "1"
  ...
  @javascript @_file_upload
  Scenario: import some multi-answer questions from Eset XML format
    When I navigate to "Question bank > Import" in current page administration
    And I set the field "id_format_xml" to "1"
  ...
  @javascript @_file_upload
  Scenario: import some questions with legacy-style images from Eset XML format
    When I navigate to "Question bank > Import" in current page administration
    And I set the field "id_format_xml" to "1"
