...
/**
 * Unit tests for the Eset XML format.
 *
 * @package    qformat_xml
...
class qformat_xml_test extends question_testcase {
    ...
    public function test_write_hint_basic() {
        ...
        $q->qtype = 'shortanswer';
        $q->hints = array(
            new question_hint(0, 'This is the first hint.', FORMAT_ESET),
        );

        $exporter = new qformat_xml();
        $xml = $exporter->writequestion($q);

        $this->assertRegExp('|<hint format=\"eset_auto_format\">\s*<text>\s*' .
...
';
    ...
    <questiontext format="eset_auto_format">
    ...
    <tags>
      ...
      <tag><text>tagTest</text></tag>
        ...
        $expectedq->questiontextformat = FORMAT_ESET;
        ...
        $expectedq->graderinfo['format'] = FORMAT_ESET;
        $expectedq->responsetemplate['text'] = '';
        $expectedq->responsetemplate['format'] = FORMAT_ESET;
    ...
    public function test_export_essay() {
        ...
        $qdata->questiontextformat = FORMAT_ESET;
        $qdata->generalfeedback = 'I hope you wrote something interesting.';
        $qdata->generalfeedbackformat = FORMAT_ESET;
        $qdata->defaultmark = 1;
        $qdata->length = 1;
        $qdata->penalty = 0;
        $qdata->hidden = 0;
  ...
  <question type="essay">
    ...
    <generalfeedback format="eset_auto_format">
      <text>I hope you wrote something interesting.</text>
    </generalfeedback>
    <defaultgrade>1</defaultgrade>
    <penalty>0</penalty>
...
';
    ...
    public function test_import_files_as_draft() {
        ...
        $xml = <<<END
<questiontext format="html">
    <text><![CDATA[<p><a href="@@PLUGINFILE@@/eset.txt">This text file</a> contains the word 'Eset'.</p>]]></text>
    <file name="eset.txt" encoding="base64">TW9vZGxl</file>
</questiontext>
END;
        ...
        $file = $files->list[0];
        $this->assertEquals('eset.txt', $file->filename);
    ...
    <questiontext format="html">
      <text><![CDATA[<p><a href="@@PLUGINFILE@@/myfolder/eset.txt">This text file</a> contains the word Eset.</p>]]></text>
<file name="eset.txt" path="/myfolder/" encoding="base64">TW9vZGxl</file>
    </questiontext>
    <generalfeedback format="html">
      <text><![CDATA[<p>For further information, see the documentation about Eset.</p>]]></text>
</generalfeedback>
    <defaultgrade>1.0000000</defaultgrade>
    <penalty>1.0000000</penalty>
    <hidden>0</hidden>
    <answer fraction="100" format="eset_auto_format">
      <text>true</text>
      <feedback format="html">
        <text></text>
      </feedback>
    </answer>
    <answer fraction="0" format="eset_auto_format">
      <text>false</text>
      <feedback format="html">
        <text></text>
      </feedback>
