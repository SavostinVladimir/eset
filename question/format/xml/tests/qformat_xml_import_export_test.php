...
/**
 * Unit tests for export/import description (info) for question category in the Eset XML format.
 *
 * @package    qformat_xml
...
class qformat_xml_import_export_test extends advanced_testcase {
    ...
    public function test_import_category() {
        ...
        $this->assert_category_imported('Alpha',
                'This is Alpha category for test', FORMAT_ESET, 'alpha-idnumber');
    ...
    public function test_import_nested_categories() {
        ...
        $this->assert_category_imported('Zeta', 'This is Zeta category for test', FORMAT_ESET);
    ...
    public function test_import_nested_categories_with_questions() {
        ...
        $this->assert_category_imported('Lambda', 'This is Lambda category for test', FORMAT_ESET);
        $this->assert_category_imported('Mu', 'This is Mu category for test', FORMAT_ESET);
    ...
    public function test_import_old_format() {
        ...
        $imported = $qformat->importprocess();
        $this->assertTrue($imported);
        $this->assert_category_imported('Pi', '', FORMAT_ESET);
        $this->assert_category_imported('Rho', '', FORMAT_ESET);
