...
/**
 * Strings for component 'qformat_xml', language 'en', branch 'ESET_20_STABLE'
 *
 * @package    qformat_xml
...
$string['pluginname'] = 'Eset XML format';
$string['pluginname_help'] = 'This is a Eset-specific format for importing and exporting questions.';
