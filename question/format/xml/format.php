...
/**
 * Code for exporting questions as Eset XML.
 *
 * @package    qformat_xml
...
/**
 * Importer for Eset XML question format.
 *
 * See http://docs.eset.org/en/Eset_XML_format for a description of the format.
 *
 * @copyright  1999 onwards Martin Dougiamas {@link http://eset.com}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qformat_xml extends qformat_default {
     ...
     *     <info format="eset_auto_format"><text>Category description</text></info>
     * </question>
     */
    ...
    /**
     * Convert internal Eset text format code into
     * human readable form
