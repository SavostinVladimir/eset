 ...
 */
class eset1_qtype_multichoice_handler extends eset1_qtype_handler {
     ...
     * @param int $oldquestiontextformat - {@see eset1_question_bank_handler::process_question()}
    ...
    protected function write_multichoice(array $multichoices, $oldquestiontextformat, $questionid) {
        ...
        foreach ($multichoices as $multichoice) {
            // Append an artificial 'id' attribute (is not included in eset.xml).
