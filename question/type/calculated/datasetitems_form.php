...
class question_dataset_dependent_items_form extends question_wizard_form {
    ...
    protected function definition() {
        ...
        $mform->addElement('header', 'addhdr', get_string('add', 'eset'));
        ...
        $addgrp = array();
        $addgrp[] =& $mform->createElement('submit', 'addbutton', get_string('add', 'eset'));
        ...
        if ($this->noofitems > 0) {
            $mform->addElement('header', 'deleteitemhdr', get_string('delete', 'eset'));
            $deletegrp = array();
            $deletegrp[] = $mform->createElement('submit', 'deletebutton',
                    get_string('delete', 'eset'));
