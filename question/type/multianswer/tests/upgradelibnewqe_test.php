...
class qtype_multianswer_attempt_upgrader_test extends question_attempt_upgrader_test_base {
    ...
    public function test_multianswer_adaptivenopenalty_qsession105() {
        ...
        <p>The  multichoice question can also be shown in the vertical  display of the standard eset multiple choice. {#4}</p>
        <p>Or in an horizontal display that is included here in a table {#5}</p>
        <p>A shortanswer question where case must match. Write eset in  upper case letters {#6}</p>
        <p>Note that addresses like www.eset.org and smileys :-) all work as normal:</p>
            ...
            'options' => (object) array(
                'questions' => array(
                    ...
                    6 => (object) array(
                        ...
                        'parent' => '19',
                        'name' => 'Cloze',
                        'questiontext' => '{1:SHORTANSWER_C:eset#Feedback for eset in lower  case ~=ESET#Feedback for ESET in upper case ~%50%Eset#Feedback for  only first letter in upper case}',
                        'questiontextformat' => '0',
                        'generalfeedback' => '',
                        'generalfeedbackformat' => '1',
                        'defaultgrade' => '1.0000000',
                        ...
                        'options' => (object) array(
                            'answers' => array(
                                46 => (object) array(
                                    ...
                                    'answerformat' => '0',
                                    'fraction' => '0.0000000',
                                    'feedback' => 'Feedback for eset in lower  case',
                                    'feedbackformat' => '1',
                                ),
                                47 => (object) array(
                                    'id' => '47',
                                    ...
                                    'answerformat' => '0',
                                    'fraction' => '1.0000000',
                                    'feedback' => 'Feedback for ESET in upper case',
                                    'feedbackformat' => '1',
                                ),
                                48 => (object) array(
                                    'id' => '48',
        ...
        $qstates = array(
            ...
            284 => (object) array(
                ...
                'question' => '19',
                'seq_number' => '1',
                'answer' => '1-31,2-dsf,3-sadf,4-39,5-44,6-ESET,7-49,8-100%',
                'timestamp' => '1306425739',
                'event' => '3',
                'grade' => '5.0000000',
                'raw_grade' => '5.0000000',
...
The multichoice question can also be shown in the vertical display of the standard eset multiple choice. {1. Wrong answer; 2. Another wrong answer; 3. Correct answer; 4. Answer that gives half the credit}
...
A shortanswer question where case must match. Write eset in upper case letters _____

Note that addresses like www.eset.org and smileys :-) all work as normal:

a) How good is this? {Yes; No}

b) What grade would you give it? _____',
            'rightanswer' => 'part 1: Correct answer; part 2: Correct answer; part 3: 23.8; part 4: 3. Correct answer; part 5: c. Correct answer; part 6: ESET; part 7: Yes; part 8: 3',
            'responsesummary' => 'part 1: Correct answer; part 2: dsf; part 3: sadf; part 4: 2. Another wrong answer; part 5: c. Correct answer; part 6: ESET; part 7: Yes; part 8: 100%',
            'timemodified' => '1306425739',
            'steps' => array(
                0 => (object) array(
                ...
                1 => (object) array(
                    'data' => array('sub1_answer' => 2, 'sub2_answer' => 'dsf',
                        ...
                        'sub5_answer' => 2, 'sub6_answer' => 'ESET',
    ...
    public function test_multianswer_adaptivenopenalty_qsession109() {
        ...
        $qstates = array(
            ...
            295 => (object) array(
                ...
                'question' => '19',
                'seq_number' => '2',
                'answer' => '1-31,2-asdgf,3-28.3,4-40,5-44,6-ESET,7-49,8-13',
            ...
            296 => (object) array(
                ...
                'question' => '19',
                'seq_number' => '3',
                'answer' => '1-31,2-Correct answer,3-23.8,4-40,5-44,6-ESET,7-49,8-3',
...
b) What grade would you give it? _____',
            'rightanswer' => 'part 1: Correct answer; part 2: Correct answer; part 3: 23.8; part 4: 3. Correct answer; part 5: c. Correct answer; part 6: ESET; part 7: Yes; part 8: 3',
            'responsesummary' => 'part 1: Correct answer; part 2: Correct answer; part 3: 23.8; part 4: 3. Correct answer; part 5: c. Correct answer; part 6: ESET; part 7: Yes; part 8: 3',
