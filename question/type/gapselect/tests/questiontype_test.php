...
class qtype_gapselect_test extends question_testcase {
    ...
    <hint format="eset_auto_format">
      ...
      <clearwrong />
        ...
        $expectedq->hint = array(
                array('text' => 'Try again.', 'format' => FORMAT_ESET),
    ...
    public function test_xml_export() {
        ...
        $qdata->options->correctfeedbackformat = FORMAT_ESET;
        $qdata->options->partiallycorrectfeedback = '<p>Your answer is partially correct.</p>';
                $qdata->options->partiallycorrectfeedbackformat = FORMAT_ESET;
        $qdata->options->shownumcorrect = true;
        $qdata->options->incorrectfeedback = '<p>Your answer is incorrect.</p>';
        $qdata->options->incorrectfeedbackformat = FORMAT_ESET;

        $qdata->options->answers = array(
            13 => new question_answer(13, 'Alpha', 0, '1', FORMAT_ESET),
            14 => new question_answer(14, 'Beta', 0, '1', FORMAT_ESET),
            15 => new question_answer(15, 'Gamma', 0, '1', FORMAT_ESET),
        );

        $qdata->hints = array(
            1 => new question_hint_with_parts(1, 'Try again.', FORMAT_ESET, true, false),
            2 => new question_hint_with_parts(2,
                    'These are the first three letters of the Greek alphabet.',
                    FORMAT_ESET, true, true),
        );
  ...
  <question type="gapselect">
    ...
    <idnumber></idnumber>
    <shuffleanswers>1</shuffleanswers>
    <correctfeedback format="eset_auto_format">
      <text><![CDATA[<p>Your answer is correct.</p>]]></text>
    </correctfeedback>
    <partiallycorrectfeedback format="eset_auto_format">
      <text><![CDATA[<p>Your answer is partially correct.</p>]]></text>
    </partiallycorrectfeedback>
    <incorrectfeedback format="eset_auto_format">
      <text><![CDATA[<p>Your answer is incorrect.</p>]]></text>
    </incorrectfeedback>
    <shownumcorrect/>
    <selectoption>
