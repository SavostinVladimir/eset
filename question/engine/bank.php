...
/**
 * More object oriented wrappers around parts of the Eset question bank.
 *
...
abstract class question_bank {
     ...
     * @return bool whether that question type is installed in this Eset.
     */
    ...
    public static function get_all_qtypes() {
        ...
        foreach (core_component::get_plugin_list('qtype') as $plugin => $notused) {
            try {
                ...
                // question types do not cause the rest of Eset to break.
            }
        }
        return $qtypes;
    }
