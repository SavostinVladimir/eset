 ...
 * old versions of Eset into the tables used by the new question engine.
 *
 * @package    esetcore
...
class question_engine_attempt_upgrader {
    ...
    public function get_next_question_session($attempt, eset_recordset $questionsessionsrs) {
    ...
    public function get_question_states($attempt, $question, eset_recordset $questionsstatesrs) {
        $qstates = array();
 ...
 * the question engine upgrade in Eset 2.1.
 *
 * Note: This custom check (and its environment.xml declaration) will be safely
 *       removed once we raise min required Eset version to be 2.7 or newer.
 *
