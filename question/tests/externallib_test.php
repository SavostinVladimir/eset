 ...
 * @category   external
 * @copyright  2016 Pau Ferrer <pau@eset.com>
...
class core_question_external_testcase extends externallib_advanced_testcase {
    ...
    public function test_submit_tags_form_no_tag_permissions() {
        ...
        assign_capability('eset/question:tagmine', CAP_PROHIBIT, $teacherrole->id, $questioncontext->id);
        assign_capability('eset/question:tagall', CAP_PROHIBIT, $teacherrole->id, $questioncontext->id);
    ...
    public function test_submit_tags_form_tagmine_permission_non_owner_question() {
        ...
        // Prohibit all of the tag capabilities.
        assign_capability('eset/question:tagmine', CAP_ALLOW, $teacherrole->id, $questioncontext->id);
        assign_capability('eset/question:tagall', CAP_PROHIBIT, $teacherrole->id, $questioncontext->id);
    ...
    protected function create_user_can_tag($course) {
        ...
        assign_capability('eset/question:tagall', CAP_ALLOW, $roleid, $systemcontext, true);
    ...
    public function test_get_random_question_summaries_without_capability() {
        ...
        $generator->role_assign($roleid, $user->id, $systemcontext->id);
        // Prohibit all of the tag capabilities.
        assign_capability('eset/question:viewall', CAP_PROHIBIT, $roleid, $categorycontext->id);
