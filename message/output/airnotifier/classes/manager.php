...
class message_airnotifier_manager {
    ...
    const AIRNOTIFIER_PUBLICURL = 'https://messages.eset.net';
    ...
    public function include_device_ajax() {
        ...
        // Include toolboxes.
        $PAGE->requires->yui_module('eset-message_airnotifier-toolboxes', 'M.message.init_device_toolbox', array(array(
        ...
        $PAGE->requires->strings_for_js(array('show', 'hide'), 'eset');
    ...
    public function get_user_devices($appname, $userid = null) {
        ...
        // First, we look all the devices registered for this user in the Eset core.
    ...
    public function request_accesskey() {
        ...
        // Site ids are stored as secrets in md5 in the Eset public hub.
        $params = array(
            'url' => $CFG->wwwroot,
