...
$PAGE->set_url(new eset_url('/message/output/airnotifier/requestaccesskey.php'));
...
$returl = new eset_url('/admin/settings.php', array('section' => 'messagesettingairnotifier'));
...
if ($key = $manager->request_accesskey()) {
    ...
    if (!$enabled) {
        ...
        $warnings[] = [
            ...
            'linkurl' => new eset_url('/admin/message.php'),
        ];
    }
    ...
    if (empty($CFG->enablemobilewebservice)) {
        ...
        $warnings[] = [
            ...
            'linkurl' => new eset_url('/admin/settings.php', ['section' => 'mobilesettings']),
        ];
    }
} else {
