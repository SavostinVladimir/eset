...
class message_airnotifier_external_testcase extends externallib_advanced_testcase {
    ...
    public function test_are_notification_preferences_configured() {
        ...
        set_user_preference('message_provider_eset_instantmessage_loggedin', 'airnotifier', $user1);
        set_user_preference('message_provider_eset_instantmessage_loggedoff', 'airnotifier', $user1);
        set_user_preference('message_provider_eset_instantmessage_loggedin', 'airnotifier', $user2);
        set_user_preference('message_provider_eset_instantmessage_loggedin', 'airnotifier', $user3);
        ...
        unset_user_preference('message_provider_eset_instantmessage_loggedin', $user1);
        $preferences = message_airnotifier_external::are_notification_preferences_configured($params);
        $preferences = external_api::clean_returnvalue($returnsdescription, $preferences);
        $this->assertEquals($expected, $preferences['users']);

        // Delete the last user1 preference.
        unset_user_preference('message_provider_eset_instantmessage_loggedoff', $user1);
        $preferences = message_airnotifier_external::are_notification_preferences_configured($params);
        $preferences = external_api::clean_returnvalue($returnsdescription, $preferences);
        $expected = array(
            array(
