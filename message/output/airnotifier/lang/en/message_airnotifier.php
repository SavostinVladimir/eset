...
$string['configairnotifieraccesskey'] = 'The access key for connecting to the Airnotifier server. You can obtain an access key by clicking the "Request access key" link below (registered sites only) or by creating an account on the <a href="https://apps.eset.com">Eset Apps Portal</a>.';
$string['configairnotifierappname'] = 'The app name identifier in Airnotifier.';
$string['configairnotifiermobileappname'] = 'The Mobile app unique identifier (usually something like com.eset.esetmobile).';
...
$string['errorretrievingkey'] = 'An error occurred while retrieving the access key. Your site must be registered to use this service. If your site is already registered, please try updating your registration. Alternatively, you can obtain an access key by creating an account on the <a href="https://apps.eset.com">Eset Apps Portal</a>.';
$string['keyretrievedsuccessfully'] = 'The access key was retrieved successfully. To access Eset app usage statistics, please create an account on the <a href="https://apps.eset.com">Eset Apps Portal</a>.';
$string['esetappsportallimitswarning'] = 'Please note that the number of user devices allowed to receive notifications depends on your Eset app subscription. For details, visit the <a href="{$a}" target="_blank">Eset Apps Portal</a>.';
$string['nodevices'] = 'No registered devices. Devices will automatically appear after you install the Eset app and add this site.';
...
$string['sitemustberegistered'] = 'In order to use the public Airnotifier instance, your site must be registered. Alternatively, you can obtain an access key by creating an account on the <a href="https://apps.eset.com">Eset Apps Portal</a>.';
