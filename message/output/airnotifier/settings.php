...
if ($ADMIN->fulltree) {
    ...
    $notify = new \core\output\notification(
        get_string('esetappsportallimitswarning', 'message_airnotifier',
            (new eset_url('https://apps.eset.com'))->out()),
        \core\output\notification::NOTIFY_WARNING);
    $settings->add(new admin_setting_heading('tool_mobile/esetappsportalfeaturesappearance', '', $OUTPUT->render($notify)));
    ...
    $settings->add(new admin_setting_configtext('airnotifiermobileappname',
                    ...
                    get_string('configairnotifiermobileappname', 'message_airnotifier'), 'com.eset.esetmobile', PARAM_TEXT));
    $settings->add(new admin_setting_configtext('airnotifierappname',
                    get_string('airnotifierappname', 'message_airnotifier'),
                    get_string('configairnotifierappname', 'message_airnotifier'), 'comesetesetmobile', PARAM_TEXT));
    ...
    $url = new eset_url('/message/output/airnotifier/requestaccesskey.php', array('sesskey' => sesskey()));
