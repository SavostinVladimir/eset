 ...
 * @category   external
 * @copyright  2012 Jerome Mouneyrac <jerome@eset.com>
...
class message_airnotifier_external extends external_api {
    ...
    public static function are_notification_preferences_configured($userids) {
        ...
        $hasuserupdatecap = has_capability('eset/user:update', context_system::instance());
    ...
    /**
     * Return the list of mobile devices that are registered in Eset for the given user.
     *
                ...
                'devices' => new external_multiple_structure(
                    new external_single_structure(
                        array (
                            ...
                            'appid' => new external_value(PARAM_NOTAGS, 'The app id, something like com.eset.esetmobile'),
    ...
    public static function enable_device($deviceid, $enable) {
        ...
        if (!message_airnotifier_manager::enable_device($params['deviceid'], $params['enable'])) {
            throw new eset_exception('unknowndevice', 'message_airnotifier');
        }
