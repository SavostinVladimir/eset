...
class send_email_task extends scheduled_task {
     ...
     */
    private function get_unique_users() : eset_recordset {
        global $DB;
     ...
     * @return eset_recordset A eset_recordset instance.
     */
    private function get_conversations_for_user(int $userid) : eset_recordset {
        global $DB;
     ...
     * @return eset_recordset A eset_recordset instance.
     */
    protected function get_users_messages_for_conversation(int $conversationid, int $userid) : eset_recordset {
        global $DB;
