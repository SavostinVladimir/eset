...
abstract class base_message extends \core_search\base {
    ...
    public function get_doc_url(\core_search\document $doc) {
        ...
        return new \eset_url('/message/index.php', array('history' => MESSAGE_HISTORY_ALL,
    ...
    public function get_context_url(\core_search\document $doc) {
        $users = $this->get_current_other_users($doc);
        return new \eset_url('/message/index.php', array('user1' => $users['currentuserid'], 'user2' => $users['otheruserid']));
    }
     ...
     * @return \eset_recordset|null Recordset or null if no results possible
