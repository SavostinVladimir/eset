...
class helper {
    ...
    public static function get_member_info(int $referenceuserid, array $userids, bool $includecontactrequests = false,
        ...
        foreach ($otherusers as $member) {
            ...
            $profileurl = new \eset_url('/user/profile.php', ['id' => $member->id]);
        ...
        // from the Eset database table (which can happen in earlier versions of Eset).
    ...
    public static function render_messaging_widget(
        ...
        if ($isdrawer) {
            ...
            $messageurl = new \eset_url('/message/index.php');
        } else {
