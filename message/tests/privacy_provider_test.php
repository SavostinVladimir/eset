 ...
 * @copyright  2018 Mark Nelson <markn@eset.com>
...
class core_message_privacy_provider_testcase extends \core_privacy\tests\provider_testcase {
    ...
    public function test_export_user_preferences() {
        ...
        set_user_preference('message_provider_eset_instantmessage_loggedin', 'airnotifier', $USER->id);
        set_user_preference('message_provider_eset_instantmessage_loggedoff', 'popup', $USER->id);
        ...
        set_user_preference('message_provider_eset_instantmessage_loggedoff', 'inbound', $user->id);
        ...
        $this->assertArrayHasKey('message_provider_eset_instantmessage_loggedin', $prefs);
        $this->assertArrayHasKey('message_provider_eset_instantmessage_loggedoff', $prefs);
        $this->assertArrayHasKey('message_blocknoncontacts', $prefs);
        $this->assertArrayHasKey('message_entertosend', $prefs);

        foreach ($prefs as $key => $pref) {
            if ($key == 'message_provider_eset_instantmessage_loggedin') {
                $this->assertEquals('airnotifier', $pref->value);
            } else if ($key == 'message_provider_eset_instantmessage_loggedoff') {
