...
#   Disable email default value
    Given the following "user preferences" exist:
      ...
      | student1  | message_provider_eset_instantmessage_loggedin   | none  |
      | student1  | message_provider_eset_instantmessage_loggedoff  | none  |
  ...
  Scenario: Config jabber
    Given the following config values are set as admin:
      ...
      | jabberusername | esetmessageservice |
