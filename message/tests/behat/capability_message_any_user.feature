...
Feature: Capability test for 'eset/site:messageanyuser'
  In order to test that the 'eset/site:messageanyuser' works as expected
  As a user with or without the capability 'eset/site:messageanyuser'
