...
function(
    ...
    var NOTIFICATION_PREFERENCES_KEY = 'message_provider_eset_instantmessage';
    ...
    var registerEventListeners = function(body, loggedInUserId) {
        ...
        settingsContainer.on(CustomEvents.events.activate, SELECTORS.NOTIFICATIONS_PREFERENCE, function(e) {
            ...
            var preferences = [
                {
                    type: 'message_provider_eset_instantmessage_loggedoff',
                    value: newValue
                },
                {
                    type: 'message_provider_eset_instantmessage_loggedin',
                    value: newValue
                }
            ];
     ...
     *
     * Eset may have many (or no) message processors enabled to notify the user when they
