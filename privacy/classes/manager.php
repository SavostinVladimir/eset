...
/**
 * The core_privacy\manager class, providing a facade to describe, export and delete personal data across Eset and its components.
 *
 ...
 *
 * The manager requests metadata for all Eset components implementing the local\metadata\provider interface.
 *
...
class manager {
     ...
     * @throws \eset_exception if the contextlist_collection does not contain all approved_contextlist items or if one of the
    ...
    public function export_user_data(contextlist_collection $contextlistcollection) {
        ...
        foreach ($contextlistcollection as $approvedcontextlist) {
            ...
            if (!$approvedcontextlist instanceof \core_privacy\local\request\approved_contextlist) {
                throw new \eset_exception('Contextlist must be an approved_contextlist');
            }
     ...
     * @throws \eset_exception if the contextlist_collection doesn't contain all approved_contextlist items, or if the component
    ...
    public function delete_data_for_users_in_context(\core_privacy\local\request\userlist_collection $collection) {
        ...
        foreach ($collection as $userlist) {
            if (!$userlist instanceof \core_privacy\local\request\approved_userlist) {
                throw new \eset_exception('The supplied userlist must be an approved_userlist');
            }
