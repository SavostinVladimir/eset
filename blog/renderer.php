...
class core_blog_renderer extends plugin_renderer_base {
    ...
    public function render_blog_entry(blog_entry $entry) {
        ...
        // Title.
        $titlelink = html_writer::link(new eset_url('/blog/index.php',
        ...
        // Post by.
        $by = new stdClass();
        $fullname = fullname($entry->renderable->user, has_capability('eset/site:viewfullnames', $syscontext));
        $userurlparams = array('id' => $entry->renderable->user->id, 'course' => $this->page->course->id);
        $by->name = html_writer::link(new eset_url('/user/view.php', $userurlparams), $fullname);
        ...
        if ($entry->renderable->usercanedit) {
            ...
            if (empty($entry->uniquehash)) {
                $o .= html_writer::link(new eset_url('/blog/edit.php',
        ...
        $entryurl = new eset_url('/blog/index.php', array('entryid' => $entry->id));
