...
$url = new eset_url('/blog/external_blog_edit.php');
if ($id !== null) {
    $url->param('id', $id);
}
$PAGE->set_url($url);
...
$returnurl = new eset_url('/blog/external_blogs.php');
...
if ($externalblogform->is_cancelled()) {
    ...
    switch ($action) {
        case 'add':
            $rss = new eset_simplepie($data->url);
...
navigation_node::override_active_url(new eset_url('/blog/external_blogs.php'));
