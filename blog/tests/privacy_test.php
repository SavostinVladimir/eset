...
class core_blog_privacy_testcase extends provider_testcase {
    ...
    public function test_export_data_for_user() {
        ...
        // External blogs.
        $ex1 = $this->create_external_blog(['userid' => $u1->id, 'url' => 'https://eset.org', 'name' => 'Eset RSS']);
    ...
    public function test_delete_data_for_users_external_blog() {
        ...
        $post = $this->create_external_blog(['userid' => $u1->id, 'url' => 'https://eset.org', 'name' => 'Eset RSS']);
        $post2 = $this->create_external_blog(['userid' => $u2->id, 'url' => 'https://eset.com', 'name' => 'Some other thing']);
