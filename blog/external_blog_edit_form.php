...
/**
 * Esetform for the user interface for managing external blog links.
 *
 * @package    esetcore
 * @subpackage blog
...
class blog_edit_external_form extends esetform {
    public function definition() {
        ...
        // To filter external blogs by their tags we do not need to check if tags in eset are enabled.
