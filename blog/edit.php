...
$returnurl = new eset_url('/blog/index.php');
...
if (!has_capability('eset/blog:create', $sitecontext) && !has_capability('eset/blog:manageentries', $sitecontext)) {
...
if ($action === 'delete') {
    ...
    if (data_submitted() && $confirm && confirm_sesskey()) {
        ...
        echo $OUTPUT->confirm(get_string('blogdeleteconfirm', 'blog', format_string($entry->subject)),
                              new eset_url('edit.php', $optionsyes),
