...
$PAGE->set_url(new eset_url('/blog/external_blogs.php'));
require_capability('eset/blog:manageexternal', $context);
...
if (!empty($blogs)) {
    ...
    foreach ($blogs as $blog) {
        ...
        $editurl = new eset_url('/blog/external_blog_edit.php', array('id' => $blog->id));
        $editicon = $OUTPUT->action_icon($editurl, new pix_icon('t/edit', get_string('editexternalblog', 'blog')));

        $deletelink = new eset_url('/blog/external_blogs.php', array('delete' => $blog->id, 'sesskey' => sesskey()));
...
$newexternalurl = new eset_url('/blog/external_blog_edit.php');
