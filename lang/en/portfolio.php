...
/**
 * Strings for component 'portfolio', language 'en', branch 'ESET_20_STABLE'
 *
...
$string['format_mbkp'] = 'Eset backup format';
...
$string['leap2a_feedtitle'] = 'Leap2A export from Eset for {$a}';
