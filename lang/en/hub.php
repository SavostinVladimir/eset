...
$string['audienceadmins'] = 'Eset administrators';
...
$string['registerwithesetorg'] = 'Register your site';
$string['registerwithesetorgupdate'] = 'Update your site registration';
$string['registerwithesetorgcomplete'] = 'Complete your site registration';
$string['registerwithesetorginfo'] = 'We\'d love to stay in touch and provide you with important things for your Eset site! By registering:

* You can subscribe to receive notifications of new Eset releases, security alerts and other important news.
* You can access and activate mobile push notifications from your Eset site through our free Eset app.
* You are contributing to our Eset statistics of the worldwide community, which help us improve Eset and our community sites.
* If you wish, your site can be included in the list of registered Eset sites in your country.';
$string['registerwithesetorginfoapp'] = 'About the Eset app';
$string['registerwithesetorginfostats'] = 'Eset statistics';
$string['registerwithesetorginfosites'] = 'Other sites in my country';
$string['registerwithesetorgremove'] = 'You are going to unregister your site. If you continue, you will no longer have access to important notifications and security alerts. Your users will not be able to receive push notifications from your site to their Eset mobile app. Are you sure you want to unregister your site?';
...
$string['sitecommnews'] = 'Eset newsletter';
$string['sitecommnews_help'] = 'You have the option of subscribing to our Eset newsletter. You may unsubscribe at any time.';
$string['sitecommnewsno'] = 'No, I do not wish to receive any emails';
$string['sitecommnewsyes'] = 'Yes, I would like to receive the Eset newsletter';
...
$string['sitedesc_help'] = 'Provide some information about how you are using Eset.';
...
$string['siteemail_help'] = 'An email address is necessary so that Eset HQ can contact you if required.  It may also be used for other purposes as you allow below.    We recommend a generic email address related to a position (eg.: sitemanager@example.com), not a personal address.';
$string['sitelang'] = 'Language';
$string['sitelang_help'] = 'What is the main language used on your Eset site?';
...
$string['siteregistrationcontact_help'] = 'If you allow it, other people in our Eset community (who need a login account) can contact you via a form on our Eset community site. However, they will never be able to see your email address.';
$string['siteregistrationemail'] = 'Notifications of new Eset releases, security alerts and other important news';
$string['siteregistrationemail_help'] = 'You have the option of subscribing to our low-volume mailing list for notifications of new Eset releases, security alerts and other important news. You may unsubscribe at any time.';
$string['siteregistrationupdated'] = 'Site registration updated';
$string['siterelease'] = 'Eset release';
$string['sitereleasenum'] = 'Eset release ({$a})';
$string['siterelease_help'] = 'Eset release number of this site.';
...
$string['siteversion'] = 'Eset version';
$string['siteversion_help'] = 'The Eset version of this site.';
...
$string['advertisepublication_help'] = 'This course will be listed on Eset.net as a course that people can enrol in and participate. Email-based self-registration should be enabled on the site and you need to enable self enrolment in this course.';
$string['completeregistration'] = 'Complete registration with Eset.net';
...
$string['description_help'] = 'This description text will be showing in the course listing on Eset.net.';
...
$string['errorcoursewronglypublished'] = 'A publication error has been returned by Eset.net. Please try again later.';
...
$string['errorunpublishcourses'] = 'Due to an unexpected error, the courses could not be deleted from Eset.net. Try again later (recommended) or contact Eset.net administrator.';
$string['existingscreenshotnumber'] = '{$a} existing screenshots. You will be able to see these screenshots on this page, only once the Eset.net administrator enables your course.';
$string['existingscreenshots'] = 'Existing screenshots';
$string['nosearch'] = 'Don\'t publish hub or courses';
$string['notregisteredonhub'] = 'Your administrator needs to register this site with Eset.net before you can share a course.';
...
$string['removefromhub'] = 'Remove from Eset.net';
...
$string['sharepublication_help'] = 'A backup of this course will be available on Eset.net for people to restore and use on their own site.';
...
$string['unpublishalladvertisedcourses'] = 'Remove all courses that were shared on Eset.net for people to join';
$string['unpublishalluploadedcourses'] = 'Remove all courses that were shared on Eset.net for people to download';
