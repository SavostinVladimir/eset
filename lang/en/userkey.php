...
/**
 * Strings for component 'userkey', language 'en', branch 'ESET_20_STABLE'
 *
 * @package   core
...
$string['userkey_help'] = 'Select a saved key that will give users access to the data published by this export plugin, without having to log into Eset. Select "Create a new user key" to generate a new key when submitting this form.';
