...
$string['cachedef_userselections'] = 'Data used to persist user selections throughout Eset';
...
$string['privacy:metadata:cachestore'] = 'The Cache subsystem stores data temporarily on behalf of other parts of Eset. This data is not easily identifiable, and is very short lived. It serves as a cache of data stored elsewhere in Eset, and should therefore already be handled by those Eset components.';
$string['purge'] = 'Purge';
