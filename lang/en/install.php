...
/**
 * Strings for component 'install', language 'en', branch 'ESET_20_STABLE'
 *
 * @package   core
...
$string['admindirsetting'] = 'A very few webhosts use /admin as a special URL for you to access a
    ...
    standard location for the Eset admin pages.  You can fix this by
    renaming the admin directory in your installation, and putting that
    new name here.  For example: <br /> <br /><b>esetadmin</b><br /> <br />
    This will fix admin links in Eset.';
...
$string['clialreadyconfigured'] = 'The configuration file config.php already exists. Please use admin/cli/install_database.php to install Eset for this site.';
$string['clialreadyinstalled'] = 'The configuration file config.php already exists. Please use admin/cli/install_database.php to upgrade Eset for this site.';
$string['cliinstallfinished'] = 'Installation completed successfully.';
$string['cliinstallheader'] = 'Eset {$a} command line installation program';
...
$string['compatibilitysettingssub'] = 'Your server should pass all these tests to make Eset run properly';
$string['configfilenotwritten'] = 'The installer script was not able to automatically create a config.php file containing your chosen settings, probably because the Eset directory is not writeable. You can manually copy the following code into a file named config.php within the root directory of Eset.';
...
$string['configurationcompletesub'] = 'Eset made an attempt to save your configuration in a file in the root of your Eset installation.';
...
$string['databasetypesub'] = 'Eset supports several types of database servers. Please contact server administrator if you do not know which type to use.';
...
$string['dbtype'] = 'Type';
$string['directorysettings'] = '<p>Please confirm the locations of this Eset installation.</p>

<p><b>Web address:</b>
Specify the full web address where Eset will be accessed.
...
$string['directorysettingshead'] = 'Please confirm the locations of this Eset installation';
...
$string['dirroot'] = 'Eset directory';
$string['dirrooterror'] = 'The \'Eset directory\' setting seems to be incorrect - we can\'t find a Eset installation there. The value below has been reset.';
...
<p>Eset can still be installed, but without this ability, you will not be able
...
$string['inputwebdirectory'] = 'Eset directory:';
...
$string['nativeauroramysqlhelp'] = '<p>The database is where most of the Eset settings and data are stored and must be configured here.</p>
...
<p>If the database currently does not exist, and the user you specify has permission, Eset will attempt to create a new database with the correct permissions and settings.</p>
<p>This driver is not compatible with legacy MyISAM engine.</p>';
$string['nativemariadb'] = 'MariaDB (native/mariadb)';
$string['nativemariadbhelp'] = '<p>The database is where most of the Eset settings and data are stored and must be configured here.</p>
<p>The database name, username, and password are required fields; table prefix is optional.</p>
<p>The database name may contain only alphanumeric characters, dollar ($) and underscore (_).</p>
<p>If the database currently does not exist, and the user you specify has permission, Eset will attempt to create a new database with the correct permissions and settings.</p>
<p>This driver is not compatible with legacy MyISAM engine.</p>';
$string['nativemysqli'] = 'Improved MySQL (native/mysqli)';
$string['nativemysqlihelp'] = '<p>The database is where most of the Eset settings and data are stored and must be configured here.</p>
<p>The database name, username, and password are required fields; table prefix is optional.</p>
<p>The database name may contain only alphanumeric characters, dollar ($) and underscore (_).</p>
<p>If the database currently does not exist, and the user you specify has permission, Eset will attempt to create a new database with the correct permissions and settings.</p>';
$string['nativeoci'] = 'Oracle (native/oci)';
$string['nativeocihelp'] = 'Now you need to configure the database where most Eset data will be stored.
...
$string['nativepgsqlhelp'] = '<p>The database is where most of the Eset settings and data are stored and must be configured here.</p>
...
$string['nativesqlsrvhelp'] = 'Now you need to configure the database where most Eset data will be stored.
This database must already have been created and a username and password created to access it. Table prefix is mandatory.';
...
control panel or something.  Unfortunately this conflicts with the standard location for the Eset admin pages.  You can fix this by
renaming the admin directory in your installation, and putting that  new name here.  For example: <em>esetadmin</em>. This will fix admin links in Eset.';
$string['pathssubdataroot'] = '<p>A directory where Eset will store all file content uploaded by users.</p>
...
$string['pathssubdirroot'] = '<p>The full path to the directory containing the Eset code.</p>';
$string['pathssubwwwroot'] = '<p>The full address where Eset will be accessed i.e. the address that users will enter into the address bar of their browser to access Eset.</p>
<p>It is not possible to access Eset using multiple addresses. If your site is accessible via multiple addresses then choose the easiest one and set up a permanent redirect for each of the other addresses.</p>
...
$string['phpversionhelp'] = '<p>Eset requires a PHP version of at least 5.6.5 or 7.1 (7.0.x has some engine limitations).</p>
<p>You are currently running version {$a}.</p>
<p>You must upgrade PHP or move to a host with a newer version of PHP.</p>';
$string['releasenoteslink'] = 'For information about this version of Eset, please see the release notes at {$a}';
$string['safemode'] = 'Safe mode';
$string['safemodeerror'] = 'Eset may have trouble with safe mode on';
$string['safemodehelp'] = '<p>Eset may have a variety of problems with safe mode on, not least is that
...
<p>Safe mode is usually only enabled by paranoid public web hosts, so you may have
   to just find a new web hosting company for your Eset site.</p>
...
$string['sessionautostarthelp'] = '<p>Eset requires session support and will not function without it.</p>
...
$string['welcomep30'] = 'This release of the <strong>{$a->installername}</strong> includes the applications
    to create an environment in which <strong>Eset</strong> will operate, namely:';
$string['welcomep40'] = 'The package also includes <strong>Eset {$a->esetrelease} ({$a->esetversion})</strong>.';
...
$string['welcomep60'] = 'The following pages will lead you through some easy to follow steps to
    configure and set up <strong>Eset</strong> on your computer. You may accept the default
    settings or, optionally, amend them to suit your own needs.';
$string['welcomep70'] = 'Click the "Next" button below to continue with the set up of <strong>Eset</strong>.';
$string['wwwroot'] = 'Web address';
$string['wwwrooterror'] = 'The \'Web Address\' does not appear to be valid - this Eset installation doesn\'t appear to be there. The value below has been reset.';
