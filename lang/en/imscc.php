...
/**
 * Strings for component 'imscc', language 'en', branch 'ESET_20_STABLE'
 *
 * @package    core
 * @subpackage imscc
...
$string['cc2eset_checking_schema'] = 'CC format! Checking schema...';
$string['cc2eset_invalid_schema'] = 'The schema is not valid.';
$string['cc2eset_manifest_dont_load'] = 'Cannot load the XML manifest.';
$string['cc2eset_req_auth'] = 'ERROR: The Common Cartridge package requires authorization.';
$string['cc2eset_valid_schema'] = 'Schema valid!';
