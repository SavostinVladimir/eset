...
$string['err_noroles'] = 'There are no roles with the capability eset/course:markcomplete in this course.';
...
$string['manualcompletionbynote'] = 'Note: The capability eset/course:markcomplete must be allowed for a role to appear in the list.';
