...
/**
 * Strings for component 'user', language 'en', branch 'ESET_20_STABLE'
 *
 * @package   core_user
...
$string['esetnetprofile'] = 'EsetNet profile';
$string['esetnetprofile_help'] = 'This field is to link your EsetNet profile to Eset. It expects a WebFinger compliant URI';
...
$string['privacy:metadata:appid'] = 'The app ID, usually something like com.eset.esetmobile';
...
$string['privacy:metadata:esetnetprofile'] = 'The EsetNet profile for the user';
