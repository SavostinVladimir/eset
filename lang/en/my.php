...
$string['myeset'] = 'Dashboard';
$string['nocourses'] = 'No course information to show.';
$string['noguest'] = 'The Dashboard page is not available to guest users';
$string['pinblocks'] = 'Configure pinned blocks for my eset';
$string['pinblocksexplan'] = 'Any block settings you configure here will be visible (and non-editable) for any user of eset on their \'My Eset\' overview page.';
$string['defaultpage'] = 'Default My Eset page';
