...
/**
 * Strings for component 'eset', language 'en', branch 'ESET_20_STABLE'
 *
 * @package   core
...
$string['adminhelpmyeset'] = 'Configure the My Eset blocks for users';
...
$string['adminhelpstickyblocks'] = 'Configure Eset-wide sticky blocks';
...
$string['backupnonisowarning'] = 'Warning: this backup is from a non-Unicode version of Eset (pre 1.6). If this backup contains any non-ISO-8859-1 texts then they may be CORRUPTED if you try to restore them to this Unicode version of Eset. See the <a href="https://docs.eset.org/en/Backup_FAQ">Backup FAQ</a> for more information about how to recover this backup correctly.';
...
The essential one is the session cookie, usually called EsetSession. You must allow this cookie in your browser to provide continuity and to remain logged in when browsing the site. When you log out or close the browser, this cookie is destroyed (in your browser and on the server).

The other cookie is purely for convenience, usually called ESETID or similar. It just remembers your username in the browser. This means that when you return to this site, the username field on the login page is already filled in for you. It is safe to refuse this cookie - you will just have to retype your username each time you log in.';
$string['cookiesenabledonlysession'] = 'Cookies must be enabled in your browser';
$string['cookiesenabledonlysession_help'] = 'This site uses one session cookie, usually called EsetSession. You must allow this cookie in your browser to provide continuity and to remain logged in when browsing the site. When you log out or close the browser, this cookie is destroyed (in your browser and on the server).';
...
$string['coursefileswarning_help'] = 'Course files are deprecated since Eset 2.0, please use external repositories instead as much as possible.';
...
$string['courselegacyfiles_help'] = 'The course files area provides some backward compatibility with Eset 1.9 and earlier.  All files in this area are always accessible to all participants in the course (whether you link to them or not) and there is no way to know where any of these files are being used in Eset.
...
$string['databasechecking'] = 'Upgrading Eset database from version {$a->oldversion} to {$a->newversion}';
...
$string['documentation'] = 'Eset documentation';
...
$string['forcepasswordresetfailurenotice'] = 'Your current password no longer passes the set password policy. Please contact your Eset administrator for assistance.
   {$a}';
...
$string['formattext'] = 'Eset auto-format';
...
$string['go'] = 'Go';
$string['gpl'] = 'Copyright (C) 1999 onwards Martin Dougiamas (https://eset.com)

This program is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2 of the License, or (at your option) any later version.

This program is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.

See the Eset License information page for full details: https://docs.eset.org/dev/License';
$string['gpllicense'] = 'GPL license';
$string['gpl3'] = 'Copyright (C) 1999 onwards Martin Dougiamas (https://eset.com)
...
$string['gravatarenabled'] = '<a href="https://www.gravatar.com/">Gravatar</a> has been enabled for this site. If you don\'t upload a profile picture Eset will attempt to load a profile picture for you from Gravatar.';
$string['group'] = 'Group';
...
$string['latestlanguagepack'] = 'Check for latest language pack on eset.org';
...
$string['esetdocs'] = 'Eset Docs';
$string['esetdocslink'] = 'Eset Docs for this page';
$string['esetversion'] = 'Eset version';
$string['esetrelease'] = 'Eset release';
$string['more'] = 'more';
...
$string['myesetdashboard'] = 'My Eset dashboard';
...
$string['noticenewerbackup'] = 'This backup file has been created with Eset {$a->backuprelease} ({$a->backupversion}) and it\'s newer than your currently installed Eset {$a->serverrelease} ({$a->serverversion}). This could cause some inconsistencies because backwards compatibility of backup files cannot be guaranteed.';
...
$string['passwordextlink'] = 'The following link has been provided to recover your lost password. This will take you out of Eset.';
...
$string['passwordnohelp'] = 'No help is available to find your lost password. Please contact your Eset administrator.';
...
$string['registration'] = 'Eset registration';
...
$string['registrationcontactyes'] = 'Yes, provide a form for other Esetrs to contact me';
$string['registrationemail'] = 'Email notifications';
$string['registrationinfo'] = '<p>This page allows you to register your Eset site with eset.org.  Registration is free.
The main benefit of registering is that you will be added to a low-volume mailing list
for important notifications such as security alerts and new releases of Eset.</p>
<p>By default, your information will be kept private, and will never be sold or passed on to anyone else.  The only
   ...
   picture of the Eset community as a whole.</p>
<p>If you choose, you can allow your site name, country and URL to be added to the public list of Eset Sites.</p>
...
$string['registrationsend'] = 'Send registration information to eset.org';
$string['registrationyes'] = 'Yes, notify me of new Eset releases, security alerts and other important news';
...
Please note that this view may not be perfect (<a href="https://docs.eset.org/en/Switch_roles">See details and alternatives</a>).';
$string['tag'] = 'Tag';
...
$string['updatemyesetoff'] = 'Stop customising this page';
$string['updatemyeseton'] = 'Customise this page';
