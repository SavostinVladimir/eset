 ...
 * @package    core_h5p
 * @category   external
 * @copyright  2019 Carlos Escobedo <carlos@eset.com>
...
class core_h5p_external_testcase extends externallib_advanced_testcase {
    ...
    public function test_h5p_invalid_url() {
        ...
        // Check the warnings to be sure that h5pinvalidurl is the message by eset_exception.
    ...
    public function test_h5p_file_not_found() {
        ...
        $syscontext = \context_system::instance();
        $filenotfoundurl  = \eset_url::make_pluginfile_url(
            $syscontext->id,
            \core_h5p\file_storage::COMPONENT,
            'unittest',
            0,
