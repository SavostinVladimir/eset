...
class h5p_file_storage_testcase extends \advanced_testcase {
    ...
    /** @var \file_storage Core Eset file_storage associated to the H5P file_storage */
    protected $h5p_fs_fs;
    /** @var \context Eset context of the H5P file_storage */
    ...
    public function test_saveLibrary(): void {
        ...
        // Check that files are in the Eset file system.
    ...
    /**
     * Test that a single file is added to Eset files.
     */
    public function test_move_file(): void {
        ...
        if (!check_dir_exists($h5pcontentfolder, true, true)) {
            throw new eset_exception('error_creating_temp_dir', 'error', $h5pcontentfolder);
        }
        ...
        // Check the file doesn't exist in Eset files.
        ...
        // Check the file exist in Eset files.
    ...
    /**
     * Tests that the content folder of an H5P content is imported in the Eset filesystem.
     */
    public function test_moveContentDiretory(): void {
        ...
        if (!check_dir_exists($contentfolder, true, true)) {
            throw new eset_exception('error_creating_temp_dir', 'error', $contentfolder);
        }
        ...
        for ($numfolder = 1; $numfolder < $numfolders; $numfolder++) {
            ...
            if (!check_dir_exists($newfolder, true, true)) {
                throw new eset_exception('error_creating_temp_dir', 'error', $newfolder);
            }
