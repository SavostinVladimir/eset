...
/**
 * Testing the Eset local class for managing the H5P Editor.
 *
 * @package    core_h5p
 * @category   test
...
class editor_testcase extends advanced_testcase {
    ...
    protected function get_test_form() {
        ...
        return new class extends \esetform {
            /**
             * Form definition.
             */
    ...
    public function test_add_editor_to_form() {
        ...
        $expectedjs[] = (new \eset_url('/h5p/js/h5p_overrides.js' . $cachebuster))->out();
