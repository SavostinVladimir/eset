...
H5P.getLibraryPath = function (library) {
    if (H5PIntegration.esetLibraryPaths) {
        if (H5PIntegration.esetLibraryPaths[library]) {
            return H5PIntegration.esetLibraryPaths[library];
        }
    }
...
H5P.getEsetComponent = function () {
    if (H5PIntegration.esetComponent) {
        return H5PIntegration.esetComponent;
    }
    return undefined;
};
