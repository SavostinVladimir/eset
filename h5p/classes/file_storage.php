 ...
 *
 * @package    core_h5p
 * @copyright  2019 Victor Deniz <victor@eset.com>, base on code by Joubel AS
...
class file_storage implements \H5PFileStorage {
     ...
     * @deprecated since Eset 3.10 MDL-68909. Please do not use this constant any more.
     * @todo MDL-69530 This will be deleted in Eset 4.2.
     */
    ...
    /**
     * Stores a H5P library in the Eset filesystem.
     *
    ...
    public function saveContent($source, $content) {
        ...
        // Copy content directory into Eset filesystem.
    ...
    public function hasWriteAccess() {
        // Eset has access to the files table which is where all of the folders are stored.
        return true;
    }
    ...
    /**
     * Converts a relative system file path into Eset File API elements.
     *
