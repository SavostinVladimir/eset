...
/**
 * Eset's implementation of the H5P framework interface.
 *
 * @package    core_h5p
 * @copyright  2019 Mihail Geshoski <mihail@eset.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class framework implements \H5PFrameworkInterface {
     ...
     *               - name: The name of the platform, for instance "Eset"
    ...
    public function getLibraryFileUrl($libraryfoldername, $filename) {
        ...
        return \eset_url::make_pluginfile_url($context->id, 'core_h5p', 'libraries',
    ...
    public function isInDevMode() {
        return false; // Not supported (Files in eset not editable).
    }
