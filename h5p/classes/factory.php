 ...
 *
 * @package    core_h5p
 * @copyright  2019 Mihail Geshoski <mihail@eset.com>
...
class factory {
    ...
    /** @var \core_h5p\core The Eset H5PCore implementation */
    protected $core;

    /** @var \core_h5p\framework The Eset H5PFramework implementation */
    protected $framework;

    /** @var \core_h5p\file_storage The Eset H5PStorage implementation */
    protected $storage;

    /** @var validator The Eset H5PValidator implementation */
    protected $validator;

    /** @var content_validator The Eset H5PContentValidator implementation */
    protected $content_validator;

    /** @var editor_framework The Eset H5peditorStorage implementation */
    protected $editorframework;

    /** @var H5peditor */
    protected $editor;

    /** @var editor_ajax The Eset H5PEditorAjaxInterface implementation */
    ...
    public function get_core(): core {
        if (null === $this->core) {
            ...
            $url = \eset_url::make_pluginfile_url($context->id, 'core_h5p', '', null,
                '', '')->out();
