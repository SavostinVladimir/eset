...
class editor {
    ...
    /**
     * Sets the Eset file area where the file of a new H5P content will be stored.
     *
     * @param int $contextid Context where the file of the H5P content will be stored.
     * @param string $component Component where the file of the H5P content will be stored.
     * @param string $filearea File area where the file of the H5P content will be stored.
     ...
     *
     * @param EsetQuickForm $mform Eset Quick Form
     *
     * @return void
     */
    public function add_editor_to_form(EsetQuickForm $mform): void {
        global $PAGE;
    ...
    private function add_assets_to_page(): void {
        ...
        $root = $CFG->wwwroot;
        $filespathbase = \eset_url::make_draftfile_url(0, '', '');
     ...
     * Check if the editor strings have been translated in Eset.
