...
abstract class gradingform_controller {
     ...
     *
     * @param eset_url $returnurl optional URL of a page where the user should be sent once they are finished with editing
     * @return eset_url
     */
    public function get_editor_url(eset_url $returnurl = null) {
        ...
        return new eset_url('/grade/grading/form/'.$this->get_method_name().'/edit.php', $params);
    }
    ...
    public function update_definition(stdClass $definition, $usermodified = null) {
        ...
        if (!empty($this->definition->id)) {
            ...
            if (empty($record->descriptionformat)) {
                $record->descriptionformat = FORMAT_ESET; // field can not be empty
            }
     ...
     * @return string
     */
    abstract public function render_preview(eset_page $page);
 ...
 * and validation of this form element. See {@link EsetQuickForm_grading}
 *
 * @package    core_grading
...
abstract class gradingform_instance {
    ...
    public static function create_new($definitionid, $raterid, $itemid) {
        ...
        $instance->feedbackformat = FORMAT_ESET;
     ...
     *
     * @see EsetQuickForm_grading in lib/form/grading.php
     *
     * @param eset_page $page
