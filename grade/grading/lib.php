...
class grading_manager {
    ...
    public function set_active_method($method) {
        ...
        if (empty($method)) {
            ...
            if ('gradingform_'.$method !== clean_param('gradingform_'.$method, PARAM_COMPONENT)) {
                throw new eset_exception('invalid_method_name', 'core_grading');
            }
     ...
     * FEATURE_ADVANCED_GRADING and the user has the permission eset/grade:managegradingforms.
     *
     ...
     *
     * @param eset_url $returnurl optional URL of the page where the user should be sent back to
     * @return eset_url
     */
    public function get_management_url(eset_url $returnurl = null) {
        ...
        return new eset_url('/grade/grading/manage.php', $params);
    }
