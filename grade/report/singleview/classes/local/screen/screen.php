...
abstract class screen {
    ...
    public function process($data) {
        ...
        foreach ($data as $varname => $throw) {
            ...
            if ($matches[1] === 'exclude' && !has_capability('eset/grade:manage', $this->context)){
    ...
    protected function load_users() {
        ...
        $showonlyactiveenrol = $showonlyactiveenrol || !has_capability('eset/course:viewsuspendedusers', $this->context);
