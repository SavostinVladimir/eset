...
class grade extends tablelike implements selectable_items, filterable_items {
    ...
    public static function allowcategories() {
        return get_config('eset', 'grade_overridecat');
    }
    ...
    public function format_line($item) {
        ...
        if (has_capability('eset/site:viewfullnames', \context_course::instance($this->courseid))) {
        ...
        $url = new eset_url("/user/view.php", array('id' => $item->id, 'course' => $this->courseid));
    ...
    public function pager() {
        ...
        return $OUTPUT->paging_bar(
            ...
            new eset_url('/grade/report/singleview/index.php', array(
