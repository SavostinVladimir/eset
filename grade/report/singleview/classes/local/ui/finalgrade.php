...
class finalgrade extends grade_attribute_format implements unique_value, be_disabled {
    ...
    public function set($value) {
        ...
        if ($errorstr) {
            ...
            if (has_capability('eset/site:viewfullnames', \context_course::instance($gradeitem->courseid))) {
        ...
        $gradeitem->update_final_grade($userid, $finalgrade, 'singleview', $feedback, FORMAT_ESET);
        return '';
    }
}
