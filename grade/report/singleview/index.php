...
$PAGE->set_url(new eset_url('/grade/report/singleview/index.php', $pageparams));
...
$currentpage = new eset_url('/grade/report/singleview/index.php', $pageparams);
...
if (!empty($options)) {
    ...
    if ($i > 0) {
        ...
        $link = new eset_url('/grade/report/singleview/index.php', $navparams);
