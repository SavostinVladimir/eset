...
/**
 * First implementation of the preferences in the form of a esetform.
 * TODO add "reset to site defaults" button
 */
class grader_report_preferences_form extends esetform {
    ...
    function definition() {
        ...
        $canviewhidden = has_capability('eset/grade:viewhidden', $context);
...
//--------------------------------------------------------------------------------
        ...
        if (has_capability('gradereport/grader:view', $context)) {
            ...
            if (has_capability('eset/course:viewsuspendedusers', $context)) {
...
/// perform some extra eset validation
