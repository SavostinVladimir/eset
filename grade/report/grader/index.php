...
$PAGE->set_url(new eset_url('/grade/report/grader/index.php', array('id'=>$courseid)));
$PAGE->requires->yui_module('eset-gradereport_grader-gradereporttable', 'Y.M.gradereport_grader.init', null, null, true);
...
if (has_capability('eset/grade:edit', $context)) {
    ...
    $buttons = new single_button(new eset_url('index.php', $options), $string, 'get');
} else {
    $USER->gradeediting[$course->id] = 0;
    $buttons = '';
}
...
if ($data = data_submitted() and confirm_sesskey() and has_capability('eset/grade:edit', $context)) {
...
// User search
$url = new eset_url('/grade/report/grader/index.php', array('id' => $course->id));
