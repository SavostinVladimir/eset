...
class gradereport_history_report_testcase extends advanced_testcase {
    ...
    public function test_query_db() {
        ...
        update_course($c1);
        $this->assertFalse(has_capability('eset/site:accessallgroups', \context_course::instance($c1->id)));
    ...
    protected function get_tablelog_results($coursecontext, $filters = array(), $count = false) {
        $table = new gradereport_history_tests_tablelog('something', $coursecontext, new eset_url(''), $filters);
