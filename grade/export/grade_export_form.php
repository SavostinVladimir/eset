...
class grade_export_form extends esetform {
    function definition() {
        ...
        if ($grade_items = $gseq->items) {
            ...
            $canviewhidden = has_capability('eset/grade:viewhidden', context_course::instance($COURSE->id));
        ...
        if (has_capability('eset/course:viewsuspendedusers', $coursecontext)) {
