...
class edit_outcome_form extends esetform {
...
/// tweak the form - depending on existing data
    function definition_after_data() {
        ...
        if ($id = $mform->getElementValue('id')) {
            ...
            } else if (!has_capability('eset/grade:manage', context_system::instance())) {
                $mform->hardFreeze('standard');
            ...
            if (empty($courseid) or !has_capability('eset/grade:manage', context_system::instance())) {
                $mform->hardFreeze('standard');
            }
        }
    }
