...
/**
 * A esetform to allow the editing of a user's grade for a particular activity
 *
 * @package   core_grades
...
class edit_grade_form extends esetform {
...
//-------------------------------------------------------------------------------
    ...
    function definition_after_data() {
        ...
        if (!has_capability('eset/grade:manage', $context) and !has_capability('eset/grade:hide', $context)) {
