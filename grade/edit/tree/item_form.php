...
/**
 * A esetform allowing the editing of the grade options for an individual grade item
 *
 * @package   core_grades
...
class edit_item_form extends esetform {
...
/// visible elements
        ...
        if ((bool) get_config('eset', 'grade_report_showmin')) {
