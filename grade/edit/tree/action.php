...
switch ($action) {
    ...
    case 'lock':
        if ($eid and confirm_sesskey()) {
            if (!has_capability('eset/grade:manage', $context) and !has_capability('eset/grade:lock', $context)) {
    ...
    case 'unlock':
        if ($eid and confirm_sesskey()) {
            if (!has_capability('eset/grade:manage', $context) and !has_capability('eset/grade:unlock', $context)) {
    ...
    case 'resetweights':
        if ($eid && confirm_sesskey()) {
            ...
            if ($type != 'category' || $object->aggregation != GRADE_AGGREGATE_SUM ||
                    !has_capability('eset/grade:manage', $context)) {
