...
$url = new eset_url('/grade/edit/tree/grade.php', array('courseid'=>$courseid));
if ($id !== 0) {
    $url->param('id', $id);
}
if ($itemid !== 0) {
...
if (!has_capability('eset/grade:manage', $context)) {
    require_capability('eset/grade:edit', $context);
}
...
// form processing
    ...
    if (has_capability('eset/grade:manage', $context) or has_capability('eset/grade:edit', $context)) {
    ...
    if (has_capability('eset/grade:manage', $context) or has_capability('eset/grade:hide', $context)) {
    ...
    if (isset($data->locked) and !$grade_item->is_locked()) {
        if (($old_grade_grade->locked or $old_grade_grade->locktime)
          and (!has_capability('eset/grade:manage', $context) and !has_capability('eset/grade:unlock', $context))) {
            //ignore data

        } else if ((!$old_grade_grade->locked and !$old_grade_grade->locktime)
          and (!has_capability('eset/grade:manage', $context) and !has_capability('eset/grade:lock', $context))) {
            //ignore data
    ...
    if (isset($data->excluded) and has_capability('eset/grade:manage', $context)) {
