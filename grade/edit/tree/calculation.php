...
$url = new eset_url('/grade/edit/tree/calculation.php', array('id'=>$id, 'courseid'=>$courseid));
...
navigation_node::override_active_url(new eset_url('/grade/edit/tree/index.php',
    array('id'=>$course->id)));
