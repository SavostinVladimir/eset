...
class edit_scale_form extends esetform {
    function definition() {
        global $CFG;
        $mform =& $this->_form;
...
/// tweak the form - depending on existing data
    function definition_after_data() {
        ...
        if ($id = $mform->getElementValue('id')) {
            ...
            } else if (!has_capability('eset/course:managescales', context_system::instance())) {
            ...
            if (empty($courseid) or !has_capability('eset/course:managescales', context_system::instance())) {
                $mform->hardFreeze('standard');
            }
        }
    }
