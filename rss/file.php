...
/** NO_DEBUG_DISPLAY - bool, Disable eset debug and error messages. Set to false to see any errors during RSS generation */
define('NO_DEBUG_DISPLAY', true);

/** NO_ESET_COOKIES - bool, Disable the use of sessions/cookies - we recreate $USER for every call. */
...
// Work out which component in Eset we want (from the frankenstyle name).
