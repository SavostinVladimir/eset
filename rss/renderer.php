...
class core_rss_renderer extends plugin_renderer_base {
    ...
    public function user_reset_rss_token_confirmation() {
        ...
        $formcontinue = new single_button(new eset_url($managetokenurl, $optionsyes), get_string('reset'));
        $formcancel = new single_button(new eset_url($managetokenurl, $optionsno), get_string('cancel'), 'get');
