...
class login implements renderable, templatable {
    ...
    public $error;
    /** @var eset_url Forgot password URL. */
    ...
    public function __construct(array $authsequence, $username = '') {
        ...
        $this->forgotpasswordurl = new eset_url('/login/forgot_password.php');
        $this->loginurl = new eset_url('/login/index.php');
        $this->signupurl = new eset_url('/login/signup.php');
    ...
    public function export_for_template(renderer_base $output) {
        ...
        list($data->instructions, $data->instructionsformat) = external_format_text($this->instructions, FORMAT_ESET,
        ...
        $data->maintenance = format_text($this->maintenance, FORMAT_ESET);
