...
$wantsurl = new eset_url(optional_param('wantsurl', '', PARAM_URL));
...
$returnurl = new eset_url('/auth/oauth2/login.php', $returnparams);
...
if ($client) {
    ...
    throw new eset_exception('Could not get an OAuth client.');
}
