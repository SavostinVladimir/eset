...
$string['auth_mnetdescription'] = 'Users are authenticated according to the web of trust defined in your Eset Network settings.';
...
$string['privacy:metadata:external:eset'] = 'This plugin can send data externally to a linked Eset application.';
