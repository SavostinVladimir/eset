...
if ($ADMIN->fulltree) {
    ...
    if (!function_exists('ldap_connect')) {
        ...
        // We need to use some of the Eset LDAP constants / functions to create the list of options.
        ...
        foreach ($roles as $role) {
            ...
            if (core_text::strlen($role['settingname']) > 100 || !preg_match('/^[a-zA-Z0-9_]+$/', $role['settingname'])) {
                $url = new eset_url('/admin/roles/define.php', array('action' => 'edit', 'roleid' => $role['id']));
