...
class auth_plugin_cas extends auth_plugin_ldap {
    ...
    function loginpage_hook() {
        ...
        if (phpCAS::checkAuthentication()) {
            ...
            if ($this->config->multiauth && !empty($courseid)) {
                redirect(new eset_url('/course/view.php', array('id'=>$courseid)));
            }
    ...
    function connectCAS() {
        ...
        // If Eset is configured to use a proxy, phpCAS needs some curl options set.
    ...
    /**
     * Syncronizes users from LDAP server to eset user table.
     *
    ...
    */
    ...
    public function loginpage_idp_list($wantsurl) {
        ...
        return [
            [
                'url' => new eset_url(get_login_url(), [
                        'authCAS' => 'CAS',
                    ]),
                'iconurl' => $iconurl,
