...
class behat_auth extends behat_base {
     ...
     * @param eset_url|null $wantsurl optional, URL to go to after logging in.
     */
    public function i_log_in_as(string $username, eset_url $wantsurl = null) {
        ...
        $loginurl = new eset_url('/login/index.php');
        if ($wantsurl !== null) {
