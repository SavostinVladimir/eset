<?php
    ...
    if (isset($idp)) {
        if (isset($idplist[$idp])) {
            ...
            $targeturl = new eset_url('/auth/shibboleth/index.php');
            $idpinfo = $idplist[$idp];
    ...
    if (isloggedin() and !isguestuser()) {
        ...
        $logout = new single_button(new eset_url('/login/logout.php', $params), get_string('logout'), 'post');
        ...
        $templatedata = (object)[
            ...
            'guestloginurl' => new eset_url('/login/index.php'),
            'idps' => $idps,
            'instructions' => $instructions,
            'loginname' => $config->login_name ?? null,
            'logintoken' => \core\session\manager::get_login_token(),
            'loginurl' => new eset_url('/auth/shibboleth/login.php'),
            'showinstructions' => $showinstructions,
            'signupurl' => new eset_url('/login/signup.php'),
            'isvalid' => $isvalid
        ];
