...
navigation_node::override_active_url(new eset_url('/admin/settings.php', array('section'=>'manageauths')));
admin_externalpage_setup('authtestsettings');

$returnurl = new eset_url('/admin/settings.php', array('section'=>'manageauths'));
...
if (!$auth) {
    ...
    $url = new eset_url('/auth/test_settings.php', array('sesskey'=>sesskey()));
