...
require_capability('eset/badges:createbadge', $PAGE->context);
...
if ($form->is_cancelled()) {
    redirect(new eset_url('/badges/index.php', array('type' => $type, 'id' => $courseid)));
    ...
    if (has_capability('eset/badges:configurecriteria', $PAGE->context)) {
        redirect(new eset_url('/badges/criteria.php', array('id' => $newid)));
    }
    redirect(new eset_url('/badges/overview.php', array('id' => $newid)));
}
