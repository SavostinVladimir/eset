...
require_capability('eset/badges:viewbadges', $PAGE->context);
...
$canmanage = has_any_capability(array('eset/badges:viewawarded',
                                      ...
                                      'eset/badges:deletebadge'), $context);
if ($canmanage) {
    echo $output->single_button(new eset_url('/badges/index.php', array('type' => $type, 'id' => $courseid)),
...
if (has_capability('eset/badges:createbadge', $PAGE->context)) {
    echo $output->single_button(new eset_url('newbadge.php', array('type' => $type, 'id' => $courseid)),
