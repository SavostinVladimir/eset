...
if ($action == 'message') {
    require_capability('eset/badges:configuremessages', $context);
} else {
...
$currenturl = new eset_url('/badges/edit.php', array('id' => $badge->id, 'action' => $action));
...
if ($form->is_cancelled()) {
    redirect(new eset_url('/badges/overview.php', array('id' => $badgeid)));
