...
$return = new eset_url('/badges/criteria.php', array('id' => $badgeid));
...
$PAGE->navbar->add($badge->name, new eset_url('overview.php', array('id' => $badge->id)))->add(get_string('criteria_' . $type, 'badges'));
...
if (!empty($addcourse)) {
    if ($data = $mform->get_data()) {
        ...
        redirect(new eset_url('/badges/criteria_settings.php',
