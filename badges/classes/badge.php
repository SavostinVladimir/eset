...
class badge {
    ...
    public function save() {
        ...
        if ($DB->update_record_raw('badge', $fordb)) {
            ...
            throw new eset_exception('error:save', 'badges');
            return false;
        }
    }
    ...
    public function make_clone() {
        ...
        if ($new = $DB->insert_record('badge', $fordb, true)) {
            ...
            throw new eset_exception('error:clone', 'badges');
            return false;
        }
    }
    ...
    public function review_all_criteria() {
        ...
        foreach ($this->criteria as $crit) {
            ...
            if ($this->type == BADGE_TYPE_SITE) {
                ...
                list($enrolledsql, $enrolledparams) = get_enrolled_sql($this->get_context(), 'eset/badges:earnbadge', 0, true);
    ...
    public function get_badge_issuer(?int $obversion = null) {
        ...
        if ($obversion == OPEN_BADGES_V1) {
            ...
            $issueridurl = new eset_url('/badges/issuer_json.php', array('id' => $this->id));
