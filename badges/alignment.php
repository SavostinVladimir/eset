...
$currenturl = new eset_url('/badges/alignment.php', array('id' => $badge->id));
...
$url = new eset_url('/badges/alignment.php', array('id' => $badge->id, 'action' => $action, 'alignmentid' => $alignmentid));
...
if ($alignmentid || $action == 'add' || $action == 'edit') {
    ...
    if (!$badge->is_active() && !$badge->is_locked()) {
        $urlbutton = new eset_url('/badges/alignment.php', array('id' => $badge->id, 'action' => 'add'));
