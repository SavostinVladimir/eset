...
if ($delete && has_capability('eset/badges:configurecriteria', $context)) {
    ...
    if (!$confirm) {
        ...
        echo $OUTPUT->header();
        $formcontinue = new single_button(new eset_url('/badges/criteria_action.php', $optionsyes), get_string('yes'));
