...
class insights_generator {
     ...
     * @param  \stdClass   $user
     * @param  \eset_url $insighturl    The insight URL
     * @param  string      $fullmessage
     * @param  string      $fullmessagehtml
     * @return null
     */
    private function notification(\context $context, \stdClass $user, \eset_url $insighturl, string $fullmessage, string $fullmessagehtml) {
     ...
     * @param  \context                     $context
     * @param  \stdClass                    $user
     * @return array Three items array with formats [\eset_url, string, string]
     */
    private function prediction_info(\core_analytics\prediction $prediction, \context $context, \stdClass $user) {
        ...
        foreach ($actions as $action) {
            if (!$action->get_url()->get_param('forwardurl')) {
                ...
                $actiondoneurl = new \eset_url('/report/insights/done.php', $params);
