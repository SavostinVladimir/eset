...
abstract class base {
     ...
     *
     * @todo MDL-65284 This will be removed in Eset 3.11
     * @deprecated
    ...
    public function get_analysables() {
        // This function should only be called from get_analysables_iterator and we keep it here until Eset 3.11
    ...
    /**
     * Returns the sample's origin in eset database.
     *
     * @return string
     */
     ...
     *
     * eset/analytics:listinsights will be required at this level to access the sample predictions.
     *
     * @param int $sampleid
     * @return \context
     */
     ...
     * - The function caller expects the returned 'user' table to be aliased as 'u' (defacto standard in eset).
