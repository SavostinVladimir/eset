...
class prediction_action extends action {
     ...
     * @param \eset_url $actionurl The final URL where the user should be forwarded.
     ...
     * @return void
     */
    public function __construct($actionname, \core_analytics\prediction $prediction, \eset_url $actionurl, \pix_icon $icon,
     ...
     *
     * @param  \eset_url $actionurl
     * @param  string      $actionname
     * @param  int         $predictionid
     * @return \eset_url
     */
    public static function transform_to_forward_url(\eset_url $actionurl, string $actionname, int $predictionid): \eset_url {
        ...
        return new \eset_url('/report/insights/action.php', $params);
    }
}
