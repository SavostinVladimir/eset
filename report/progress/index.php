...
$url = new eset_url('/report/progress/index.php', array('course'=>$id));
if ($sort !== '') {
    $url->param('sort', $sort);
}
if ($format !== '') {
...
$initialsbarurl = new eset_url($url);
...
foreach($progress as $user) {
    ...
    foreach($activities as $activity) {
        ...
        if ($csv) {
            ...
            if (has_capability('eset/course:overridecompletion', $context) &&
                ...
                $url = new eset_url($PAGE->url, ['sesskey' => sesskey()]);
