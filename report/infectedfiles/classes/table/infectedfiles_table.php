...
class infectedfiles_table extends \table_sql implements \renderable {
     ...
     * @param \eset_url $url page url
     * @param int $page current page
     * @param int $perpage number or record per page
     * @throws \coding_exception
     */
    public function __construct($uniqueid, \eset_url $url, $page = 0, $perpage = 30) {
     ...
     * @param \eset_url $url
     */
    protected function define_table_configs(\eset_url $url) {
        // Set table url.
    ...
    protected function col_author($row) : string {
        ...
        $url = new \eset_url('/user/profile.php', ['id' => $row->userid]);
    ...
    protected function col_actions($row) : string {
        ...
        $links = '';
        $managefilepage = new \eset_url('/report/infectedfiles/index.php');

        // Download.
        $downloadparams = ['file' => $fileid, 'action' => 'download', 'sesskey' => sesskey()];
        $downloadurl = new \eset_url($managefilepage, $downloadparams);
        ...
        $deleteurl = new \eset_url($managefilepage, $deleteparams);
    ...
    public function display($pagesize, $useinitialsbar, $downloadhelpbutton='') {
        ...
        $deleteallurl = new \eset_url($managefilepage, $deleteallparams);
        ...
        $downloadallurl = new \eset_url($managefilepage, $downloadallparams);
