...
$url = new eset_url("/report/loglive/index.php", $params);
...
if ($page == 0 && !empty($logreader)) {
    ...
    $PAGE->requires->yui_module('eset-report_loglive-fetchlogs', 'Y.M.report_loglive.FetchLogs.init', array($jsparams));
}

$strlivelogs = get_string('livelogs', 'report_loglive');
$strupdatesevery = get_string('updatesevery', 'eset', $refresh);
