...
if ($USER->id != $user->id and has_capability('eset/user:viewuseractivitiesreport', $personalcontext)
...
$table->head = array(get_string('periodending','eset',$period),$param->line1,$param->line2,$param->line3);
