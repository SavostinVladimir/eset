...
class report_stats_events_testcase extends advanced_testcase {
     ...
     *
     * It's not possible to use the eset API to simulate the viewing of stats report, so here we
     ...
     *
     * It's not possible to use the eset API to simulate the viewing of user stats report, so here we
     * simply create the event and trigger it.
     */
