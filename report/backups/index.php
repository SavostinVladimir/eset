...
if ($courseid) {
    ...
    if (isset($backup)) {
        ...
        $baseurl = new eset_url('/report/backups/index.php', array('courseid' => $courseid));
...
foreach ($rs as $backuprow) {
    ...
    $backuplogsurl = new eset_url('/report/backups/index.php', array('courseid' => $backuprow->courseid));
