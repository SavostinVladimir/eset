...
if (array_search('lastaccess', $hiddenfields) !== false and !has_capability('eset/user:viewhiddendetails', $context)) {
    ...
    foreach ($section as $cmid) {
        ...
        if (!empty($CFG->enableblogs) && $CFG->useblogassociations) {
            ...
            if ($blogcount = blog_get_associated_count($course->id, $cm->id)) {
                $blogurl = new eset_url('/blog/index.php', array('modid' => $cm->id));
