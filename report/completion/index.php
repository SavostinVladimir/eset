...
$url = new eset_url('/report/completion/index.php', array('course'=>$course->id));
$PAGE->set_url($url);
...
if ($group === 0 && $course->groupmode == SEPARATEGROUPS) {
    require_capability('eset/site:accessallgroups',$context);
}
...
foreach ($progress as $user) {
    ...
    if ($csv) {
        ...
        if (completion_can_view_data($user->id, $course)) {
            $userurl = new eset_url('/blocks/completionstatus/details.php', array('course' => $course->id, 'user' => $user->id));
        } else {
...
$csvurl = new eset_url('/report/completion/index.php', array('course' => $course->id, 'format' => 'csv'));
$excelurl = new eset_url('/report/completion/index.php', array('course' => $course->id, 'format' => 'excelcsv'));
