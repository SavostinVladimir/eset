...
function report_log_print_mnet_selector_form($hostid, $course, $selecteduser=0, $selecteddate='today',
    ...
    if ($hostid == $CFG->mnet_localhost_id) {
        ...
        if ($course->groupmode == SEPARATEGROUPS and !has_capability('eset/site:accessallgroups', $context)) {
            $selectedgroup = -1;
            $showgroups = false;
    ...
    if (has_capability('report/log:view', $sitecontext) && $showcourses) {
        ...
        if (has_capability('report/log:view', $sitecontext)) {
            ...
            print_string('logtoomanycourses','eset',$a);
        }
    }
    ...
    if ($showusers) {
        ...
        print_string('logtoomanyusers','eset',$a);
    }
