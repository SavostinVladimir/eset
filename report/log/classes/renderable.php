...
class report_log_renderable implements renderable {
    ...
    /** @var eset_url url of report page */
    public $url;
     ...
     * @param eset_url|string $url (optional) page url.
    ...
    public function get_group_list() {
        ...
        if (($groupmode == VISIBLEGROUPS) ||
                ($groupmode == SEPARATEGROUPS and has_capability('eset/site:accessallgroups', $context))) {
            // Get all groups.
        ...
        if ($this->showusers) {
            if ($courseusers) {
                foreach ($courseusers as $courseuser) {
                     $users[$courseuser->id] = fullname($courseuser, has_capability('eset/site:viewfullnames', $context));
                }
            }
