...
$string['check_themedesignermode_details'] = 'This is often the cause of slow Eset sites. <p>On average it might take at least twice the amount of CPU to run a Eset site with theme designer mode enabled.</p>';
