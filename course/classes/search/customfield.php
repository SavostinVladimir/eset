 ...
 *
 * @package core_course
 * @copyright Toni Barbera <toni@eset.com>
...
class customfield extends \core_search\base {
     ...
     * @return \eset_recordset|null Recordset or null if no change possible
     */
    ...
    public function get_context_url(\core_search\document $doc) {
        return new \eset_url('/course/view.php', array('id' => $doc->get('courseid')));
    }
