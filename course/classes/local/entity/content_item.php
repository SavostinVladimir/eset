...
class content_item {
    ...
    /** @var \eset_url $link the url for the content item's setup page (usually mod/edit.php). */
    private $link;
     ...
     * @param \eset_url $link The URL to the creation page, with any item specific params
     * @param string $icon HTML containing the icon for the item
     * @param string $help The description of the item.
     * @param int $archetype the archetype for the content item (see MOD_ARCHETYPE_X definitions in lib/esetlib.php).
     * @param string $componentname the name of the component/plugin with which this content item is associated.
     */
    public function __construct(int $id, string $name, title $title, \eset_url $link, string $icon, string $help,
     ...
     * @return \eset_url
     */
    public function get_link(): \eset_url {
        return $this->link;
    }
