...
class course_handler extends \core_customfield\handler {
    ...
    public function can_configure() : bool {
        return has_capability('eset/course:configurecustomfields', $this->get_configuration_context());
    }
    ...
    public function can_edit(field_controller $field, int $instanceid = 0) : bool {
        if ($instanceid) {
            ...
            return (!$field->get_configdata_property('locked') ||
                    has_capability('eset/course:changelockedcustomfields', $context));
        } else {
            $context = $this->get_parent_context();
            return (!$field->get_configdata_property('locked') ||
                guess_if_creator_will_have_course_capability('eset/course:changelockedcustomfields', $context));
        }
    }
    ...
    public function can_view(field_controller $field, int $instanceid) : bool {
        ...
        if ($visibility == self::NOTVISIBLE) {
            ...
            return has_capability('eset/course:update', $this->get_instance_context($instanceid));
        } else {
            return true;
        }
    }
     ...
     *
     * @return \eset_url The URL to configure custom fields for this component
     */
    public function get_configuration_url() : \eset_url {
        return new \eset_url('/course/customfield.php');
    }
