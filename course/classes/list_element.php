...
class core_course_list_element implements IteratorAggregate {
    ...
    public function can_edit() {
        return has_capability('eset/course:update', $this->get_context());
    }
    ...
    public function can_change_visibility() {
        ...
        return has_all_capabilities(array('eset/course:visibility', 'eset/course:viewhiddencourses'),
            $this->get_context());
    }
    ...
    public function can_review_enrolments() {
        return has_capability('eset/course:enrolreview', $this->get_context());
    }
    ...
    public function can_backup() {
        return has_capability('eset/backup:backupcourse', $this->get_context());
    }
    ...
    public function can_restore() {
        return has_capability('eset/restore:restorecourse', $this->get_context());
    }
}
