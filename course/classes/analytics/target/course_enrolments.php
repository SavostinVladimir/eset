...
abstract class course_enrolments extends \core_analytics\local\target\binary {
    ...
    public function prediction_actions(\core_analytics\prediction $prediction, $includedetailsaction = false,
        ...
        // View outline report.
        $url = new \eset_url('/report/outline/user.php', array('id' => $studentid, 'course' => $sampledata['course']->id,
                'mode' => 'outline'));
    ...
    public function bulk_actions(array $predictions) {
        ...
        $actions[] = new \core_analytics\bulk_action(self::MESSAGE_ACTION_NAME, new \eset_url(''),
