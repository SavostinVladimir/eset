...
class restore_format_topics_plugin extends restore_format_plugin {
    ...
    /**
     * Checks if backup file was made on Eset before 3.3 and we should respect the 'numsections'
    ...
    public function after_restore_course() {
        ...
        if (!$this->need_restore_numsections()) {
            // Backup file was made in Eset 3.3 or later, we don't need to process 'numsecitons'.
            return;
        }
