...
?>
  ...
  eset.php, which you can also do, but this separate file is recommended
...
If these files exist, Eset will use them to set up database tables when you
...
* yourformat/version.php
  ...
  $plugin->requires = 2006092801; // Required Eset version
  ?>
...
If this file exists, Eset refreshes your format's capabilities
...
* yourformat/styles.php
  ...
  If this file exists it will be included in the CSS Eset generates.
