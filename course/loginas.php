...
$url = new eset_url('/course/loginas.php', array('id'=>$id));
$PAGE->set_url($url);
...
if (\core\session\manager::is_loggedinas()) {
    ...
    redirect(new eset_url($url, array('redirect'=>1)));
}
...
if (has_capability('eset/user:loginas', $systemcontext)) {
    ...
    require_capability('eset/user:loginas', $coursecontext);
    if (is_siteadmin($userid)) {
        print_error('nologinas');
    }
