YUI.add('eset-course-categoryexpander', function (Y, NAME) {
 ...
 *
 * @module eset-course-categoryexpander
 */
 ...
 *
 * @constructor
 * @class Y.Eset.course.categoryexpander
 */
...
var CSS = {
    ...
    NS = Y.namespace('Eset.course.categoryexpander'),
    TYPE_CATEGORY = 0,
    TYPE_COURSE = 1,
...
NS.setup_keyboard_listeners = function() {
    ...
    Y.log('Setting the tabindex for all expandable course nodes', 'info', 'eset-course-categoryexpander');
...
NS.expand_category = function(categorynode) {
    ...
    Y.use('io-base', 'json-parse', 'eset-core-notification', 'anim-node-plugin', function() {
...
NS.update_collapsible_actions = function(ancestor) {
    ...
    if (foundmaximisedchildren) {
        ...
        togglelink.setHTML(M.util.get_string('collapseall', 'eset'))
        ...
        togglelink.setHTML(M.util.get_string('expandall', 'eset'))
