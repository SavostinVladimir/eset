YUI.add('eset-course-util-cm', function (Y, NAME) {

/**
 * A collection of utility classes for use with course modules.
 *
 * @module eset-course-util
 * @submodule eset-course-util-cm
 */

Y.namespace('Eset.core_course.util.cm');

/**
 * A collection of utility classes for use with course modules.
 *
 * @class Eset.core_course.util.cm
 * @static
 */
Y.Eset.core_course.util.cm = {
    CONSTANTS: {
...
}, '@VERSION@', {"requires": ["node", "eset-course-util-base"]});
