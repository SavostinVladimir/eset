YUI.add('eset-course-coursebase', function (Y, NAME) {

/**
 * The coursebase class to provide shared functionality to Modules within
 * Eset.
 *
 * @module eset-course-coursebase
 */
...
M.course.format.get_section_selector = M.course.format.get_section_selector || function() {
    ...
    Y.log('section_node and section_class are not defined in M.course.format.get_config', 'warn', 'eset-course-coursebase');
    return null;
};
...
M.course.format.get_containernode = M.course.format.get_containernode || function() {
    ...
    if (config.container_node) {
        ...
        Y.log('container_node is not defined in M.course.format.get_config', 'warn', 'eset-course-coursebase');
    }
};
...
M.course.format.get_containerclass = M.course.format.get_containerclass || function() {
    ...
    if (config.container_class) {
        ...
        Y.log('container_class is not defined in M.course.format.get_config', 'warn', 'eset-course-coursebase');
    }
};
...
M.course.format.get_sectionnode = M.course.format.get_sectionnode || function() {
    ...
    if (config.section_node) {
        ...
        Y.log('section_node is not defined in M.course.format.get_config', 'warn', 'eset-course-coursebase');
    }
};
...
M.course.format.get_sectionclass = M.course.format.get_sectionclass || function() {
    ...
    if (config.section_class) {
        ...
        Y.log('section_class is not defined in M.course.format.get_config', 'warn', 'eset-course-coursebase');
    }
};
