...
$url = new eset_url('/course/editcategory.php');
if ($id) {
    ...
    navigation_node::override_active_url(new eset_url('/course/editcategory.php', array('parent' => $parent)));
...
$manageurl = new eset_url('/course/management.php');
