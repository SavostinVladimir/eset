 ...
 * @package    core
 * @subpackage course
 * @deprecated Eset 2.8 MDL-46428 - Now redirects to mod.php.
...
debugging('Please use eset_url(\'/course/mod.php\', array(\'duplicate\' => $cmid
    , \'id\' => $courseid, \'sesskey\' => sesskey(), \'sr\' => $sectionreturn)))
    instead of new eset_url(\'/course/modduplicate.php\', array(\'cmid\' => $cmid
    , \'course\' => $courseid, \'sr\' => $sectionreturn))', DEBUG_DEVELOPER);

redirect(new eset_url('/course/mod.php', array('duplicate' => $cmid, 'id' => $courseid,
