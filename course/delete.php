...
navigation_node::override_active_url(new eset_url('/course/management.php', array('categoryid'=>$course->category)));
...
if (!async_helper::is_async_pending($id, 'course', 'backup')) {
    ...
    $continueurl = new eset_url('/course/delete.php', array('id' => $course->id, 'delete' => md5($course->timemodified)));
