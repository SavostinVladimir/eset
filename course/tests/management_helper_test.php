...
class core_course_management_helper_test extends advanced_testcase {
    ...
    /** Category management capability: eset/category:manage */
    const CATEGORY_MANAGE = 'eset/category:manage';
    /** View hidden category capability: eset/category:viewhiddencategories */
    const CATEGORY_VIEWHIDDEN = 'eset/category:viewhiddencategories';
    /** View course capability: eset/course:visibility */
    const COURSE_VIEW = 'eset/course:visibility';
    /** View hidden course capability: eset/course:viewhiddencourses */
    const COURSE_VIEWHIDDEN = 'eset/course:viewhiddencourses';
     ...
     *
     * In order to show/hide the user must have eset/category:manage on the parent context.
     * In order to view hidden categories the user must have eset/category:viewhiddencategories
     */
    ...
    public function test_get_category_listitem_actions() {
        ...
        $PAGE->set_url(new eset_url('/course/management.php'));
