...
class core_course_category_testcase extends advanced_testcase {
    ...
    public function test_name_idnumber_exceptions() {
        try {
            ...
            $this->assertInstanceOf('eset_exception', $e);
        }
    ...
    public function test_visibility() {
        $this->assign_capability('eset/category:viewhiddencategories');
        $this->assign_capability('eset/category:manage');
    ...
    public function test_delete() {
        ...
        $this->assign_capability('eset/category:manage');
        $this->assign_capability('eset/course:create');
        ...
        $this->assign_capability('eset/course:create', CAP_ALLOW, context_coursecat::instance($category3->id));
        $this->assign_capability('eset/category:manage');
        ...
        // Add necessary capabilities.
        $this->assign_capability('eset/course:delete', CAP_ALLOW, context_coursecat::instance($category3->id));
    ...
    public function test_get_search_courses() {
        ...
        // Add necessary capabilities.
        $this->assign_capability('eset/course:create', CAP_ALLOW, context_coursecat::instance($cat2->id));
        // Do another search with restricted capabilities.
        $reqcaps = array('eset/course:create');
    ...
    public function test_coursecat_is_uservisible() {
        ...
        // User $user should still have the eset/category:viewhiddencategories capability.
        $this->assertTrue($category1->is_uservisible($userid));
        $this->assertTrue($category2->is_uservisible($userid));

        $this->assign_capability('eset/category:viewhiddencategories', CAP_INHERIT);
    ...
    public function test_current_user_coursecat_get() {
        ...
        // Expecting to get an exception as this new user does not have the eset/category:viewhiddencategories capability.
