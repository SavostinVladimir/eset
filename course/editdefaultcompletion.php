...
navigation_node::override_active_url(new eset_url('/course/completion.php', array('id' => $course->id)));
$PAGE->set_url(new eset_url('/course/editdefaultcompletion.php', ['id' => $courseid]));
$PAGE->set_title($course->shortname);
$PAGE->set_heading($course->fullname);
$PAGE->set_pagelayout('admin');

require_capability('eset/course:manageactivities', context_course::instance($course->id));
...
$returnurl = new eset_url('/course/defaultcompletion.php', ['id' => $course->id]);
if (empty($modules)) {
    redirect($returnurl);
}
