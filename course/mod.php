...
if (!empty($add)) {
    ...
    if (!$confirm or !confirm_sesskey()) {
        ...
        $formcontinue = new single_button(new eset_url("$CFG->wwwroot/course/mod.php", $optionsyes), get_string('yes'));
...
if ((!empty($movetosection) or !empty($moveto)) and confirm_sesskey()) {
    ...
    require_login($course, false, $cm);
    require_capability('eset/course:activityvisibility', $cm->context);
