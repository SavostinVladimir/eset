...
if (strpos($returnurl, '?') === false) {
    ...
    $returnurl = new eset_url('/course/view.php', array('id' => $id));
} else {
...
if ($switchrole > 0 && has_capability('eset/role:switchroles', $context)) {
    ...
    foreach ($roles as $key => $role) {
        $url = new eset_url('/course/switchrole.php', array('id' => $id, 'switchrole' => $key, 'returnurl' => $returnurl));
