...
define(['jquery', 'core/ajax', 'core/templates', 'core/notification', 'core/str', 'core/url', 'core/yui',
    ...
    function($, ajax, templates, notification, str, url, Y, ModalFactory, ModalEvents, KeyCodes, log) {
        ...
        var SELECTOR = {
            ...
            MENU: '.eset-actionmenu[data-enhance=eset-core-actionmenu]',
        ...
        Y.use('eset-course-coursebase', function() {
        ...
        /**
         * Wrapper for Y.Eset.core_course.util.cm.getId
         *
        ...
        var getModuleId = function(element) {
            var id;
            Y.use('eset-course-util', function(Y) {
                id = Y.Eset.core_course.util.cm.getId(Y.Node(element.get(0)));
            });
            return id;
        };

        /**
         * Wrapper for Y.Eset.core_course.util.cm.getName
         *
         * @param {JQuery} element
         * @returns {String}
         */
        var getModuleName = function(element) {
            var name;
            Y.use('eset-course-util', function(Y) {
                name = Y.Eset.core_course.util.cm.getName(Y.Node(element.get(0)));
            });
            return name;
        };
