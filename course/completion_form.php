 ...
 */
class course_completion_form extends esetform {
    ...
    public function definition() {
        ...
        $roles = get_roles_with_capability('eset/course:markcomplete', CAP_ALLOW, context_course::instance($course->id, IGNORE_MISSING));
