...
$capabilities = array('eset/course:create', 'eset/category:manage');
...
$courseurl = core_course_category::user_top() ? new eset_url('/course/index.php') : null;
$PAGE->navbar->add($strcourses, $courseurl);
$PAGE->navbar->add($strsearch, new eset_url('/course/search.php'));
if (!empty($search)) {
...
if (empty($searchcriteria)) {
    ...
    if ((can_edit_in_category() || !empty($usercatlist))) {
        $aurl = new eset_url('/course/management.php', $searchcriteria);
