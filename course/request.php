...
$url = new eset_url('/course/request.php');
$return = optional_param('return', null, PARAM_ALPHANUMEXT);
$categoryid = optional_param('category', null, PARAM_INT);
if ($return === 'management') {
    $url->param('return', $return);
    $returnurl = new eset_url('/course/management.php', array('categoryid' => $CFG->defaultrequestcategory));
} else {
    $returnurl = new eset_url('/course/index.php');
}
...
if ($CFG->lockrequestcategory) {
    ...
    $list = core_course_category::make_categories_list('eset/course:request');
...
require_capability('eset/course:request', $context);
