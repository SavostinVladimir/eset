...
$PAGE->navbar->add($strrecentactivity, new eset_url('/course/recent.php', array('id'=>$course->id)));
    ...
    foreach ($activities as $key => $activity) {
        ...
        if (($activity->type == 'section') && ($param->sortby == 'default')) {
            ...
            if ($param->sortby == 'default') {
                ...
                $link = html_writer::link(new eset_url("/mod/$cm->modname/view.php",
            ...
            if (!isset($viewfullnames[$activity->cmid])) {
                ...
                $viewfullnames[$activity->cmid] = has_capability('eset/site:viewfullnames', $cm_context);
            }
