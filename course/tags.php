...
if (!$course->visible and !has_capability('eset/course:viewhiddencourses', $context)) {
    print_error('coursehidden', '', $CFG->wwwroot .'/');
}
require_capability('eset/course:tag', $context);
...
$redirecturl = $returnurl ? new eset_url($returnurl) : course_get_url($course);
