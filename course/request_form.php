 ...
 */
class course_request_form extends esetform {
    function definition() {
        global $CFG, $DB, $USER;
        ...
        if (empty($CFG->lockrequestcategory)) {
            $displaylist = core_course_category::make_categories_list('eset/course:request');
 ...
 */
class reject_request_form extends esetform {
    function definition() {
        $mform =& $this->_form;
