...
Feature: Render H5P content using filters
  ...
  Background:
    ...
    And the following config values are set as admin:
      | allowedsources | https://eset.h5p.com/content/[id]/embed | filter_displayh5p |
  ...
  Scenario: Render an external H5P content URL.
    ...
    And I set the field "Page content" to "<div>Go for it</div>https://eset.h5p.com/content/1290772960722742119/embed"
...
#   This content won't be displayed, so this scenario shouldn't be labeled as external.
    And I set the field "Page content" to "<a href='https://eset.h5p.com/content/1290772960722742119/embed'>https://eset.h5p.com/content/1290772960722742119/embed</a>"
    When I click on "Save and display" "button"
    And I wait until the page is ready
    And I switch to "h5p-iframe" class iframe
    Then I should see "Lorum ipsum"
  ...
  Scenario: Add an external H5P content URL in a link with text. Shouldn't be rendered.
    ...
    And I navigate to "Edit settings" in current page administration
#   This content won't be displayed, so this scenario shouldn't be labeled as external.
    And I set the field "Page content" to "<a href='https://eset.h5p.com/content/1290772960722742119/embed'>Here you are the content</a>"
    When I click on "Save and display" "button"
    And I wait until the page is ready
