...
class filter_urltolink extends eset_text_filter {
    ...
    protected function convert_urls_into_links(&$text) {
        ...
        // TODO: this check should be a environment requirement in Eset 2.0, as far as unicode
        ...
        // Unicode check, negative assertion and other bits from Eset.
        ...
        if (get_config('filter_urltolink', 'embedimages')) {
            ...
            // this may be useful only if somebody relies on the fact the links in FORMAT_ESET get converted
 ...
 *
 * This plugin is intended for automatic conversion of image URLs when FORMAT_ESET used.
 *
 * @param  $link
 * @return string
 */
