...
/**
 * This class looks for email addresses in Eset text and
 * hides them using the Eset obfuscate_text function.
 */
class filter_emailprotect extends eset_text_filter {
