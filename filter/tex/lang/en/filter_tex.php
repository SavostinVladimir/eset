...
/**
 * Strings for component 'filter_tex', language 'en', branch 'ESET_20_STABLE'
 *
 * @package    filter
 * @subpackage tex
...
$string['pathmimetexdesc'] = 'Eset will use its own mimetex binary unless another valid path is specified.';
