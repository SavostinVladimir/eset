...
/**
 * Eset - Filter for converting TeX expressions to cached gif images
 *
 * This Eset text filter converts TeX expressions delimited
...
function filter_text_image($imagefile, $tex, $height, $width, $align, $alt) {
    ...
    if (!file_exists("$CFG->dataroot/filter/tex/$imagefile") && has_capability('eset/site:config', context_system::instance())) {
 ...
 * TeX filtering class.
 */
class filter_tex extends eset_text_filter {
