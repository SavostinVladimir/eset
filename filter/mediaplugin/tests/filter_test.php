 ...
 * @category   phpunit
 * @copyright  2011 Rossiani Wijaya <rwijaya@eset.com>
...
class filter_mediaplugin_testcase extends advanced_testcase {
    ...
    function test_filter_mediaplugin_link() {
        ...
        $longurl = '<a href="http://eset/.mp4">my test file</a>';
        $longhref = '';
        ...
        $longurl = '<a href="http://eset/' . $longhref . '.mp4">my test file</a>';

        $validtexts = array (
            '<a href="http://eset.org/testfile/test.mp3">test mp3</a>',
            '<a href="http://eset.org/testfile/test.ogg">test ogg</a>',
            '<a id="movie player" class="center" href="http://eset.org/testfile/test.mp4">test mp4</a>',
            '<a href="http://eset.org/testfile/test.webm">test</a>',
            ...
            '<a class="_blanktarget" href="http://eset.org/testfile/test.flv?d=100x100">test flv</a>',
            '<a class="hrefcss" href="http://www.youtube.com/watch?v=JghQgA2HMX8">test file</a>',
            '<a  class="content"     href="http://eset.org/testfile/test.ogg">test ogg</a>',
            '<a     id="audio"      href="http://eset.org/testfile/test.mp3">test mp3</a>',
            '<a  href="http://eset.org/testfile/test.mp3">test mp3</a>',
            '<a     href="http://eset.org/testfile/test.mp3">test mp3</a>',
            '<a     href="http://www.youtube.com/watch?v=JghQgA2HMX8?d=200x200">youtube\'s</a>',
            '<a
                            href="http://eset.org/testfile/test.mp3">
                            test mp3</a>',
            '<a                         class="content"


                            href="http://eset.org/testfile/test.wav">test wav
                                    </a>',
            '<a             href="http://www.youtube.com/watch?v=JghQgA2HMX8?d=200x200"     >youtube\'s</a>',
...
<iframe title="Valid link" width="400" height="300"
  src="https://www.youtube.com/embed/uUhWl9Lm3OM?rel=0&amp;wmode=transparent" frameborder="0" allowfullscreen="1"></iframe>
        ...
        $invalidtexts = array(
            '<a class="_blanktarget">href="http://eset.org/testfile/test.mp3"</a>',
            '<a>test test</a>',
            '<a >test test</a>',
            '<a     >test test</a>',
            '<a >test test</a>',
            '<ahref="http://eset.org/testfile/test.mp3">sample</a>',
            '<a href="" test></a>',
            '<a href="http://www.eset.com/path/to?#param=29">test</a>',
            '<a href="http://eset.org/testfile/test.mp3">test mp3',
            '<a href="http://eset.org/testfile/test.mp3"test</a>',
            '<a href="http://eset.org/testfile/">test</a>',
            '<href="http://eset.org/testfile/test.avi">test</a>',
            '<abbr href="http://eset.org/testfile/test.mp3">test mp3</abbr>',
            '<ahref="http://eset.org/testfile/test.mp3">test mp3</a>',
            '<aclass="content" href="http://eset.org/testfile/test.mp3">test mp3</a>',
        ...
        $precededlongurl = '<a href="http://eset.org/testfile/test.mp3">test.mp3</a>'. $longurl;
