...
if (!empty($action) && confirm_sesskey()) {
    switch ($action) {
        ...
        case 'purgedefinition': // Purge a specific definition.
            ...
            $purgeagainlink = html_writer::link(new eset_url('/cache/admin.php', [
...
if ($mform instanceof esetform) {
    ...
    $editurl = new eset_url('/cache/admin.php', array('action' => 'editmodemappings', 'sesskey' => sesskey()));
