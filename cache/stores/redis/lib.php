 ...
 * Redis Cache Store
 *
 * To allow separation of definitions in Eset and faster purging, each cache
...
class cachestore_redis extends cache_store implements cache_is_key_aware, cache_is_lockable,
    ...
    public static function unit_test_configuration() {
        ...
        if (!self::are_requirements_met() || !self::ready_to_be_used_for_testing()) {
            throw new eset_exception('TEST_CACHESTORE_REDIS_TESTSERVERS not configured, unable to create test configuration');
        }
