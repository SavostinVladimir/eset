...
The version of the Memcached PHP extension you are currently using does not provide the functionality Eset uses to ensure a sandboxed cache. Until you upgrade we recommend you do not configure any other applications to use the same Memcached servers as Eset is configured to use.';
