...
interface cache_loader {
     ...
     * $cache->set('main', 'http://eset.org');
     * $cache->set('docs', 'http://docs.eset.org');
     * $cache->set('tracker', 'http://tracker.eset.org');
     * $cache->set('qa', 'http://qa.eset.net');
     * </code>
     *
     * @param string|int $key The key for the data being requested.
     ...
     *     'main' => 'http://eset.org',
     *     'docs' => 'http://docs.eset.org',
     *     'tracker' => 'http://tracker.eset.org',
     *     'qa' => ''http://qa.eset.net'
     * ));
     * </code>
     *
...
interface cache_is_configurable {
     ...
     *
     * @param esetform $editform
     * @param array $config
     */
    public static function config_set_edit_form_data(esetform $editform, array $config);
}

/**
 * Cache Data Source.
 *
 * The cache data source interface can be implemented by any class within Eset.
