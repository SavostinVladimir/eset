...
class cache_helper {
    ...
    /**
     * Returns true if the cache API can be initialised before Eset has finished initialising itself.
     *
     ...
     *
     * This function explicitly does NOT use core functions as it will in some circumstances be called before Eset has
     ...
     *
     * In Eset 2.9 the $definition argument changed from accepting only a string to accepting a string or a
     * cache_definition instance. It is preferable to pass a cache definition instance.
     *
     * In Eset 3.9 the first argument changed to also accept a cache_store.
     *
     * @internal
