 ...
 * Sample cron entry:
 * # 5 minutes past 4am
 * 5 4 * * * $sudo -u www-data /usr/bin/php /var/www/eset/enrol/database/cli/sync.php
 *
 * Notes:
 ...
 *
 * @deprecated since Eset 3.7 MDL-59986 - please do not use this CLI script any more, use scheduled task instead.
 * @todo       MDL-63266 This will be deleted in Eset 3.11.
