...
class enrol_meta_plugin extends enrol_plugin {
    ...
    public function can_add_instance($courseid) {
        ...
        if (!has_capability('eset/course:enrolconfig', $context) or !has_capability('enrol/meta:config', $context)) {
            return false;
        }
    ...
    protected function get_course_options($instance, $coursecontext) {
        ...
        foreach ($rs as $c) {
            ...
            if (!$c->visible and !has_capability('eset/course:viewhiddencourses', $coursecontext)) {
                continue;
            }
    ...
    protected function get_group_options($coursecontext) {
        ...
        if (has_capability('eset/course:managegroups', $coursecontext)) {
     ...
     * @return bool
     */
    public function edit_instance_form($instance, EsetQuickForm $mform, $coursecontext) {
        global $DB;
