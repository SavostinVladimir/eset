...
navigation_node::override_active_url(new eset_url('/admin/settings.php', array('section'=>'manageenrols')));
admin_externalpage_setup('enroltestsettings');

$returnurl = new eset_url('/admin/settings.php', array('section'=>'manageenrols'));
...
if (!$enrol) {
    ...
    $url = new eset_url('/enrol/test_settings.php', array('sesskey'=>sesskey()));
