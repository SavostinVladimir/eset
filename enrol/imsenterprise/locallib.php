...
class imsenterprise_roles {
     ...
     * For example, IMS role '01' is 'Learner', so may map to 'student' in Eset.
     *
...
/**
 * Mapping between Eset course attributes and IMS enterprise group description tags
 *
 * @package   enrol_imsenterprise
...
class imsenterprise_courses {
    ...
    private $imsnames;
    /** @var array eset course field names */
    private $courseattrs;
