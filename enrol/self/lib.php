...
class enrol_self_plugin extends enrol_plugin {
    ...
    public function can_add_instance($courseid) {
        ...
        if (!has_capability('eset/course:enrolconfig', $context) or !has_capability('enrol/self:config', $context)) {
            return false;
        }
    ...
    protected function email_welcome_message($instance, $user) {
        ...
        if (trim($instance->customtext1) !== '') {
            ...
            if (strpos($message, '<') === false) {
                ...
                // This is most probably the tag/newline soup known as FORMAT_ESET.
                $messagehtml = format_text($message, FORMAT_ESET, array('context'=>$context, 'para'=>false, 'newlines'=>true, 'filter'=>true));
