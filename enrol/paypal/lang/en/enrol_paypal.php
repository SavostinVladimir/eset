...
$string['privacy:metadata:enrol_paypal:enrol_paypal:timeupdated'] = 'The time of Eset being notified by PayPal about the payment.';
...
$string['privacy:metadata:enrol_paypal:paypal_com'] = 'The PayPal enrolment plugin transmits user data from Eset to the PayPal website.';
