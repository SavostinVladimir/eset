YUI.add('eset-enrol-rolemanager', function(Y) {

    var MOD_NAME                    = 'Eset role manager',
        MOD_USER                    = 'Eset role user',
        MOD_PANEL                   = 'Eset role assignment panel',
        USERIDS                     = 'userIds',
        COURSEID                    = 'courseId',
        USERID                      = 'userId',
        CONTAINER                   = 'container',
...
}, '@VERSION@', {requires:['base','node','io-base','json-parse','test','eset-core-notification']});
