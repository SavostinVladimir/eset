YUI.add('eset-enrol-otherusersmanager', function(Y) {
                    ...
                    .append(Y.Node.create('<div class="'+CSS.CONTENT+'"></div>')
                        ...
                        .append(Y.Node.create('<div class="'+CSS.LIGHTBOX+' '+CSS.HIDDEN+'"></div>')
                            .append(Y.Node.create('<img alt="loading" class="'+CSS.LOADINGICON+'" />')
                                .setAttribute('src', M.util.image_url('i/loading', 'eset')))
...
}, '@VERSION@', {requires:['base','node', 'overlay', 'io-base', 'test', 'json-parse', 'event-delegate', 'dd-plugin', 'event-key', 'eset-core-notification']});
