...
class enrol_ldap_plugin extends enrol_plugin {
    ...
    public function sync_user_enrolments($user) {
        ...
        foreach($roles as $role) {
            foreach ($enrolments[$role->id]['ext'] as $enrol) {
                ...
                // Deal with enrolment in the eset db
            ...
            foreach ($ldap_contexts as $ldap_context) {
                ...
                if (count($flat_records)) {
                    ...
                    foreach($flat_records as $course) {
                        ...
                        // Does the course exist in eset already?
    ...
    protected function ldap_connect(progress_trace $trace = null) {
        ...
        if ($ldapconnection = ldap_connect_eset($this->get_config('host_url'), $this->get_config('ldap_version'),
    ...
    /**
     * Will create the eset course from the template
    ...
    /**
     * Will update a eset course with new values from LDAP
