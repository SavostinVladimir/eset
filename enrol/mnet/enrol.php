 ...
 * Eset 1.x MNet clients. There is a proposal in MDL-21993 to allow
 ...
 *
 * Class methods are compatible with API 1 of the service used by Eset 1.x
...
class enrol_mnet_mnetservice_enrol {
     ...
     *
     * Since Eset 2.0, courses are made available for MNet peers by creating an instance
    ...
    /**
     * This method has never been implemented in Eset MNet API
     *
     * @uses mnet_remote_client Callable via XML-RPC only
    ...
    public function enrol_user(array $userdata, $courseid) {
        ...
        if ($user === false) {
            ...
            // users {@link http://tracker.eset.org/browse/MDL-21327}
     ...
     *
     * In Eset 1.x the returned array used to be indexed by username. The side effect
