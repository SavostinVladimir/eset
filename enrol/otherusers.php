...
require_capability('eset/course:reviewotherusers', $context);
...
navigation_node::override_active_url(new eset_url('/enrol/otherusers.php', array('id' => $id)));
...
$canassign = has_capability('eset/role:assign', $manager->get_context());
