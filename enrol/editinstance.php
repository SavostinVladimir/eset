...
if (!$plugin) {
    throw new eset_exception('invaliddata', 'error');
}
...
if (empty($return)) {
    $return = new eset_url('/enrol/instances.php', array('id' => $course->id));
}
...
if ($instanceid) {
    ...
    require_capability('eset/course:enrolconfig', $context);
    // No instance yet, we have to add new instance.
    navigation_node::override_active_url(new eset_url('/enrol/instances.php', array('id' => $course->id)));
