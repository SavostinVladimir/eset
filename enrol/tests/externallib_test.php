...
class core_enrol_externallib_testcase extends externallib_advanced_testcase {
    ...
    public function get_enrolled_users_visibility_provider() {
        return array(
            ...
            'Course with separate groups, default behavior (not filtering but having eset/site:accessallgroups)' =>
            array(
                'settings' => array(
                    'coursegroupmode' => VISIBLEGROUPS,
                    'withcapability' => null,
                    'groupid' => null,
                    'onlyactive' => false,
                    'allowedcaps' => array('eset/site:accessallgroups'),
                ),
                'results' => array( // Everybody can view everybody.
                    'user0' => array('canview' => array('user0', 'user1', 'user2', 'user2su', 'user31', 'user32', 'userall')),
                    'user1' => array('canview' => array('user0', 'user1', 'user2', 'user2su', 'user31', 'user32', 'userall')),
            ...
            'Course with separate groups, filtering onlyactive (missing eset/course:enrolreview)' =>
            array(
                'settings' => array(
                    'coursegroupmode' => SEPARATEGROUPS,
                    'withcapability' => null,
            ...
            'Course with separate groups, filtering onlyactive (having eset/course:enrolreview)' =>
            array(
                'settings' => array(
                    'coursegroupmode' => SEPARATEGROUPS,
                    'withcapability' => null,
                    'groupid' => null,
                    'onlyactive' => true,
                    'allowedcaps' => array('eset/course:enrolreview'),
                ),
            ...
            'Course with separate groups, filtering by groupid (not having eset/site:accessallgroups)' =>
            array(
                'settings' => array(
                    'coursegroupmode' => SEPARATEGROUPS,
                    'withcapability' => null,
            ...
            'Course with separate groups, filtering by groupid (having eset/site:accessallgroups)' =>
            array(
                'settings' => array(
                    'coursegroupmode' => SEPARATEGROUPS,
                    'withcapability' => null,
                ...
                'results' => array( // All users with 'eset/site:accessallgroups' can view group 2
            ...
            'Course with separate groups, filtering by withcapability (not having eset/role:review)' =>
            array(
                'settings' => array(
                    'coursegroupmode' => SEPARATEGROUPS,
                    'withcapability' => 'eset/course:bulkmessaging',
                    'groupid' => null,
                    'onlyactive' => false,
                    'allowedcaps' => array(),
                ),
                'results' => array( // No user has 'eset/role:review' so exception.
                    'user0' => array('exception' => array(
                        'type' => 'required_capability_exception',
            ...
            'Course with separate groups, filtering by withcapability (having eset/role:review)' =>
            array(
                'settings' => array(
                    'coursegroupmode' => SEPARATEGROUPS,
                    'withcapability' => 'eset/course:bulkmessaging',
                    'groupid' => null,
                    'onlyactive' => false,
                    'allowedcaps' => array('eset/role:review'),
                ),
                'results' => array( // No user has withcapability, but all have 'eset/role:review'. Empties.
            ...
            array(
                'settings' => array(
                    ...
                    'groupid' => null,
                    'onlyactive' => false,
                    'allowedcaps' => array('eset/role:review', 'eset/course:bulkmessaging'),
                ),
                'results' => array( // Users (previous) have withcapability, and all have 'eset/role:review'.
                    'user0' => array('canview' => array()),
    ...
    public function get_enrolled_users_setup($capability) {
        ...
        $this->assignUserCapability('eset/user:viewdetails', $return->context->id, $return->roleid);
    ...
    public function test_get_enrolled_users_without_parameters() {
        $capability = 'eset/course:viewparticipants';
