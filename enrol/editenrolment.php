...
$usersurl = new eset_url('/user/index.php', array('id' => $course->id));
...
$returnurl = new eset_url($usersurl, $manager->get_url_params()+$table->get_url_params());
// The URL of this page.
$url = new eset_url('/enrol/editenrolment.php', $returnurl->params());
