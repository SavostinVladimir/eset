...
class enrol_manual_external extends external_api {
    ...
    public static function enrol_users($enrolments) {
        ...
        if (empty($enrol)) {
            throw new eset_exception('manualpluginnotinstalled', 'enrol_manual');
        }
        ...
        foreach ($params['enrolments'] as $enrolment) {
            ...
            if (!array_key_exists($enrolment['roleid'], $roles)) {
                ...
                throw new eset_exception('wsusercannotassign', 'enrol_manual', '', $errorparams);
            }
            ...
            if (empty($instance)) {
              $errorparams = new stdClass();
              $errorparams->courseid = $enrolment['courseid'];
              throw new eset_exception('wsnoinstance', 'enrol_manual', $errorparams);
            }
            ...
            if (!$enrol->allow_enrol($instance)) {
                ...
                $errorparams->courseid = $enrolment['courseid'];
                $errorparams->userid = $enrolment['userid'];
                throw new eset_exception('wscannotenrol', 'enrol_manual', '', $errorparams);
            }
    ...
    public static function unenrol_users($enrolments) {
        ...
        foreach ($params['enrolments'] as $enrolment) {
            ...
            if (!$instance) {
                throw new eset_exception('wsnoinstance', 'enrol_manual', $enrolment);
            }
            ...
            if (!$enrol->allow_unenrol($instance)) {
                throw new eset_exception('wscannotunenrol', 'enrol_manual', '', $enrolment);
            }
