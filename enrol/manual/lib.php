...
class enrol_manual_plugin extends enrol_plugin {
    ...
    public function get_manual_enrol_link($instance) {
        ...
        return new eset_url('/enrol/manual/manage.php', array('enrolid'=>$instance->id, 'id'=>$instance->courseid));
    }
    ...
    public function can_add_instance($courseid) {
        ...
        if (!has_capability('eset/course:enrolconfig', $context) or !has_capability('enrol/manual:config', $context)) {
            return false;
        }
    ...
    public function get_action_icons(stdClass $instance) {
        ...
        if (has_capability('enrol/manual:enrol', $context) or has_capability('enrol/manual:unenrol', $context)) {
            $managelink = new eset_url("/enrol/manual/manage.php", array('enrolid'=>$instance->id));
