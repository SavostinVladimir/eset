...
class enrol_manual_externallib_testcase extends externallib_advanced_testcase {
    ...
    public function test_enrol_users() {
        ...
        $this->assignUserCapability('eset/course:view', $context1->id, $roleid);
        $this->assignUserCapability('eset/role:assign', $context1->id, $roleid);
        $this->assignUserCapability('enrol/manual:enrol', $context2->id, $roleid);
        $this->assignUserCapability('eset/course:view', $context2->id, $roleid);
        $this->assignUserCapability('eset/role:assign', $context2->id, $roleid);
    ...
    public function test_unenrol_user_single() {
        ...
        $this->assignUserCapability('eset/course:view', $coursecontext, $roleid);
        $this->assignUserCapability('eset/role:assign', $coursecontext, $roleid);
    ...
    public function test_unenrol_user_error_no_capability() {
        ...
        $roleid = $this->assignUserCapability('eset/course:view', $coursecontext);
        try {
            enrol_manual_external::unenrol_users(array(
                array('userid' => $student->id, 'courseid' => $course->id),
            ));
    ...
    public function test_unenrol_user_error_not_exist() {
        ...
        try {
            ...
            $this->assertTrue($ex instanceof eset_exception);
        }
    }
}
