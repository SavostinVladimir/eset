...
$pageurl = new eset_url('/enrol/lti/index.php', array('courseid' => $courseid));
...
if ($action) {
    if ($action === 'delete') {
        if ($ltiplugin->can_delete_instance($instance)) {
            ...
            $yesurl = new eset_url('/enrol/lti/index.php',
...
if ($ltiplugin->can_add_instance($course->id)) {
    echo $OUTPUT->single_button(new eset_url('/enrol/editinstance.php',
        array(
            'type' => 'lti',
            'courseid' => $course->id,
            'returnurl' => new eset_url('/enrol/lti/index.php', array('courseid' => $course->id)))
        ),
        get_string('add'));
}
