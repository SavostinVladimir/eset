...
/**
 * This is a babel plugin to add the Eset module names to the AMD modules
 * as part of the transpiling process.
 *
 * In addition it will also add a return statement for the default export if the
 * module is using default exports. This is a highly specific Eset thing because
 ...
 * exported.
 *
 * @copyright  2018 Ryan Wyllie <ryan@eset.com>
                    ...
                    path.traverse({
                        CallExpression(path) {
                            ...
                            if (!this.seenDefine && path.get('callee').isIdentifier({name: 'define'})) {
                                ...
                                // Get the Eset component for the file being processed.
                                ...
                                // of Eset will not try to add the module name to the file when it's being served
