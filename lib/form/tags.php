 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class EsetQuickForm_tags extends EsetQuickForm_autocomplete {
    /**
    ...
    protected function is_tagging_enabled() {
        ...
        // Backward compatibility with code developed before Eset 3.0 where itemtype/component were not specified.
        return true;
    }
     ...
     */
    public function EsetQuickForm_tags($elementName = null, $elementLabel = null, $options = array(), $attributes = null) {
    ...
    function toHtml(){
        ...
        $managelink = '';
        if (has_capability('eset/tag:manage', context_system::instance()) && $this->showstandard) {
            $url = new eset_url('/tag/manage.php', array('tc' => $this->get_tag_collection()));
