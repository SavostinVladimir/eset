 ...
 *
 * Overloaded {@link EsetQuickForm_submit} with default behavior modified to cancel a form.
 *
 * @package   core_form
 * @category  form
 * @copyright 2007 Jamie Pratt <me@jamiep.org>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class EsetQuickForm_cancel extends EsetQuickForm_submit
{
    /**
     * constructor
     *
     ...
     */
    public function EsetQuickForm_cancel($elementName=null, $value=null, $attributes=null) {
