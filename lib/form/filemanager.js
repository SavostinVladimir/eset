    ...
    Y.extend(FileManagerHelper, Y.Base, {
        ...
        initializer: function(options) {
            ...
            this.selectui = new M.core.dialogue({
                draggable    : true,
                headerContent: '<h3 id="' + labelid +'">' + M.util.get_string('edit', 'eset') + '</h3>',
        ...
        setup_buttons: function() {
            ...
            buttonDeleteFile.on('click', function(e) {
                ...
                dialogOptions.header = M.util.get_string('confirm', 'eset');
        ...
        select_file: function(node) {
            ...
            Y.one('#fm-dialog-label_'+selectnode.get('id')).setContent(Y.Escape.html(M.util.get_string('edit', 'eset')+' '+nodename));
            // show panel
            this.selectui.show();
