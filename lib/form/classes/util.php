...
class util {
     ...
     *
     * This is automatically called from various points in Eset such as send_file_xx functions
     * in filelib.php.
     */
    public static function form_download_complete() {
        // If this doesn't look like a Eset QuickForms request, ignore.
        $quickform = false;
        ...
        setcookie('esetdownload_' . sesskey(), time());
    }
}
