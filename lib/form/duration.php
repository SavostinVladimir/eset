 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class EsetQuickForm_duration extends EsetQuickForm_group {
    /**
    ...
    */
        ...
        if (isset($options['defaultunit'])) {
            if (!array_key_exists($options['defaultunit'], $this->get_units())) {
                throw new coding_exception($options['defaultunit'] .
                        ' is not a recognised unit in EsetQuickForm_duration.');
            }
     ...
     */
    public function EsetQuickForm_duration($elementName = null, $elementLabel = null,
            $options = [], $attributes = null) {
     ...
     * @param EsetQuickForm $caller calling object
     * @return bool
     */
