 ...
 *
 * Emulates eset print_date_selector function
 *
 * @package   core_form
 * @category  form
 * @copyright 2007 Jamie Pratt <me@jamiep.org>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class EsetQuickForm_date_selector extends EsetQuickForm_group {
     ...
     */
    public function EsetQuickForm_date_selector($elementName = null, $elementLabel = null, $options = array(), $attributes = null) {
    ...
    function _createElements() {
        ...
        if ($calendartype->get_name() === 'gregorian') {
            $image = $OUTPUT->pix_icon('i/calendar', get_string('calendar', 'calendar'), 'eset');
