 ...
 */
class EsetQuickForm_editor extends HTML_QuickForm_element implements templatable {
     ...
     */
    public function EsetQuickForm_editor($elementName=null, $elementLabel=null, $attributes=null, $options=null) {
    ...
    function setHelpButton($_helpbuttonargs, $function='_helpbutton') {
        throw new coding_exception('setHelpButton() can not be used any more, please see EsetQuickForm::addHelpButton().');
    }
    ...
    function toHtml() {
        ...
        if ($maxfiles != 0 ) {
            ...
            if (has_capability('eset/h5p:deploy', $ctx)) {
        ...
        // during eset installation, user area doesn't exist
        ...
        if (!during_initial_install() && empty($CFG->adminsetuppending)) {
            ...
            if ($maxfiles != 0 ) {
                ...
                $editorurl = new eset_url("$CFG->wwwroot/repository/draftfiles_manager.php", array(
                    'action'=>'browse',
                    'env'=>'editor',
                    'itemid'=>$draftitemid,
                    'subdirs'=>$subdirs,
