 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class EsetQuickForm_password extends HTML_QuickForm_password implements templatable {
    ...
    public function __construct($elementName=null, $elementLabel=null, $attributes=null) {
        global $CFG;
        // no standard mform in eset should allow autocomplete of passwords
        if (empty($attributes)) {
     ...
     */
    public function EsetQuickForm_password($elementName=null, $elementLabel=null, $attributes=null) {
