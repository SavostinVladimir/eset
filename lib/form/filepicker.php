 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class EsetQuickForm_filepicker extends HTML_QuickForm_input implements templatable {
     ...
     */
    public function EsetQuickForm_filepicker($elementName=null, $elementLabel=null, $attributes=null, $options=null) {
    ...
    function toHtml() {
        ...
        $nonjsfilepicker = new eset_url('/repository/draftfiles_manager.php', array(
            'env'=>'filepicker',
            'action'=>'browse',
            'itemid'=>$draftitemid,
            'subdirs'=>0,
