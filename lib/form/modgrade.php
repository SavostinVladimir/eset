 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class EsetQuickForm_modgrade extends EsetQuickForm_group {
    ...
    /** @var EsetQuickForm_select $gradetypeformelement */
    private $gradetypeformelement;

    /** @var EsetQuickForm_select $scaleformelement */
    private $scaleformelement;

    /** @var EsetQuickForm_text $maxgradeformelement */
     ...
     */
    public function EsetQuickForm_modgrade($elementname = null, $elementlabel = null, $options = array(), $attributes = null) {
     ...
     * @param esetform $caller calling object
     * @return mixed
     */
