 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class EsetQuickForm_filemanager extends HTML_QuickForm_element implements templatable {
     ...
     */
    public function EsetQuickForm_filemanager($elementName=null, $elementLabel=null, $attributes=null, $options=null) {
...
class form_filemanager implements renderable {
    ...
    public function get_nonjsurl() {
        global $PAGE;
        return new eset_url('/repository/draftfiles_manager.php', array(
            'env'=>'filemanager',
            'action'=>'browse',
