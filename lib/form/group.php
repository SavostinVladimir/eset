 ...
 *
 * Overloaded {@link HTML_QuickForm_group} with default behavior modified for Eset.
 *
 * @package   core_form
 * @category  form
 * @copyright 2007 Jamie Pratt <me@jamiep.org>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class EsetQuickForm_group extends HTML_QuickForm_group implements templatable {
     ...
     */
    public function EsetQuickForm_group($elementName=null, $elementLabel=null, $elements=null, $separator=null, $appendName = true) {
     ...
     * This object is later used by {@link EsetQuickForm_group::createElement()}
     * @param null|EsetQuickForm $mform
     */
    public function setEsetForm($mform) {
        if ($mform && $mform instanceof EsetQuickForm) {
            $this->_mform = $mform;
        }
    }
     ...
     * storing the EsetQuickForm object, see {@link EsetQuickForm_group::setEsetForm()}
     *
    ...
    public function onQuickFormEvent($event, $arg, &$caller) {
        $this->setEsetForm($caller);
        return parent::onQuickFormEvent($event, $arg, $caller);
    }

    /**
     * Creates an element to add to the group
     * Expects the same arguments as EsetQuickForm::createElement()
     */
