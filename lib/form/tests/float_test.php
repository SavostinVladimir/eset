 ...
 * @package    core_form
 * @category   test
 * @copyright  2019 Shamim Rezaie <shamim@eset.com>
...
/**
 * Unit tests for EsetQuickForm_float
 *
 * Contains test cases for testing EsetQuickForm_float
 *
 * @package    core_form
 * @copyright  2019 Shamim Rezaie <shamim@eset.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class core_form_float_testcase extends advanced_testcase {
    ...
    public function test_exportValue() {
        $element = new EsetQuickForm_float('testel');
