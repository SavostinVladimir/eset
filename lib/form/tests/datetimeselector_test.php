...
/**
 * Unit tests for EsetQuickForm_date_time_selector
 *
 * Contains test cases for testing EsetQuickForm_date_time_selector
 *
 * @package    core_form
 * @category   phpunit
 * @copyright  2012 Rajesh Taneja
...
class core_form_datetimeselector_testcase extends advanced_testcase {
    /** @var EsetQuickForm Keeps reference of dummy form object */
    private $mform;
    ...
    public function test_exportvalue() {
        ...
        foreach ($testvals as $vals) {
            ...
            $this->assertTrue($el instanceof EsetQuickForm_date_time_selector);
 ...
 */
class temp_form_datetime extends esetform {
    /**
     * Form definition.
     */
