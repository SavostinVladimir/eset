...
/**
 * Unit tests for EsetQuickForm_date_selector
 *
 * Contains test cases for testing EsetQuickForm_date_selector
 *
 * @package    core_form
 * @category   phpunit
 * @copyright  2012 Rajesh Taneja
...
class core_form_dateselector_testcase extends advanced_testcase {
    ...
    public function test_exportvalue() {
        ...
        foreach ($testvals as $vals) {
            ...
            $this->assertTrue($el instanceof EsetQuickForm_date_selector);
 ...
 */
class temp_form_date extends esetform {
    /**
     * Form definition.
     */
