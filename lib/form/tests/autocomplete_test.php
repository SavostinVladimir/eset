 ...
 *
 * @package    core_form
 * @copyright  2015 Damyon Wiese <damyon@eset.com>
...
/**
 * Unit tests for EsetQuickForm_autocomplete
 *
 * Contains test cases for testing EsetQuickForm_autocomplete
 *
 * @package    core_form
 * @copyright  2015 Damyon Wiese <damyon@eset.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class core_form_autocomplete_testcase extends basic_testcase {
    ...
    public function test_validation() {
        ...
        $element = new EsetQuickForm_autocomplete('testel', null, $options);
        ...
        $options = array('1' => 'One', 2 => 'Two');
        $element = new EsetQuickForm_autocomplete('testel', null, $options, array('multiple'=>'multiple'));
        ...
        $element = new EsetQuickForm_autocomplete('testel', null, array(), array('multiple'=>'multiple', 'ajax'=>'anything'));
        $submission = array('testel' => array(2, 3));
