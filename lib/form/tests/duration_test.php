...
/**
 * Unit tests for EsetQuickForm_duration
 *
 * Contains test cases for testing EsetQuickForm_duration
 *
 * @package    core_form
 * @category   phpunit
 * @copyright  2009 Tim Hunt
...
class core_form_duration_testcase extends basic_testcase {
     ...
     */
    protected function get_test_form(): EsetQuickForm {
     ...
     *
     * @return array with two elements, a EsetQuickForm and a EsetQuickForm_duration.
     */
 ...
 */
class temp_form_duration extends esetform {
    /**
     * Form definition.
     */
