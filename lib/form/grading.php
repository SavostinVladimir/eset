...
if (class_exists('HTML_QuickForm')) {
    HTML_QuickForm::registerRule('gradingvalidated', 'callback', '_validate', 'EsetQuickForm_grading');
}
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class EsetQuickForm_grading extends HTML_QuickForm_input implements templatable {
     ...
     */
    public function EsetQuickForm_grading($elementName=null, $elementLabel=null, $attributes=null) {
    ...
    public function onQuickFormEvent($event, $arg, &$caller) {
        if ($event == 'createElement') {
            ...
            if (!is_array($attributes) || !array_key_exists('gradinginstance', $attributes) || !($attributes['gradinginstance'] instanceof gradingform_instance)) {
                throw new eset_exception('exc_gradingformelement', 'grading');
            }
        }
