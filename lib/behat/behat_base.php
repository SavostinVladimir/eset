 ...
 *
 * To extend by the steps definitions of the different Eset components.
 *
...
class behat_base extends Behat\MinkExtension\Context\RawMinkContext {
     ...
     * be enough.
     *
     * @deprecated since Eset 3.7 MDL-64979 - please use get_reduced_timeout() instead
     * @todo MDL-64982 This will be deleted in Eset 3.11
     ...
     *
     * @deprecated since Eset 3.7 MDL-64979 - please use get_timeout() instead
     * @todo MDL-64982 This will be deleted in Eset 3.11
     ...
     *
     * @deprecated since Eset 3.7 MDL-64979 - please use get_extended_timeout() instead
     * @todo MDL-64982 This will be deleted in Eset 3.11
     ...
     *
     * @deprecated since Eset 2.7 MDL-44084 - please do not use this function any more.
...
EOF;
     ...
     * @see Eset\BehatExtension\Tester\EsetStepTester
     */
    public function look_for_exceptions() {
        ...
        try {
            ...
            if ($errormsg = $this->getSession()->getPage()->find('xpath', $exceptionsxpath)) {
                ...
                if (empty($errorinfoboxes)) {
                    $errorinfoboxes = $this->getSession()->getPage()->findAll('css', 'div.eset-exception-message');
                ...
                $msg = "Eset exception: " . $errormsg->getText() . "\n" . $errorinfo;
    ...
    protected function get_session_user() {
        ...
        $sid = $this->getSession()->getCookie('EsetSession');
        if (empty($sid)) {
            throw new coding_exception('failed to get eset session');
        }
    ...
    protected function js_trigger_click($node) {
        ...
        if ($driver instanceof \Eset\BehatExtension\Driver\EsetSelenium2Driver) {
     ...
     */
    protected function resolve_page_url(string $page): eset_url {
     ...
     * @throws Exception with a meaningful error message if the specified page cannot be found.
     */
    protected function resolve_page_instance_url(string $type, string $identifier): eset_url {
        throw new Exception('Component "' . get_class($this) .
