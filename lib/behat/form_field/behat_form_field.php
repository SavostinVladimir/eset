...
class behat_form_field {
     ...
     * in cases like eset form group elements we can not find the type of
     ...
     * eset form elements we will need to refactor this simple HTML elements
     * guess method.
     *
