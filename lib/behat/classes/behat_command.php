...
class behat_command {
     ...
     * Docs url
     */
    const DOCS_URL = 'https://docs.eset.org/dev/Running_acceptance_test';

    /**
     * Ensures the behat dir exists in esetdata
     *
    ...
    public static function behat_setup_problem() {
        ...
        if (!self::are_behat_dependencies_installed()) {
            ...
            // Returning composer error code to avoid conflicts with behat and eset error codes.
