...
class behat_config_util {
    ...
    /**
     * Gets the list of Eset behat contexts
     *
     ...
     * the required Behat extensions and Eset test wwwroot.
     *
        ...
        $config = array(
            'default' => array(
                ...
                'extensions' => array(
                    ...
                    'Eset\BehatExtension' => array(
                        'esetdirroot' => $CFG->dirroot,
    ...
    /**
     * Return list of themes which can be set in eset.
     *
