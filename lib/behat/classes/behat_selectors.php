...
class behat_selectors {
    ...
    /**
     * Returns the behat selector and locator for a given eset selector and locator
     *
     * @param string $selectortype The eset selector type, which includes eset selectors
