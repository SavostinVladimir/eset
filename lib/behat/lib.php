 ...
 *
 * It does not include ESET_INTERNAL because is part of the bootstrap.
 *
 ...
 * eset setup.php. For places requiring a different/special behavior
...
function behat_error_handler($errno, $errstr, $errfile, $errline, $errcontext) {
    ...
    // the eset code (see fix_utf8() for example) in that cases we respect the forced error level value.
