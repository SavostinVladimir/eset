...
class license_manager {
     ...
     *            version  => int a version number used by eset [required]
     * }
     */
     ...
     * @todo MDL-67344 This will be deleted in Eset 4.1.
     ...
     *
     * @throws \eset_exception if attempting to update a core license.
     */
     ...
     *
     * @throws \eset_exception when attempting to delete a license you are not allowed to.
     */
        ...
        if (!empty($licensetodelete)) {
            if ($licensetodelete->custom == self::CUSTOM_LICENSE) {
                ...
                if ($countfilesusinglicense > 0) {
                    throw new eset_exception('cannotdeletelicenseinuse', 'license');
                }
                ...
                throw new eset_exception('cannotdeletecore', 'license');
            }
        } else {
            throw new eset_exception('licensenotfoundshortname', 'license', $licenseshortname);
        }
    }
     ...
     *
     * @throws \eset_exception if attempting to use invalid direction value.
     */
    ...
    /**
     * Install eset built-in licenses.
     */
