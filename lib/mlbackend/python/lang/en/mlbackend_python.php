...
$string['packageinstalledshouldbe'] = 'The esetmlbackend Python package should be updated. The required version is "{$a->required}" and the installed version is "{$a->installed}".';
$string['packageinstalledtoohigh'] = 'The esetmlbackend Python package is not compatible with this version of Eset. The required version is "{$a->required}" or higher as long as it is API-compatible. The installed version "{$a->installed}" is too high.';
...
$string['pythonpackagenotinstalled'] = 'The esetmlbackend Python package is not installed or there is a problem with it. Please execute "{$a}" from command line interface for more info.';
...
$string['usernamedesc'] = 'String of characters used as a username to communicate between the Eset server and the Python server.';
$string['password'] = 'Password';
$string['passworddesc'] = 'String of characters used as a password to communicate between the Eset server and the Python server.';
