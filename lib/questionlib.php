 ...
 * @return boolean whether any of these questions are being used by any part of Eset.
 */
...
/**
 * Tests whether any question in a category is used by any part of Eset.
 *
 ...
 * @param context $newcontext The Eset context the questions are being moved to
 */
...
function question_preview_url($questionid, $preferredbehaviour = null,
    ...
    return new eset_url('/question/preview.php', $params);
}
...
function question_make_default_categories($contexts) {
    ...
    foreach ($contexts as $key => $context) {
        ...
        if (has_any_capability(array('eset/question:usemine', 'eset/question:useall'), $context)) {
...
function question_has_capability_on($questionorid, $cap, $notused = -1) {
    ...
    if (!isset($capabilitieswithallandmine[$cap])) {
        return has_capability('eset/question:' . $cap, $context);
    } else {
        return has_capability('eset/question:' . $cap . 'all', $context) ||
            ($question->createdby == $USER->id && has_capability('eset/question:' . $cap . 'mine', $context));
    }
}
...
function question_get_question_capabilities() {
    return array(
        'eset/question:add',
        'eset/question:editmine',
        'eset/question:editall',
        'eset/question:viewmine',
        'eset/question:viewall',
        'eset/question:usemine',
        'eset/question:useall',
        'eset/question:movemine',
        'eset/question:moveall',
        'eset/question:tagmine',
        'eset/question:tagall',
    );
}
...
function question_get_all_capabilities() {
    ...
    $caps[] = 'eset/question:managecategory';
    $caps[] = 'eset/question:flag';
    return $caps;
}
...
class question_edit_contexts {
    ...
    public static $caps = array(
        'editq' => array('eset/question:add',
            ...
            'eset/question:movemine',
            'eset/question:moveall'),
        'questions'=>array('eset/question:add',
            'eset/question:editmine',
            'eset/question:editall',
            'eset/question:viewmine',
            'eset/question:viewall',
            'eset/question:movemine',
            'eset/question:moveall'),
        'categories'=>array('eset/question:managecategory'),
        'import'=>array('eset/question:add'),
        'export'=>array('eset/question:viewall', 'eset/question:viewmine'));
    ...
    public function having_add_and_use() {
        $contextswithcap = array();
        foreach ($this->allcontexts as $context) {
            if (!has_capability('eset/question:add', $context)) {
                continue;
            }
            if (!has_any_capability(array('eset/question:useall', 'eset/question:usemine'), $context)) {
                            continue;
            }
            $contextswithcap[] = $context;
        }
...
function question_get_export_single_question_url($question) {
    ...
    return new eset_url('/question/exportone.php', $params);
}
