...
class file_info_context_course extends file_info {
    ...
    public function get_file_info($component, $filearea, $itemid, $filepath, $filename) {
        ...
        if (!$this->course->visible and !has_capability('eset/course:viewhiddencourses', $this->context)) {
            return null;
        }
    ...
    protected function get_area_course_summary($itemid, $filepath, $filename) {
        ...
        if (!has_capability('eset/course:update', $this->context)) {
            return null;
        }
        if (is_null($itemid)) {
            return $this;
    ...
    protected function get_area_course_legacy($itemid, $filepath, $filename) {
        if (!has_capability('eset/course:managefiles', $this->context)) {
            return null;
        }
    ...
    protected function get_area_backup_course($itemid, $filepath, $filename) {
        ...
        if (!has_capability('eset/backup:backupcourse', $this->context) and !has_capability('eset/restore:restorecourse', $this->context)) {
            return null;
        }
        if (is_null($itemid)) {
            return $this;
        ...
        $downloadable = has_capability('eset/backup:downloadfile', $this->context);
        $uploadable   = has_capability('eset/restore:uploadfile', $this->context);
    ...
    protected function get_area_backup_automated($itemid, $filepath, $filename) {
        ...
        if (!has_capability('eset/restore:viewautomatedfilearea', $this->context)) {
            return null;
        }
        if (is_null($itemid)) {
            return $this;
        ...
        $downloadable = has_capability('eset/backup:downloadfile', $this->context) &&
                        has_capability('eset/restore:userinfo', $this->context);
        $uploadable   = false;
