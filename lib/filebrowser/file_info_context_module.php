...
class file_info_context_module extends file_info {
    ...
    public function get_file_info($component, $filearea, $itemid, $filepath, $filename) {
        ...
        if (!$this->course->visible and !has_capability('eset/course:viewhiddencourses', $coursecontext)) {
            return null;
        }
    ...
    protected function get_area_intro($itemid, $filepath, $filename) {
        ...
        if (!plugin_supports('mod', $this->modname, FEATURE_MOD_INTRO, true) or !has_capability('eset/course:managefiles', $this->context)) {
            return null;
        }
    ...
    protected function get_area_backup($itemid, $filepath, $filename) {
        ...
        if (!has_capability('eset/backup:backupactivity', $this->context)) {
            return null;
        }
