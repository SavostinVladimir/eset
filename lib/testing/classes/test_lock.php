...
class test_lock {
    ...
    /**
     * Prevent parallel test execution - this can not work in Eset because we modify database and dataroot.
     *
    ...
    public static function acquire(string $framework, string $lockfilesuffix = '') {
        ...
        if (!file_exists($lockfile)) {
            file_put_contents($lockfile, 'This file prevents concurrent execution of Eset ' . $framework . ' tests');
