...
class core_test_generator_testcase extends advanced_testcase {
    ...
    public function test_create() {
        ...
        $this->assertSame(FORMAT_ESET, $category->descriptionformat);
        ...
        $this->assertSame(FORMAT_ESET, $cohort->descriptionformat);
        ...
        $this->assertSame(FORMAT_ESET, $course->summaryformat);
    ...
    public function test_create_module() {
        ...
        // Note: module can have more autocompletion rules as defined in esetform_mod::add_completion_rules().
