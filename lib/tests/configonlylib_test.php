...
class core_configonlylib_testcase extends advanced_testcase {
    ...
    public function test_min_get_slash_argument() {
        ...
        $this->resetAfterTest();
        $this->assertEquals('https://www.example.com/eset', $CFG->wwwroot);

        $_SERVER = array();
        $_SERVER['SERVER_SOFTWARE'] = 'Apache/2.2.22 (Unix)';
        $_SERVER['QUERY_STRING'] = 'theme=standard&component=core&rev=5&image=u/f1';
        $_SERVER['REQUEST_URI'] = '/eset/theme/image.php?theme=standard&component=core&rev=5&image=u/f1';
        $_SERVER['SCRIPT_NAME'] = '/eset/theme/image.php';
        $this->assertSame('', min_get_slash_argument());

        $_SERVER = array();
        $_SERVER['SERVER_SOFTWARE'] = 'Apache/2.2.22 (Unix)';
        $_SERVER['QUERY_STRING'] = '';
        $_SERVER['REQUEST_URI'] = '/eset/theme/image.php/standard/core/5/u/f1';
        ...
        $_SERVER['QUERY_STRING'] = '';
        $_SERVER['REQUEST_URI'] = '/eset/theme/image.php/standard/core/5/u/f1';
        $_SERVER['PATH_INFO'] = '/eset/theme/image.php/standard/core/5/u/f1';
        $_SERVER['SCRIPT_NAME'] = '/eset/theme/image.php';
        $_GET = array();
        $this->assertSame('/standard/core/5/u/f1', min_get_slash_argument());
