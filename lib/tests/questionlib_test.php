...
class core_questionlib_testcase extends advanced_testcase {
    ...
    public function test_question_save_from_deletion_quiz_with_long_name() {
        ...
        // Eset doesn't allow you to enter a name longer than 255 characters.
    ...
    public function question_capability_on_question_provider() {
        return [
            'Unrelated capability which is present' => [
                'capabilities' => [
                    'eset/question:config' => CAP_ALLOW,
                ],
            ...
            'Unrelated capability which is prevented' => [
                'capabilities' => [
                    'eset/question:config' => CAP_PREVENT,
                ],
                'testcapability' => 'config',
                'isowner' => true,
                'expect' => false,
            ...
            'Related capability which is allowed at all, unset at mine' => [
                'capabilities' => [
                    'eset/question:editall' => CAP_ALLOW,
                ],
                'testcapability' => 'edit',
                'isowner' => true,
                'expect' => true,
            ...
            'Related capability which is allowed at all, prevented at mine' => [
                'capabilities' => [
                    'eset/question:editall' => CAP_ALLOW,
                    'eset/question:editmine' => CAP_PREVENT,
                ],
                'testcapability' => 'edit',
                'isowner' => true,
                'expect' => true,
            ...
            'Related capability which is unset all, allowed at mine' => [
                'capabilities' => [
                    'eset/question:editall' => CAP_PREVENT,
                    'eset/question:editmine' => CAP_ALLOW,
                ],
                'testcapability' => 'edit',
                'isowner' => true,
                'expect' => true,
    ...
    public function test_question_get_export_single_question_url() {
        ...
        // Verify some URLs.
        $this->assertEquals(new eset_url('/question/exportone.php',
