...
class core_events_testcase extends advanced_testcase {
    ...
    public function test_course_category_created() {
        ...
        $url = new eset_url('/course/management.php', array('categoryid' => $event->objectid));
    ...
    public function test_course_category_updated() {
        ...
        $this->assertEquals(context_coursecat::instance($category->id), $event->get_context());
        $url = new eset_url('/course/editcategory.php', array('id' => $event->objectid));
        $this->assertEquals($url, $event->get_url());
     ...
     *
     * It's not possible to use the eset API to simulate the failure of sending
    ...
    public function test_recent_capability_viewed() {
        ...
        $this->assertEventLegacyLogData($expected, $event);
        $this->assertEventContextNotUsed($event);
        $url = new eset_url('/course/recent.php', array('id' => $course->id));
        $this->assertEquals($url, $event->get_url());
        $event->get_name();
    }
