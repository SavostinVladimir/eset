...
class core_update_validator_testcase extends advanced_testcase {
    ...
    public function test_validate_files_layout() {
        ...
        $validator = testable_core_update_validator::instance($fixtures.'/github', array(
            'eset-repository_mahara-master/' => true,
            'eset-repository_mahara-master/lang/' => true,
            'eset-repository_mahara-master/lang/en/' => true,
            'eset-repository_mahara-master/lang/en/repository_mahara.php' => true,
            'eset-repository_mahara-master/version.php' => true));
        $this->assertFalse($validator->execute());
        $this->assertTrue($this->has_message($validator->get_messages(), $validator::ERROR, 'rootdirinvalid',
            'eset-repository_mahara-master'));
    }
    ...
    public function test_validate_version_php() {
        ...
        $validator->assert_eset_version(0);
        ...
        $validator->assert_eset_version('2013031400.00');
        $this->assertFalse($validator->execute());
