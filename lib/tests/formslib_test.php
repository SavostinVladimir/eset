...
class core_formslib_testcase extends advanced_testcase {
    ...
    public function test_require_rule() {
        ...
        $rule = new EsetQuickForm_Rule_Required();
    ...
    public function test_generate_id_select() {
        $el = new EsetQuickForm_select('choose_one', 'Choose one',
            array(1 => 'One', '2' => 'Two'));
        $el->_generateId();
    ...
    public function test_generate_id_like_repeat() {
        $el = new EsetQuickForm_text('text[7]', 'Type something');
        $el->_generateId();
        $this->assertSame('id_text_7', $el->getAttribute('id'));
    }

    public function test_can_manually_set_id() {
        $el = new EsetQuickForm_text('elementname', 'Type something',
    ...
    public function test_generate_id_radio() {
        $el = new EsetQuickForm_radio('radio', 'Label', 'Choice label', 'choice_value');
        $el->_generateId();
        $this->assertSame('id_radio_choice_value', $el->getAttribute('id'));
    }

    public function test_radio_can_manually_set_id() {
        $el = new EsetQuickForm_radio('radio2', 'Label', 'Choice label', 'choice_value',
    ...
    public function test_generate_id_radio_like_repeat() {
        $el = new EsetQuickForm_radio('repeatradio[2]', 'Label', 'Choice label', 'val');
        $el->_generateId();
 ...
 */
class formslib_test_form extends esetform {
 ...
 */
class formslib_settype_debugging_text extends esetform {
    public function definition() {
        $mform = $this->_form;
 ...
 */
class formslib_settype_debugging_hidden extends esetform {
    public function definition() {
        $mform = $this->_form;
 ...
 * Used to test debugging is called when hidden added without setType.
 */
class formslib_settype_debugging_url extends esetform {
    public function definition() {
        $mform = $this->_form;
 ...
 */
class formslib_settype_debugging_repeat extends esetform {
    public function definition() {
        $mform = $this->_form;
 ...
 */
class formslib_settype_debugging_repeat_ok extends esetform {
    public function definition() {
        $mform = $this->_form;
 ...
 */
class formslib_settype_debugging_group extends esetform {
    public function definition() {
        $mform = $this->_form;
        $group = array(
 ...
 */
class formslib_settype_debugging_namedgroup extends esetform {
    public function definition() {
        $mform = $this->_form;
        $group = array(
            $mform->createElement('text', 'groupel1', 'groupel1'),
 ...
 */
class formslib_settype_debugging_funky_name extends esetform {
    public function definition() {
        $mform = $this->_form;
 ...
 */
class formslib_settype_debugging_type_inheritance extends esetform {
    public function definition() {
        $mform = $this->_form;
 ...
 */
class formslib_settype_debugging_type_group_in_repeat extends esetform {
    public function definition() {
        $mform = $this->_form;
        $groupelements = array(
 ...
 */
class formslib_settype_debugging_type_namedgroup_in_repeat extends esetform {
    public function definition() {
        $mform = $this->_form;
        $groupelements = array(
            $mform->createElement('text', 'test1', 'test1', 'test'),
 ...
 */
class formslib_clean_value extends esetform {
 ...
 */
class formslib_multiple_modgrade_form extends esetform {
    public function definition() {
        $mform = $this->_form;
 ...
 */
class formslib_persistantrreeze_element extends esetform {
    public function definition() {
        $mform = $this->_form;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class formslib_multiple_validation_form extends esetform {
    /**
