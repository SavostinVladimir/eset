...
class core_grades_external_testcase extends externallib_advanced_testcase {
    ...
    protected function load_test_data($assignmentname, $student1rawgrade, $student2rawgrade) {
        ...
        $parentroleid = $this->assignUserCapability('eset/grade:viewall', $student1context->id);
    ...
    public function test_update_grades() {
        ...
        // Give the student role 'eset/grade:hide' and they should now be able to hide the grade item.
        $studentrole = $DB->get_record('role', array('shortname' => 'student'));
        $coursecontext = context_course::instance($course->id);
        assign_capability('eset/grade:hide', CAP_ALLOW, $studentrole->id, $coursecontext->id);
