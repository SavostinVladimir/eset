...
class core_weblib_testcase extends advanced_testcase {
    ...
    public function test_clean_text() {
        ...
        $this->assertSame('lala xx', clean_text($text, FORMAT_ESET));
...
I'm writing to you from the Eset Majlis in Muscat, Oman, where we just had several days of Eset community goodness.

URL outside a tag: https://eset.org/logo/logo-240x60.gif
Plugin url outside a tag: @@PLUGINFILE@@/logo-240x60.gif

External link 1:<img src='https://eset.org/logo/logo-240x60.gif' alt='Eset'/>
External link 2:<img alt="Eset" src="https://eset.org/logo/logo-240x60.gif"/>
Internal link 1:<img src='@@PLUGINFILE@@/logo-240x60.gif' alt='Eset'/>
Internal link 2:<img alt="Eset" src="@@PLUGINFILE@@logo-240x60.gif"/>
...
Anchor + ext. img:<a title="bananas" href="../logo-240x60.gif"><img alt="Eset" src="@@PLUGINFILE@@logo-240x60.gif"/></a>
Ext. anchor + img:<a href="@@PLUGINFILE@@logo-240x60.gif"><img alt="Eset" src="https://eset.org/logo/logo-240x60.gif"/></a>
SOURCE;
        $expected = <<<EXPECTED
Hello!
...
Ext. anchor + img:<img alt="Eset" src="https://eset.org/logo/logo-240x60.gif" />
EXPECTED;
...
<span lang='fr' class='multilang'>français</span>", FORMAT_HTML, "english català español français")
    ...
    public function data_validate_email() {
        return [
            ...
            [
                'email' => 'eset@example.com',
                'result' => true
            ],
            [
                'email' => 'eset@localhost.local',
                'result' => true
            ],
            [
                'email' => 'verp_email+is=mighty@eset.org',
                'result' => true
            ],
            [
            ...
            [
                'email' => 'posts+AAAAAAAAAAIAAAAAAAAGQQAAAAABFSXz1eM/P/lR2bYyljM+@posts.eset.org',
                'result' => true
            ],

            // Test addresses that should NOT pass.
            [
                'email' => 'eset@localhost',
                'result' => false
            ],
            [
                'email' => '"attacker\\" -oQ/tmp/ -X/var/www/vhost/eset/backdoor.php  some"@email.com',
                'result' => false
            ],
            [
