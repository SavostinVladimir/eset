...
', FORMAT_HTML);
    ...
    public function test_external_util_get_area_files() {
        ...
        $this->DB = $DB;
        $DB = $this->getMockBuilder('eset_database')->getMock();
    ...
    public function test_user_created_tokens_duration() {
        ...
        $service = $DB->get_record('external_services', array('shortname' => ESET_OFFICIAL_MOBILE_SERVICE, 'enabled' => 1));
