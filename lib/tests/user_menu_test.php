 ...
 *
 * @package    core
 * @copyright  2015 Jetha Chan <jetha@eset.com>
...
class core_user_menu_testcase extends advanced_testcase {
    ...
    public function custom_user_menu_data() {
        return array(
            ...
            array('#my1files,eset|/user/files.php|download', 1, 0),
            array('#my1files,esetakjladf|/user/files.php|download', 1, 0),
...
privatefiles,eset|/user/files.php|download
###
...
#f234|2', 5, 2),
    ...
    public function test_custom_user_menu($data, $entrycount, $dividercount) {
        ...
        // Test using an admin user at the root of Eset; this way we don't have to create a test user with avatar.
        $this->setAdminUser();
        $PAGE->set_url('/');
        $CFG->theme = 'classic';
