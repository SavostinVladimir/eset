...
class core_grading_externallib_testcase extends externallib_advanced_testcase {
    ...
    public function test_get_definitions() {
        ...
        $roleid = $this->assignUserCapability('eset/course:viewparticipants', $coursecontext->id, 3);
    ...
    public function test_save_definitions_rubric() {
        ...
        $this->assignUserCapability('eset/grade:managegradingforms', $context->id, $teacherrole->id);
