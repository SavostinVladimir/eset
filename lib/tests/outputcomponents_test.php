...
class core_outputcomponents_testcase extends advanced_testcase {
    ...
    public function test_get_url() {
        ...
        $this->assertSame('https://www.example.com/eset', $CFG->wwwroot);
        ...
        $up2 = new user_picture($user2);
        $this->assertSame('http://www.gravatar.com/avatar/ab53a2911ddf9b4817ac01ddcd3d975f?s=35&d=http%3A%2F%2Fwww.example.com%2Feset%2Fpix%2Fu%2Ff2.png', $up2->get_url($page, $renderer)->out(false));
        ...
        $up2 = new user_picture($user2);
        $this->assertSame('https://secure.gravatar.com/avatar/ab53a2911ddf9b4817ac01ddcd3d975f?s=35&d=https%3A%2F%2Fwww.example.com%2Feset%2Fpix%2Fu%2Ff2.png', $up2->get_url($page, $renderer)->out(false));
        ...
        // $up2 = new user_picture($user2);
        // $this->assertEquals('http://www.gravatar.com/avatar/ab53a2911ddf9b4817ac01ddcd3d975f?s=35&d=http%3A%2F%2Fwww.example.com%2Feset%2Ftheme%2Fafterburner%2Fpix_core%2Fu%2Ff2.png', $up2->get_url($page, $renderer)->out(false));

        // $up2 = new user_picture($user2);
        // $this->assertSame('https://secure.gravatar.com/avatar/ab53a2911ddf9b4817ac01ddcd3d975f?s=35&d=https%3A%2F%2Fwww.example.com%2Feset%2Ftheme%2Fafterburner%2Fpix_core%2Fu%2Ff2.png', $up2->get_url($page, $renderer)->out(false));
    ...
    public function test_basic_syntax() {
        $definition = <<<EOF
Eset community|http://eset.org
-Eset free support|http://eset.org/support
-Eset development|http://eset.org/development
--Eset Tracker|http://tracker.eset.org
--Eset Docs|http://docs.eset.org
-Eset News|http://eset.org/news
Eset company||Eset trust pty
-Hosting|http://eset.com/hosting|Commercial hosting
-Support|http://eset.com/support|Commercial support
EOF;
        ...
        $this->assertEquals('Eset community', $item->get_text());
        $itemurl = $item->get_url();
        $this->assertTrue($itemurl instanceof eset_url);
        $this->assertEquals('http://eset.org', $itemurl->out());
        ...
        $this->assertSame('Eset company', $item->get_text());
        $this->assertNull($item->get_url());
        $this->assertSame('Eset trust pty', $item->get_title());
