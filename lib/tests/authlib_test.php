...
class core_authlib_testcase extends advanced_testcase {
    ...
    public function test_signup_validate_data_same_email() {
        ...
        // the default `validate_email()` and Eset does not yet provide a CFG switch to allow such emails.  So we
        ...
        $defaultvalidator = eset_phpmailer::$validator;
        eset_phpmailer::$validator = function($address) {
        ...
        // Emails in Eset are supposed to be case-insensitive (and accent-sensitive but accents are not yet supported).
        ...
        // Please note that Eset does not normally support such emails yet. We test the DB search sensitivity here.
        ...
        eset_phpmailer::$validator = $defaultvalidator;
    }
}
