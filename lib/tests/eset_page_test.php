...
class core_eset_page_testcase extends advanced_testcase {

    /**
     * @var testable_eset_page
     */
    protected $testpage;
    ...
    public function setUp() {
        parent::setUp();
        $this->resetAfterTest();
        $this->testpage = new testable_eset_page();
    }
    ...
    public function test_set_state_normal_path() {
        ...
        $this->assertEquals(eset_page::STATE_BEFORE_HEADER, $this->testpage->state);

        $this->testpage->set_state(eset_page::STATE_PRINTING_HEADER);
        $this->assertEquals(eset_page::STATE_PRINTING_HEADER, $this->testpage->state);

        $this->testpage->set_state(eset_page::STATE_IN_BODY);
        $this->assertEquals(eset_page::STATE_IN_BODY, $this->testpage->state);

        $this->testpage->set_state(eset_page::STATE_DONE);
        $this->assertEquals(eset_page::STATE_DONE, $this->testpage->state);
    }
    ...
    public function test_url_to_class_name() {
        ...
        $this->assertSame('example-com--eset', $this->testpage->url_to_class_name('https://example.com/eset'));
        $this->assertSame('example-com--8080--nested-eset', $this->testpage->url_to_class_name('https://example.com:8080/nested/eset'));
    }
    ...
    public function test_set_url_using_eset_url() {
        global $CFG;
        // Fixture setup.
        $url = new eset_url('/mod/workshop/allocation.php', array('cmid' => 29, 'method' => 'manual'));
        // Exercise SUT.
    ...
    public function test_default_editing_capabilities() {
        ...
        // Validated.
        $this->assertEquals(array('eset/site:manageblocks'), $this->testpage->all_editing_caps());
    }
    ...
    public function test_other_block_editing_cap() {
        ...
        // Exercise SUT.
        $this->testpage->set_blocks_editing_capability('eset/my:manageblocks');
        // Validated.
        $this->assertEquals(array('eset/my:manageblocks'), $this->testpage->all_editing_caps());
    }
    ...
    public function test_other_editing_cap() {
        ...
        // Exercise SUT.
        $this->testpage->set_other_editing_capability('eset/course:manageactivities');
        // Validated.
        $actualcaps = $this->testpage->all_editing_caps();
        $expectedcaps = array('eset/course:manageactivities', 'eset/site:manageblocks');
    ...
    public function test_other_editing_caps() {
        ...
        // Exercise SUT.
        $this->testpage->set_other_editing_capability(array('eset/course:manageactivities', 'eset/site:other'));
        // Validated.
        $actualcaps = $this->testpage->all_editing_caps();
        $expectedcaps = array('eset/course:manageactivities', 'eset/site:other', 'eset/site:manageblocks');
        $this->assertEquals(array_values($expectedcaps), array_values($actualcaps));
    }
 ...
 */
class testable_eset_page extends eset_page {
