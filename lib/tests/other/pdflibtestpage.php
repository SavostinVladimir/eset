...
if ($getpdf) {
    ...
    $doc->SetTitle('Eset PDF library test');
    $doc->SetAuthor('Eset ' . $CFG->release);
    $doc->SetCreator('lib/tests/other/pdflibtestpage.php');
    $doc->SetKeywords('Eset, PDF');
    $doc->SetSubject('This has been generated by Eset as its PDF library test page');
    $doc->SetMargins(15, 30);

    $doc->setPrintHeader(true);
    $doc->setHeaderMargin(10);
    $doc->setHeaderFont(array($fontfamily, 'b', 10));
    $doc->setHeaderData('pix/esetlogo.png', 40, $SITE->fullname, $CFG->wwwroot);
    ...
    $doc->Cell(0, 0, 'Eset PDF library test', 0, 1, 'C', 1);
...
echo $OUTPUT->continue_button(new eset_url($PAGE->url, array('getpdf' => 1, 'fontfamily' => PDF_FONT_NAME_MAIN)));
echo $OUTPUT->footer();
