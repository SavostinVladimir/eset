 ...
 * @subpackage  fixtures
 * @category    test
 * @copyright   2012, 2015 David Mudrak <david@eset.com>
...
class testable_checker extends checker {
    ...
    private function get_fake_response() {
        $fakeresponse = array(
            'status' => 'OK',
            'provider' => 'https://download.eset.org/api/1.0/updates.php',
            'apiver' => '1.0',
            'timegenerated' => time(),
            ...
            'updates' => array(
                'core' => array(
                    array(
                        ...
                        'maturity' => 200,
                        'url' => 'https://download.eset.org/',
                        'download' => 'https://download.eset.org/download.php/ESET_23_STABLE/eset-2.3.3-latest.zip',
                    ),
                    array(
                        ...
                        'maturity' => 50,
                        'url' => 'https://download.eset.org/',
                        'download' => 'https://download.eset.org/download.php/ESET_24_STABLE/eset-2.4.0-latest.zip',
                    ),
                ),
                'mod_foo' => array(
                    array(
                        ...
                        'maturity' => 200,
                        'release' => '1.1',
                        'url' => 'http://eset.org/plugins/blahblahblah/',
                        'download' => 'http://eset.org/plugins/download.php/blahblahblah',
                    ),
                    array(
                        'version' => 2012030502,
                        'requires' => 2012010100,
