 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class core_max_input_vars_form extends esetform {
    /**
     * Form definition.
     */
    public function definition() {
        ...
        // without using a Eset form element.
...
$PAGE->set_url(new eset_url('/lib/tests/fixtures/max_input_vars.php'));
...
if ($type && ($result = $mform->get_data())) {
    ...
    switch ($type[0]) {
        case 'c' :
            ...
            // Check using Eset form and _param functions too.
        ...
        case 'a' :
            ...
            // Check using Eset _param function. The form does not include these
