...
class core_component_testcase extends advanced_testcase {
    ...
    public function test_normalize_componentname() {
        ...
        $this->assertSame('core', core_component::normalize_componentname('eset'));
        $this->assertSame('core', core_component::normalize_componentname(''));

        // Eset core subsystems.
        ...
        $this->assertSame('core_admin', core_component::normalize_componentname('eset_admin'));
    ...
    public function test_normalize_component() {
        ...
        $this->assertSame(array('core', null), core_component::normalize_component('eset'));
        ...
        $this->assertSame(array('core', 'admin'), core_component::normalize_component('eset_admin'));
    ...
    public function test_deprecated_normalize_component() {
        ...
        $this->assertSame(array('core', null), normalize_component('eset'));
        ...
        $this->assertSame(array('core', 'admin'), normalize_component('eset_admin'));
    ...
    public function test_get_component_classes_in_namespace() {
        ...
        $this->assertCount(7, core_component::get_component_classes_in_namespace('eset', 'update'));
