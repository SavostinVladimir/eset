...
class core_update_api_testcase extends advanced_testcase {
    ...
    public function test_validate_pluginfo_format() {
        ...
        $json = '{"id":127,"name":"Course contents","component":"block_course_contents","source":"https:\/\/github.com\/mudrd8mz\/eset-block_course_contents","doc":"http:\/\/docs.eset.org\/20\/en\/Course_contents_block","bugs":"https:\/\/github.com\/mudrd8mz\/eset-block_course_contents\/issues","discussion":null,"version":{"id":8100,"version":"2015030300","release":"3.0","maturity":200,"downloadurl":"https:\/\/eset.org\/plugins\/download.php\/8100\/block_course_contents_eset29_2015030300.zip","downloadmd5":"8d8ae64822f38d278420776f8b42eaa5","vcssystem":"git","vcssystemother":null,"vcsrepositoryurl":"https:\/\/github.com\/mudrd8mz\/eset-block_course_contents","vcsbranch":"master","vcstag":"v3.0","supportedesets":[{"version":2014041100,"release":"2.7"},{"version":2014101000,"release":"2.8"},{"version":2015041700,"release":"2.9"}]}}';
        ...
        $data = json_decode($json);
        $data->version->downloadurl = 'ftp://archive.eset.org/block_course_contents/2014041100.zip';
        $this->assertFalse($client->validate_pluginfo_format($data));
    }
}
