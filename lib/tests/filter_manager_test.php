...
class core_filter_manager_testcase extends advanced_testcase {
    ...
    public function test_filter_normal() {
        ...
        $this->assertRegExp('~^<p><img class="icon emoticon" alt="smile" title="smile" src="https://www.example.com/eset/theme/image.php/_s/boost/core/1/s/smiley" /></p>$~',
    ...
    public function test_one_filter_of_two_disabled() {
        ...
        $this->assertRegExp('~^<p><img class="icon emoticon" alt="smile" title="smile" src="https://www.example.com/eset/theme/image.php/_s/boost/core/1/s/smiley" /> http://google.com/</p>$~',
