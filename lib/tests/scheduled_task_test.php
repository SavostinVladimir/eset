...
class core_scheduled_task_testcase extends advanced_testcase {
    ...
    public function test_timezones() {
        ...
        // I used http://www.timeanddate.com/worldclock/fixedtime.html?msg=Eset+Test&iso=20160502T01&p1=113
    ...
    public function test_reset_scheduled_tasks_for_component_customised(): void {
        ...
        $tasks = \core\task\manager::load_scheduled_tasks_for_component('eset');
    ...
    public function test_reset_scheduled_tasks_for_component_deleted(): void {
        ...
        $tasklist = \core\task\manager::load_scheduled_tasks_for_component('eset');
        ...
        $this->assertTaskEquals($task, $taskafterreset);
        $this->assertCount(count($tasklist), \core\task\manager::load_scheduled_tasks_for_component('eset'));
    }
    ...
    public function test_reset_scheduled_tasks_for_component_delete() {
        ...
        $count = $DB->count_records('task_scheduled', array('component' => 'eset'));
        $allcount = $DB->count_records('task_scheduled');

        $task = new \core\task\scheduled_test_task();
        $task->set_component('eset');
        ...
        $aftercount = $DB->count_records('task_scheduled', array('component' => 'eset'));
        ...
        $this->assertEquals($count, $DB->count_records('task_scheduled', array('component' => 'eset')));
