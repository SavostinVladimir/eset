...
class core_weblib_format_text_testcase extends advanced_testcase {
    ...
    public function test_format_text_format_html() {
        ...
        $this->assertRegExp('~^<p><img class="icon emoticon" alt="smile" title="smile" ' .
                'src="https://www.example.com/eset/theme/image.php/_s/boost/core/1/s/smiley" /></p>$~',
    ...
    public function test_format_text_format_markdown() {
        ...
        $this->assertRegExp('~^<p><em><img class="icon emoticon" alt="smile" title="smile" ' .
                'src="https://www.example.com/eset/theme/image.php/_s/boost/core/1/s/smiley" />' .
                '</em></p>\n$~',
    ...
    public function test_format_text_format_eset() {
        $this->resetAfterTest();
        filter_set_global_state('emoticon', TEXTFILTER_ON);
        $this->assertRegExp('~^<div class="text_to_html"><p>' .
                '<img class="icon emoticon" alt="smile" title="smile" ' .
                'src="https://www.example.com/eset/theme/image.php/_s/boost/core/1/s/smiley" /></p></div>$~',
                format_text('<p>:-)</p>', FORMAT_ESET));
    }

    public function test_format_text_format_eset_no_filters() {
        $this->resetAfterTest();
        filter_set_global_state('emoticon', TEXTFILTER_ON);
        $this->assertEquals('<div class="text_to_html"><p>:-)</p></div>',
                format_text('<p>:-)</p>', FORMAT_ESET, array('filter' => false)));
    }
    ...
    public function test_format_text_blanktarget($link, $expected) {
        $actual = format_text($link, FORMAT_ESET, array('blanktarget' => true, 'filter' => false, 'noclean' => true));
