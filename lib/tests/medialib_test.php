...
class core_medialib_testcase extends advanced_testcase {
    ...
    public function test_get_filename() {
        ...
        $this->assertSame('frog.mp4', $manager->get_filename(new eset_url(
    ...
    public function test_get_extension() {
        ...
        $this->assertSame('mp4', $manager->get_extension(new eset_url(
                '/pluginfile.php/312/mod_page/content/7/frog.mp4')));
        $this->assertSame('', $manager->get_extension(new eset_url(
    ...
    public function test_list_supported_urls() {
        ...
        // Some example URLs.
        $supported1 = new eset_url('http://example.org/1.test');
        $supported2 = new eset_url('http://example.org/2.TST');
        $unsupported = new eset_url('http://example.org/2.jpg');
    ...
    public function test_can_embed_url() {
        ...
        $url = new eset_url('http://example.org/test.mp4');
        $manager = core_media_manager::instance();
    ...
    public function test_embed_url_fallbacks() {
        ...
        foreach ($mediaformats as $format) {
            $url = new eset_url('http://example.org/test.' . $format);
    ...
    public function test_embed_url_swf() {
        ...
        // Without any options...
        $url = new eset_url('http://example.org/test.swf');
        $t = $manager->embed_url($url);
    ...
    public function test_slash_arguments() {
        ...
        // Format: mp3.
        $url = new eset_url('http://example.org/pluginfile.php?file=x/y/z/test.mp3');
        $t = $manager->embed_url($url);
    ...
    public function test_embed_or_blank() {
        ...
        $url = new eset_url('http://example.org/test.ogg');
    ...
    public function test_embed_url_size() {
        ...
        $url = new eset_url('http://example.org/test.mp4?d=123x456');
        $t = $manager->embed_url($url, '', '666', '101');
    ...
    public function test_embed_alternatives() {
        ...
        $urls = array(
            new eset_url('http://example.org/test.mp4'),
            new eset_url('http://example.org/test.ogv'),
            new eset_url('http://example.org/test.webm'),
            new eset_url('http://example.org/test.flv'),
        );
    ...
    public function test_initialise() {
        $esetpage1 = new eset_page();

        $mediamanager1 = core_media_manager::instance($esetpage1);
        $mediamanager2 = core_media_manager::instance($esetpage1);

        $this->assertSame($mediamanager1, $mediamanager2);

        $esetpage3 = new eset_page();
        $mediamanager3 = core_media_manager::instance($esetpage3);
