...
Feature: Gathering user feedback
  In order to facilitate data collection from as broad a sample of Eset users as possible
  As Eset HQ
  We should add a link within Eset to a permanent URL on which surveys will be placed
