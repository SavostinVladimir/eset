...
class behat_general extends behat_base {
     ...
     */
    const MAIN_WINDOW_NAME = '__eset_behat_main_window_name';
    ...
    public function i_wait_to_be_redirected() {
        ...
        // eset_page::$periodicrefreshdelay possible values.
    ...
    /**
     * Switches to the main Eset frame.
     *
    ...
    /**
     * Switches to the main Eset window. Useful when you finish interacting with popup windows.
     *
...
EOF;
    ...
    public function download_file_from_link($link) {
        ...
        $session = $this->getSession()->getCookie('EsetSession');
        return download_file_content($url, array('Cookie' => 'EsetSession=' . $session));
    }
    ...
    public function the_image_at_should_be_identical_to($element, $selectortype, $filepath) {
        ...
        $session = $this->getSession()->getCookie('EsetSession');
        $content = download_file_content($url, array('Cookie' => 'EsetSession=' . $session));
     ...
     * @return void.
     * @throws \Eset\BehatExtension\Exception\SkippedException
     */
    public function database_family_used_is_one_of_the_following(TableNode $databasefamilies) {
        ...
        throw new \Eset\BehatExtension\Exception\SkippedException();
    }
     ...
     *
     * @param string|eset_url $localurl The URL relative to the behat_wwwroot to visit.
     */
    public function i_visit($localurl): void {
        $localurl = new eset_url($localurl);
