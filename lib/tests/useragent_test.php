...
class core_useragent_testcase extends advanced_testcase {
    ...
    public function user_agents_providers() {
        ...
        return array(
            ...
            // EsetBot.
            array(
                'User-Agent: EsetBot/3.8 (+https://eset.org)',
                array(
                    'is_web_crawler'                => true,
                    'versionclasses'                => array(
                    ),
            ...
            // Macos Desktop app.
            array(
                'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_6) AppleWebKit/537.36 (KHTML, like Gecko) esetmobile/3.6.0 Chrome/69.0.3497.106 Electron/4.0.1 Safari/537.36 EsetMobile',
                array(
                    'is_eset_app'                => true,
                    'is_webkit'                    => true,
                    'is_chrome'                    => true,
            ...
            // Linux Desktop app.
            array(
                'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) esetdesktop/3.6.0 Chrome/69.0.3497.106 Electron/4.0.1 Safari/537.36 EsetMobile',
                array(
                    'is_eset_app'                => true,
                    'is_webkit'                    => true,
                    'is_chrome'                    => true,
            ...
            // Windows Desktop app.
            array(
                'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) esetdesktop/3.6.0 Chrome/69.0.3497.106 Electron/4.0.1 Safari/537.36 EsetMobile',
                array(
                    'is_eset_app'                => true,
                    'is_webkit'                    => true,
                    'is_chrome'                    => true,
            ...
            // Android app.
            array(
                'Mozilla/5.0 (Linux; Android 7.1.1; Moto G Play Build/NPIS26.48-43-2; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/71.0.3578.99 Mobile Safari/537.36 EsetMobile',
                array(
                    'is_eset_app'                => true,
                    'is_webkit'                    => true,
                    'is_webkit_android'            => true,
            ...
            // iOS (iPhone) app.
            array(
                'Mozilla/5.0 (iPhone; CPU OS 13_3_3 like Mac OS X) AppleWebKit/603.3.8 (KHTML, like Gecko) Mobile/14G60 EsetMobile',
                array(
                    'is_eset_app'                => true,
                    'is_ios'                       => true,
                    'is_webkit'                    => true,
            ...
            // iOS (iPad) app.
            array(
                'Mozilla/5.0 (iPad; CPU OS 12_1_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/16D39 EsetMobile',
                array(
                    'is_eset_app'                => true,
                    'is_ios'                       => true,
                    'is_webkit'                    => true,
    ...
    public function test_useragent_ios($useragent, $tests) {
        ...
        if (isset($tests['is_ios']) && $tests['is_ios']) {
            ...
            if (!isset($tests['is_eset_app']) || !$tests['is_eset_app']) {
                $this->assertTrue(core_useragent::check_safari_ios_version());
            }
        } else {
     ...
     * @dataProvider user_agents_providers
     */
    public function test_useragent_eset_app($useragent, $tests) {
        // Setup the core_useragent instance.
        core_useragent::instance(true, $useragent);

        $expectation = isset($tests['is_eset_app']) ? $tests['is_eset_app'] : false;
        $this->assertSame($expectation, core_useragent::is_eset_app());
    }
}
