YUI.add('eset-core-dragdrop', function (Y, NAME) {

/* eslint-disable no-empty-function */
/**
 * The core drag and drop module for Eset which extends the YUI drag and
 * drop functionality with additional features.
 *
 * @module eset-core-dragdrop
 */
var MOVEICON = {
    pix: "i/move_2d",
    largepix: "i/dragdrop",
    component: 'eset',
    cssclass: 'eset-core-dragdrop-draghandle'
};
...
Y.extend(DRAGDROP, Y.Base, {
    ...
    find_element_text: function(n) {
        ...
        return M.util.get_string('emptydragdropregion', 'eset');
    },
    ...
    global_start_keyboard_drag: function(e, draghandle, dragcontainer) {
        ...
        var dialogtitle = M.util.get_string('movecontent', 'eset', nodetitle);
        ...
        droptargets.each(function(node) {
            ...
            if (validdrop) {
                ...
                if (this.samenodelabel && node.hasClass(this.samenodeclass)) {
                    ...
                    listitemtext = M.util.get_string('tocontent', 'eset', nodetitle);
                }
...
}, '@VERSION@', {"requires": ["base", "node", "io", "dom", "dd", "event-key", "event-focus", "eset-core-notification"]});
