YUI.add('eset-core-tooltip', function (Y, NAME) {

/**
 * Provides the base tooltip class.
 *
 * @module eset-core-tooltip
 */
 ...
 * @static
 */
TOOLTIP.NAME = 'eset-core-tooltip';
 ...
 * @static
 */
TOOLTIP.CSS_PREFIX = 'eset-dialogue';
...
/**
  ...
  *
  * The supplid string will be wrapped in a div with the CSS.PANELTEXT class and a standard Eset spinner
  * appended.
  *
...
Y.extend(TOOLTIP, M.core.dialogue, {
    ...
    initializer: function() {
        ...
        // set.
        this.bb.addClass('eset-dialogue-tooltip');
...
Y.Base.modifyAttrs(TOOLTIP, {
     ...
     *
     * Eset override: We override this for tooltip to default it to false.
     *
     * @attribute Modal
     * @type Boolean
     * @default false
