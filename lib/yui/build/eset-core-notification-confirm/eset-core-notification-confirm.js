YUI.add('eset-core-notification-confirm', function (Y, NAME) {
 ...
 * @submodule eset-core-notification-confirm
 */

var CONFIRM_NAME = 'Eset confirmation dialogue',
    CONFIRM;
...
Y.extend(CONFIRM, M.core.notification.info, {
    ...
    initializer: function() {
        ...
        this.get(BASE).addClass('eset-dialogue-confirm');
        this.setStdModContent(Y.WidgetStdMod.BODY, content, Y.WidgetStdMod.REPLACE);
        this.setStdModContent(Y.WidgetStdMod.HEADER,
                '<h1 id="eset-dialogue-' + this.get('COUNT') + '-header-text">' + this.get(TITLE) + '</h1>',
    ...
    ATTRS: {
        ...
        yesLabel: {
            ...
            valueFn: function() {
                return M.util.get_string('yes', 'eset');
            },
        ...
        noLabel: {
            validator: Y.Lang.isString,
            valueFn: function() {
                return M.util.get_string('no', 'eset');
            },
            setter: function(value) {
                if (this._noButton) {
        ...
        title: {
            validator: Y.Lang.isString,
            value: M.util.get_string('confirm', 'eset')
        },
        ...
        question: {
            validator: Y.Lang.isString,
            valueFn: function() {
                return M.util.get_string('areyousure', 'eset');
            },
            setter: function(value) {
                if (this._question) {
