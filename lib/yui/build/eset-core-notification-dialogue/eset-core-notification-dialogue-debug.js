YUI.add('eset-core-notification-dialogue', function (Y, NAME) {
...
M.core = M.core || {};
/**
 * The generic dialogue class for use in Eset.
 *
 * @module eset-core-notification
 * @submodule eset-core-notification-dialogue
 */

var DIALOGUE_NAME = 'Eset dialogue',
    DIALOGUE,
    ...
    DOT = '.',
    HAS_ZINDEX = 'eset-has-zindex',
    CAN_RECEIVE_FOCUS_SELECTOR = 'input:not([type="hidden"]), a[href], button, textarea, select, [tabindex]',
    FORM_SELECTOR = 'form';

/**
 * A re-usable dialogue box with Eset classes applied.
 *
...
DIALOGUE = function(config) {
    ...
    var id = 'eset-dialogue-' + Y.stamp(this) + '-wrap'; // Can't use this.get('id') as it's not set at this stage.
...
Y.extend(DIALOGUE, Y.Panel, {
    ...
    ATTRS: {
         ...
         * @type Boolean
         * @default true
         * @deprecated Since Eset 2.7. Please use modal instead.
         */
        lightbox: {
            lazyAdd: false,
            setter: function(value) {
                Y.log("The lightbox attribute of M.core.dialogue has been deprecated since Eset 2.7, " +
                      "please use the modal attribute instead",
                    'warn', 'eset-core-notification-dialogue');
        ...
        closeButtonTitle: {
            ...
            value: M.util.get_string('closebuttontitle', 'eset')
        },
...
Y.Base.modifyAttrs(DIALOGUE, {
     ...
     * `align` Attribute.
     *
     * Note: We override this in Eset such that it sets a value for the
    ...
    id: {
        writeOnce: true,
        valueFn: function() {
            var id = 'eset-dialogue-' + Y.stamp(this);
            return id;
        }
    },
...
Y.extend(INFO, M.core.dialogue, {
    ...
    NAME: 'Eset information dialogue',
    CSS_PREFIX: DIALOGUE_PREFIX
});
...
M.core.notification.info = INFO;
    ...
    "requires": [
        ...
        "event-key",
        "dd-plugin",
        "eset-core-widget-focusafterclose",
        "eset-core-lockscroll"
    ]
});
