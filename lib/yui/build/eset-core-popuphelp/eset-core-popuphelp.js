YUI.add('eset-core-popuphelp', function (Y, NAME) {

/**
 * A popup help dialogue for Eset.
 *
 * @module eset-core-popuphelp
 */
...
POPUPHELP.NAME = 'eset-core-popuphelp';
...
Y.extend(POPUPHELP, Y.Base, {
    ...
    display_panel: function(e) {
        if (!this.panel) {
            this.panel = new M.core.tooltip({
                ...
                initialheadertext: M.util.get_string('loadinghelp', 'eset'),
                initialfootertext: ''
            });
        }
    ...
    set_footer: function(helpobject) {
        // Check for an optional link to documentation on eset.org.
...
}, '@VERSION@', {"requires": ["eset-core-tooltip"]});
