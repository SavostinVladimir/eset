YUI.add('eset-core-formchangechecker', function (Y, NAME) {

/**
 * A utility to check for form changes before navigating away from a page.
 *
 * @module eset-core-formchangechecker
 */
 ...
 *
 * Y.use('eset-core-formchangechecker', function() {
...
}, '@VERSION@', {"requires": ["base", "event-focus", "eset-core-event"]});
