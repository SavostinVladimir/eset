YUI.add('eset-core-actionmenu', function (Y, NAME) {

/**
 * Provides drop down menus for list of action links.
 *
 * @module eset-core-actionmenu
 */
...
ACTIONMENU.prototype = {
    ...
    handleKeyboardEvent: function(e) {
        ...
        if (e.keyCode === 27) {
            ...
            if (!found) {
                Y.log("Unable to find this menu item in the list of menu children", 'debug', 'eset-core-actionmenu');
                return;
            }
