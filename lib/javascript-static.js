// Miscellaneous core Javascript functions for Eset
...
M.util.image_url = function(imagename, component) {
    ...
    if (!component || component == '' || component == 'eset' || component == 'core') {
        component = 'core';
    }
...
M.util.CollapsibleRegion = function(Y, id, userpref, strtooltip) {
    ...
    if (this.div.hasClass('collapsed')) {
        ...
        this.icon = Y.Node.create('<img src="'+M.util.image_url(collapsedimage, 'eset')+'" alt="" />');
        // Shrink the div as it is collapsed by default
        this.div.setStyle('height', caption.get('offsetHeight')+'px');
    } else {
        // Add the correct image and record the YUI node created in the process
        this.icon = Y.Node.create('<img src="'+M.util.image_url('t/expanded', 'eset')+'" alt="" />');
    }
    a.append(this.icon);
    ...
    animation.on('end', function() {
        ...
        if (this.div.hasClass('collapsed')) {
            this.icon.set('src', M.util.image_url(collapsedimage, 'eset'));
        } else {
            this.icon.set('src', M.util.image_url('t/expanded', 'eset'));
        }
    }, this);
...
/**
 * Makes a best effort to connect back to Eset to update a user preference,
 * however, there is no mechanism for finding out if the update succeeded.
 *
 * Before you can use this function in your JavsScript, you must have called
 * user_preference_allow_ajax_update from esetlib.php to tell Eset that
...
M.util.show_confirm_dialog = function(e, args) {
    ...
    YUI().use('eset-core-notification-confirm', function(Y) {
    ...
    Y.use('node', 'event-mouseenter', function(){
        ...
        var colourpicker = {
            ...
            init : function() {
                ...
                this.image.setAttribute('src', M.util.image_url('i/colourpicker', 'eset'));
        ...
        M.util.block_hider = M.util.block_hider || (function(){
            ...
            Y.extend(blockhider, Y.Base, blockhider.prototype, {
                ...
                ATTRS : {
                    ...
                    preference : {},
                    iconVisible : {
                        value : M.util.image_url('t/switch_minus', 'eset')
                    },
                    iconHidden : {
                        value : M.util.image_url('t/switch_plus', 'eset')
                    },
                    block : {
 ...
 */
YUI.add('eset-core-io', function(Y) {
 ...
 * same way as PHP get_string() in Eset does.
 *
...
M.util.add_lightbox = function(Y, node) {
    var WAITICON = {'pix':"i/loading_small",'component':'eset'};
...
/**
 * @deprecated since Eset 3.3, but shouldn't be used in earlier versions either.
 */
