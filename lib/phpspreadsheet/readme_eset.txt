Description of PhpSpreadsheet 1.10.1 import into Eset
...
STEPS:
 * Create a temporary folder outside your eset installation
 ...
 * Add the next Eset hack at the beginning of the function sysGetTempDir()
