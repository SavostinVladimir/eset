Description of importing the codemirror library into Eset.

NOTE 2: To make it more readable, in this explanation [LIBRARYPATH] means:
    [PATH TO YOUR ESET]/lib/editor/atto/plugins/html/yui/src/codemirror
...
2 Then copy the following files to your local Eset directory:
...
3 Update the verison number in:
    [PATH TO YOUR ESET]/var/www/html/m/master2/lib/editor/atto/plugins/html/thirdpartylibs.xml

3 rebuild the module by:
    cd [PATH TO YOUR ESET]/lib/editor/atto/plugins/html/yui/src/
    grunt shifter
