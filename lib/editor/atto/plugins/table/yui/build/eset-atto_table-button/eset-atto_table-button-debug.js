YUI.add('eset-atto_table-button', function (Y, NAME) {
...
}, '@VERSION@', {"requires": ["eset-editor_atto-plugin", "eset-editor_atto-menu", "event", "event-valuechange"]});
