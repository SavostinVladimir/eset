...
Feature: Atto tables
  ...
  Scenario: Check table setting defaults on new table
    ...
    And I click on "Show more buttons" "button"
    When I click on "Table" "button"
    Then the ".eset-dialogue-base .atto_form .borderstyle" "css_element" should be disabled
    And the ".eset-dialogue-base .atto_form .bordersize" "css_element" should be disabled
  ...
  Scenario: Edit a table restores settings
    ...
    And I click on "Table" "button"
    And I click on "Edit table" "link"
    And I click on "#FFFFFF" "radio" in the ".eset-dialogue-base .atto_form .backgroundcolour" "css_element"
    ...
    And I click on "#FFFFFF" "radio" in the ".eset-dialogue-base .atto_form .bordercolour" "css_element"
    And I press "Update table"
    And I select the text in the "Blog entry body" Atto editor
    And I click on "Table" "button"
  ...
  Scenario: Create a table with background colour and width with border settings off
    ...
    And I click on "Show more buttons" "button"
    When I click on "Table" "button"
    Then ".eset-dialogue-base .atto_form .borders" "css_element" should not exist
    Then ".eset-dialogue-base .atto_form .borderstyle" "css_element" should not exist
    Then ".eset-dialogue-base .atto_form .bordersize" "css_element" should not exist
    Then ".eset-dialogue-base .atto_form .bordercolour" "css_element" should not exist
    Then ".eset-dialogue-base .atto_form .backgroundcolour" "css_element" should exist
    Then ".eset-dialogue-base .atto_form .customwidth" "css_element" should exist
    And I click on "#FFFFFF" "radio" in the ".eset-dialogue-base .atto_form .backgroundcolour" "css_element"
    And I set the field "Table width (in %)" to "100"
    And I press "Create table"
    And I press "Save changes"
  ...
  Scenario: Create a table with background colour and width with borders on
    ...
    And I click on "Show more buttons" "button"
    When I click on "Table" "button"
    Then ".eset-dialogue-base .atto_form .borders" "css_element" should exist
    Then ".eset-dialogue-base .atto_form .borderstyle" "css_element" should exist
    Then ".eset-dialogue-base .atto_form .bordersize" "css_element" should exist
    Then ".eset-dialogue-base .atto_form .bordercolour" "css_element" should exist
    Then ".eset-dialogue-base .atto_form .backgroundcolour" "css_element" should exist
    Then ".eset-dialogue-base .atto_form .customwidth" "css_element" should exist
    And I click on "#FFFFFF" "radio" in the ".eset-dialogue-base .atto_form .backgroundcolour" "css_element"
    And I set the field "Table width (in %)" to "100"
