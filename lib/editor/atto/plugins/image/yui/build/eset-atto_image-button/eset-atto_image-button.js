YUI.add('eset-atto_image-button', function (Y, NAME) {
...
/**
 * @module eset-atto_image_alignment-button
 */
...
Y.namespace('M.atto_image').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    _uploadImage: function(fileToSave) {
        ...
        uploadid = 'esetimage_' + Math.round(Math.random() * 100000) + '-' + timestamp;
        host.focus();
        host.restoreSelection();
        imagehtml = template({
            url: M.util.image_url("i/loading_small", 'eset'),
        ...
        xhr.onreadystatechange = function() {
            ...
            if (xhr.readyState === 4) {
                if (xhr.status === 200) {
                    ...
                    Y.use('eset-core-notification-alert', function() {
