...
Feature: Add images to Atto
  ...
  Scenario: Insert an image
    ...
    And I set the field "Describe this image for someone who cannot see it" to "It's the Eset"
    ...
    And I select the text in the "Description" Atto editor
    And I click on "Insert or edit image" "button"
    Then the field "Describe this image for someone who cannot see it" matches value "It's the Eset"
    And the field "Width" matches value "123"
    And the field "Height" matches value "456"
