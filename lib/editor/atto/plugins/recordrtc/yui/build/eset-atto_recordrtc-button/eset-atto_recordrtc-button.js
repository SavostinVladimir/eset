YUI.add('eset-atto_recordrtc-button', function (Y, NAME) {
...
/**
 * @module eset-atto_recordrtc-button
 */
...
}, '@VERSION@', {"requires": ["eset-editor_atto-plugin", "eset-atto_recordrtc-recording"]});
