...
Feature: Add h5ps to Atto
  ...
  Background:
    ...
    And the following config values are set as admin:
      | allowedsources | https://eset.h5p.com/content/[id] | filter_displayh5p |
  ...
  Scenario: Insert an embedded h5p
    ...
    And I set the field with xpath "//input[@data-region='h5pfile']" to "https://eset.h5p.com/content/1290772960722742119"
...
#   This is not a real external URL, so this scenario shouldn't be labeled as external.
    And I set the field with xpath "//input[@data-region='h5pfile']" to "ftp://eset.h5p.com/content/1290772960722742119"
  ...
  Scenario: No h5p capabilities
    ...
    | eset/h5p:deploy | Prohibit | editingteacher | Course | C1 |
...
#   Embed and copyright buttons displayed. Download not displayed
  ...
  Scenario: H5P options are ignored for H5P URLs
    ...
    And I navigate to "Edit settings" in current page administration
    And I click on "Insert H5P" "button" in the "#fitem_id_page" "css_element"
    And I set the field with xpath "//input[@data-region='h5pfile']" to "https://eset.h5p.com/content/1290752078589054689"
    And I click on "H5P options" "link"
    And I click on "Embed button" "checkbox"
    And I click on "Insert H5P" "button" in the "Insert H5P" "dialogue"
    And I wait until the page is ready
