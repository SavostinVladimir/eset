YUI.add('eset-atto_managefiles-usedfiles', function (Y, NAME) {
...
/**
 * @module eset-atto_managefiles-usedfiles
 */
...
M.atto_managefiles.usedfiles = M.atto_managefiles.usedfiles || {
    ...
    init: function(config) {
        ...
        if (!form || !window.parent) {
            Y.log("Unable to find parent window", 'warn', 'eset-atto_managemedia-usedfiles');
            return;
        }
