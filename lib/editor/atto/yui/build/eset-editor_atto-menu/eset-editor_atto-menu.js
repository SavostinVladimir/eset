YUI.add('eset-editor_atto-menu', function (Y, NAME) {
...
var LOGNAME = 'eset-editor_atto-menu';
var MENUDIALOGUE = '' +
...
/**
 * A Menu for the Atto editor used in Eset.
 *
...
Y.extend(Menu, M.core.dialogue, {
    ...
    initializer: function(config) {
        ...
        bb.one('.eset-dialogue-wrap')
            .removeClass('eset-dialogue-wrap')
            .addClass('eset-dialogue-content');
...
}, '@VERSION@', {"requires": ["eset-core-notification-dialogue", "node", "event", "event-custom"]});
