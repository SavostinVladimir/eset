YUI.add('eset-editor_atto-editor', function (Y, NAME) {
...
/**
 * The Atto WYSIWG pluggable editor, written for Eset.
 *
 * @module     eset-editor_atto-editor
 * @package    editor_atto
 * @copyright  2013 Damyon Wiese  <damyon@eset.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @main       eset-editor_atto-editor
 */
...
var LOGNAME = 'eset-editor_atto-editor';
var CSS = {
...
// Function for Eset's initialisation.
 ...
 *
 * @module     eset-editor_atto-notify
 * @submodule  notify
 * @package    editor_atto
...
var LOGNAME_NOTIFY = 'eset-editor_atto-editor-notify',
    NOTIFY_INFO = 'info',
...
EditorNotify.prototype = {
    ...
    setupNotifications: function() {
        ...
        preload1.src = M.util.image_url('i/warning', 'eset');
        preload2.src = M.util.image_url('i/info', 'eset');
    ...
    showMessage: function(message, type, timeout) {
        ...
        if (type === NOTIFY_WARNING) {
            messageTypeIcon = '<img src="' +
                              M.util.image_url('i/warning', 'eset') +
                              '" alt="' + M.util.get_string('warning', 'eset') + '"/>';
        } else if (type === NOTIFY_INFO) {
            messageTypeIcon = '<img src="' +
                              M.util.image_url('i/info', 'eset') +
                              '" alt="' + M.util.get_string('info', 'eset') + '"/>';
        } else {
        }
...
EditorTextArea.prototype = {
    ...
    updateOriginal: function() {
        ...
        if (oldValue !== newValue) {
            ...
            // Trigger the onchange callback on the textarea, essentially to notify eset-core-formchangechecker.
 ...
 *
 * @module     eset-editor_atto-autosave
...
var SUCCESS_MESSAGE_TIMEOUT = 5000,
    ...
    LOGNAME_AUTOSAVE = 'eset-editor_atto-editor-autosave';
 ...
 * A autosave function for the Atto editor.
 *
 * @module     eset-editor_atto-autosave-io
