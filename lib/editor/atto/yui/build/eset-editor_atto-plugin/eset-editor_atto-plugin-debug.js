YUI.add('eset-editor_atto-plugin', function (Y, NAME) {
 ...
 * Atto editor plugin.
 *
 * @module eset-editor_atto-plugin
...
/**
 * A Plugin for the Atto Editor used in Eset.
 *
...
var DISABLED = 'disabled',
    HIGHLIGHT = 'highlight',
    LOGNAME = 'eset-editor_atto-editor-plugin',
    CSS = {
...
EditorPluginButtons.prototype = {
    ...
    _normalizeIcon: function(config) {
        if (!config.iconurl) {
            ...
            if (!config.iconComponent || config.iconComponent == 'eset') {
