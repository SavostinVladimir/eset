@editor @editor_tinymce @tinymce @editor_esetform
Feature: Tinymce with enable/disable function.
  ...
  Scenario: Check disable Tinymce editor.
    ...
    And the "class" attribute of "a#id_myeditor_esetnolink" "css_element" should contain "mceButtonDisabled"
    And the "class" attribute of "a#id_myeditor_image" "css_element" should contain "mceButtonDisabled"
    And the "class" attribute of "a#id_myeditor_esetmedia" "css_element" should contain "mceButtonDisabled"
  ...
  Scenario: Check enable Tinymce editor.
    ...
    And the "class" attribute of "a#id_myeditor_esetmedia" "css_element" should contain "mceButtonEnabled"
    And I switch to "id_myeditor_ifr" iframe
