...
M.editor_tinymce.init_editor = function(Y, editorid, options) {
    ...
    // Load necessary Eset plugins into editor.
    if (options.eset_init_plugins) {
        var extraplugins = options.eset_init_plugins.split(',');
    ...
    options.setup = function(editor) {
        ...
        Y.use('event', 'eset-core-event', function(Y) {
