...
// No need to require lang packs in eset plugins.
...
function generatePreview(c) {
    ...
    pl = tinyMCEPopup.editor.plugins.esetmedia._parse(pl);
    ...
    p.innerHTML = '<iframe src="' + tinyMCEPopup.editor.getParam("eset_plugin_base") + 'esetmedia/preview.php'
