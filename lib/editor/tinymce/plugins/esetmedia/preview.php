...
/**
 * Provides A/V preview features for the TinyMCE editor Eset Media plugin.
...
$PAGE->set_url(new eset_url('/lib/editor/tinymce/plugins/esetmedia/preview.php'));
...
if (isloggedin() and !isguestuser() and $mediarenderer->can_embed_url($url)) {
    ...
    print_string('nopreview', 'tinymce_esetmedia');
}
