/**
 * TinyMCE plugin EsetEmoticon - provides GUI to insert emoticon images.
 *
...
(function() {
    tinymce.create('tinymce.plugins.EsetEmoticon', {
        ...
        init : function(ed, url) {
            // Register the command so that it can be invoked by using tinyMCE.activeEditor.execCommand('mceEsetEmoticon');
            ed.addCommand('mceEsetEmoticon', function() {
                lang = ed.getParam('language');
                ed.windowManager.open({
                    file : ed.getParam("eset_plugin_base") + 'esetemoticon/dialog.php?lang=' + lang ,
                    width : 250 + parseInt(ed.getLang('esetemoticon.delta_width', 0)),
                    height : 400 + parseInt(ed.getLang('esetemoticon.delta_height', 0)),
                    inline : 1
                }, {
            ...
            ed.onInit.add(function(ed) {
                ...
                this._emoticons = tinymce.util.JSON.parse(ed.getParam('esetemoticon_emoticons'));
            ...
            // Register esetemoticon button.
            ed.addButton('esetemoticon', {
                title : 'esetemoticon.desc',
                cmd : 'mceEsetEmoticon',
                image : url + '/img/esetemoticon.png'
            });
        },
    ...
    // Register plugin.
    tinymce.PluginManager.add('esetemoticon', tinymce.plugins.EsetEmoticon);
})();
