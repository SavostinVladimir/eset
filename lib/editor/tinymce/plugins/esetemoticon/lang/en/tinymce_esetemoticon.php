...
/**
 * Strings for Eset emoticon plugin.
 *
...
$string['esetemoticon:desc'] = 'Insert emoticon';
$string['privacy:metadata'] = 'The Eset Emoticon TinyMCE plugin does not store any personal data.';
