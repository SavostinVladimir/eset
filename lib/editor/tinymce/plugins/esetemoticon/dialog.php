...
/**
 * Displays the TinyMCE popup window to insert a Eset emoticon
 *
...
$PAGE->set_url('/lib/editor/tinymce/plugins/esetemoticon/dialog.php');

$emoticonmanager = get_emoticon_manager();
$stringmanager = get_string_manager();

$editor = get_texteditor('tinymce');
$plugin = $editor->get_plugin('esetemoticon');
...
<head>
    <title><?php print_string('esetemoticon:desc', 'tinymce_esetemoticon'); ?></title>
