...
(function() {
    tinymce.create('tinymce.plugins.EsetManageFiles', {
        /**
        ...
        init : function(ed, url) {
            ...
            ed.addCommand('mceManageFiles', function() {
                var managefiles = ed.getParam('managefiles', {}), key, cnt = 0,
                    fileurl = ed.getParam("eset_plugin_base") + 'managefiles/manage.php?';
        ...
        getInfo : function() {
            return {
                longname : 'Eset Manage embedded files plugin',
                author : 'Marina Glancy',
    ...
    // Register plugin.
    tinymce.PluginManager.add('managefiles', tinymce.plugins.EsetManageFiles);
})();
