...
class tgz_extractor {
     ...
     * Constructor.
     *
     * @param stored_file|string $archivefile Eset file or OS path to archive
     */
     ...
     * @throws eset_exception If there is any error processing the archive
     */
    ...
    protected function extract_or_list(tgz_extractor_handler $handler = null, file_progress $progress = null) {
        ...
        if (!$gz) {
            throw new eset_exception('errorprocessingarchive', '', '', null,
     ...
     *
     * @param tgz_extractor_handler $handler Will be called for extracted files
     * @throws eset_exception If there is an error closing it
     */
