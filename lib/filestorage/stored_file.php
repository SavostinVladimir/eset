 ...
 *
 * Since Eset 2.0 file contents are stored in sha1 pool and
...
class stored_file {
    ...
    */
    ...
    /**
     * Imports the contents of an external file into eset filepool.
     *
     * @throws eset_exception if file could not be downloaded or is too big
