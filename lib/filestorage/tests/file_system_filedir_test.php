...
class core_files_file_system_filedir_testcase extends advanced_testcase {
    ...
    /**
     * Test that the standard Eset warning message is put into the filedir.
     *
     * @covers ::__construct
     */
    public function test_warnings_put_in_place() {
        ...
        $this->assertEquals(
            'This directory contains the content of uploaded files and is controlled by Eset code. ' .
    ...
    public function test_remove_file_empty() {
        ...
        $DB = $this->getMockBuilder(\eset_database::class)
