 ...
 * attachments. When some other part of eset needs to access
...
class file_storage {
    ...
    public function create_file_from_reference($filerecord, $repositoryid, $reference, $options = array()) {
        ...
        if (!empty($existingfile)) {
            ...
            if ($lastcontent) {
                ...
                // External file doesn't have content in eset.
    ...
    /**
     * When user referring to a eset file, we build the reference field
     *
     * @param array $params
     * @return string
     */
     ...
     *
     * @throws eset_exception if file could not be downloaded
     *
