...
class tgz_packer extends file_packer {
    ...
    /**
     * @var string Name of special archive index file added by Eset.
     */
     ...
     */
    const ARCHIVE_INDEX_COUNT_PREFIX = 'Eset archive file index. Count: ';
     ...
     * @throws eset_exception If error
     */
