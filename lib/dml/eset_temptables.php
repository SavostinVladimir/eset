...
class eset_temptables {

    /** @var circular reference, to be able to use DB facilities here if needed */
    protected $mdb;
    /** @var prefix to be used for all the DB objects */
    protected $prefix;
    /** @var simple array of eset, not prefixed 'tablename' => DB, final (prefixed) 'tablename' */
    protected $temptables;

    /**
     * Creates new eset_temptables instance
     * @param eset_database $mdb An instance of eset_database.
     */
     ...
     *
     * Given one eset temptable name (without prefix), add it to the store, with the
     * key being the original eset name and the value being the real db temptable name
     * already prefixed
     *
