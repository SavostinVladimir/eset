...
require_once(__DIR__.'/pdo_eset_recordset.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class pdo_eset_database extends eset_database {
    ...
    /**
     * Factory method that creates a recordset for return by a query. The generic pdo_eset_recordset
     * class should fit most cases, but pdo_eset_database subclasses can override this method to return
     * a subclass of pdo_eset_recordset.
     * @param object $sth instance of PDOStatement
     * @return object instance of pdo_eset_recordset
     */
    protected function create_recordset($sth) {
        return new pdo_eset_recordset($sth);
    }
    ...
    /**
     * Get a number of records as an eset_recordset.  $sql must be a complete SQL query.
