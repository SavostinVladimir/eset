...
class sqlsrv_native_eset_recordset extends eset_recordset {
    ...
    /** @var sqlsrv_native_eset_database */
    protected $db;

    public function __construct($rsrc, sqlsrv_native_eset_database $db) {
        $this->rsrc    = $rsrc;
    ...
    private function fetch_next() {
        ...
        // Eset expects everything from DB as strings.
        foreach ($row as $k=>$v) {
            if (is_null($v)) {
                continue;
            }
