...
require_once(__DIR__.'/test_eset_database.php');
require_once(__DIR__.'/../../eset_read_slave_trait.php');

/**
 * Database driver test class with eset_read_slave_trait
 *
 * @package    core
 * @category   dml
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class read_slave_eset_database extends test_eset_database {
