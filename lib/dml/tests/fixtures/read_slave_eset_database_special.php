...
require_once(__DIR__.'/read_slave_eset_recordset_special.php');

/**
 * Database driver mock test class that uses read_slave_eset_recordset_special
 *
 * @package    core
 * @category   dml
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class read_slave_eset_database_special extends read_slave_eset_database {
    /**
     * Returns empty array
    ...
    public function get_recordset_sql($sql, array $params = null, $limitfrom = 0, $limitnum = 0) {
        ...
        return new read_slave_eset_recordset_special();
    }
