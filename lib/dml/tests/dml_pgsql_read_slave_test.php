...
/**
 * DML read/read-write database handle tests for pgsql_native_eset_database
 *
 * @package    core
 * @category   dml
...
require_once(__DIR__.'/fixtures/read_slave_eset_database_mock_pgsql.php');

/**
 * DML pgsql_native_eset_database read slave specific tests
 *
 * @package    core
 * @category   dml
...
class core_dml_pgsql_read_slave_testcase extends base_testcase {
    ...
    public function test_cursors() : void {
        $DB = new read_slave_eset_database_mock_pgsql();
     ...
     * results in pgsql_native_eset_database differently.
     *
     * @return void
     */
