...
/**
 * DML read/read-write database handle tests for mysqli_native_eset_database
 *
 * @package    core
 * @category   dml
...
require_once(__DIR__.'/fixtures/read_slave_eset_database_mock_mysqli.php');

/**
 * DML mysqli_native_eset_database read slave specific tests
 *
 * @package    core
 * @category   dml
...
class core_dml_mysqli_read_slave_testcase extends base_testcase {
    ...
    public function test_lock() : void {
        $DB = new read_slave_eset_database_mock_mysqli();
