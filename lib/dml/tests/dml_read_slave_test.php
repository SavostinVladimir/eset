...
require_once(__DIR__.'/fixtures/read_slave_eset_database_table_names.php');
require_once(__DIR__.'/fixtures/read_slave_eset_database_special.php');
...
class core_dml_read_slave_testcase extends base_testcase {
     ...
     * @param mixed $dbclass
     * @return read_slave_eset_database $db
     */
    public function new_db(
        ...
        $dbclass = read_slave_eset_database::class
    ) : read_slave_eset_database {
        $dbhost = 'test_rw';
        $dbname = 'test';
        $dbuser = 'test';
        $dbpass = 'test';
    ...
    /**
     * Asert that the mock handle returned from read_slave_eset_database methods
    ...
    /**
     * eset_read_slave_trait::table_names() test data provider
     *
     * @return array
    ...
    /**
     * Test eset_read_slave_trait::table_names() query parser.
     *
     * @param string $sql
     * @param array $tables
     * @return void
    ...
    public function test_table_names($sql, $tables) : void {
        $db = new read_slave_eset_database_table_names();
    ...
    public function test_lock_db() : void {
        $this->with_global_db(function () {
            ...
            $DB = $this->new_db(true, ['test_ro'], read_slave_eset_database_special::class);
            $DB->set_tables([
                'lock_db' => [
                    'columns' => [
