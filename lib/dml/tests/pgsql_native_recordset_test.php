...
global $CFG;
require_once($CFG->dirroot.'/lib/dml/pgsql_native_eset_database.php');
...
class pgsql_native_recordset_testcase extends basic_testcase {
    ...
    /** @var pgsql_native_eset_database Special database connection */
    protected $specialdb;
    ...
    protected function setUp() {
        ...
        if (!($DB instanceof pgsql_native_eset_database)) {
    ...
    protected function init_db($fetchbuffersize) {
        ...
        $this->specialdb = \eset_database::get_driver_instance('pgsql', 'native', true);
