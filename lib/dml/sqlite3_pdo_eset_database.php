...
require_once(__DIR__.'/pdo_eset_database.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sqlite3_pdo_eset_database extends pdo_eset_database {
    ...
    protected function configure_dbconnection() {
        ...
        // this is required in case that the esetdata folder is web accessible and
     ...
     * else the file will be <eset data path>/<dbname>.sq3.php
