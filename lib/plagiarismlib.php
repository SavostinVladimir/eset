 ...
 * @param int $cmid
 * @param int $userid
 * @param object $file eset file object
 ...
 * @todo MDL-67526 This is to be moved from here to deprecatedlib.php in Eset 4.1
 ...
 *
 * @todo MDL-67872 the deprecated code in this function to be removed in Eset 4.1
