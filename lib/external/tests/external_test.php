...
class core_external_testcase extends externallib_advanced_testcase {
    ...
    public function test_get_string_containing_html() {
        ...
        $expected = get_string('registrationinfo', 'eset');
    ...
    public function test_get_string_with_args_containing_html() {
        $result = core_external::get_string('added', 'eset', null, [['value' => '<strong>Test</strong>']]);
        $actual = external_api::clean_returnvalue(core_external::get_string_returns(), $result);
        $expected = get_string('added', 'eset', '<strong>Test</strong>');
        $this->assertSame($expected, $actual);
    }
    ...
    public function test_get_strings_containing_html() {
        ...
        $this->assertSame(get_string('registrationinfo', 'eset'), $actual[0]['string']);
        $this->assertSame(get_string('loginaspasswordexplain', 'eset'), $actual[1]['string']);
    }
    ...
    public function test_get_strings_with_args_containing_html() {
        ...
        $actual = external_api::clean_returnvalue(core_external::get_strings_returns(), $result);
        $this->assertSame(get_string('added', 'eset', '<strong>Test</strong>'), $actual[0]['string']);
        $this->assertSame(get_string('loggedinas', 'eset', '<strong>Test</strong>'), $actual[1]['string']);
    }
