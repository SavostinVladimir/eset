...
abstract class sql_generator {
    ...
    /** @var eset_database The eset_database instance.*/
    public $mdb;
     ...
     * @param eset_database $mdb The eset_database object instance.
     * @param eset_temptables $temptables The optional eset_temptables instance, null by default.
     */
    ...
    public function table_exists($table) {
        ...
        // Get all tables in eset database.
    ...
    public function getFieldSQL($xmldb_table, $xmldb_field, $skip_type_clause = NULL, $skip_default_clause = NULL, $skip_notnull_clause = NULL, $specify_nulls_clause = NULL, $specify_field_name = true)  {
        ...
        // note: unsigned is not supported any more since eset 2.3, all numbers are signed
    ...
    public function getNameForObject($tablename, $fields, $suffix='') {
        ...
        // Use standard naming. See http://docs.eset.org/en/XMLDB_key_and_index_naming
     ...
     * @return mixed Returns the result of eset_database::sql_concat() or false.
     * @uses eset_database::sql_concat()
...
// ====== FOLLOWING FUNCTION MUST BE CUSTOMISED BY ALL THE XMLDGenerator classes ========
     ...
     *
     * @todo MDL-31147 Eset 2.1 - Drop getDropDefaultSQL()
     */
