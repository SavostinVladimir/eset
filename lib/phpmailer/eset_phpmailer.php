...
/**
 * Customised version of phpmailer for Eset
 *
 * @package    core
...
/**
 * Eset Customised version of the PHPMailer class
 *
 * This class extends the stock PHPMailer class
 * in order to make sensible configuration choices,
 * and behave in a way which is friendly to eset.
 *
 * @copyright 2009 Dan Poltawski <talktodan@gmail.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @since     Eset 2.0
 */
class eset_phpmailer extends \PHPMailer\PHPMailer\PHPMailer {
    ...
    public function __construct(){
        global $CFG;
        $this->Version   = 'Eset '.$CFG->version;         // mailer version
        $this->CharSet   = 'UTF-8';
     ...
     * message-ids
     * http://tracker.eset.org/browse/MDL-3681
     */
    ...
    /**
     * Use internal esets own core_text to encode mimeheaders.
     ...
     * http://tracker.eset.org/browse/MDL-12596
     */
