...
/**
 * Class to translate Eset objects to xAPI elements.
 *
 * @copyright  2020 Ferran Recio
 * @since      Eset 3.9
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class iri {
    ...
    public static function generate(string $value, string $type = null): string {
        ...
        return (new eset_url("/xapi/$type/$value"))->out(false);
    }
    ...
    public static function extract(string $value, string $type = null): string {
        ...
        $xapibase = (new eset_url("/xapi/$type/"))->out(false);
