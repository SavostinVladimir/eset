ESET-SPECIFIC PEAR MODIFICATIONS
==================================

XML/Parser
=================
1/ changed ereg_ to preg_
* http://cvs.eset.org/eset/lib/pear/XML/Parser.php.diff?r1=1.1&r2=1.2
...
MDL-40267 - Eset core_text strlen functions used for range rule rule to be utf8 safe.
