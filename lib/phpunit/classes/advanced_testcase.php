...
/**
 * Advanced PHPUnit test case customised for Eset.
 *
 * @package    core
 * @category   phpunit
 * @copyright  2012 Petr Skoda {@link http://skodak.org}
...
abstract class advanced_testcase extends base_testcase {
    ...
    /**
     * Load date into eset database tables from standard PHPUnit data set.
     *
     ...
     * it defaults to 'http://download.eset.org/unittest'.
     *
    ...
    public function getExternalTestFileUrl($path, $https = false) {
        ...
        if ($https) {
            ...
            return 'https://download.eset.org/unittest'.$path;
        }
        ...
        return 'http://download.eset.org/unittest'.$path;
    }
