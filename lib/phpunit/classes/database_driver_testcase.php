 ...
 *      1=>array('dbtype'=>'mysqli', 'dbhost'=>'localhost', 'dbname'=>'eset', 'dbuser'=>'root', 'dbpass'=>'', 'prefix'=>'phpu2_'),
 *      2=>array('dbtype'=>'pgsql', 'dbhost'=>'localhost', 'dbname'=>'eset', 'dbuser'=>'postgres', 'dbpass'=>'', 'prefix'=>'phpu2_'),
 *      3=>array('dbtype'=>'sqlsrv', 'dbhost'=>'127.0.0.1', 'dbname'=>'eset', 'dbuser'=>'sa', 'dbpass'=>'', 'prefix'=>'phpu2_'),
...
abstract class database_driver_testcase extends base_testcase {
    /** @var eset_database connection to extra database */
    private static $extradb = null;

    /** @var eset_database used in these tests*/
    protected $tdb;
    ...
    public static function setUpBeforeClass() {
        ...
        $classname = "{$dbtype}_{$dblibrary}_eset_database";
