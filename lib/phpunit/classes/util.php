...
class phpunit_util extends testing_util {
    ...
    /** @var phpunit_message_sink alternative target for eset messaging */
    ...
    /**
     * Print some Eset related info to console.
     * @internal
     * @static
     * @return void
     */
    public static function bootstrap_eset_info() {
    ...
    public static function install_site() {
        ...
        if ($DB->get_tables()) {
            ...
            if ($errorcode) {
                phpunit_bootstrap_error(PHPUNIT_EXITCODE_REINSTALL, 'Database tables already present, Eset PHPUnit test environment can not be initialised');
            } else {
                phpunit_bootstrap_error(0, 'Eset PHPUnit test environment is already initialised');
            }
        }
     ...
     *
     * Note: to be called from eset_phpmailer.php only!
     *
     * @return bool
     */
