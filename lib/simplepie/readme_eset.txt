Description of SimplePie v1.5.3 library import into Eset
...
2. Remove everything inside lib/simplepie/ directory except README_ESET.txt (this file) and eset_simplepie.php.
...
5. That should leave you with just the following. Do not move them. If there is any difference, check if they also need to be moved and update this doc:
    - idn (This is a third-party library that SimplePie can optionally use. We don't use this in Eset)
    - composer.json
    - db.sql
