Description of import of various jQuery libraries into Eset:

1/ download jQuery JS from http://jquery.com/download/,
   delete old files and edit plugins.php and lib/requirejs/eset-config.js
...
6/ Update the version of jquery in core_privacy\local\request\eset_content_writer::write_html_data()
