...
class core_grades_external extends external_api {
     ...
     * @since Eset 2.7
     * @deprecated Eset 3.2 MDL-51373 - Please do not call this function any more.
    ...
    public static function get_grades($courseid, $component = null, $activityid = null, $userids = array()) {
        ...
        require_capability('eset/grade:viewhidden', $coursecontext);
        ...
        if (has_capability('eset/grade:viewall', $coursecontext)) {
            ...
            if ($params['userids'][0] == $USER->id and has_capability('eset/grade:view', $coursecontext)) {
                // Student can view their own grades in this course.
                $access = true;

            } else if (has_capability('eset/grade:viewall', context_user::instance($params['userids'][0]))) {
        ...
        if (!$access) {
            throw new eset_exception('nopermissiontoviewgrades', 'error');
        }
        ...
        if ($activitygrades = grade_item::fetch_all($gradeparams)) {
            $canviewhidden = has_capability('eset/grade:viewhidden', context_course::instance($params['courseid']));
    ...
    public static function update_grades($source, $courseid, $component, $activityid,
        ...
        if ($editinggradeitem && !has_capability('eset/grade:manage', $coursecontext)) {
            throw new eset_exception('nopermissiontoviewgrades', 'error', '', null,
                'eset/grade:manage required to edit grade information');
        }
        if ($hidinggrades && !has_capability('eset/grade:hide', $coursecontext) &&
            !has_capability('eset/grade:hide', $coursecontext)) {
            throw new eset_exception('nopermissiontoviewgrades', 'error', '', null,
                'eset/grade:hide required to hide grade items');
        }
        if ($editinggrades && !has_capability('eset/grade:edit', $coursecontext)) {
            throw new eset_exception('nopermissiontoviewgrades', 'error', '', null,
                'eset/grade:edit required to edit grades');
        }
    ...
    public static function create_gradecategory(int $courseid, string $fullname, array $options) {
        ...
        require_capability('eset/grade:manage', $context);
