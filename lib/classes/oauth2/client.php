...
class client extends \oauth2_client {
     ...
     * the fields back into eset fields.
     *
     * @return array|false Eset user fields for the logged in user (or false if request failed)
     */
    public function get_userinfo() {
        ...
        $user = new stdClass();
        foreach ($map as $openidproperty => $esetproperty) {
