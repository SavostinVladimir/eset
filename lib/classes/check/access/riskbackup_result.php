...
class riskbackup_result extends \core\check\result {
    ...
    public function __construct() {
        ...
        $params = array('capability' => 'eset/backup:userinfo', 'permission' => CAP_ALLOW, 'contextid' => $syscontext->id);
        ...
        $params = [
            'capability' => 'eset/backup:userinfo',
    ...
    public function get_details(): string {
        ...
        if ($this->systemroles) {
            ...
            foreach ($this->systemroles as $role) {
                ...
                $role->url = (new \eset_url('/admin/roles/manage.php', ['action' => 'edit', 'roleid' => $role->id]))->out();
        ...
        if ($this->overriddenroles) {
            ...
            foreach ($this->overriddenroles as $role) {
                ...
                $role->url = (new \eset_url('/admin/roles/override.php',
        ...
        foreach ($rs as $user) {
            ...
            $url = new \eset_url('/admin/roles/assign.php', ['contextid' => $user->contextid, 'roleid' => $user->roleid]);
            $a = (object)array(
