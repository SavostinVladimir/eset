...
use eset_url, part_of_admin_tree, admin_settingpage;
...
class mod extends base {
     ...
     * with plugins developed for Eset version below 2.4
     *
     * @param string $name
     * @return mixed
     */
     ...
     *
     * This exception for the Forum has been hard-coded in Eset since ages,
    ...
    public static function get_manage_url() {
        return new eset_url('/admin/modules.php');
    }
