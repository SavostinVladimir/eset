...
class enrol extends base {
    ...
    public static function get_manage_url() {
        return new eset_url('/admin/settings.php', array('section'=>'manageenrols'));
    }
    ...
    public function get_uninstall_extra_warning() {
        ...
        $migrateurl = new eset_url('/admin/enrol.php', array('action'=>'migrate', 'enrol'=>$this->name, 'sesskey'=>sesskey()));
