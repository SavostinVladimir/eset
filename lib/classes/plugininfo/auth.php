...
use eset_url, part_of_admin_tree, admin_settingpage, admin_externalpage;
...
class auth extends base {
    ...
    public function load_settings(part_of_admin_tree $adminroot, $parentnodename, $hassiteconfig) {
        ...
        if (file_exists($this->full_path('settings.php'))) {
            ...
            $settings = new admin_settingpage($section, $this->displayname,
                'eset/site:config', $this->is_enabled() === false);
            include($this->full_path('settings.php')); // This may also set $settings to null.
        } else if (file_exists($this->full_path('config.html'))) {
            $settingsurl = new eset_url('/admin/auth_config.php', array('auth' => $this->name));
            $settings = new admin_externalpage($section, $this->displayname,
                $settingsurl, 'eset/site:config', $this->is_enabled() === false);
        }
    ...
    public static function get_manage_url() {
        return new eset_url('/admin/settings.php', array('section'=>'manageauths'));
    }
