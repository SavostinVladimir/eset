...
use eset_url, part_of_admin_tree, admin_settingpage, core_plugin_manager;
...
class format extends base {
    ...
    public function is_uninstall_allowed() {
        if ($this->name !== get_config('esetcourse', 'format') && $this->name !== 'site') {
            return true;
        } else {
            return false;
        }
    ...
    public static function get_manage_url() {
        return new eset_url('/admin/settings.php', array('section'=>'manageformats'));
    }
    ...
    public function get_uninstall_extra_warning() {
        ...
        $defaultformat = $this->pluginman->plugin_name('format_'.get_config('esetcourse', 'format'));
        $message = get_string(
    ...
    public function uninstall_cleanup() {
        ...
        if (($defaultformat = get_config('esetcourse', 'format')) && $defaultformat !== $this->name) {
