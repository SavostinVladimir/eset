...
interface url_rewriter {
    ...
    /**
     * Rewrite eset_urls into another form.
     *
     * @param eset_url $url a url to potentially rewrite
     * @return eset_url Returns a new, or the original, eset_url;
     */
    public static function url_rewrite(\eset_url $url);
