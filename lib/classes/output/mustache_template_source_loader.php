...
class mustache_template_source_loader {
     ...
     *
     * @param string $component The eset component (e.g. core_message)
     ...
     * ]
     *
     * @param string $templatecomponent The eset component (e.g. core_message)
     ...
     * @param string|null $lang eset translation language, null means use current.
     * @return array
     */
