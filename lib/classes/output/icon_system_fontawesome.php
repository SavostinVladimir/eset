 ...
 *   2. fontawesome - font awesome markup is generated with the name of the icon mapped from the eset icon name.
...
class icon_system_fontawesome extends icon_system_font {
    ...
    /**
     * @var array $map Cached map of eset icon names to font awesome icon names.
     */
    private $map = [];
    ...
    public function get_core_icon_map() {
        return [
            ...
            'core:i/eset_host' => 'fa-graduation-cap',
