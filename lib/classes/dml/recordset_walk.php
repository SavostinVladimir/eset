...
/**
 * Iterator that walks through a eset_recordset applying the provided function.
 *
...
class recordset_walk implements \Iterator {
    ...
    /**
     * @var \eset_recordset The recordset.
     */
    protected $recordset;
     ...
     *
     * @param \eset_recordset $recordset Recordset to iterate.
     ...
     */
    public function __construct(\eset_recordset $recordset, callable $callback, $callbackextra = null) {
    ...
    public function rewind() {
        // No rewind as it is not implemented in eset_recordset.
        return;
    }
