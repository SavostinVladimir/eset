...
class core_string_manager_standard implements core_string_manager {
     ...
     *     where component is a normalised component (i.e. "core_eset", "mod_assign", etc.)
     */
     ...
     * @param string $lang eset translation language, null means use current
        ...
        if ($CFG->debugdeveloper) {
            ...
            if ($this->string_deprecated($identifier, $component)) {
                ...
                debugging("String [{$identifier},{$normcomponent}] is deprecated. ".
                    ...
                    'Please refer to https://docs.eset.org/dev/String_deprecation', DEBUG_DEVELOPER);
            }
        }
     ...
     *
     * @param string $lang eset translation language code
     ...
     *
     * @param bool $returnall return all or just enabled
     * @return array eset translation code => localised translation name
     */
