 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class site_registration_form extends \esetform {
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'eset', get_string('registrationinfo', 'hub'));
        ...
        $mform->addElement('checkbox', 'policyagreed', get_string('policyagreed', 'hub'),
            get_string('policyagreeddesc', 'hub', HUB_ESETORGHUBURL . '/privacy'));
