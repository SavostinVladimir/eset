...
';
     ...
     *
     * @param string|null $component A valid eset component (frankenstyle) or null if searching all components
    ...
    public static function normalize_component($component) {
        if ($component === 'eset' or $component === 'core' or $component === '') {
