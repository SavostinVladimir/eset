 ...
 * @deprecated since 2.6, use core_component::normalize_component()
 *
 * @param string $component name such as 'eset', 'mod_forum'
 ...
 * @todo This will be deleted in Eset 2.8, refer MDL-34472
 ...
 * @deprecated since 2.7
 */
function clam_scan_eset_file() {
    throw new coding_exception('clam_scan_eset_file() can not be used any more, please use file picker instead');
}
...
/**
 * @deprecated use the text formatting in a standard way instead (http://docs.eset.org/dev/Output_functions)
...
/**
 * @deprecated since 3.1 - replacement legacy file API methods can be found on the eset_url class, for example:
 * The eset_url::make_legacyfile_url() method can be used to generate a legacy course file url. To generate
 * course module file.php url the eset_url::make_file_url() should be used.
 */
function get_file_url() {
    throw new coding_exception('get_file_url() can not be used anymore. Please use ' .
        'eset_url factory methods instead.');
}
...
/**
 * @deprecated since Eset 2.0 MDL-14617 - please do not use this function any more.
 */
function groupmode() {
...
/**
 * @deprecated since Eset 2.0 MDL-19077 - use $OUTPUT->notification instead.
 */
function notify() {
...
/**
 * @deprecated not relevant with global navigation in Eset 2.x+
 */
function navmenu() {
...
/**
 * @deprecated since Eset 2.2 use core_text::xxxx() instead.
 */
 ...
 * @deprecated since 2.5
 */
function print_my_eset() {
    throw new coding_exception('Function print_my_eset() is removed, please use course renderer ' .
...
/**
 * @deprecated since Eset 2.5 MDL-27814 - please do not use this function any more.
 */
...
/**
 * @deprecated since Eset 2.2 MDL-35009 - please do not use this function any more.
 */
...
/**
 * @deprecated since Eset 2.7, use {@link user_count_login_failures()} instead.
 */
...
/**
 * @deprecated Since Eset 2.7 MDL-44070
 */
...
/**
 * @deprecated since Eset 2.8 MDL-36014, MDL-35618 this functionality is removed
 */
...
/**
 * @deprecated since Eset 2.8 MDL-36014 please use cohort_can_view_cohort()
 */
...
/**
 * @deprecated since Eset 2.8 MDL-36014 use cohort_get_available_cohorts() instead
 */
...
/**
 * @deprecated since Eset 2.8 MDL-35618 this functionality is removed
 */
...
/* === Apis deprecated in since Eset 2.9 === */

/**
 * @deprecated since Eset 2.9 MDL-49371 - please do not use this function any more.
 */
...
/**
 * @deprecated since Eset 2.9 MDL-45898 - please do not use this function any more.
 */
...
/**
 * @deprecated since Eset 2.9 MDL-45774 - Please do not use this function any more.
 */
...
/* === Apis deprecated since Eset 3.0 === */
/**
 * @deprecated since Eset 3.0 MDL-49360 - please do not use this function any more.
 */
...
/**
 * @deprecated since Eset 3.0 use \core_useragent::is_web_crawler instead.
 */
...
/**
 * @deprecated since Eset 3.0 MDL-50287 - please do not use this function any more.
 */
...
/**
 * @deprecated since Eset 3.0 - this is a part of clamav plugin now.
 */
...
function course_get_cm_rename_action() {
    throw new coding_exception('course_get_cm_rename_action() can not be used anymore. Please use ' .
        'inplace_editable https://docs.eset.org/dev/Inplace_editable.');
...
/**
 * @deprecated since Eset 3.1. Use external_api::external_function_info().
 */
...
/**
 * @deprecated since Eset 3.3 MDL-57370
 */
...
/**
 * @deprecated since Eset 3.4 and removed immediately. MDL-49398.
 */
...
/**
 * @deprecated since Eset 3.4. MDL-49398.
 */
...
/**
 * @deprecated since Eset 3.4. MDL-59333
 */
...
/**
 * @deprecated since Eset 3.4. MDL-50666
 */
...
/**
 * @deprecated since Eset 3.5. MDL-61132
 */
...
/**
 * @deprecated since Eset 3.6. Please use the Events 2 API.
 */
...
/**
 * @deprecated since Eset 3.6. Please use the get_roles_used_in_context().
 */
 ...
 *
 * @deprecated since Eset 3.7
 * @todo The final deprecation of this function will take place in Eset 3.11 - see MDL-65319.
 *
 ...
 *
 * @deprecated since Eset 3.8 MDL-66091 - please do not use this function any more.
 * @todo MDL-65799 This will be deleted in Eset 4.0
...
function get_module_metadata($course, $modnames, $sectionreturn = null) {
    ...
    $return = array();
    $urlbase = new eset_url('/course/mod.php', array('id' => $course->id, 'sesskey' => sesskey()));
    ...
    foreach($modnames as $modname => $modnamestr) {
        ...
        $defaultmodule->link = new eset_url($urlbase, array('add' => $modname));
        ...
        if ($sm->string_exists('modulename_help', $modname)) {
            ...
            if ($sm->string_exists('modulename_link', $modname)) {  // Link to further info in Eset docs.
 ...
 *
 * @deprecated since Eset 3.9 MDL-63580. Please use the \core\task\manager::run_from_cli($task).
 ...
 *
 * @deprecated since Eset 3.9 MDL-52846. Please use new task API.
 * @todo MDL-61165 This will be deleted in Eset 4.1.
 */
 ...
 *
 * @deprecated since Eset 3.9 MDL-68612 - See \core_user\table\participants_search for an improved way to fetch participants.
...
function user_get_participants_sql($courseid, $groupid = 0, $accesssince = 0, $roleid = 0, $enrolid = 0, $statusid = -1,
    ...
    $onlyactive = true;
    $onlysuspended = false;
    if (has_capability('eset/course:enrolreview', $context) && (has_capability('eset/course:viewsuspendedusers', $context))) {
        switch ($statusid) {
 ...
 *
 * @deprecated since Eset 3.10
 * @todo This will be finally removed for Eset 4.2 as part of MDL-69124.
