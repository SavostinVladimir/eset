 ...
 * @return bool
 */
function is_eset_cookie_secure() {
    global $CFG;
...
/**
 * Sets a eset cookie with a weakly encrypted username
 *
 * @param string $username to encrypt and place in a cookie, '' means delete current cookie
 * @return void
 */
function set_eset_cookie($username) {
    global $CFG;
    ...
    $cookiename = 'ESETID1_'.$CFG->sessioncookie;
...
/**
 * Gets a eset cookie with a weakly encrypted username
 *
 * @return string username
 */
function get_eset_cookie() {
    global $CFG;
