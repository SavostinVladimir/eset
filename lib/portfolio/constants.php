 ...
 *                         into eset.xml (?and the file bits if necessary)
 */
...
/**
 * PORTFOLIO_ADD_MOODULE_URL - hacky way to turn the button class into a eset_url to redirect to
 *                             this replaces the old portfolio_fake_add_url function
 */
define('PORTFOLIO_ADD_ESET_URL', 6);
