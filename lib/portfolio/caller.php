 ...
 *
 * For places in eset that want to
 * add export functionality to subclass from {@link http://docs.eset.org/dev/Adding_a_Portfolio_Button_to_a_page}
 *
 ...
 *
 * @link See http://docs.eset.org/dev/Adding_a_Portfolio_Button_to_a_page
...
abstract class portfolio_caller_base {
     ...
     *
     * @param esetform $mform passed by reference, add elements to it.
    ...
    /**
     * Just like the eset form validation function,
     ...
     *
     * @param eset_page $PAGE global page object
     */
 ...
 * don't need to.
 * {@link http://docs.eset.org/dev/Adding_a_Portfolio_Button_to_a_page}
...
abstract class portfolio_module_caller_base extends portfolio_caller_base {
     ...
     *
     * @param eset_page $PAGE global PAGE
     */
