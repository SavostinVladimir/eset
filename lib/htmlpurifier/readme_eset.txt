Description of HTML Purifier v4.12.0 library import into Eset
...
* add locallib.php with Eset specific extensions to /lib/htmlpurifier/
* add this readme_eset.txt to /lib/htmlpurifier/
