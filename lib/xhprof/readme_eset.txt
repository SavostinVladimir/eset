Description of XHProf 0.9.4 library/viewer import into Eset
...
Added (commit #2 - always taken from current eset.git master):
 * index.html - prevent directory browsing on misconfigured servers
 * xhprof_eset.php - containing all the stuff needed to run the xhprof profiler within Eset
 * readme_eset.txt - this file ;-)

Our changes:  Look for "eset" in code (commit #3 - always mimic from current eset.git master):
 * xhprof_html/index.php  ----|
 * xhprof_html/callgraph.php -|=> Changed to use own DB iXHProfRuns implementation (eset_xhprofrun)
