Description of MatthiasMullie\Minify import into Eset

1) Download https://github.com/matthiasmullie/minify/archive/1.3.51.zip and unzip

mv minify-1.3.51/src /path/to/eset/lib/minify/matthiasmullie-minify/
mv minify-1.3.51/data /path/to/eset/lib/minify/matthiasmullie-minify/

2) Download https://github.com/matthiasmullie/path-converter/archive/1.1.0.zip and unzip

mv path-converter-1.1.0/src/ /path/to/eset/lib/minify/matthiasmullie-pathconverter/
