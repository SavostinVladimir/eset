...
class filter_manager {
    /**
     * @var eset_text_filter[][] This list of active filters, by context, for filtering content.
     * An array contextid => ordered array of filter name => filter objects.
     */
    protected $textfilters = array();

    /**
     * @var eset_text_filter[][] This list of active filters, by context, for filtering strings.
     * An array contextid => ordered array of filter name => filter objects.
     */
     ...
     * @return eset_text_filter The filter, or null, if this type of filter is
     ...
     * @param string $text
     * @param eset_text_filter[] $filterchain array filter name => filter object.
     ...
     * @return eset_text_filter[] A text filter
     */
    ...
    /**
     * @deprecated Since Eset 3.0 MDL-50491. This was used by the old text filtering system, but no more.
     */
...
class null_filter_manager {
     ...
     * As for the equivalent {@link filter_manager} method.
     *
     * @deprecated Since Eset 3.0 MDL-50491.
     */
    public function text_filtering_hash() {
        throw new coding_exception('filter_manager::text_filtering_hash() can not be used any more');
    }
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class eset_text_filter {
    ...
    public function hash() {
        throw new coding_exception('eset_text_filter::hash() can not be used any more');
    }
...
/**
 * Get the names of all the filters installed in this Eset.
 *
...
function filter_get_active_in_context($context) {
    ...
    // http://docs.eset.org/dev/Filter_enable/disable_by_context.
