...
/**
 * Simple implementation of some Google API functions for Eset.
 *
 * @package   core
    ...
    public function get_file_list($search = '') {
        ...
        try {
            if (strpos($content, '<?xml') !== 0) {
                throw new eset_exception('invalidxmlresponse');
            }
