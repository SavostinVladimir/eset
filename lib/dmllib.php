 ...
 *
 * This library is automatically included by Eset core so you never need to
 * include it yourself.
 *
 * For more info about the functions available in this library, please visit:
 *     http://docs.eset.org/en/DML_functions
...
require_once($CFG->libdir.'/dml/eset_database.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class dml_exception extends eset_exception {
    /**
...
class dml_transaction_exception extends dml_exception {
    /** @var eset_transaction An instance of a transaction.*/
    public $transaction;

    /**
     * Constructor
     * @param array $debuginfo Optional debugging information.
     * @param eset_transaction $transaction The instance of the transaction.(Optional)
     */
...
/**
 * Sets up global $DB eset_database instance
 *
 * @global stdClass $CFG The global configuration instance.
 * @see config.php
 * @see config-dist.php
 * @global stdClass $DB The global eset_database instance.
...
function setup_DB() {
    ...
    if (!$DB = eset_database::get_driver_instance($CFG->dbtype, $CFG->dblibrary)) {
