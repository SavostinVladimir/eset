 ...
 * @package   core_table
 * @category  test
 * @copyright  2020 Simey Lameze <simey@eset.com>
...
class get_test extends advanced_testcase {
    ...
    public function test_table_get_execute(): void {
        ...
        $course = $this->getDataGenerator()->create_course();
        $user1 = $this->getDataGenerator()->create_and_enrol($course, 'student', ['email' => 's1@eset.com']);
        $user2 = $this->getDataGenerator()->create_and_enrol($course, 'student', ['email' => 's2@eset.com']);
        $user3 = $this->getDataGenerator()->create_user(['email' => 's3@eset.com']);
        $teacher = $this->getDataGenerator()->create_and_enrol($course, 'teacher', ['email' => 't1@eset.com']);
