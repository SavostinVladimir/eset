...
by Eloy Lafuente <stronk7@eset.org>
...
by Marina Glancy <marina@eset.com>
...
by Jun Pataleta <jun@eset.com>

2015/03/23
----------
Upgrade to tcpdf_php5 TCPDF 6.2.6 (MDL-49522)
by Adrian Greeve <adrian@eset.com>
...
* FreeFont chosen as a default utf8 font distributed by default, all others will
    be downloadable from eset.org via new UI
* removed font/utils/
...
* modified config/tcpdf_config.php
    ...
    the Eset installation. K_PATH_CACHE set to Eset datadir cache.
    K_PATH_URL_CACHE can't be mapped in Eset as datadir should not be
