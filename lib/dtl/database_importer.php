...
class database_importer {
    /** @var eset_database Connection to the target database (a @see eset_database object). */
    protected $mdb;
    ...
    /** @var eset_transaction Transaction object */
    protected $transaction;

    /**
     * Object constructor.
     *
     * @param eset_database $mdb Connection to the target database (a
     * @see eset_database object). Use null to use the current $DB connection.
     ...
     * @see begin_database_import).
     */
    public function __construct(eset_database $mdb, $check_schema=true) {
        $this->mdb          = $mdb;
     ...
     *
     * @throws dbtransfer_exception if any checking (e.g. database schema, Eset
     * version) fails
     *
