...
class database_mover extends database_exporter {
     ...
     * Object constructor.
     *
     * @param eset_database $mdb_source Connection to the source database (a
     * @see eset_database object).
     * @param eset_database $mdb_target Connection to the target database (a
     * @see eset_database object).
     ...
     * @see export_database).
     */
    public function __construct(eset_database $mdb_source, eset_database $mdb_target,
