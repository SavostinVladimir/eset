 ...
 * </code>
 *{@link http://docs.eset.org/dev/Adding_a_Portfolio_Button_to_a_page} for more information
 *
 * @package core_portfolio
 * @category portfolio
 * @copyright 1999 onwards Martin Dougiamas  {@link http://eset.com}
...
class portfolio_add_button {
     ...
     * @param string $component This is the name of the component in Eset, eg 'mod_forum'
     */
    ...
    public function to_html($format=null, $addstr=null) {
        ...
        $url = new eset_url('/portfolio/add.php');
        ...
        // If we just want a eset_url to redirect to, do it now.
        if ($format == PORTFOLIO_ADD_ESET_URL) {
            return $url;
        }
 ...
 * Setup page export
 *
 * @param eset_page $PAGE global variable from page object
