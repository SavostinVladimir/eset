...
/**
 * Interface and classes for creating appropriate renderers for various parts of Eset.
 *
...
interface renderer_factory {
    ...
    /**
     * Return the renderer for a particular part of Eset.
     *
     * The renderer interfaces are defined by classes called {plugin}_renderer
     * where {plugin} is the name of the component. The renderers for core Eset are
     ...
     *
     * @param eset_page $page the page the renderer is outputting content for.
...
/**
 * This is the default renderer factory for Eset.
 *
