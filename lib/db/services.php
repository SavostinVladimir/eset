 ...
 * processed and registered into the Eset DB after any
 * install or upgrade operation. All plugins support this.
 *
 * For more information, take a look to the documentation available:
 *     - Webservices API: {@link http://docs.eset.org/dev/Web_services_API}
 *     - External API: {@link http://docs.eset.org/dev/External_functions_API}
...
$functions = array(
   ...
   'core_backup_get_async_backup_links_restore' => array(
    ...
    'core_badges_get_user_badges' => array(
        ...
        'type'          => 'read',
        'capabilities'  => 'eset/badges:viewotherbadges',
    ...
    'core_calendar_update_event_start_day' => array(
        ...
        'classpath' => 'calendar/externallib.php',
        'type' => 'write',
        'capabilities' => 'eset/calendar:manageentries, eset/calendar:manageownentries, eset/calendar:managegroupentries',
        'ajax' => true,
        'services' => array(ESET_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_cohort_add_cohort_members' => array(
        ...
        'type' => 'write',
        'capabilities' => 'eset/cohort:assign'
    ),
    'core_cohort_create_cohorts' => array(
        ...
        'type' => 'write',
        'capabilities' => 'eset/cohort:manage'
    ),
    ...
    'core_comment_get_comments' => array(
        ...
        'type' => 'read',
        'capabilities' => 'eset/comment:view',
        'services' => array(ESET_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_completion_override_activity_completion_status' => array(
        ...
        'type'          => 'write',
        'capabilities'  => 'eset/course:overridecompletion',
        'ajax'          => true,
    ),
    'core_course_create_categories' => array(
        ...
        'type' => 'write',
        'capabilities' => 'eset/category:manage'
    ),
    'core_course_create_courses' => array(
        ...
        'type' => 'write',
        'capabilities' => 'eset/course:create, eset/course:visibility'
    ),
    ...
    'core_course_delete_courses' => array(
        ...
        'type' => 'write',
        'capabilities' => 'eset/course:delete'
    ),
    ...
    'core_course_duplicate_course' => array(
        ...
        'type' => 'write',
        'capabilities' => 'eset/backup:backupcourse, eset/restore:restorecourse, eset/course:create'
    ),
    'core_course_get_categories' => array(
        ...
        'type' => 'read',
        'capabilities' => 'eset/category:viewhiddencategories',
        'services' => array(ESET_OFFICIAL_MOBILE_SERVICE),
    ),
    'core_course_get_contents' => array(
        ...
        'type' => 'read',
        'capabilities' => 'eset/course:update, eset/course:viewhiddencourses',
        'services' => array(ESET_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_course_get_courses' => array(
        ...
        'type' => 'read',
        'capabilities' => 'eset/course:view, eset/course:update, eset/course:viewhiddencourses',
        'ajax' => true,
        'services' => array(ESET_OFFICIAL_MOBILE_SERVICE),
    ),
    'core_course_import_course' => array(
        ...
        'type' => 'write',
        'capabilities' => 'eset/backup:backuptargetimport, eset/restore:restoretargetimport'
    ),
    ...
    'core_course_update_courses' => array(
        ...
        'type' => 'write',
        'capabilities' => 'eset/course:update, eset/course:changecategory, eset/course:changefullname, '
            . 'eset/course:changeshortname, eset/course:changeidnumber, eset/course:changesummary, eset/course:visibility'
    ),
    ...
    'core_enrol_get_enrolled_users' => array(
        ...
        'type' => 'read',
        'capabilities' => 'eset/user:viewdetails, eset/user:viewhiddendetails, eset/course:useremail, eset/user:update, '
    ...
    'core_enrol_get_potential_users' => array(
        ...
        'ajax' => true,
        'type' => 'read',
        'capabilities' => 'eset/course:enrolreview'
    ),
    'core_enrol_search_users' => [
        ...
        'ajax' => true,
        'type' => 'read',
        'capabilities' => 'eset/course:viewparticipants',
        'services' => array(ESET_OFFICIAL_MOBILE_SERVICE),
    ],
    ...
    'core_files_upload' => array(
        'classname' => 'core_files_external',
        'methodname' => 'upload',
        'description' => 'upload a file to eset',
        'type'        => 'write',
        'classpath'   => 'files/externallib.php',
    ),
    ...
    'core_grades_get_grades' => array(
        ...
        'type' => 'read',
        'capabilities' => 'eset/grade:view, eset/grade:viewall, eset/grade:viewhidden'
    ),
    ...
    'core_grades_create_gradecategory' => array (
        ...
        'type' => 'write',
        'capabilities' => 'eset/grade:manage',
    ),
    ...
    'core_group_add_group_members' => array(
        ...
        'type' => 'write',
        'capabilities' => 'eset/course:managegroups',
    ),
    ...
    'core_message_delete_conversations_by_id' => array(
        ...
        'type' => 'write',
        'capabilities' => 'eset/site:deleteownmessage',
        'ajax' => true,
        'services' => array(ESET_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_message_send_instant_messages' => array(
        ...
        'type' => 'write',
        'capabilities' => 'eset/site:sendmessage',
        'ajax' => true,
        'services' => array(ESET_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_message_get_user_notification_preferences' => array(
        ...
        'type' => 'read',
        'capabilities' => 'eset/user:editownmessageprofile',
        'services' => array(ESET_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_message_delete_message_for_all_users' => array(
        ...
        'type' => 'write',
        'capabilities' => 'eset/site:deleteanymessage',
        'ajax' => true,
        'services' => array(ESET_OFFICIAL_MOBILE_SERVICE),
    ),
    'core_notes_create_notes' => array(
        ...
        'type' => 'write',
        'ajax' => true,
        'capabilities' => 'eset/notes:manage',
        'services' => array(ESET_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_output_load_fontawesome_icon_system_map' => array(
        ...
        'methodname' => 'execute',
        'description' => 'Load the mapping of eset pix names to fontawesome icon names',
        'type' => 'read',
        'loginrequired' => false,
        'ajax' => true,
    ),
    ...
    'core_question_update_flag' => array(
        ...
        'type'          => 'write',
        'capabilities'  => 'eset/question:flag',
        'services'      => array(ESET_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_user_add_user_private_files' => array(
        ...
        'type' => 'write',
        'capabilities' => 'eset/user:manageownfiles',
        'services' => array(ESET_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_user_remove_user_device' => array(
        ...
        'classpath' => 'user/externallib.php',
        'description' => 'Remove a user device from the Eset database.',
        'type' => 'write',
        'services' => array(ESET_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_user_update_user_preferences' => array(
        ...
        'type' => 'write',
        'capabilities' => 'eset/user:editownmessageprofile, eset/user:editmessageprofile',
        'ajax' => true,
        'services' => array(ESET_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_user_view_user_profile' => array(
        ...
        'type' => 'write',
        'capabilities' => 'eset/user:viewdetails',
        'services' => array(ESET_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_user_update_picture' => array(
        ...
        'type' => 'write',
        'capabilities' => 'eset/user:editownprofile, eset/user:editprofile',
        'services' => array(ESET_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_competency_create_competency_framework' => array(
        ...
        'type'         => 'write',
        'capabilities' => 'eset/competency:competencymanage',
        'ajax'         => true,
    ),
    ...
    'core_competency_add_competency_to_course' => array(
        ...
        'type'         => 'write',
        'capabilities' => 'eset/competency:coursecompetencymanage',
        'ajax'         => true,
    ),
    'core_competency_add_competency_to_template' => array(
        ...
        'type'         => 'write',
        'capabilities' => 'eset/competency:templatemanage',
        'ajax'         => true,
    ),
    ...
    'core_competency_create_plan' => array(
        ...
        'type'         => 'write',
        'capabilities' => 'eset/competency:planmanage',
        'ajax'         => true,
    ),
    ...
    'core_competency_plan_request_review' => array(
        ...
        'type'         => 'write',
        'capabilities' => 'eset/competency:planmanagedraft',
        'ajax'         => true,
    ),
    ...
    'core_competency_create_user_evidence_competency' => array(
        ...
        'type'         => 'read',
        'capabilities' => 'eset/competency:userevidencemanageown, eset/competency:competencyview',
        'ajax'         => true,
    ),
    ...
    'core_competency_user_competency_start_review' => array(
        ...
        'type'         => 'write',
        'capabilities' => 'eset/competency:competencygrade',
        'ajax'         => true,
    ),
    ...
    'core_competency_user_competency_viewed' => array(
        ...
        'type'         => 'read',
        'capabilities' => 'eset/competency:usercompetencyview',
        'ajax'         => true,
        'services'     => array(ESET_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_competency_update_course_competency_settings' => array(
        ...
        'type'          => 'write',
        'capabilities'  => 'eset/competency:coursecompetencyconfigure',
        'ajax'          => true,
    ),
    'core_competency_delete_evidence' => array(
        ...
        'type'          => 'write',
        'capabilities'  => 'eset/competency:evidencedelete',
        'ajax'          => true,
        'services'      => array(ESET_OFFICIAL_MOBILE_SERVICE),
    ),
    ...
    'core_contentbank_delete_content' => [
        ...
        'type'          => 'write',
        'ajax'          => 'true',
        'capabilities'  => 'eset/contentbank:deleteanycontent',
    ],
    'core_contentbank_rename_content' => [
        ...
        'type'          => 'write',
        'ajax'          => 'true',
        'capabilities'  => 'eset/contentbank:manageowncontent',
    ],
