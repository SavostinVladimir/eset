...
/**
 * This file contains the eset_page class. There is normally a single instance
 ...
 * @property-read string $docspath The path to the Eset docs for this page.
 ...
 * @property-read eset_url $url The eset url object for this page.
 */
class eset_page {
    ...
    /**
     * @var string Set a different path to use for the 'Eset docs for this page' link.
    ...
    /**
     * @var eset_url The URL for this page. This is mandatory and must be set
     ...
     */
    protected $_blockseditingcap = 'eset/site:manageblocks';
     ...
     * initialised via {@link eset_page::initialise_theme_and_output()} which
    ...
    /**
     * Please do not call this method directly, use the ->state syntax. {@link eset_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->headerprinted syntax. {@link eset_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->course syntax. {@link eset_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->cm syntax. {@link eset_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->activityrecord syntax. {@link eset_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->activityname syntax. {@link eset_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->category syntax. {@link eset_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->categories syntax. {@link eset_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->context syntax. {@link eset_page::__get()}.
     * @return context the main context to which this page belongs.
     */
    protected function magic_get_context() {
        global $CFG;
        if (is_null($this->_context)) {
            if (CLI_SCRIPT or NO_ESET_COOKIES) {
    ...
    /**
     * Please do not call this method directly, use the ->pagetype syntax. {@link eset_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->pagelayout syntax. {@link eset_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->layout_options syntax. {@link eset_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->subpage syntax. {@link eset_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->bodyclasses syntax. {@link eset_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->title syntax. {@link eset_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->heading syntax. {@link eset_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->docspath syntax. {@link eset_page::__get()}.
     * @return string the path to the Eset docs for this page.
     */
    ...
    /**
     * Please do not call this method directly, use the ->url syntax. {@link eset_page::__get()}.
     * @return eset_url the clean URL required to load the current page. (You
    ...
    /**
     * Please do not call this method directly, use the ->blocks syntax. {@link eset_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->requires syntax. {@link eset_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->cacheable syntax. {@link eset_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->focuscontrol syntax. {@link eset_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->button syntax. {@link eset_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->theme syntax. {@link eset_page::__get()}.
    ...
    /**
     * Please do not call this method directly, use the ->devicetypeinuse syntax. {@link eset_page::__get()}.
    ...
    /**
     * Please do not call this method directly use the ->opencontainers syntax. {@link eset_page::__get()}
     ...
     * In the eset_page class all properties must be set using the appropriate
    ...
    public function set_state($state) {
        if ($state != $this->_state + 1 || $state > self::STATE_DONE) {
            throw new coding_exception('Invalid state passed to eset_page::set_state. We are in state ' .
    ...
    public function set_course($course) {
        ...
        if (empty($course->id)) {
            throw new coding_exception('$course passed to eset_page::set_course does not look like a proper course object.');
        }
     ...
     * {@link http://docs.eset.org/dev/Themes_2.0#The_different_layouts_as_of_August_17th.2C_2010}
     ...
     * available for your version of Eset is {@link theme/base/config.php}
     *
    ...
    public function add_body_class($class) {
        if ($this->_state > self::STATE_BEFORE_HEADER) {
            throw new coding_exception('Cannot call eset_page::add_body_class after output has been started.');
        }
    ...
    /**
     * Sets some HTML to use next to the heading {@link eset_page::set_heading()}
     *
    ...
    /**
     * Set a different path to use for the 'Eset docs for this page' link.
     *
     ...
     *
     * @param string $path the path to use at the end of the eset docs URL.
     */
     ...
     *
     * @param eset_url|string $url URL relative to $CFG->wwwroot or {@link eset_url} instance
    ...
    public function set_url($url, array $params = null) {
        ...
        $this->_url = new eset_url($url, $params);
     ...
     * @param string|eset_url $url The URL of the alternate version.
     * @param string $mimetype The mime-type of the alternate version.
     * @throws coding_exception
     */
    public function add_alternate_version($title, $url, $mimetype) {
        if ($this->_state > self::STATE_BEFORE_HEADER) {
            throw new coding_exception('Cannot call eset_page::add_alternate_version after output has been started.');
        }
        $alt = new stdClass;
        $alt->title = $title;
        $alt->url = $url;
     ...
     *
     * Normally the default of 'eset/site:manageblocks' is used, but a few
     * pages like the My Eset page need to use a different capability
     * like 'eset/my:manageblocks'.
     *
    ...
    /**
     * Method for use by Eset core to set up the theme. Do not
     ...
     * page.
     *
     * This will load {@link eset_page::$_module} with a row from the related
     * module table in the database.
     * For instance if {@link eset_page::$_cm} is a forum then a row from the
    ...
    protected function load_category($categoryid) {
        ...
        if (!$category) {
            throw new eset_exception('unknowncategory');
        }
