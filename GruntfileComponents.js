...
/**
 * Helper functions for working with Eset component names, directories, and sources.
 *
...
/** @var {Object} A list of subsystems in Eset */
const componentData = {};

/**
 * Load details of all eset modules.
 *
 * @returns {object}
 */
const fetchComponentData = () => {
    ...
    if (!Object.entries(componentData).length) {
        ...
        // Build the list of eset subsystems.
