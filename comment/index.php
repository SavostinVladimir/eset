...
require_capability('eset/comment:delete', $context);
...
if ($action === 'delete') {
    ...
    if (!empty($commentid)) {
        if (!$confirm) {
            ...
            $buttoncontinue = new single_button(new eset_url('/comment/index.php', $optionsyes), get_string('delete'));
            $buttoncancel = new single_button(new eset_url('/comment/index.php', $optionsno), get_string('cancel'));
