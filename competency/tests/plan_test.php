...
class core_competency_plan_testcase extends advanced_testcase {
    ...
    public function test_can_manage_user() {
        ...
        assign_capability('eset/competency:planmanage', CAP_ALLOW, $manage, $syscontext->id);
        assign_capability('eset/competency:planmanageown', CAP_ALLOW, $manageown, $u2context->id);
    ...
    public function test_can_manage_user_draft() {
        ...
        assign_capability('eset/competency:planmanage', CAP_ALLOW, $manage, $syscontext->id);
        assign_capability('eset/competency:planmanageown', CAP_ALLOW, $manageown, $syscontext->id);
        assign_capability('eset/competency:planmanagedraft', CAP_ALLOW, $managedraft, $syscontext->id);
        assign_capability('eset/competency:planmanageowndraft', CAP_ALLOW, $manageowndraft, $syscontext->id);
    ...
    public function test_can_read_user() {
        ...
        assign_capability('eset/competency:planview', CAP_ALLOW, $read, $syscontext->id);
        assign_capability('eset/competency:planviewown', CAP_ALLOW, $readown, $u2context->id);
    ...
    public function test_can_read_user_draft() {
        ...
        assign_capability('eset/competency:planview', CAP_ALLOW, $read, $syscontext->id);
        assign_capability('eset/competency:planviewown', CAP_ALLOW, $readown, $syscontext->id);
        assign_capability('eset/competency:planviewdraft', CAP_ALLOW, $readdraft, $syscontext->id);
        assign_capability('eset/competency:planviewowndraft', CAP_ALLOW, $readowndraft, $syscontext->id);
        assign_capability('eset/competency:planviewown', CAP_PROHIBIT, $readowndraft, $syscontext->id);
