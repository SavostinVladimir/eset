...
class core_competency_external_testcase extends externallib_advanced_testcase {
    ...
    public function test_create_and_update_plans() {
        ...
        assign_capability('eset/competency:planmanageowndraft', CAP_ALLOW, $this->userrole, $syscontext->id);
        accesslib_clear_all_caches_for_unit_testing();
        ...
        assign_capability('eset/competency:planmanageown', CAP_ALLOW, $this->userrole, $syscontext->id);
        accesslib_clear_all_caches_for_unit_testing();
        ...
        unassign_capability('eset/competency:planmanageown', $this->userrole, $syscontext->id);
        unassign_capability('eset/competency:planmanageowndraft', $this->userrole, $syscontext->id);
        accesslib_clear_all_caches_for_unit_testing();
    ...
    public function test_read_plans() {
        ...
        assign_capability('eset/competency:plancommentown', CAP_PROHIBIT, $this->userrole, $syscontext->id, true);
        assign_capability('eset/competency:planviewown', CAP_PROHIBIT, $this->userrole, $syscontext->id, true);
        assign_capability('eset/competency:planviewowndraft', CAP_ALLOW, $this->userrole, $syscontext->id, true);
        accesslib_clear_all_caches_for_unit_testing();
        ...
        assign_capability('eset/competency:plancommentown', CAP_ALLOW, $this->userrole, $syscontext->id, true);
        assign_capability('eset/competency:planviewown', CAP_ALLOW, $this->userrole, $syscontext->id, true);
        assign_capability('eset/competency:planmanageowndraft', CAP_PROHIBIT, $this->userrole, $syscontext->id, true);
        accesslib_clear_all_caches_for_unit_testing();
        ...
        assign_capability('eset/competency:planviewown', CAP_PROHIBIT, $this->userrole, $syscontext->id, true);
        assign_capability('eset/competency:planmanageown', CAP_PROHIBIT, $this->userrole, $syscontext->id, true);
        assign_capability('eset/competency:planmanageowndraft', CAP_ALLOW, $this->userrole, $syscontext->id, true);
        accesslib_clear_all_caches_for_unit_testing();
        ...
        assign_capability('eset/competency:planviewown', CAP_PROHIBIT, $this->userrole, $syscontext->id, true);
        assign_capability('eset/competency:planmanageowndraft', CAP_PROHIBIT, $this->userrole, $syscontext->id, true);
        assign_capability('eset/competency:planmanageown', CAP_ALLOW, $this->userrole, $syscontext->id, true);
        accesslib_clear_all_caches_for_unit_testing();
    ...
    public function test_delete_plans() {
        ...
        unassign_capability('eset/competency:planmanage', $this->creatorrole, $syscontext->id);
        accesslib_clear_all_caches_for_unit_testing();
    ...
    public function test_add_competency_to_template() {
        ...
        // Unassign capability.
        unassign_capability('eset/competency:templatemanage', $this->creatorrole, $syscontext->id);
        accesslib_clear_all_caches_for_unit_testing();
    ...
    public function test_read_template() {
        ...
        assign_capability('eset/competency:templateview', CAP_PROHIBIT, $this->userrole, $syscontextid, true);
        accesslib_clear_all_caches_for_unit_testing();
        $this->setUser($this->user);
        $this->assertFalse(has_capability('eset/competency:templateview', context_system::instance()));
        try {
        ...
        assign_capability('eset/competency:templateview', CAP_PREVENT, $this->userrole, $syscontextid, true);
        assign_capability('eset/competency:templateview', CAP_ALLOW, $this->userrole, $catcontextid, true);
        accesslib_clear_all_caches_for_unit_testing();
        $this->assertFalse(has_capability('eset/competency:templateview', context_system::instance()));
        $this->assertTrue(has_capability('eset/competency:templateview', context_coursecat::instance($this->category->id)));
        try {
            external::read_template($systemplate->id);
            $this->fail('Invalid permissions');
        } catch (required_capability_exception $e) {
        ...
        assign_capability('eset/competency:templateview', CAP_ALLOW, $this->userrole, $syscontextid, true);
        accesslib_clear_all_caches_for_unit_testing();
        $this->assertTrue(has_capability('eset/competency:templateview', context_system::instance()));
    ...
    public function test_update_course_competency_settings() {
        ...
        assign_capability('eset/competency:coursecompetencyconfigure', CAP_ALLOW, $roleid, $context->id, true);
        assign_capability('eset/competency:coursecompetencyview', CAP_ALLOW, $roleid, $context->id, true);
        assign_capability('eset/competency:coursecompetencyview', CAP_ALLOW, $noobroleid, $context->id, true);
