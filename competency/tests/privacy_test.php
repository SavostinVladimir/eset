...
class core_competency_privacy_testcase extends provider_testcase {
    ...
    protected function allow_anyone_to_comment_anywhere() {
        ...
        assign_capability('eset/competency:plancomment', CAP_ALLOW, $roleid, SYSCONTEXTID, true);
        assign_capability('eset/competency:planmanage', CAP_ALLOW, $roleid, SYSCONTEXTID, true);
        assign_capability('eset/competency:planmanagedraft', CAP_ALLOW, $roleid, SYSCONTEXTID, true);
        assign_capability('eset/competency:usercompetencycomment', CAP_ALLOW, $roleid, SYSCONTEXTID, true);
        assign_capability('eset/competency:usercompetencyview', CAP_ALLOW, $roleid, SYSCONTEXTID, true);
