...
class core_competency_course_competency_settings_testcase extends advanced_testcase {
    ...
    public function test_who_can_change_settings() {
        ...
        assign_capability('eset/competency:coursecompetencyconfigure', CAP_ALLOW, $role, $syscontext->id);
        assign_capability('eset/competency:competencygrade', CAP_ALLOW, $role, $syscontext->id);
        assign_capability('eset/competency:coursecompetencyview', CAP_ALLOW, $role, $syscontext->id);
        assign_capability('eset/competency:planview', CAP_ALLOW, $role, $syscontext->id);
        $gradedrole = create_role('Graded role', 'graded', 'Someone who can be graded');
        assign_capability('eset/competency:coursecompetencygradable', CAP_ALLOW, $gradedrole, $syscontext->id);
