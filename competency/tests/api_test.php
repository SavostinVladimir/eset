...
class core_competency_api_testcase extends advanced_testcase {
    ...
    public function test_get_framework_related_contexts_with_capabilities() {
        ...
        assign_capability('eset/competency:competencyview', CAP_ALLOW, $roleallow, $sysctx->id);
        role_assign($roleallow, $user->id, $sysctx->id);

        $roleprevent = create_role('Prevent', 'prevent', 'Prevent read');
        assign_capability('eset/competency:competencyview', CAP_PROHIBIT, $roleprevent, $sysctx->id);
        role_assign($roleprevent, $user->id, $cat2ctx->id);

        accesslib_clear_all_caches_for_unit_testing();
        $this->setUser($user);
        $this->assertFalse(has_capability('eset/competency:competencyview', $cat2ctx));

        $requiredcap = array('eset/competency:competencyview');
    ...
    public function test_get_template_related_contexts_with_capabilities() {
        ...
        $roleallow = create_role('Allow', 'allow', 'Allow read');
        assign_capability('eset/competency:templateview', CAP_ALLOW, $roleallow, $sysctx->id);
        role_assign($roleallow, $user->id, $sysctx->id);

        $roleprevent = create_role('Prevent', 'prevent', 'Prevent read');
        assign_capability('eset/competency:templateview', CAP_PROHIBIT, $roleprevent, $sysctx->id);
        role_assign($roleprevent, $user->id, $cat2ctx->id);

        accesslib_clear_all_caches_for_unit_testing();
        $this->setUser($user);
        $this->assertFalse(has_capability('eset/competency:templateview', $cat2ctx));

        $requiredcap = array('eset/competency:templateview');
    ...
    public function test_update_plan() {
        ...
        assign_capability('eset/competency:planmanageowndraft', CAP_ALLOW, $manageowndraftrole, $syscontext->id);
        assign_capability('eset/competency:planviewowndraft', CAP_ALLOW, $manageowndraftrole, $syscontext->id);

        assign_capability('eset/competency:planmanageown', CAP_ALLOW, $manageownrole, $syscontext->id);
        assign_capability('eset/competency:planviewown', CAP_ALLOW, $manageownrole, $syscontext->id);

        assign_capability('eset/competency:planmanagedraft', CAP_ALLOW, $managedraftrole, $syscontext->id);
        assign_capability('eset/competency:planviewdraft', CAP_ALLOW, $managedraftrole, $syscontext->id);

        assign_capability('eset/competency:planmanage', CAP_ALLOW, $managerole, $syscontext->id);
        assign_capability('eset/competency:planview', CAP_ALLOW, $managerole, $syscontext->id);
    ...
    protected function setup_workflow_data() {
        ...
        assign_capability('eset/competency:planmanageowndraft', CAP_ALLOW, $userrole, $syscontext->id);
        assign_capability('eset/competency:planmanage', CAP_ALLOW, $reviewerrole, $syscontext->id);
        assign_capability('eset/competency:planviewdraft', CAP_ALLOW, $reviewerrole, $syscontext->id);
    ...
    public function test_update_plan_manage_archived_competencies() {
        ...
        assign_capability('eset/competency:planmanageowndraft', CAP_ALLOW, $manageownrole, $syscontext->id);
        assign_capability('eset/competency:planviewowndraft', CAP_ALLOW, $manageownrole, $syscontext->id);
        assign_capability('eset/competency:planmanageown', CAP_ALLOW, $manageownrole, $syscontext->id);
        assign_capability('eset/competency:planviewown', CAP_ALLOW, $manageownrole, $syscontext->id);
    ...
    public function test_delete_plan_manage_archived_competencies() {
        ...
        assign_capability('eset/competency:planmanageowndraft', CAP_ALLOW, $managerole, $syscontext->id);
        assign_capability('eset/competency:planmanageown', CAP_ALLOW, $managerole, $syscontext->id);
    ...
    public function test_list_plan_competencies_manage_archived_competencies() {
        ...
        assign_capability('eset/competency:planviewdraft', CAP_ALLOW, $viewrole, $syscontext->id);
        assign_capability('eset/competency:planview', CAP_ALLOW, $viewrole, $syscontext->id);
    ...
    public function test_create_template_cohort_permissions() {
        ...
        $user = $dg->create_user();
        $role = $dg->create_role();
        assign_capability('eset/competency:templatemanage', CAP_ALLOW, $role, $syscontext->id, true);
        $dg->role_assign($role, $user->id, $syscontext->id);

        $cohortrole = $dg->create_role();
        assign_capability('eset/cohort:view', CAP_ALLOW, $cohortrole, $syscontext->id, true);
    ...
    public function test_reorder_template_competencies_permissions() {
        ...
        unassign_capability('eset/competency:templatemanage', $role, $syscontext->id);
        accesslib_clear_all_caches_for_unit_testing();
        ...
        assign_capability('eset/competency:templatemanage', CAP_ALLOW, $role, $catcontext->id, true);
        ...
        unassign_capability('eset/competency:templatemanage', $role, $catcontext->id);
        accesslib_clear_all_caches_for_unit_testing();
    ...
    public function test_add_evidence_log() {
        ...
        $evidence = api::add_evidence($u1->id, $c1->get('id'), $u1ctx->id, \core_competency\evidence::ACTION_LOG, 'invaliddata',
            'error', '$a', false, 'http://eset.org', null, 2, 'The evidence of prior learning were reviewed.');
        $evidence->read();
        $uc = \core_competency\user_competency::get_record(array('userid' => $u1->id, 'competencyid' => $c1->get('id')));
        $this->assertEquals(\core_competency\user_competency::STATUS_IDLE, $uc->get('status'));
        $this->assertSame(null, $uc->get('grade'));
        ...
        $this->assertEquals('http://eset.org', $evidence->get('url'));
        $this->assertSame(null, $evidence->get('grade'));
    ...
    public function test_add_evidence_existing_user_competency() {
        ...
        $evidence = api::add_evidence($user->id, $c1->get('id'), $syscontext->id, \core_competency\evidence::ACTION_OVERRIDE,
            'invalidevidencedesc', 'core_competency', array('a' => 'b'), false, 'http://eset.org', 1, 2);
    ...
    public function test_add_evidence_no_existing_user_competency() {
        ...
        $evidence = api::add_evidence($user->id, $c1->get('id'), $syscontext->id, \core_competency\evidence::ACTION_OVERRIDE,
            'invalidevidencedesc', 'core_competency', 'Hello world!', false, 'http://eset.org', 1, 2);
        $this->assertEquals(1, \core_competency\evidence::count_records());
    ...
    public function test_grade_competency_in_course_permissions() {
        ...
        assign_capability('eset/competency:coursecompetencygradable', CAP_ALLOW, $gradablerole, $sysctx->id);

        $notgradablerole = $dg->create_role();
        assign_capability('eset/competency:coursecompetencygradable', CAP_PROHIBIT, $notgradablerole, $sysctx->id);

        $canviewucrole = $dg->create_role();
        assign_capability('eset/competency:usercompetencyview', CAP_ALLOW, $canviewucrole, $sysctx->id);

        $cannotviewcomp = $dg->create_role();
        assign_capability('eset/competency:competencyview', CAP_PROHIBIT, $cannotviewcomp, $sysctx->id);

        $canmanagecomp = $dg->create_role();
        assign_capability('eset/competency:competencymanage', CAP_ALLOW, $canmanagecomp, $sysctx->id);

        $cangraderole = $dg->create_role();
        assign_capability('eset/competency:competencygrade', CAP_ALLOW, $cangraderole, $sysctx->id);
    ...
    public function test_list_plans_to_review() {
        ...
        assign_capability('eset/competency:planreview', CAP_ALLOW, $roleallow, $sysctx->id);
        assign_capability('eset/competency:planreview', CAP_PROHIBIT, $roleprohibit, $sysctx->id);
    ...
    public function test_list_user_competencies_to_review() {
        ...
        $roleallow = $dg->create_role();
        $roleprohibit = $dg->create_role();
        assign_capability('eset/competency:usercompetencyreview', CAP_ALLOW, $roleallow, $sysctx->id);
        assign_capability('eset/competency:usercompetencyreview', CAP_PROHIBIT, $roleprohibit, $sysctx->id);
        role_assign($roleallow, $reviewer->id, $sysctx->id);
        accesslib_clear_all_caches_for_unit_testing();
