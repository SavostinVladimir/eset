...
class core_competency_lib_testcase extends advanced_testcase {
    ...
    public function test_comment_add_user_competency() {
        ...
        assign_capability('eset/competency:planview', CAP_ALLOW, $reviewerroleid, context_system::instance()->id, true);
        assign_capability('eset/competency:usercompetencycomment', CAP_ALLOW, $reviewerroleid,
        ...
        $this->assertEquals(FORMAT_ESET, $message->fullmessageformat);
    ...
    public function test_comment_add_plan() {
        ...
        $reviewerroleid = $dg->create_role();
        assign_capability('eset/competency:planviewowndraft', CAP_ALLOW, $userroleid, context_system::instance()->id, true);
        assign_capability('eset/competency:planviewown', CAP_ALLOW, $userroleid, context_system::instance()->id, true);
        assign_capability('eset/competency:planviewdraft', CAP_ALLOW, $reviewerroleid, context_system::instance()->id, true);
        assign_capability('eset/competency:planmanage', CAP_ALLOW, $reviewerroleid, context_system::instance()->id, true);
        assign_capability('eset/competency:plancomment', CAP_ALLOW, $reviewerroleid, context_system::instance()->id, true);
