...
class template extends persistent {
    ...
    public static function can_manage_context($context) {
        return has_capability('eset/competency:templatemanage', $context);
    }
    ...
    public static function can_read_context($context) {
        return has_capability('eset/competency:templateview', $context) || self::can_manage_context($context);
    }
