...
class api {
    ...
    public static function require_enabled() {
        if (!static::is_enabled()) {
            throw new eset_exception('competenciesarenotenabled', 'core_competency');
        }
    }
    ...
    protected static function validate_course($courseorid, $throwexception = true) {
        ...
        if (!$course->visible and !has_capability('eset/course:viewhiddencourses', $coursecontext)) {
            if ($throwexception) {
     ...
     *
     * Requires eset/competency:competencymanage capability at the system context.
     *
    ...
    public static function create_competency(stdClass $record) {
        ...
        require_capability('eset/competency:competencymanage', $competency->get_context());
    ...
    public static function move_down_competency($id) {
        ...
        // First we do a permissions check.
        require_capability('eset/competency:competencymanage', $current->get_context());
     ...
     *
     * Requires eset/competency:competencyview capability at the system context.
     *
    ...
    public static function read_competency($id, $includerelated = false) {
        ...
        if (!has_any_capability(array('eset/competency:competencyview', 'eset/competency:competencymanage'), $context)) {
             throw new required_capability_exception($context, 'eset/competency:competencyview', 'nopermissions', '');
        }
     ...
     *
     * Requires eset/competency:competencyview capability at the framework context.
     *
     ...
     *
     * Requires eset/competency:competencyview capability at some context.
     *
    ...
    public static function create_framework(stdClass $record) {
        ...
        require_capability('eset/competency:competencymanage', $framework->get_context());
    ...
    public static function read_framework($id) {
        static::require_enabled();
        $framework = new competency_framework($id);
        if (!has_any_capability(array('eset/competency:competencyview', 'eset/competency:competencymanage'),
                $framework->get_context())) {
            throw new required_capability_exception($framework->get_context(), 'eset/competency:competencyview',
                'nopermissions', '');
        }
        return $framework;
    }
    ...
    public static function competency_viewed($competencyorid) {
        ...
        if (!has_any_capability(array('eset/competency:competencyview', 'eset/competency:competencymanage'),
            ...
            throw new required_capability_exception($competency->get_context(), 'eset/competency:competencyview',
                'nopermissions', '');
        }
    ...
    public static function list_frameworks($sort, $order, $skip, $limit, $context, $includes = 'children',
        ...
        $contexts = self::get_related_contexts($context, $includes,
            array('eset/competency:competencyview', 'eset/competency:competencymanage'));
    ...
    public static function list_course_modules_using_competency($competencyid, $courseid) {
        ...
        if (!has_any_capability($capabilities, $coursecontext)) {
            throw new required_capability_exception($coursecontext, 'eset/competency:coursecompetencyview', 'nopermissions', '');
        }
    ...
    public static function list_course_module_competencies_in_course_module($cmorid) {
        ...
        $capabilities = array('eset/competency:coursecompetencyview', 'eset/competency:coursecompetencymanage');
        if (!has_any_capability($capabilities, $context)) {
            throw new required_capability_exception($context, 'eset/competency:coursecompetencyview', 'nopermissions', '');
        }
    ...
    public static function get_user_competency($userid, $competencyid) {
        ...
        if (!$uc->can_read()) {
            throw new required_capability_exception($uc->get_context(), 'eset/competency:usercompetencyview',
                'nopermissions', '');
        }
        return $uc;
    }
    ...
    public static function get_user_competency_in_course($courseid, $userid, $competencyid) {
        ...
        if (!has_any_capability($capabilities, $context)) {
            ...
            throw new required_capability_exception($context, 'eset/competency:usercompetencyview', 'nopermissions', '');
        }
    ...
    public static function list_user_competencies_to_review($skip = 0, $limit = 50, $userid = null) {
        ...
        $capability = 'eset/competency:usercompetencyreview';
    ...
    public static function add_competency_to_course_module($cmorid, $competencyid) {
        ...
        require_capability('eset/competency:coursecompetencymanage', $context);
     ...
     *
     * Requires eset/competency:coursecompetencymanage capability at the course module context.
     *
     * @param mixed $cmorid The course module, or id of the course module
     ...
     *
     * Requires eset/competency:coursecompetencymanage capability at the course context.
     *
    ...
    public static function set_course_competency_ruleoutcome($coursecompetencyorid, $ruleoutcome) {
        ...
        require_capability('eset/competency:coursecompetencymanage', $coursecontext);
     ...
     *
     * Requires eset/competency:templatemanage capability.
     *
     * @param stdClass $record Record containing all the data for an instance of the class.
     * @return template
     */
    public static function create_template(stdClass $record) {
        ...
        if (!$template->can_manage()) {
            throw new required_capability_exception($template->get_context(), 'eset/competency:templatemanage',
                'nopermissions', '');
        }
     ...
     *
     * Requires eset/competency:templatemanage capability at the template context.
     *
    ...
    public static function delete_template($id, $deleteplans = true) {
        ...
        if ($success) {
            ...
            $transaction->rollback(new eset_exception('Error while deleting the template.'));
        }
    ...
    public static function update_template($record) {
        ...
        if (!$success) {
            $transaction->rollback(new eset_exception('Error while updating the template.'));
            return $success;
        }
     ...
     *
     * Requires eset/competency:templateview capability at the system context.
     *
    ...
    public static function read_template($id) {
        ...
        if (!$template->can_read()) {
             throw new required_capability_exception($template->get_context(), 'eset/competency:templateview',
                'nopermissions', '');
        }
    ...
    public static function list_templates($sort, $order, $skip, $limit, $context, $includes = 'children', $onlyvisible = false) {
        ...
        // Get all the relevant contexts.
        $contexts = self::get_related_contexts($context, $includes,
            array('eset/competency:templateview', 'eset/competency:templatemanage'));

        // First we do a permissions check.
        if (empty($contexts)) {
             throw new required_capability_exception($context, 'eset/competency:templateview', 'nopermissions', '');
        }
    ...
    public static function count_templates_using_competency($competencyid) {
        ...
        $capabilities = array('eset/competency:templateview', 'eset/competency:templatemanage');
        if (!has_any_capability($capabilities, $context)) {
             throw new required_capability_exception($context, 'eset/competency:templateview', 'nopermissions', '');
        }

        if (has_capability('eset/competency:templatemanage', $context)) {
            $onlyvisible = 0;
        }
     ...
     *
     * Requires eset/competency:templatemanage capability at the system context.
     *
    ...
    public static function create_template_cohort($templateorid, $cohortorid) {
        ...
        require_capability('eset/competency:templatemanage', $template->get_context());
        ...
        if (!$cohort->visible && !has_capability('eset/cohort:view', $cohortcontext)) {
            throw new required_capability_exception($cohortcontext, 'eset/cohort:view', 'nopermissions', '');
        }
    ...
    public static function list_user_plans($userid) {
        ...
        if (!plan::can_read_user($userid) && !plan::can_read_user_draft($userid)) {
            throw new required_capability_exception($context, 'eset/competency:planview', 'nopermissions', '');
        }
    ...
    public static function list_plans_to_review($skip = 0, $limit = 100, $userid = null) {
        ...
        // TODO MDL-52243 Use core function.
        list($insql, $inparams) = self::filter_users_with_capability_on_user_context_sql('eset/competency:planreview',
    ...
    public static function create_plan(stdClass $record) {
        ...
        if (!$plan->can_manage()) {
            ...
            throw new required_capability_exception($context, 'eset/competency:planmanage', 'nopermissions', '');
        }
    ...
    public static function create_plan_from_template($templateorid, $userid) {
        ...
        $plan = new plan(0, $record);
        if (!$plan->can_manage()) {
            throw new required_capability_exception($plan->get_context(), 'eset/competency:planmanage',
                'nopermissions', '');
        }
    ...
    public static function unlink_plan_from_template($planorid) {
        ...
        if (!$plan->can_manage()) {
            throw new required_capability_exception($plan->get_context(), 'eset/competency:planmanage', 'nopermissions', '');
        }
    ...
    public static function plan_cancel_review_request($planorid) {
        ...
        if (!$plan->can_read()) {
            throw new required_capability_exception($plan->get_context(), 'eset/competency:planview', 'nopermissions', '');
        }
    ...
    public static function complete_plan($planorid) {
        ...
        if (!$success) {
            $transaction->rollback(new eset_exception('The plan could not be updated.'));
            return $success;
        }
    ...
    public static function get_plan_competency($planorid, $competencyid) {
        ...
        if (!user_competency::can_read_user($plan->get('userid'))) {
            throw new required_capability_exception($plan->get_context(), 'eset/competency:usercompetencyview',
                'nopermissions', '');
        }
     ...
     *
     * Requires eset/competency:planmanage capability at the system context.
     *
     * @param int $planid The plan  id
     * @param int $competencyidfrom The id of the competency we are moving.
     * @param int $competencyidto The id of the competency we are moving to.
    ...
    public static function user_competency_cancel_review_request($userid, $competencyid) {
        ...
        if (!$uc || !$uc->can_read()) {
            ...
            throw new required_capability_exception($context, 'eset/competency:usercompetencyrequestreview', 'nopermissions', '');
        }
    ...
    public static function user_competency_request_review($userid, $competencyid) {
        ...
        if (!$uc->can_read()) {
            ...
            throw new required_capability_exception($uc->get_context(), 'eset/competency:usercompetencyrequestreview',
                'nopermissions', '');
        }
    ...
    public static function user_competency_start_review($userid, $competencyid) {
        ...
        if (!$uc || !$uc->can_read()) {
            ...
            throw new required_capability_exception($context, 'eset/competency:usercompetencyreview', 'nopermissions', '');
        }
    ...
    public static function user_competency_viewed_in_course($usercoursecompetencyorid) {
        ...
        if (!$ucc || !user_competency::can_read_user_in_course($ucc->get('userid'), $ucc->get('courseid'))) {
            throw new required_capability_exception($ucc->get_context(), 'eset/competency:usercompetencyview',
                'nopermissions', '');
        }
    ...
    public static function user_competency_plan_viewed($usercompetencyplanorid) {
        ...
        if (!$ucp || !user_competency::can_read_user($ucp->get('userid'))) {
            throw new required_capability_exception($ucp->get_context(), 'eset/competency:usercompetencyview',
                'nopermissions', '');
        }
    ...
    public static function add_related_competency($competencyid, $relatedcompetencyid) {
        ...
        require_capability('eset/competency:competencymanage', $competency1->get_context());
    ...
    public static function read_user_evidence($id) {
        ...
        if (!$userevidence->can_read()) {
            ...
            throw new required_capability_exception($context, 'eset/competency:userevidenceview', 'nopermissions', '');
        }
    ...
    public static function create_user_evidence($data, $draftitemid = null) {
        ...
        if (!$userevidence->can_manage()) {
            throw new required_capability_exception($context, 'eset/competency:userevidencemanage', 'nopermissions', '');
        }
    ...
    public static function delete_evidence($evidenceorid) {
        ...
        if (!evidence::can_delete_user($uc->get('userid'))) {
            throw new required_capability_exception($uc->get_context(), 'eset/competency:evidencedelete', 'nopermissions', '');
        }
    ...
    protected static function apply_competency_rules_from_usercompetency(user_competency $usercompetency,
        ...
        if ($ruleoutcome == competency::OUTCOME_EVIDENCE) {
            ...
            throw new eset_exception('Unexpected rule outcome: ' + $ruleoutcome);
        }
        ...
        if ($eventdata->completionstate == COMPLETION_COMPLETE
            ...
            foreach ($coursemodulecompetencies as $coursemodulecompetency) {
                ...
                if ($outcome == course_module_competency::OUTCOME_EVIDENCE) {
                    ...
                    throw new eset_exception('Unexpected rule outcome: ' + $outcome);
                }
    ...
    public static function grade_competency($userid, $competencyid, $grade, $note = null) {
        ...
        if (!user_competency::can_grade_user($uc->get('userid'))) {
            throw new required_capability_exception($context, 'eset/competency:competencygrade', 'nopermissions', '');
        }
        ...
        if (!has_any_capability(array('eset/competency:competencyview', 'eset/competency:competencymanage'),
                $competencycontext)) {
            throw new required_capability_exception($competencycontext, 'eset/competency:competencyview', 'nopermissions', '');
        }
    ...
    public static function grade_competency_in_course($courseorid, $userid, $competencyid, $grade, $note = null) {
        ...
        if (!is_enrolled($context, $userid, 'eset/competency:coursecompetencygradable')) {
     ...
     *
     * Requires eset/competency:coursecompetencyview capability at the course context.
     *
     * @param int $courseid The course id
     * @param int $skip The number of records to skip
     * @param int $limit The max number of records to return
    ...
    public static function get_least_proficient_competencies_for_course($courseid, $skip = 0, $limit = 100) {
        ...
        if (!has_any_capability(array('eset/competency:coursecompetencyview', 'eset/competency:coursecompetencymanage'),
                $coursecontext)) {
            throw new required_capability_exception($coursecontext, 'eset/competency:coursecompetencyview', 'nopermissions', '');
        }
     ...
     *
     * Requires eset/competency:coursecompetencyconfigure capability at the course context.
     *
     * @param int $courseid The course id
    ...
    public static function update_course_competency_settings($courseid, $settings) {
        ...
        if (!course_competency_settings::can_manage_course($courseid)) {
            $context = context_course::instance($courseid);
            throw new required_capability_exception($context, 'eset/competency:coursecompetencyconfigure', 'nopermissions', '');
        }
