...
class user_competency extends persistent {
    ...
    public static function get_status_name($status) {
        ...
        switch ($status) {
            ...
            case self::STATUS_IN_REVIEW:
                ...
                break;
            default:
                throw new \eset_exception('errorusercomptencystatus', 'core_competency', '', $status);
                break;
        }
    ...
    public static function can_comment_user($userid) {
        ...
        $capabilities = array('eset/competency:usercompetencycomment');
        if ($USER->id == $userid) {
            $capabilities[] = 'eset/competency:usercompetencycommentown';
        }
    ...
    public static function can_grade_user($userid) {
        $ratecap = 'eset/competency:competencygrade';
    ...
    public static function can_read_user_in_course($userid, $courseid) {
        $capability = 'eset/competency:usercompetencyview';
    ...
    public static function can_request_review_user($userid) {
        ...
        $capabilities = array('eset/competency:usercompetencyrequestreview');
        if ($USER->id == $userid) {
            $capabilities[] = 'eset/competency:usercompetencyrequestreviewown';
        }
