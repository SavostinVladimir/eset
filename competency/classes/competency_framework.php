...
class competency_framework extends persistent {
    ...
    public static function can_manage_context($context) {
        return has_capability('eset/competency:competencymanage', $context);
    }
    ...
    public static function can_read_context($context) {
        return has_capability('eset/competency:competencyview', $context) || self::can_manage_context($context);
    }
