...
class plan extends persistent {
    ...
    protected static function define_properties() {
        return array(
            ...
            'descriptionformat' => array(
                'choices' => array(FORMAT_HTML, FORMAT_ESET, FORMAT_PLAIN, FORMAT_MARKDOWN),
                'type' => PARAM_INT,
                'default' => FORMAT_HTML,
            ),
            'userid' => array(
    ...
    public function get_statusname() {
        ...
        switch ($status) {
            ...
            case self::STATUS_COMPLETE:
                ...
                break;
            default:
                throw new \eset_exception('errorplanstatus', 'core_competency', '', $status);
                break;
        }
    ...
    public static function can_comment_user($planuserid) {
        ...
        $capabilities = array('eset/competency:plancomment');
        if ($USER->id == $planuserid) {
            $capabilities[] = 'eset/competency:plancommentown';
        }
    ...
    public static function can_manage_user($planuserid) {
        ...
        $capabilities = array('eset/competency:planmanage');
        if ($context->instanceid == $USER->id) {
            $capabilities[] = 'eset/competency:planmanageown';
        }
    ...
    public static function can_manage_user_draft($planuserid) {
        ...
        $capabilities = array('eset/competency:planmanagedraft');
        if ($context->instanceid == $USER->id) {
            $capabilities[] = 'eset/competency:planmanageowndraft';
        }
    ...
    public static function can_read_user($planuserid) {
        ...
        $capabilities = array('eset/competency:planview');
        if ($context->instanceid == $USER->id) {
            $capabilities[] = 'eset/competency:planviewown';
        }
    ...
    public static function can_read_user_draft($planuserid) {
        ...
        $capabilities = array('eset/competency:planviewdraft');
        if ($context->instanceid == $USER->id) {
            $capabilities[] = 'eset/competency:planviewowndraft';
        }
    ...
    public static function can_request_review_user($planuserid) {
        ...
        $capabilities = array('eset/competency:planrequestreview');
        if ($USER->id == $planuserid) {
            $capabilities[] = 'eset/competency:planrequestreviewown';
        }
    ...
    public static function can_review_user($planuserid) {
        return has_capability('eset/competency:planreview', context_user::instance($planuserid))
            || self::can_manage_user($planuserid);
    }
