...
class evidence extends persistent {
    ...
    /**
     * Convenience method handling eset_urls.
     *
     * @param null|string|eset_url $url The URL.
     */
    ...
    public static function can_delete_user($userid) {
        return has_capability('eset/competency:evidencedelete', context_user::instance($userid));
    }
