...
/**
 * Strings for component 'block_rss_client', language 'en', branch 'ESET_20_STABLE'
 *
...
$string['enableautodiscovery_help'] = 'If enabled, feeds on web pages are found automatically. For example, if https://docs.eset.org is entered, then https://docs.eset.org/en/index.php?title=Special:RecentChanges&feed=rss would be found.';
