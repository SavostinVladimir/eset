 ...
 */
class eset1_block_rss_client_handler extends eset1_block_handler {
    public function process_block(array $data) {
        ...
        // Eset 1.9 backups do not include sufficient data to restore feeds, so we need an empty shell rss_client.xml
