...
class item implements \renderable, \templatable {
     ...
     */
    public function __construct($id, \eset_url $link, $title, $description, \eset_url $permalink, $timestamp,
     ...
     * @return \block_rss_client\output\item
     */
    public function set_link(\eset_url $link) {
        $this->link = $link;
