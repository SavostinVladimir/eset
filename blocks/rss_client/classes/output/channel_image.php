...
class channel_image implements \renderable, \templatable {
     ...
     * Contructor
     *
     * @param \eset_url $url The URL location of the image
     * @param string $title The title of the image
     * @param \eset_url $link The URL of the image link
     */
    public function __construct(\eset_url $url, $title, \eset_url $link = null) {
        $this->url      = $url;
        $this->title    = $title;
        $this->link     = $link;
    }
