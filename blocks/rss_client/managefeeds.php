...
$baseurl = new eset_url('/blocks/rss_client/managefeeds.php', $urlparams);
...
$managefeeds = new eset_url('/blocks/rss_client/managefeeds.php', $urlparams);
...
$table->define_headers(array(get_string('feed', 'block_rss_client'), get_string('actions', 'eset')));
...
foreach($feeds as $feed) {
    ...
    $editurl = new eset_url('/blocks/rss_client/editfeed.php?rssid=' . $feed->id . $extraparams);
    $editaction = $OUTPUT->action_icon($editurl, new pix_icon('t/edit', get_string('edit')));

    $deleteurl = new eset_url('/blocks/rss_client/managefeeds.php?deleterssid=' . $feed->id . '&sesskey=' . sesskey() . $extraparams);
