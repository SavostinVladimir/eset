...
class block_online_users extends block_base {
    ...
    function get_content() {
        ...
        $isseparategroups = ($this->page->course->groupmode == SEPARATEGROUPS
                             ...
                             && !has_capability('eset/site:accessallgroups', $this->page->context));
        ...
        if (!empty($users)) {
            ...
            if (isloggedin() && has_capability('eset/site:sendmessage', $this->page->context)
                ...
                if (isguestuser($user)) {
                    ...
                    if ($USER->id == $user->id) {
                        ...
                        if ($canshowicon) {  // Only when logged in and messaging active etc.
                            ...
                            $anchorurl = new eset_url('/message/index.php', array('id' => $user->id));
