...
class block_tag_youtube extends block_base {
     ...
     * @deprecated since Eset 2.8.8, 2.9.2 and 3.0 MDL-49085 - please do not use this function any more.
     * @param string $request
     * @throws coding_exception
     */
    public function fetch_request($request) {
        throw new coding_exception('Sorry, this function has been deprecated in Eset 2.8.8, 2.9.2 and 3.0. Use block_tag_youtube::get_service instead.');
    ...
    function render_video_list(SimpleXMLElement $xml){
        throw new coding_exception('Sorry, this function has been deprecated in Eset 2.8.8, 2.9.2 and 3.0. Use block_tag_youtube::render_items instead.');
    }
