...
/**
 * Strings for component 'block_tag_flickr', language 'en', branch 'ESET_20_STABLE'
 *
...
$string['privacy:metadata:block_tag_flickr'] = 'The Flickr block plugin does not store any personal data, but does transmit user data from Eset to the remote system.';
