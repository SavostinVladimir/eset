...
class block_completionstatus extends block_base {
    ...
    public function get_content() {
        ...
        // Can edit settings?
        $can_edit = has_capability('eset/course:update', $context);
        ...
        if ($info->is_tracked_user($USER->id)) {
            ...
            $details = new eset_url('/blocks/completionstatus/details.php', array('course' => $course->id));
        ...
        if (has_capability('report/completion:view', $context)) {
            $report = new eset_url('/report/completion/index.php', array('course' => $course->id));
