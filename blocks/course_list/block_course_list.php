...
class block_course_list extends block_list {
    ...
    function get_content() {
        ...
        $allcourselink =
            (has_capability('eset/course:update', context_system::instance())
            || empty($CFG->block_course_list_hideallcourseslink)) &&
            core_course_category::user_top();

        if (empty($CFG->disablemycourses) and isloggedin() and !isguestuser() and
          !(has_capability('eset/course:update', context_system::instance()) and $adminseesall)) {    // Just print My Courses
        ...
        if ($topcategory->is_uservisible() && ($categories = $topcategory->get_children())) { // Check we have categories.
            ...
            /// If we can update any course of the view all isn't hidden, show the view all courses link
                ...
                /// If we can update any course of the view all isn't hidden, show the view all courses link
                    ...
                    if (has_capability('eset/course:create', context_coursecat::instance($category->id))) {
